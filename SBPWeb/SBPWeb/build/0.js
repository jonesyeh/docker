...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ParameterGroupComponentsModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__parameter_group_parameter_group__ = __webpack_require__(1070);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_parameter_group_services_parameter_group_services__ = __webpack_require__(926);
...
var ParameterGroupComponentsModule = /** @class */ (function () {
    function ParameterGroupComponentsModule() {
    }
    ParameterGroupComponentsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__parameter_group_parameter_group__["a" /* ParameterGroupComponent */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_parameter_group_services_parameter_group_services__["a" /* ParameterGroupServicesProvider */],
            ],
    ...
    ], ParameterGroupComponentsModule);
    return ParameterGroupComponentsModule;
}());

//# sourceMappingURL=parameter-group.components.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ParameterGroupViewModel__ = __webpack_require__(908);
...
var ParameterGroupComponent = /** @class */ (function () {
    function ParameterGroupComponent(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, ParameterGroupServices, modalCtrl, platform, conf) {
        ...
        this.detail_page = "ParameterColumnPage";
        this.ParameterColumn_page = "ParameterColumnPage";
        ...
        if (this.authServices.authenticated() === true) {
            ...
            this.CanEditJob = this.authServices.CanEditJob();
            this.LoadData(true);
        }
    }
    ParameterGroupComponent.prototype.get_board_class = function (item) {
        if (item.parameter_column_group === this.selected)
            return "select_bordered";
        else
            return "bordered";
    };
    ParameterGroupComponent.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    ParameterGroupComponent.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
        console.log('Select Event', selected, this.row_selected);
    };
    ParameterGroupComponent.prototype.setPage = function (pageInfo) {
    ...
    ParameterGroupComponent.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    ParameterGroupComponent.prototype.doInfinite = function () {
        var _this = this;
    ...
    ParameterGroupComponent.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.ParameterGroupServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    ...
                    if (_this.totalRows > 0) {
                        ...
                        _this.row_selected = [_this.selectedItem];
                        _this.data_list = _this.data_list.slice();
                        _this.loadPages++;
                    }
                    else {
                        _this.selectedItem = null;
                        _this.row_selected = null;
                    }
    ...
    ParameterGroupComponent.prototype.ShowModal = function (item) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ParameterGroupViewModel__["a" /* ParameterGroupViewModel */]();
        ...
        var modal = this.modalCtrl.create("ParameterGroupAddEditModalPage", {
            mode: this.mode,
            item: item,
            CanEditJob: this.CanEditJob,
        });
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.ParameterGroupServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    ParameterGroupComponent.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.parameter_column_group),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.ParameterGroupServices.DeleteAsync(item.parameter_column_group).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    ParameterGroupComponent.prototype.openNavParameterColumnPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.ParameterColumn_page, { item: item });
        });
    };
    ParameterGroupComponent.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.ParameterGroupServices.GetSqlAsync(item.parameter_column_group, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    ParameterGroupComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_parameter_group_services_parameter_group_services__["a" /* ParameterGroupServicesProvider */],
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ParameterColumnServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_ParameterColumnListResponse__ = __webpack_require__(1586);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_Response_ParameterColumnResponse__ = __webpack_require__(1587);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/*
  Generated class for the ParameterColumnServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var ParameterColumnServicesProvider = /** @class */ (function () {
    function ParameterColumnServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "ParameterColumn";
        console.log("Hello ParameterColumnServiceProvider Provider");
    }
    ParameterColumnServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, parameter_column_group, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "ParameterColumn?PageSize={1}&PageNumber={2}&keyword={3}&parameter_column_group={4}&order_type={5}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, PageSize, PageNumber, keyword, parameter_column_group, order_type);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.ParameterColumns = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_ParameterColumnListResponse__["a" /* ParameterColumnListResponse */]({
            ...
            return _this.ParameterColumns;
        });
    };
    ParameterColumnServicesProvider.prototype.PostPutAsync = function (ParameterColumnViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "ParameterColumn";
        else
            sub_url = "ParameterColumn?parameter_column_group={1}&parameter_column={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, ParameterColumnViewModel.parameter_column_group, ParameterColumnViewModel.parameter_column);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, ParameterColumnViewModel, mode).map(function (item) {
            _this.ParameterColumn = new __WEBPACK_IMPORTED_MODULE_5__Model_Response_ParameterColumnResponse__["a" /* ParameterColumnResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.ParameterColumn;
        });
    };
    ParameterColumnServicesProvider.prototype.DeleteAsync = function (parameter_column_group, parameter_column) {
        var _this = this;
        var sub_url;
        sub_url = "ParameterColumn?parameter_column_group={1}&parameter_column={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, parameter_column_group, parameter_column);
    ...
    ParameterColumnServicesProvider.prototype.GetSqlAsync = function (parameter_column_group, parameter_column, method) {
        var sub_url;
        sub_url = "ParameterColumn/get_{3}_sql?parameter_column_group={1}&parameter_column={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, parameter_column_group, parameter_column, method);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
    ...
    ParameterColumnServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_services__["a" /* ServicesProvider */]])
    ], ParameterColumnServicesProvider);
    return ParameterColumnServicesProvider;
}());

//# sourceMappingURL=parameter-column-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ParameterColumnPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_global_global__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_auth_services_auth_services__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_parameter_column_services_parameter_column_services__ = __webpack_require__(1237);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ParameterColumnViewModel__ = __webpack_require__(1068);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/**
 * Generated class for the ParameterColumnPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var ParameterColumnPage = /** @class */ (function () {
    function ParameterColumnPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, ParameterColumnServices, modalCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.loadingCtrl = loadingCtrl;
        this.alertCtrl = alertCtrl;
        this.global = global;
        this.authServices = authServices;
        this.ParameterColumnServices = ParameterColumnServices;
        this.modalCtrl = modalCtrl;
        this.data_list = [];
        this.keyword = "";
        this.pageNumber = 1;
        ...
        if (navParams.data.item != null) {
            this.title = navParams.data.item.Parameter_group_desc;
    ...
    ParameterColumnPage.prototype.doInfinite = function () {
        var _this = this;
        console.log("Begin async operation");
        this.pageNumber += 1;
        return new Promise(function (resolve) {
    ...
    ParameterColumnPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.ParameterColumnServices.GetListsByAsync(_this.pageSize, _this.pageNumber, _this.keyword, _this.parameter_column_group, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    ParameterColumnPage.prototype.ShowModal = function (item) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ParameterColumnViewModel__["a" /* ParameterColumnViewModel */]();
            item.parameter_column_group = this.parameter_column_group;
            item.parameter_Column = "";
            item.parameter_Column_value = "";
            item.parameter_Column_format = "";
        }
        else {
            this.mode = "PUT";
        }
        var modal = this.modalCtrl.create("ParameterColumnAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.createLoader();
            _this.global.loading.present().then(function () {
                _this.ParameterColumnServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("功能", data.Message);
    ...
    ParameterColumnPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}-{1}嗎?", item.parameter_column_group, item.parameter_column),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.ParameterColumnServices.DeleteAsync(item.parameter_column_group, item.parameter_column).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
                                    _this.global.showPopup("刪除", data.Message);
    ...
    ParameterColumnPage.prototype.openNavCodePage = function (code_type) {
    ...
    ParameterColumnPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.ParameterColumnServices.GetSqlAsync(item.parameter_column_group, item.parameter_column, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    ParameterColumnPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad ParameterColumnPage');
    };
    ParameterColumnPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-parameter-column',template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\parameter-column\parameter-column.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <ion-title>{{title}}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n  <ion-row>\n    <ion-col>\n\n      <ion-searchbar [ngClass]="[\'search\']" (keyup.enter)="LoadData(true)" placeholder="搜尋關鍵字(參數欄位名稱(包含)、參數欄位值(包含))" [(ngModel)]="keyword">\n      </ion-searchbar>\n    </ion-col>\n  </ion-row>\n  <ion-grid *ngIf="subject>\'\'">\n    <ion-row>\n      <ion-col col-12 col-sm-2 col-md-3>\n      </ion-col>\n      <ion-col col-12 col-sm-8 col-md-6>\n\n        <ion-grid [ngClass]="[\'subject\']">\n          <ion-row>\n            <ion-col>\n\n              <b>{{subject}}</b>\n            </ion-col>\n          </ion-row>\n\n        </ion-grid>\n      </ion-col>\n      <ion-col col-12 col-sm-2 col-md-3>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n  <div *ngIf="data_list">\n    <ion-row>\n\n      <ion-col col-lg-4 col-md-6 col-sm-6 col-12 *ngFor="let item of data_list">\n\n        <ion-grid [ngClass]="[\'bordered\']">\n          <ion-row>\n            <ion-col>\n                <button small title="編輯" ion-button color="light" icon-left (click)="ShowModal(item)">\n                    <ion-icon name="create"></ion-icon>\n                  </button>\n              <button *ngIf="CanEditBatch==true" small title="刪除" ion-button color="dark" icon-left (click)="Delete(item)">\n                <ion-icon name="trash"></ion-icon>\n              </button>\n              <button small title="產生Insert SQL語法" ion-button color="light" icon-left (click)="openNavSqlPage(item,\'insert\')">\n                Ins\n               </button>\n               <button small title="產生Update SQL語法" ion-button color="light" icon-left (click)="openNavSqlPage(item,\'update\')">\n                Upd\n               </button>\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              {{item.parameter_column}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              {{item.parameter_column_value}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              {{item.parameter_column_format}}\n            </ion-col>\n          </ion-row>\n\n        </ion-grid>\n      </ion-col>\n\n    </ion-row>\n  </div>\n  <ion-infinite-scroll *ngIf="pageNumber < totalPages" (ionInfinite)="$event.waitFor(doInfinite())">\n    <ion-infinite-scroll-content loadingSpinner="bubbles">\n    </ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n\n</ion-content>\n<ion-footer>\n  <ion-toolbar>\n    <ion-row>\n      <ion-col>\n        <div [ngClass]="[\'command\']">\n            <button small title="重新整理" ion-button color="dark" icon-left (click)="LoadData(true)">\n                <ion-checkbox name="order_type" title="遞增/遞減" color="dark" [(ngModel)]="order_type" (ionChange)="LoadData(true)" ></ion-checkbox>\n                 <ion-icon name="refresh"></ion-icon>\n              </button>\n          <button *ngIf="CanEditBatch==true" small title="新增" ion-button color="dark" icon-left (click)="ShowModal(null)">\n            <ion-icon name="add"></ion-icon>\n          </button>\n          <button small  title="共用變數" ion-button color="dark" icon-left (click)="openNavCodePage(\'037\')">\n            <ion-icon name="options"></ion-icon>\n          </button>\n        </div>\n        <StatusComponent [pageNumber]="pageNumber" [totalPages]="totalPages" [totalRows]="totalRows"></StatusComponent>\n      </ion-col>\n    </ion-row>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\parameter-column\parameter-column.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* LoadingController */],
            ...
            __WEBPACK_IMPORTED_MODULE_2__components_global_global__["a" /* GlobalComponent */],
            __WEBPACK_IMPORTED_MODULE_3__providers_auth_services_auth_services__["a" /* AuthServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_4__providers_parameter_column_services_parameter_column_services__["a" /* ParameterColumnServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* ModalController */]])
    ], ParameterColumnPage);
    return ParameterColumnPage;
}());

//# sourceMappingURL=parameter-column.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ParameterColumnListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_ParameterColumnViewModel__ = __webpack_require__(1068);
...
var ParameterColumnListResponse = /** @class */ (function (_super) {
    __extends(ParameterColumnListResponse, _super);
    function ParameterColumnListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_ParameterColumnViewModel__["a" /* ParameterColumnViewModel */]();
                item.parameter_column_group = data.parameter_column_group;
                item.parameter_column = data.parameter_column;
                item.parameter_column_value = data.parameter_column_value;
                item.parameter_column_value_format =
                    (data && data.parameter_column_value_format) || null;
    ...
    return ParameterColumnListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=ParameterColumnListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ParameterColumnResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_ParameterColumnViewModel__ = __webpack_require__(1068);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var ParameterColumnResponse = /** @class */ (function (_super) {
    __extends(ParameterColumnResponse, _super);
    function ParameterColumnResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_ParameterColumnViewModel__["a" /* ParameterColumnViewModel */]();
            _this.Model.parameter_column_group = obj.Model.parameter_column_group;
            _this.Model.parameter_column = obj.Model.parameter_column;
            _this.Model.parameter_column_value = obj.Model.parameter_column_value;
            _this.Model.parameter_column_value_format =
                (obj && obj.Model.parameter_column_value_format) || null;
    ...
    return ParameterColumnResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=ParameterColumnResponse.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__parameter_column__ = __webpack_require__(1585);
...
var ParameterColumnPageModule = /** @class */ (function () {
    function ParameterColumnPageModule() {
    }
    ParameterColumnPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__parameter_column__["a" /* ParameterColumnPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_parameter_column_services_parameter_column_services__["a" /* ParameterColumnServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__parameter_column__["a" /* ParameterColumnPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_parameter_group_components_module__["a" /* ParameterGroupComponentsModule */],
            ],
        })
    ], ParameterColumnPageModule);
    return ParameterColumnPageModule;
}());

//# sourceMappingURL=parameter-column.module.js.map
