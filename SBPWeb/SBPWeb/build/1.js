...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportBeforeServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileImportBeforeListResponse__ = __webpack_require__(1443);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileImportBeforeResponse__ = __webpack_require__(1444);
...
/*
  Generated class for the FileImportBeforeServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var FileImportBeforeServicesProvider = /** @class */ (function () {
    function FileImportBeforeServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "FileImportBefore";
        console.log("Hello FileImportBeforeServiceProvider Provider");
    }
    FileImportBeforeServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, exec_file_seq, schemaname, tablename, db_conn_id, parameter_column_group, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "FileImportBefore?PageSize={1}&PageNumber={2}&keyword={3}&exec_file_seq={4}&schemaname={5}&tablename={6}&db_conn_id={7}&parameter_column_group={8}&order_type={9}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, PageSize, PageNumber, keyword, exec_file_seq, schemaname, tablename, db_conn_id, parameter_column_group, order_type);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.FileImportBefores = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileImportBeforeListResponse__["a" /* FileImportBeforeListResponse */]({
            ...
            return _this.FileImportBefores;
        });
    };
    FileImportBeforeServicesProvider.prototype.PostPutAsync = function (FileImportBeforeViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "FileImportBefore";
        else
            sub_url = "FileImportBefore/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, FileImportBeforeViewModel.import_sql_seq);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, FileImportBeforeViewModel, mode).map(function (item) {
            _this.FileImportBefore = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileImportBeforeResponse__["a" /* FileImportBeforeResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.FileImportBefore;
        });
    };
    FileImportBeforeServicesProvider.prototype.DeleteAsync = function (import_sql_seq) {
        var sub_url;
        sub_url = "FileImportBefore/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, import_sql_seq);
    ...
    FileImportBeforeServicesProvider.prototype.GetSqlAsync = function (import_sql_seq, method) {
        var sub_url;
        sub_url = "FileImportBefore/get_{2}_sql/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, import_sql_seq, method);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            return new __WEBPACK_IMPORTED_MODULE_5__Model_Response_StringResponse__["a" /* StringResponse */]({
                Message: item.Message,
                DidError: item.DidError,
    ...
    FileImportBeforeServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_services__["a" /* ServicesProvider */]])
    ], FileImportBeforeServicesProvider);
    return FileImportBeforeServicesProvider;
}());

//# sourceMappingURL=file-import-before-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportBeforePage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_import_before_services_file_import_before_services__ = __webpack_require__(1218);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileImportBeforeViewModel__ = __webpack_require__(972);
 ...
 * Components.
 */
var FileImportBeforePage = /** @class */ (function () {
    function FileImportBeforePage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileImportBeforeServices, modalCtrl, platform, conf) {
        ...
        this.FileImportBeforeServices = FileImportBeforeServices;
        ...
        this.keyword = "";
        this.file_type_key = "";
        this.show_select_add = false;
        this.show_select = false;
        this.File_page = "FileSelectModalPage";
        ...
        this.schemaname = navParams.data.item.schemaname;
        this.tablename = navParams.data.item.tablename;
        this.db_conn_id = navParams.data.item.db_conn_id;
        this.parameter_column_group = navParams.data.item.parameter_column_group;
        this.subject = __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("{0}-{1}", this.exec_file_seq, navParams.data.item.tablefullname);
    ...
    FileImportBeforePage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    FileImportBeforePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileImportBeforePage.prototype.setPage = function (pageInfo) {
    ...
    FileImportBeforePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileImportBeforePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileImportBeforePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.FileImportBeforeServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_file_seq, _this.schemaname, _this.tablename, _this.db_conn_id, _this.parameter_column_group, _this.order_type).subscribe(function (data) {
    ...
    FileImportBeforePage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileImportBeforeViewModel__["a" /* FileImportBeforeViewModel */]();
            item.exec_file_seq = this.exec_file_seq;
            item.db_conn_id = this.db_conn_id;
            item.schemaname = this.schemaname;
            item.tablename = this.tablename;
            item.db_conn_id = this.db_conn_id;
            item.parameter_column_group = this.parameter_column_group;
            // item.exec_seq=this.totalRows+1;
            // item.import_sql_seq=this.exec_file_seq*100+item.exec_seq;
            item.is_active = true;
            item.prog_type_key = "066|01";
            item.prog_type = "檢核";
        }
        else {
            this.mode = "PUT";
        ...
        var modal = this.modalCtrl.create("FileImportBeforeAddEditModalPage", {
            mode: this.mode,
            item: item,
            change_mode: change_mode,
            totalRows: this.totalRows,
            file_type_key: this.file_type_key,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileImportBeforeServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    FileImportBeforePage.prototype.ShowCheckModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileImportBeforeViewModel__["a" /* FileImportBeforeViewModel */]();
        ...
        var modal = this.modalCtrl.create("FileImportBeforeCheckAddEditModalPage", {
            mode: this.mode,
            change_mode: change_mode,
            item: item,
            totalRows: this.totalRows,
            ...
            _this.global.loading.present().then(function () {
                _this.FileImportBeforeServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("匯入前檢核設定", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileImportBeforePage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.import_sql_seq),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileImportBeforeServices.DeleteAsync(item.import_sql_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileImportBeforePage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileImportBeforeServices.GetSqlAsync(item.import_sql_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileImportBeforePage.prototype.openNavFileMapPage = function (item) {
        var modal = this.modalCtrl.create(this.File_page, {
            item: item,
            show_select_add: false
        });
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
    ...
    FileImportBeforePage.prototype.ionViewDidLoad = function () {
        console.log("Hello FileComponent Component");
    };
    FileImportBeforePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-file-import-before",template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\file-import-before\file-import-before.html"*/'<ion-header>\n  <headerComponent [title]="\'匯入前程式清單\'" [permission_id]="\'CanBatch\'" [show_table_select]=true></headerComponent>\n</ion-header>\n\n<ion-content (window:resize)="onResize($event)">\n  <ion-row>\n    <ion-col>\n\n      <ion-searchbar [ngClass]="[\'search\']" (keyup.enter)="LoadData(true)" placeholder="關鍵字(程式編號包含、程式說明包含、sql包含)" [(ngModel)]="keyword">\n      </ion-searchbar>\n    </ion-col>\n  </ion-row>\n  <ion-grid *ngIf="subject>\'\'">\n    <ion-row>\n      <ion-col col-12 col-sm-2 col-md-3>\n      </ion-col>\n      <ion-col col-12 col-sm-8 col-md-6>\n\n        <ion-grid [ngClass]="[\'subject\']">\n          <ion-row>\n            <ion-col>\n\n              <b>{{subject}}</b>\n            </ion-col>\n          </ion-row>\n\n        </ion-grid>\n      </ion-col>\n      <ion-col col-12 col-sm-2 col-md-3>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n  <ion-grid *ngIf="conf.mobile_mode==false && selectedItem!=null" [ngClass]="\'bordered\'">\n    <ion-row>\n      <ion-col>\n          <button small title="編輯" *ngIf="selectedItem.prog_type_key==\'066|00\' || selectedItem.prog_type_key==\'066|01\'" ion-button color="light" icon-left (click)="ShowModal(selectedItem,\'e\')">\n              <ion-icon name="create"></ion-icon>\n            </button>\n            <button small title="複製" *ngIf="selectedItem.prog_type_key==\'066|00\' || selectedItem.prog_type_key==\'066|01\'" ion-button color="light" icon-left (click)="ShowModal(selectedItem,\'c\')">\n              <ion-icon name="copy"></ion-icon>\n            </button>\n            <button small title="編輯" *ngIf="selectedItem.prog_type_key==\'066|02\' || selectedItem.prog_type_key==\'066|03\'" ion-button color="light" icon-left (click)="ShowCheckModal(selectedItem,\'e\')">\n              <ion-icon name="create"></ion-icon>\n            </button>\n            <button small title="複製" *ngIf="selectedItem.prog_type_key==\'066|02\' || selectedItem.prog_type_key==\'066|03\'" ion-button color="light" icon-left (click)="ShowCheckModal(selectedItem,\'c\')">\n              <ion-icon name="copy"></ion-icon>\n            </button>\n            <button *ngIf="CanEditBatch==true" small title="刪除" ion-button color="dark" icon-left (click)="Delete(selectedItem)">\n              <ion-icon name="trash"></ion-icon>\n            </button>\n      </ion-col>\n\n      <ion-col>\n          <button small title="產生Insert SQL語法" ion-button color="light" icon-left (click)="openNavSqlPage(selectedItem,\'insert\')">\n          Ins\n         </button>\n         <button small title="產生Update SQL語法" ion-button color="light" icon-left (click)="openNavSqlPage(selectedItem,\'update\')">\n          Upd\n         </button>\n\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n  <ngx-datatable NgxResizeWatcher class="bootstrap" *ngIf="totalRows>0 && conf.mobile_mode==false" [selected]="selected" [selectionType]="\'single\'"\n      (select)=\'onRowSelect($event)\'   [rows]="data_list" [columnMode]="\'flex\'" [headerHeight]="40" [rowHeight]="\'auto\'" [footerHeight]="40"\n      [reorderable]=false [limit]="limit" [count]="totalRows" [offset]="offset" (page)=\'setPage($event)\'>\n\n      <ngx-datatable-column prop="import_sql_seq" name="匯入流水號" [flexGrow]="1" [frozenLeft]="true">\n      </ngx-datatable-column>\n      <ngx-datatable-column prop="program_no" name="程式編號" [flexGrow]="1"  >\n        </ngx-datatable-column>\n        <ngx-datatable-column prop="program_desc" name="程式說明" [flexGrow]="2" >\n          </ngx-datatable-column>\n          <ngx-datatable-column prop="prog_type_key" name="程式類別主鍵" [flexGrow]="1"  >\n            </ngx-datatable-column>\n          <ngx-datatable-column prop="prog_type" name="程式類別" [flexGrow]="1"  >\n            </ngx-datatable-column>\n\n              <ngx-datatable-column prop="exec_seq" name="執行順序" [flexGrow]="1">\n              </ngx-datatable-column>\n\n              <ngx-datatable-column prop="is_active_desc" name="啟用" [flexGrow]="1">\n                <ng-template let-row="row" let-value="value" ngx-datatable-cell-template>\n                  <div [ngClass]="row[\'is_active_color\']">{{value}}</div>\n                </ng-template>\n              </ngx-datatable-column>\n\n    </ngx-datatable>\n<div *ngIf="totalRows>0 && conf.mobile_mode==true">\n    <ion-row>\n\n      <ion-col col-lg-4 col-md-6 col-sm-6 col-12 *ngFor="let item of data_list">\n\n        <ion-grid [ngClass]="\'bordered\'">\n          <ion-row>\n            <ion-col>\n              <button small title="編輯" *ngIf="item.prog_type_key==\'066|00\' || item.prog_type_key==\'066|01\'" ion-button color="light" icon-left (click)="ShowModal(item,\'e\')">\n                <ion-icon name="create"></ion-icon>\n              </button>\n              <button small title="複製" *ngIf="item.prog_type_key==\'066|00\' || item.prog_type_key==\'066|01\'" ion-button color="light" icon-left (click)="ShowModal(item,\'c\')">\n                <ion-icon name="copy"></ion-icon>\n              </button>\n              <button small title="編輯" *ngIf="item.prog_type_key==\'066|02\' || item.prog_type_key==\'066|03\'" ion-button color="light" icon-left (click)="ShowCheckModal(item,\'e\')">\n                <ion-icon name="create"></ion-icon>\n              </button>\n              <button small title="複製" *ngIf="item.prog_type_key==\'066|02\' || item.prog_type_key==\'066|03\'" ion-button color="light" icon-left (click)="ShowCheckModal(item,\'c\')">\n                <ion-icon name="copy"></ion-icon>\n              </button>\n              <button *ngIf="CanEditBatch==true" small title="刪除" ion-button color="dark" icon-left (click)="Delete(item)">\n                <ion-icon name="trash"></ion-icon>\n              </button>\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              <button small title="產生Insert SQL語法" ion-button color="light" icon-left (click)="openNavSqlPage(item,\'insert\')">\n                Ins\n              </button>\n              <button small title="產生Update SQL語法" ion-button color="light" icon-left (click)="openNavSqlPage(item,\'update\')">\n                Upd\n              </button>\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col col-8>\n              {{item.program_no}}\n            </ion-col>\n            <ion-col col-4>\n              <div text-right>\n                {{item.import_sql_seq}}\n              </div>\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col col-8>\n              {{item.prog_type}}\n            </ion-col>\n            <ion-col col-4>\n              <div text-right>\n                {{item.exec_seq}}\n              </div>\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              {{item.program_desc}}\n            </ion-col>\n          </ion-row>\n\n        </ion-grid>\n      </ion-col>\n\n    </ion-row>\n  </div>\n  <ion-infinite-scroll *ngIf="pageNumber < totalPages && conf.mobile_mode==true" (ionInfinite)="$event.waitFor(doInfinite())">\n    <ion-infinite-scroll-content loadingSpinner="bubbles">\n    </ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n\n</ion-content>\n<ion-footer>\n  <ion-toolbar>\n    <ion-row>\n      <ion-col>\n        <div [ngClass]="[\'command\']">\n          <button small title="重新整理" ion-button color="dark" icon-left (click)="LoadData(true)">\n            <ion-checkbox name="order_type" title="遞增/遞減" color="dark" [(ngModel)]="order_type" (ionChange)="LoadData(true)"></ion-checkbox>\n            <ion-icon name="refresh"></ion-icon>\n          </button>\n          <button *ngIf="CanEditBatch==true" small title="新增SQL程式" ion-button color="dark" icon-left (click)="ShowModal(null,\'n\')">\n            <ion-icon name="add"></ion-icon>\n          </button>\n          <button *ngIf="CanEditBatch==true" small title="新增檢核設定程式" ion-button color="dranger" icon-left (click)="ShowCheckModal(null,\'n\')">\n            <ion-icon name="add"></ion-icon>\n          </button>\n\n\n        </div>\n        <StatusComponent [pageNumber]="pageNumber" [totalPages]="totalPages" [totalRows]="totalRows"></StatusComponent>\n      </ion-col>\n    </ion-row>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\file-import-before\file-import-before.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_import_before_services_file_import_before_services__["a" /* FileImportBeforeServicesProvider */],
    ...
    ], FileImportBeforePage);
    return FileImportBeforePage;
}());

//# sourceMappingURL=file-import-before.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportBeforeListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileImportBeforeViewModel__ = __webpack_require__(972);
...
var FileImportBeforeListResponse = /** @class */ (function (_super) {
    __extends(FileImportBeforeListResponse, _super);
    function FileImportBeforeListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileImportBeforeViewModel__["a" /* FileImportBeforeViewModel */]();
                item.import_sql_seq = data.import_sql_seq;
    ...
    return FileImportBeforeListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=FileImportBeforeListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportBeforeResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileImportBeforeViewModel__ = __webpack_require__(972);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var FileImportBeforeResponse = /** @class */ (function (_super) {
    __extends(FileImportBeforeResponse, _super);
    function FileImportBeforeResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileImportBeforeViewModel__["a" /* FileImportBeforeViewModel */]();
            _this.Model.import_sql_seq = obj.Model.import_sql_seq;
    ...
    return FileImportBeforeResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=FileImportBeforeResponse.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileImportBeforePageModule", function() { return FileImportBeforePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_file_import_components_module__ = __webpack_require__(970);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__file_import_before__ = __webpack_require__(1442);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_import_before_services_file_import_before_services__ = __webpack_require__(1218);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileImportBeforePageModule = /** @class */ (function () {
    function FileImportBeforePageModule() {
    }
    FileImportBeforePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__file_import_before__["a" /* FileImportBeforePage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_import_before_services_file_import_before_services__["a" /* FileImportBeforeServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__file_import_before__["a" /* FileImportBeforePage */]),
                __WEBPACK_IMPORTED_MODULE_0__components_file_import_components_module__["a" /* FileImportComponentsModule */],
            ],
        })
    ], FileImportBeforePageModule);
    return FileImportBeforePageModule;
}());

//# sourceMappingURL=file-import-before.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportComponentsModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__file_import_file_import__ = __webpack_require__(971);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_import_services_file_import_services__ = __webpack_require__(912);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileImportComponentsModule = /** @class */ (function () {
    function FileImportComponentsModule() {
    }
    FileImportComponentsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__file_import_file_import__["a" /* FileImportComponent */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_import_services_file_import_services__["a" /* FileImportServicesProvider */],
            ],
    ...
    ], FileImportComponentsModule);
    return FileImportComponentsModule;
}());

//# sourceMappingURL=file-import.components.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_global_global__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_auth_services_auth_services__ = __webpack_require__(64);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileImportViewModel__ = __webpack_require__(907);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_run_job_services_run_job_services__ = __webpack_require__(268);
 ...
 * Components.
 */
var FileImportComponent = /** @class */ (function () {
    function FileImportComponent(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileImportServices, modalCtrl, runjobServices, platform, conf) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.loadingCtrl = loadingCtrl;
        this.alertCtrl = alertCtrl;
        ...
        this.show_select = false;
        this.File_page = "FileImportTablePage";
    ...
    FileImportComponent.prototype.openNavFileLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileImportComponent.prototype.openNavRunPage = function (item, id) {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
    ...
    FileImportComponent.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
        if (this.authServices.authenticated() === true) {
    ...
    FileImportComponent.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileImportComponent.prototype.setPage = function (pageInfo) {
        this.pageNumber = Math.floor(pageInfo.offset / 3) + 1;
        if ((pageInfo.offset + 1) % 3 === 0) {
            if ((pageInfo.offset + 1) / 3 + 1 > this.loadPages) {
                this.loadPageNumber = this.pageNumber + 1;
    ...
    FileImportComponent.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileImportComponent.prototype.doInfinite = function () {
        var _this = this;
        console.log("Begin async operation");
        if (this.loadPages < this.totalPages) {
            this.pageNumber++;
    ...
    FileImportComponent.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileImportServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileImportComponent.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileImportViewModel__["a" /* FileImportViewModel */]();
            item.empty_file_check_flag = false;
            item.file_proc_key = "018|1";
            item.file_proc = "不動作";
            item.fail_file_proc_key = "018|1";
            item.fail_file_proc = "不動作";
        ...
        var modal = this.modalCtrl.create("FileImportAddEditModalPage", {
            mode: this.mode,
            item: item,
            change_mode: change_mode,
            CanEditBatch: this.CanEditBatch,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.createLoader();
            _this.global.loading.present().then(function () {
                _this.FileImportServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("功能", data.Message);
    ...
    FileImportComponent.prototype.ShowFileProcessedSqlModal = function (item) {
        var modal = this.modalCtrl.create("FileProcessedSqlAddEditModalPage", {
            item: item,
            CanEditBatch: this.CanEditBatch
        });
        modal.onDidDismiss(function (select_data) {
    ...
    FileImportComponent.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileImportServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
                                    _this.global.showPopup("刪除", data.Message);
    ...
    FileImportComponent.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileImportServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileImportComponent.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileImportComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_1__components_global_global__["a" /* GlobalComponent */],
            __WEBPACK_IMPORTED_MODULE_2__providers_auth_services_auth_services__["a" /* AuthServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_3__providers_file_import_services_file_import_services__["a" /* FileImportServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["j" /* ModalController */],
            __WEBPACK_IMPORTED_MODULE_7__providers_run_job_services_run_job_services__["a" /* RunJobServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["n" /* Platform */],
