...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BatchProgramCheckComponentsModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__batch_program_check_batch_program_check__ = __webpack_require__(1088);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_program_check_services_program_check_services__ = __webpack_require__(937);
...
var BatchProgramCheckComponentsModule = /** @class */ (function () {
    function BatchProgramCheckComponentsModule() {
    }
    BatchProgramCheckComponentsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__batch_program_check_batch_program_check__["a" /* BatchProgramCheckComponent */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_program_check_services_program_check_services__["a" /* ProgramCheckServicesProvider */],
            ],
    ...
    ], BatchProgramCheckComponentsModule);
    return BatchProgramCheckComponentsModule;
}());

//# sourceMappingURL=batchprogramcheck.components.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BatchProgramCheckComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ProgramCheckViewModel__ = __webpack_require__(925);
...
/**
 * Generated class for the ProgramCheckPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var BatchProgramCheckComponent = /** @class */ (function () {
    function BatchProgramCheckComponent(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, ProgramCheckServices, modalCtrl, platform, conf) {
        ...
        this.detail_page = "ProgramCheckDetailByBatchProgramCheckPage";
        this.Batch_page = "BatchProgramCheckPage";
        this.sql_page = "SqlPage";
        this.order_type = true;
        this.innerWidth = window.innerWidth;
        this.innerHeight = window.innerHeight;
    }
    BatchProgramCheckComponent.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    BatchProgramCheckComponent.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    BatchProgramCheckComponent.prototype.setPage = function (pageInfo) {
    ...
    BatchProgramCheckComponent.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    BatchProgramCheckComponent.prototype.doInfinite = function () {
        var _this = this;
    ...
    BatchProgramCheckComponent.prototype.get_board_class = function (item) {
        if (item.program_no === this.select_item)
            return "select_bordered";
        else
            return "bordered";
    };
    BatchProgramCheckComponent.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.ProgramCheckServices.GetSqlAsync(item.program_no, method).subscribe(function (data) {
    ...
    BatchProgramCheckComponent.prototype.openNavSysSqlPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.ProgramCheckServices.GetSysSqlAsync(item.program_no, item.temp_schema, item.temp_table).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    BatchProgramCheckComponent.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.ProgramCheckServices.GetListsAsync(_this.pageSize, _this.loadPageNumber, _this.temp_schema, _this.temp_table, _this.keyword, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    BatchProgramCheckComponent.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ProgramCheckViewModel__["a" /* ProgramCheckViewModel */]();
            item.program_no = "auto";
            item.prog_type_key = "066|02";
            item.err_key = "003|6";
            item.err_desc = "外部索引鍵檢核異常";
            item.where_condition = "";
            item.prog_type = "關聯主鍵檢核";
            item.is_active = true;
            item.temp_schema = this.temp_schema;
            item.temp_table = this.temp_table;
            item.temp_column_check = "";
        }
        else {
            if (change_mode === "c") {
                this.mode = "POST";
        ...
        var modal = this.modalCtrl.create("BatchProgramCheckAddEditModalPage", {
            mode: this.mode,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.ProgramCheckServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("檢核設定", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    BatchProgramCheckComponent.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.program_no),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.ProgramCheckServices.DeleteAsync(item.program_no).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    BatchProgramCheckComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_program_check_services_program_check_services__["a" /* ProgramCheckServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* ModalController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Platform */],
            __WEBPACK_IMPORTED_MODULE_7__Model_MyAppSharedSettings__["a" /* MyAppSharedSettings */]])
    ], BatchProgramCheckComponent);
    return BatchProgramCheckComponent;
}());

//# sourceMappingURL=batch-program-check.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BatchProgramCheckSelectModalPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
/**
 * Generated class for the BatchProgramCheckSelectModalPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var BatchProgramCheckSelectModalPage = /** @class */ (function () {
    function BatchProgramCheckSelectModalPage(navCtrl, navParams, viewCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.viewCtrl = viewCtrl;
        if (navParams.data.select_item)
            this.select_item = navParams.data.select_item;
        if (navParams.data.temp_schema)
            this.temp_schema = navParams.data.temp_schema;
        if (navParams.data.temp_table)
            this.temp_table = navParams.data.temp_table;
    }
    BatchProgramCheckSelectModalPage.prototype.onSelect = function (item) {
        this.viewCtrl.dismiss(item);
    };
    BatchProgramCheckSelectModalPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad BatchProgramCheckSelectModalPage");
    };
    BatchProgramCheckSelectModalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-batch-program-check-select-modal",template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\batch-program-check-select-modal\batch-program-check-select-modal.html"*/'<!--\n  Generated template for the BatchProgramCheckSelectModalPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>批次設定選取</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n<BatchProgramCheckComponent [show_select]=true (onSelect)="onSelect($event)" [select_item]="select_item"  [temp_schema]="temp_schema"   [temp_table]="temp_table"   ></BatchProgramCheckComponent>\n</ion-content>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\batch-program-check-select-modal\batch-program-check-select-modal.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* ViewController */]])
    ], BatchProgramCheckSelectModalPage);
    return BatchProgramCheckSelectModalPage;
}());

//# sourceMappingURL=batch-program-check-select-modal.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BatchProgramCheckSelectModalPageModule", function() { return BatchProgramCheckSelectModalPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__batch_program_check_select_modal__ = __webpack_require__(1275);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_batchprogramcheck_components_module__ = __webpack_require__(1087);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BatchProgramCheckSelectModalPageModule = /** @class */ (function () {
    function BatchProgramCheckSelectModalPageModule() {
    }
    BatchProgramCheckSelectModalPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__batch_program_check_select_modal__["a" /* BatchProgramCheckSelectModalPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__batch_program_check_select_modal__["a" /* BatchProgramCheckSelectModalPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_batchprogramcheck_components_module__["a" /* BatchProgramCheckComponentsModule */],
            ],
        })
    ], BatchProgramCheckSelectModalPageModule);
    return BatchProgramCheckSelectModalPageModule;
}());

//# sourceMappingURL=batch-program-check-select-modal.module.js.map
