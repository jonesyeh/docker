...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileEmailAttachServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileEmailAttachListResponse__ = __webpack_require__(1108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileEmailAttachResponse__ = __webpack_require__(1109);
...
/*
  Generated class for the FileEmailAttachServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var FileEmailAttachServicesProvider = /** @class */ (function (_super) {
    __extends(FileEmailAttachServicesProvider, _super);
    function FileEmailAttachServicesProvider(Services) {
        var _this = _super.call(this, Services) || this;
        _this.Services = Services;
        _this.ctl = "FileEmailAttach";
        console.log("Hello FileEmailAttachServiceProvider Provider");
        return _this;
    }
    FileEmailAttachServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, exec_group, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "FileEmailAttach?PageSize={1}&PageNumber={2}&keyword={3}&exec_group={4}&order_type={5}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.FileEmailAttachs = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileEmailAttachListResponse__["a" /* FileEmailAttachListResponse */]({
            ...
            return _this.FileEmailAttachs;
        });
    };
    FileEmailAttachServicesProvider.prototype.PostPutAsync = function (FileEmailAttachViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "FileEmailAttach";
        else
            sub_url = "FileEmailAttach/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, FileEmailAttachViewModel.exec_file_seq);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, FileEmailAttachViewModel, mode).map(function (item) {
            _this.FileEmailAttach = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileEmailAttachResponse__["a" /* FileEmailAttachResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.FileEmailAttach;
        });
    };
    FileEmailAttachServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_services__["a" /* ServicesProvider */]])
    ], FileEmailAttachServicesProvider);
    return FileEmailAttachServicesProvider;
}(__WEBPACK_IMPORTED_MODULE_5__file_services_file_services__["a" /* FileServicesProvider */]));

//# sourceMappingURL=file-email-attach-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileEmailAttachListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileEmailAttachViewModel__ = __webpack_require__(948);
...
var FileEmailAttachListResponse = /** @class */ (function (_super) {
    __extends(FileEmailAttachListResponse, _super);
    function FileEmailAttachListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileEmailAttachViewModel__["a" /* FileEmailAttachViewModel */]();
    ...
    return FileEmailAttachListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=FileEmailAttachListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileEmailAttachResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileEmailAttachViewModel__ = __webpack_require__(948);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var FileEmailAttachResponse = /** @class */ (function (_super) {
    __extends(FileEmailAttachResponse, _super);
    function FileEmailAttachResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileEmailAttachViewModel__["a" /* FileEmailAttachViewModel */]();
    ...
    return FileEmailAttachResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=FileEmailAttachResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileEmailAttachPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_email_attach_services_file_email_attach_services__ = __webpack_require__(1019);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileEmailAttachViewModel__ = __webpack_require__(948);
 ...
 * Components.
 */
var FileEmailAttachPage = /** @class */ (function () {
    function FileEmailAttachPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileEmailAttachServices, modalCtrl, viewCtrl, TableServices, platform, conf) {
        ...
        this.FileEmailAttachServices = FileEmailAttachServices;
        ...
        this.File_page = "FileEmailAttachTablePage";
    ...
    FileEmailAttachPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileEmailAttachPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileEmailAttachPage.prototype.setPage = function (pageInfo) {
    ...
    FileEmailAttachPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileEmailAttachPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileEmailAttachPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.FileEmailAttachServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.order_type).subscribe(function (data) {
    ...
    FileEmailAttachPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileEmailAttachViewModel__["a" /* FileEmailAttachViewModel */]();
            item.is_active = true;
        ...
        var modal = this.modalCtrl.create("FileEmailAttachAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileEmailAttachServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("Email附件", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileEmailAttachPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileEmailAttachServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileEmailAttachPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileEmailAttachServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileEmailAttachPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileEmailAttachPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_email_attach_services_file_email_attach_services__["a" /* FileEmailAttachServicesProvider */],
    ...
    return FileEmailAttachPage;
}());

//# sourceMappingURL=file-email-attach.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_email_attach__ = __webpack_require__(1363);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_email_attach_services_file_email_attach_services__ = __webpack_require__(1019);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileEmailAttachPageModule = /** @class */ (function () {
    function FileEmailAttachPageModule() {
    }
    FileEmailAttachPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_email_attach__["a" /* FileEmailAttachPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_email_attach_services_file_email_attach_services__["a" /* FileEmailAttachServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_email_attach__["a" /* FileEmailAttachPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileEmailAttachPageModule);
    return FileEmailAttachPageModule;
}());

//# sourceMappingURL=file-email-attach.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileEmailAttachViewModel; });
var FileEmailAttachViewModel = /** @class */ (function () {
    function FileEmailAttachViewModel() {
    }
    return FileEmailAttachViewModel;
}());

//# sourceMappingURL=FileEmailAttachViewModel.js.map
