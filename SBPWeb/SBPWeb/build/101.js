...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileDependServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileDependListResponse__ = __webpack_require__(1367);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileDependResponse__ = __webpack_require__(1368);
...
/*
  Generated class for the FileDependServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var FileDependServicesProvider = /** @class */ (function () {
    function FileDependServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "FileDepend";
        console.log("Hello FileDependServiceProvider Provider");
    }
    FileDependServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, exec_file_seq, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "FileDepend?PageSize={1}&PageNumber={2}&keyword={3}&exec_file_seq={4}&order_type={5}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.FileDepends = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileDependListResponse__["a" /* FileDependListResponse */]({
            ...
            return _this.FileDepends;
        });
    };
    FileDependServicesProvider.prototype.PostPutAsync = function (FileDependViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "FileDepend";
        else
            sub_url = "FileDepend?exec_file_seq={1}&exec_file_depend_seq={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, FileDependViewModel.exec_file_seq, FileDependViewModel.exec_file_depend_seq);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, FileDependViewModel, mode).map(function (item) {
            _this.FileDepend = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileDependResponse__["a" /* FileDependResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.FileDepend;
        });
    };
    FileDependServicesProvider.prototype.DeleteAsync = function (exec_file_seq, exec_file_depend_seq) {
        var sub_url;
        sub_url = "FileDepend?exec_file_seq={1}&exec_file_depend_seq={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, exec_file_seq, exec_file_depend_seq);
    ...
    FileDependServicesProvider.prototype.GetSqlAsync = function (exec_file_seq, exec_file_depend_seq, method) {
        var sub_url;
        sub_url = "FileDepend/get_{3}_sql?exec_file_seq={1}&exec_file_depend_seq={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, exec_file_seq, exec_file_depend_seq, method);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            return new __WEBPACK_IMPORTED_MODULE_5__Model_Response_StringResponse__["a" /* StringResponse */]({
                Message: item.Message,
                DidError: item.DidError,
    ...
    FileDependServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_services__["a" /* ServicesProvider */]])
    ], FileDependServicesProvider);
    return FileDependServicesProvider;
}());

//# sourceMappingURL=file-depend-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileDependPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_depend_services_file_depend_services__ = __webpack_require__(1206);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileDependViewModel__ = __webpack_require__(1020);
 ...
 * Components.
 */
var FileDependPage = /** @class */ (function () {
    function FileDependPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileDependServices, TableServices, modalCtrl, platform, conf) {
        ...
        this.FileDependServices = FileDependServices;
        ...
        this.exec_group = navParams.data.item.exec_group;
        this.file_keyword = navParams.data.item.file_keyword;
    ...
    FileDependPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    FileDependPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileDependPage.prototype.setPage = function (pageInfo) {
    ...
    FileDependPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileDependPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileDependPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.FileDependServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
    ...
    FileDependPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileDependViewModel__["a" /* FileDependViewModel */]();
            item.exec_file_seq = this.exec_file_seq;
            item.depend_filename = "";
        }
        else {
            this.mode = "PUT";
            if (change_mode === "c") {
        ...
        var modal = this.modalCtrl.create("FileDependAddEditModalPage", {
            mode: this.mode,
            item: item,
            file_keyword: this.file_keyword,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileDependServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("相依檔案", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileDependPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}-{1}嗎?", item.exec_file_seq, item.exec_file_depend_seq),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileDependServices.DeleteAsync(item.exec_file_seq, item.exec_file_depend_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileDependPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileDependServices.GetSqlAsync(item.exec_file_seq, item.exec_file_depend_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileDependPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_depend_services_file_depend_services__["a" /* FileDependServicesProvider */],
    ...
    return FileDependPage;
}());

//# sourceMappingURL=file-depend.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileDependListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileDependViewModel__ = __webpack_require__(1020);
...
var FileDependListResponse = /** @class */ (function (_super) {
    __extends(FileDependListResponse, _super);
    function FileDependListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileDependViewModel__["a" /* FileDependViewModel */]();
                item.exec_file_seq = data.exec_file_seq;
                item.exec_file_depend_seq = data.exec_file_depend_seq;
                item.depend_filename = data.depend_filename;
                item.creator = data.creator;
                item.create_time = data.create_time;
                item.modifier = data.modifier;
                item.last_update_time = data.last_update_time;
                item.depend_file_keyword = data.depend_file_keyword;
                _this.Model.push(item);
            }) || null;
        }
        return _this;
    }
    return FileDependListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=FileDependListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileDependResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileDependViewModel__ = __webpack_require__(1020);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var FileDependResponse = /** @class */ (function (_super) {
    __extends(FileDependResponse, _super);
    function FileDependResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileDependViewModel__["a" /* FileDependViewModel */]();
            _this.Model.exec_file_seq = obj.Model.exec_file_seq;
            _this.Model.exec_file_depend_seq = obj.Model.exec_file_depend_seq;
            _this.Model.depend_filename = obj.Model.depend_filename;
            ...
            _this.Model.depend_file_keyword = obj.Model.depend_file_keyword;
        }
        return _this;
    }
    return FileDependResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=FileDependResponse.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileDependPageModule", function() { return FileDependPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_depend__ = __webpack_require__(1366);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_depend_services_file_depend_services__ = __webpack_require__(1206);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileDependPageModule = /** @class */ (function () {
    function FileDependPageModule() {
    }
    FileDependPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_depend__["a" /* FileDependPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_depend_services_file_depend_services__["a" /* FileDependServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_depend__["a" /* FileDependPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileDependPageModule);
    return FileDependPageModule;
}());

//# sourceMappingURL=file-depend.module.js.map
