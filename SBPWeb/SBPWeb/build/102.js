...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileCopyServicesProvider; });
...
/*
  Generated class for the FileCopyServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var FileCopyServicesProvider = /** @class */ (function (_super) {
    __extends(FileCopyServicesProvider, _super);
    function FileCopyServicesProvider(Services) {
        var _this = _super.call(this, Services) || this;
        _this.Services = Services;
        _this.ctl = "FileCopy";
        console.log("Hello FileCopyServiceProvider Provider");
        return _this;
    }
    FileCopyServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, exec_group, exec_file_seq, order_type) {
        var _this = this;
        var sub_url;
        if (exec_file_seq === 0) {
            sub_url = "FileCopy?PageSize={1}&PageNumber={2}&keyword={3}&exec_group={4}&order_type={5}";
            ...
            sub_url = "FileCopy/Select?PageSize={1}&PageNumber={2}&keyword={3}&exec_group={4}&exec_file_seq={5}&order_type={6}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.FileCopys = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileCopyListResponse__["a" /* FileCopyListResponse */]({
            ...
            return _this.FileCopys;
        });
    };
    FileCopyServicesProvider.prototype.PostPutAsync = function (FileCopyViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "FileCopy";
            ...
            sub_url = "FileCopy/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, FileCopyViewModel.exec_file_seq);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, FileCopyViewModel, mode).map(function (item) {
            _this.FileCopy = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileCopyResponse__["a" /* FileCopyResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.FileCopy;
        });
    };
    FileCopyServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_services__["a" /* ServicesProvider */]])
    ], FileCopyServicesProvider);
    return FileCopyServicesProvider;
}(__WEBPACK_IMPORTED_MODULE_5__file_services_file_services__["a" /* FileServicesProvider */]));

//# sourceMappingURL=file-copy-services.js.map
...
var FileCopyListResponse = /** @class */ (function (_super) {
    __extends(FileCopyListResponse, _super);
    function FileCopyListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileCopyViewModel__["a" /* FileCopyViewModel */]();
    ...
    return FileCopyListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=FileCopyListResponse.js.map
...
var FileCopyResponse = /** @class */ (function (_super) {
    __extends(FileCopyResponse, _super);
    function FileCopyResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileCopyViewModel__["a" /* FileCopyViewModel */]();
...
//# sourceMappingURL=FileCopyResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileCopyPage; });
 ...
 * Components.
 */
var FileCopyPage = /** @class */ (function () {
    function FileCopyPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileCopyServices, modalCtrl, viewCtrl, TableServices, runjobServices, platform, conf) {
        ...
        this.FileCopyServices = FileCopyServices;
    ...
    FileCopyPage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
    ...
    FileCopyPage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
    ...
    FileCopyPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileCopyPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileCopyPage.prototype.setPage = function (pageInfo) {
    ...
    FileCopyPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileCopyPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileCopyPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileCopyServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileCopyPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileCopyViewModel__["a" /* FileCopyViewModel */]();
        ...
        var modal = this.modalCtrl.create("FileCopyAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileCopyServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    FileCopyPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileCopyServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileCopyPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileCopyServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileCopyPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileCopyPage.prototype.add = function (item) {
        this.viewCtrl.dismiss(item);
    };
    FileCopyPage.prototype.close = function () {
        this.viewCtrl.dismiss();
    };
    FileCopyPage.prototype.ionViewDidLoad = function () {
        console.log("Hello FileCopy Page");
    };
    FileCopyPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_copy_services_file_copy_services__["a" /* FileCopyServicesProvider */],
...
var FileCopyPageModule = /** @class */ (function () {
    function FileCopyPageModule() {
    }
    FileCopyPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_copy__["a" /* FileCopyPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_copy_services_file_copy_services__["a" /* FileCopyServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_copy__["a" /* FileCopyPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileCopyPageModule);
    return FileCopyPageModule;
}());

//# sourceMappingURL=file-copy.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileCopyViewModel; });
...
var FileCopyViewModel = /** @class */ (function (_super) {
    __extends(FileCopyViewModel, _super);
    function FileCopyViewModel() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return FileCopyViewModel;
}(__WEBPACK_IMPORTED_MODULE_0__FileManagementViewModel__["a" /* FileManagementViewModel */]));

//# sourceMappingURL=FileCopyViewModel.js.map
