...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileCodePageListResponse__ = __webpack_require__(1106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileCodePageResponse__ = __webpack_require__(1107);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileCodePageViewModel__ = __webpack_require__(947);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileCodePageViewModel__ = __webpack_require__(947);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileCodePage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_code_page_services_file_code_page_services__ = __webpack_require__(1018);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileCodePageViewModel__ = __webpack_require__(947);
 ...
 * Components.
 */
var FileCodePage = /** @class */ (function () {
    function FileCodePage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileCodePageServices, modalCtrl, viewCtrl, TableServices, runjobServices, platform, conf) {
        ...
        this.File_page = "FileCodePageTablePage";
    ...
    FileCodePage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
    ...
    FileCodePage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
    ...
    FileCodePage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileCodePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileCodePage.prototype.setPage = function (pageInfo) {
    ...
    FileCodePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileCodePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileCodePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileCodePageServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileCodePage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileCodePageViewModel__["a" /* FileCodePageViewModel */]();
            ...
            item.file_func_proc_key = "060|BIG5";
            item.file_func_proc = "轉BIG5";
        }
        else {
            this.mode = "PUT";
            if (change_mode === "c")
        ...
        var modal = this.modalCtrl.create("FileCodeAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileCodePageServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("編碼轉換", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileCodePage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileCodePageServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileCodePage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileCodePageServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileCodePage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileCodePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_code_page_services_file_code_page_services__["a" /* FileCodePageServicesProvider */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_code__ = __webpack_require__(1365);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_code_page_services_file_code_page_services__ = __webpack_require__(1018);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileCodePageModule = /** @class */ (function () {
    function FileCodePageModule() {
    }
    FileCodePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_code__["a" /* FileCodePage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_code_page_services_file_code_page_services__["a" /* FileCodePageServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_code__["a" /* FileCodePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileCodePageModule);
    return FileCodePageModule;
}());

//# sourceMappingURL=file-code.module.js.map
