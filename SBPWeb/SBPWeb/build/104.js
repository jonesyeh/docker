...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileCmdListResponse__ = __webpack_require__(1102);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileCmdResponse__ = __webpack_require__(1103);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileCmdViewModel__ = __webpack_require__(945);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileCmdViewModel__ = __webpack_require__(945);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileCmdPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_cmd_services_file_cmd_services__ = __webpack_require__(1016);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileCmdViewModel__ = __webpack_require__(945);
 ...
 * Components.
 */
var FileCmdPage = /** @class */ (function () {
    function FileCmdPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileCmdServices, modalCtrl, viewCtrl, TableServices, runjobServices, platform, conf) {
        ...
        this.File_page = "FileCmdTablePage";
    ...
    FileCmdPage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
    ...
    FileCmdPage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
    ...
    FileCmdPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileCmdPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileCmdPage.prototype.setPage = function (pageInfo) {
    ...
    FileCmdPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileCmdPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileCmdPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileCmdServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileCmdPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileCmdViewModel__["a" /* FileCmdViewModel */]();
            item.is_active = true;
        ...
        var modal = this.modalCtrl.create("FileCmdAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileCmdServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    FileCmdPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileCmdServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileCmdPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileCmdServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileCmdPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileCmdPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_cmd_services_file_cmd_services__["a" /* FileCmdServicesProvider */],
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileCmdPageModule", function() { return FileCmdPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_cmd__ = __webpack_require__(1355);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_cmd_services_file_cmd_services__ = __webpack_require__(1016);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileCmdPageModule = /** @class */ (function () {
    function FileCmdPageModule() {
    }
    FileCmdPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_cmd__["a" /* FileCmdPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_cmd_services_file_cmd_services__["a" /* FileCmdServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_cmd__["a" /* FileCmdPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileCmdPageModule);
    return FileCmdPageModule;
}());

//# sourceMappingURL=file-cmd.module.js.map
