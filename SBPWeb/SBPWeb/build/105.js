...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EmailServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_EmailListResponse__ = __webpack_require__(1334);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_Response_EmailResponse__ = __webpack_require__(1335);
...
/*
  ...
  and Angular DI.
*/
var EmailServicesProvider = /** @class */ (function () {
    function EmailServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "Email";
        console.log("Hello EmailServiceProvider Provider");
    }
    EmailServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, exec_group, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "Email?PageSize={1}&PageNumber={2}&keyword={3}&order_type={4}&pexec_group={5}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, PageSize, PageNumber, keyword, order_type, exec_group);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.Emails = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_EmailListResponse__["a" /* EmailListResponse */]({
    ...
    EmailServicesProvider.prototype.PostPutAsync = function (EmailViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "Email";
        else
            sub_url = "Email?exec_group={1}&exec_status_key={2}&email_id={3}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, EmailViewModel.exec_group, EmailViewModel.exec_status_key, EmailViewModel.email_id);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, EmailViewModel, mode).map(function (item) {
            _this.Email = new __WEBPACK_IMPORTED_MODULE_5__Model_Response_EmailResponse__["a" /* EmailResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
    ...
    EmailServicesProvider.prototype.DeleteAsync = function (exec_group, exec_status_key, email_id) {
        var _this = this;
        var sub_url;
        sub_url = "Email?exec_group={1}&exec_status_key={2}&email_id={3}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, exec_group, exec_status_key, email_id);
    ...
    EmailServicesProvider.prototype.GetSqlAsync = function (exec_group, exec_status_key, email_id, method) {
        var sub_url;
        sub_url = "Email/get_{4}_sql?exec_group={1}&exec_status_key={2}&email_id={3}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, exec_group, exec_status_key, email_id, method);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_email_services_email_services__ = __webpack_require__(1200);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_EmailViewModel__ = __webpack_require__(1010);
...
var EmailPage = /** @class */ (function () {
    function EmailPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, EmailServices, modalCtrl, viewCtrl, runjobServices, platform, conf) {
    ...
    EmailPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    EmailPage.prototype.setPage = function (pageInfo) {
    ...
    EmailPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    EmailPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    EmailPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.EmailServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.order_type).subscribe(function (data) {
    ...
    EmailPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_EmailViewModel__["a" /* EmailViewModel */]();
            item.exec_group = this.exec_group;
            item.exec_status_key = "012|C";
            item.exec_status = "完成";
        }
        else {
            this.mode = "PUT";
        ...
        var modal = this.modalCtrl.create("EmailAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.EmailServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("Email寄送設定", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    EmailPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}-{1}-{2}嗎?", item.exec_group, item.exec_status_key, item.email_id),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.EmailServices.DeleteAsync(item.exec_group, item.exec_status_key, item.email_id).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    EmailPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.EmailServices.GetSqlAsync(item.exec_group, item.exec_status_key, item.email_id, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    EmailPage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.runjobServices.RunExecGroupAsync(id, item.email_exec_group)
    ...
    EmailPage.prototype.openNavAttachPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push("EmailAttachPage", { email: item, parent_page: _this });
        });
    };
    EmailPage.prototype.openNavLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push("EmailSendLogPage", { email: item, parent_page: _this });
        });
    };
    EmailPage.prototype.add = function (item) {
    ...
    EmailPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_email_services_email_services__["a" /* EmailServicesProvider */],
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EmailListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_EmailViewModel__ = __webpack_require__(1010);
...
var EmailListResponse = /** @class */ (function (_super) {
    ...
    function EmailListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_EmailViewModel__["a" /* EmailViewModel */]();
                ...
                item.attach_cnt = data.attach_cnt;
                if (item.attach_cnt > 0)
                    item.attach_color = "danger";
                else
                    item.attach_color = "light";
                item.email_exec_group = item.exec_group + "_" + item.exec_status_key.substr(4, 1);
...
//# sourceMappingURL=EmailListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EmailResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_EmailViewModel__ = __webpack_require__(1010);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var EmailResponse = /** @class */ (function (_super) {
    ...
    function EmailResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_EmailViewModel__["a" /* EmailViewModel */]();
            _this.Model.exec_group = obj.Model.exec_group;
            _this.Model.exec_status_key = obj.Model.exec_status_key;
            ...
            _this.Model.exec_status = obj.Model.exec_status;
            _this.Model.email_desc = obj.Model.email_desc;
            _this.Model.email_full_desc =
                obj.Model.email_id + "-" + obj.Model.email_desc;
            _this.Model.attach_cnt = obj.Model.attach_cnt;
            _this.Model.email_exec_group = _this.Model.exec_group + "_" + _this.Model.exec_status_key.substr(4, 1);
            if (_this.Model.attach_cnt > 0)
                _this.Model.attach_color = "danger";
            else
                _this.Model.attach_color = "light";
        }
        return _this;
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__email__ = __webpack_require__(1333);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_email_services_email_services__ = __webpack_require__(1200);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var EmailPageModule = /** @class */ (function () {
    ...
    EmailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_email_services_email_services__["a" /* EmailServicesProvider */],
            ],
            imports: [
