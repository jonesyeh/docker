...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EmailAttachServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_EmailAttachListResponse__ = __webpack_require__(1323);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_Response_EmailAttachResponse__ = __webpack_require__(1324);
...
/*
  Generated class for the EmailAttachServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var EmailAttachServicesProvider = /** @class */ (function () {
    function EmailAttachServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "EmailAttach";
        console.log("Hello EmailAttachServiceProvider Provider");
    }
    EmailAttachServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, exec_group, exec_status_key, email_id, keyword, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "EmailAttach?PageSize={1}&PageNumber={2}&keyword={3}&order_type={4}&pexec_group={5}&pexec_status_key={6}&pemail_id={7}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, PageSize, PageNumber, keyword, order_type, exec_group, exec_status_key, email_id);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.EmailAttachs = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_EmailAttachListResponse__["a" /* EmailAttachListResponse */]({
            ...
            return _this.EmailAttachs;
        });
    };
    EmailAttachServicesProvider.prototype.PostPutAsync = function (EmailAttachViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "EmailAttach";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, EmailAttachViewModel, mode).map(function (item) {
            _this.EmailAttach = new __WEBPACK_IMPORTED_MODULE_5__Model_Response_EmailAttachResponse__["a" /* EmailAttachResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.EmailAttach;
        });
    };
    EmailAttachServicesProvider.prototype.DeleteAsync = function (exec_group, exec_status_key, email_id, attach_exec_group) {
        var _this = this;
        var sub_url;
        sub_url = "EmailAttach?exec_group={1}&exec_status_key={2}&email_id={3}&attach_exec_group={4}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, exec_group, exec_status_key, email_id, attach_exec_group);
    ...
    EmailAttachServicesProvider.prototype.GetSqlAsync = function (exec_group, exec_status_key, email_id, attach_exec_group, method) {
        var sub_url;
        sub_url = "EmailAttach/get_{5}_sql?exec_group={1}&exec_status_key={2}&email_id={3}&attach_exec_group={4}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, exec_group, exec_status_key, email_id, attach_exec_group, method);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
    ...
    EmailAttachServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_services__["a" /* ServicesProvider */]])
    ], EmailAttachServicesProvider);
    return EmailAttachServicesProvider;
}());

//# sourceMappingURL=email-attach-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EmailAttachPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_email_attach_services_email_attach_services__ = __webpack_require__(1198);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_EmailAttachViewModel__ = __webpack_require__(1011);
 ...
 * Components.
 */
var EmailAttachPage = /** @class */ (function () {
    function EmailAttachPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, EmailAttachServices, modalCtrl, viewCtrl, TableServices, platform, conf) {
        ...
        this.EmailAttachServices = EmailAttachServices;
        ...
        this.keyword = "";
        this.exec_group = "";
        this.exec_status_key = "";
        this.exec_status = "";
        this.email_id = "";
        this.title = "Email附件設定";
        this.exec_file_seq = 0;
        this.show_select = false;
        this.File_page = "EmailAttachTablePage";
        ...
        if (navParams.data.email != null) {
            this.email = navParams.data.email;
        }
    }
    EmailAttachPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    EmailAttachPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    EmailAttachPage.prototype.setPage = function (pageInfo) {
    ...
    EmailAttachPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    EmailAttachPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    EmailAttachPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.EmailAttachServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.email.exec_group, _this.email.exec_status_key, _this.email.email_id, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    EmailAttachPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_EmailAttachViewModel__["a" /* EmailAttachViewModel */]();
            item.exec_group = this.email.exec_group;
            item.exec_status_key = this.email.exec_status_key;
            item.email_id = this.email.email_id;
        }
        else {
            this.mode = "PUT";
            if (change_mode === "c")
        ...
        var modal = this.modalCtrl.create("EmailAttachAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.EmailAttachServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("Email附件設定", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    EmailAttachPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}?", item.attach_exec_group),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.EmailAttachServices.DeleteAsync(item.exec_group, item.exec_status_key, item.email_id, item.attach_exec_group).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    EmailAttachPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.EmailAttachServices.GetSqlAsync(item.exec_group, item.exec_status_key, item.email_id, item.attach_exec_group, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    EmailAttachPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_email_attach_services_email_attach_services__["a" /* EmailAttachServicesProvider */],
    ...
    return EmailAttachPage;
}());

//# sourceMappingURL=email-attach.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EmailAttachListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_EmailAttachViewModel__ = __webpack_require__(1011);
...
var EmailAttachListResponse = /** @class */ (function (_super) {
    __extends(EmailAttachListResponse, _super);
    function EmailAttachListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_EmailAttachViewModel__["a" /* EmailAttachViewModel */]();
                item.exec_group = data.exec_group;
                item.exec_status_key = data.exec_status_key;
                item.attach_exec_group = data.attach_exec_group;
    ...
    return EmailAttachListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=EmailAttachListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EmailAttachResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_EmailAttachViewModel__ = __webpack_require__(1011);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var EmailAttachResponse = /** @class */ (function (_super) {
    __extends(EmailAttachResponse, _super);
    function EmailAttachResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_EmailAttachViewModel__["a" /* EmailAttachViewModel */]();
            _this.Model.exec_group = obj.Model.exec_group;
            _this.Model.exec_status_key = obj.Model.exec_status_key;
            _this.Model.attach_exec_group = obj.Model.attach_exec_group;
...
//# sourceMappingURL=EmailAttachResponse.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EmailAttachPageModule", function() { return EmailAttachPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__email_attach__ = __webpack_require__(1322);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_email_attach_services_email_attach_services__ = __webpack_require__(1198);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var EmailAttachPageModule = /** @class */ (function () {
    function EmailAttachPageModule() {
    }
    EmailAttachPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__email_attach__["a" /* EmailAttachPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_email_attach_services_email_attach_services__["a" /* EmailAttachServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__email_attach__["a" /* EmailAttachPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], EmailAttachPageModule);
    return EmailAttachPageModule;
}());

//# sourceMappingURL=email-attach.module.js.map
