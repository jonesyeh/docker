...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DelTablePage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_DelTableViewModel__ = __webpack_require__(944);
 ...
 * Components.
 */
var DelTablePage = /** @class */ (function () {
    function DelTablePage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, DelTableServices, modalCtrl, viewCtrl, runjobServices, platform, conf) {
        ...
        this.File_page = "DelTableTablePage";
    ...
    DelTablePage.prototype.openNavTableLogPage = function (item) {
        var _this = this;
    ...
    DelTablePage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
    ...
    DelTablePage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    DelTablePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    DelTablePage.prototype.setPage = function (pageInfo) {
    ...
    DelTablePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    DelTablePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    DelTablePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.DelTableServices.GetListsByAsync(_this.exec_group, _this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    DelTablePage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_DelTableViewModel__["a" /* DelTableViewModel */]();
            item.is_active = true;
            item.datepart = "d";
            item.del_method_key = "027|DEL";
            item.del_method = "刪除歷史資料";
            item.keep_num = 30;
            item.dateformat_columnname = "data_date";
        }
        else {
            this.mode = "PUT";
            if (change_mode === "c")
        ...
        var modal = this.modalCtrl.create("DelTableAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.DelTableServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    DelTablePage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.DelTableServices.DeleteAsync(item.exec_table_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    DelTablePage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.DelTableServices.GetSqlAsync(item.exec_table_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    DelTablePage.prototype.openNavDelTableSqlPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.DelTableServices.GetDelTableSqlAsync(item.tablefullname, item.date_columnname, item.dateformat_columnname, item.datepart, item.keep_num, item.del_method_key).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    DelTablePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_del_table_services_del_table_services__["a" /* DelTableServicesProvider */],
...
//# sourceMappingURL=del-table.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DelTablePageModule", function() { return DelTablePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__del_table__ = __webpack_require__(1318);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_del_table_services_del_table_services__ = __webpack_require__(1009);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DelTablePageModule = /** @class */ (function () {
    function DelTablePageModule() {
    }
    DelTablePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__del_table__["a" /* DelTablePage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_del_table_services_del_table_services__["a" /* DelTableServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__del_table__["a" /* DelTablePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], DelTablePageModule);
    return DelTablePageModule;
}());

//# sourceMappingURL=del-table.module.js.map
