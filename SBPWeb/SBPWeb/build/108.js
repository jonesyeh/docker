...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ConfigColIndexLoopPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_config_col_index_loop_services_config_col_index_loop_services__ = __webpack_require__(1008);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_ConfigColIndexLoopViewModel__ = __webpack_require__(943);
...
var ConfigColIndexLoopPage = /** @class */ (function () {
    function ConfigColIndexLoopPage(menuCtrl, navCtrl, navParams, ConfigColIndexLoopServices, loadingCtrl, global, authServices, modalCtrl, alertCtrl) {
        ...
        this.CanConfigColIndexLoopExec = true;
        this.detail_page = "ConfigColIndexLoopDetailPage";
        ...
        this.col_index = navParams.data.item.col_index;
    ...
    ConfigColIndexLoopPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
        this.show_title();
    };
    ConfigColIndexLoopPage.prototype.show_title = function () {
    ...
    ConfigColIndexLoopPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    ConfigColIndexLoopPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.ConfigColIndexLoopServices.GetListsByAsync(_this.pageSize, _this.pageNumber, _this.schemaname, _this.tablename, _this.columnname, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    ConfigColIndexLoopPage.prototype.openNavSqlPage = function (item, method, is_exec) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.ConfigColIndexLoopServices.GetSqlAsync(item.table_index_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    ConfigColIndexLoopPage.prototype.ShowModal = function (item) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_ConfigColIndexLoopViewModel__["a" /* ConfigColIndexLoopViewModel */]();
            item.schemaname = this.schemaname;
            item.tablename = this.tablename;
            item.columnname = this.columnname;
            item.col_index = this.col_index;
        }
        else {
            this.mode = "PUT";
        }
        var modal = this.modalCtrl.create("ConfigColIndexLoopAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.ConfigColIndexLoopServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("例外欄位設定", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    ConfigColIndexLoopPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_6__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.table_index_seq),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.ConfigColIndexLoopServices.DeleteAsync(item.table_index_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    ConfigColIndexLoopPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad ConfigColIndexLoop");
    };
    __decorate([
    ...
    ], ConfigColIndexLoopPage);
    return ConfigColIndexLoopPage;
}());

//# sourceMappingURL=config-col-index-loop.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__config_col_index_loop__ = __webpack_require__(1302);
...
var ConfigColIndexLoopPageModule = /** @class */ (function () {
    function ConfigColIndexLoopPageModule() {
    }
    ConfigColIndexLoopPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__config_col_index_loop__["a" /* ConfigColIndexLoopPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_config_col_index_loop_services_config_col_index_loop_services__["a" /* ConfigColIndexLoopServicesProvider */],],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__config_col_index_loop__["a" /* ConfigColIndexLoopPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], ConfigColIndexLoopPageModule);
    return ConfigColIndexLoopPageModule;
}());

//# sourceMappingURL=config-col-index-loop.module.js.map
