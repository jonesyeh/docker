...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ColumnTypeMappingServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_ColumnTypeMappingListResponse__ = __webpack_require__(1298);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_Response_ColumnTypeMappingResponse__ = __webpack_require__(1299);
...
/*
  Generated class for the ColumnTypeMappingServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var ColumnTypeMappingServicesProvider = /** @class */ (function () {
    function ColumnTypeMappingServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "ColumnTypeMapping";
        console.log("Hello ColumnTypeMappingServiceProvider");
    }
    ColumnTypeMappingServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "ColumnTypeMapping?PageSize={1}&PageNumber={2}&keyword={3}&order_type={4}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.ColumnTypeMappings = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_ColumnTypeMappingListResponse__["a" /* ColumnTypeMappingListResponse */]({
            ...
            return _this.ColumnTypeMappings;
        });
    };
    ColumnTypeMappingServicesProvider.prototype.PostPutAsync = function (ColumnTypeMappingViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "ColumnTypeMapping";
        else
            sub_url = "ColumnTypeMapping/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, ColumnTypeMappingViewModel.columnname);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, ColumnTypeMappingViewModel, mode).map(function (item) {
            _this.ColumnTypeMapping = new __WEBPACK_IMPORTED_MODULE_5__Model_Response_ColumnTypeMappingResponse__["a" /* ColumnTypeMappingResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.ColumnTypeMapping;
        });
    };
    ColumnTypeMappingServicesProvider.prototype.DeleteAsync = function (columnname) {
        var _this = this;
        var sub_url;
        sub_url = "ColumnTypeMapping/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, columnname);
    ...
    ColumnTypeMappingServicesProvider.prototype.GetSqlAsync = function (columnname, method) {
        var sub_url;
        sub_url = "ColumnTypeMapping/get_{2}_sql?columnname={1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, columnname, method);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
    ...
    ColumnTypeMappingServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_services__["a" /* ServicesProvider */]])
    ], ColumnTypeMappingServicesProvider);
    return ColumnTypeMappingServicesProvider;
}());

//# sourceMappingURL=column-type-mapping-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ColumnTypeMappingPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_column_type_mapping_services_column_type_mapping_services__ = __webpack_require__(1197);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_ColumnTypeMappingViewModel__ = __webpack_require__(1007);
...
var ColumnTypeMappingPage = /** @class */ (function () {
    function ColumnTypeMappingPage(menuCtrl, navCtrl, navParams, ColumnTypeMappingServices, loadingCtrl, global, authServices, modalCtrl, alertCtrl, platform, conf) {
        this.menuCtrl = menuCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.ColumnTypeMappingServices = ColumnTypeMappingServices;
        ...
        this.CanColumnTypeMappingExec = true;
        this.detail_page = "ColumnTypeMappingDetailPage";
        this.CheckType_page = "ColumnTypeMappingTypeDetailPage";
    ...
    ColumnTypeMappingPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    ColumnTypeMappingPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    ColumnTypeMappingPage.prototype.setPage = function (pageInfo) {
    ...
    ColumnTypeMappingPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    ColumnTypeMappingPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    ColumnTypeMappingPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.ColumnTypeMappingServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    ColumnTypeMappingPage.prototype.openNavSqlPage = function (item, method, is_exec) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.ColumnTypeMappingServices.GetSqlAsync(item.columnname, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    ColumnTypeMappingPage.prototype.ShowModal = function (item) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_ColumnTypeMappingViewModel__["a" /* ColumnTypeMappingViewModel */]();
        }
        else {
            this.mode = "PUT";
        }
        var modal = this.modalCtrl.create("ColumnTypeMappingAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.ColumnTypeMappingServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("欄位類型對應", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    ColumnTypeMappingPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.ColumnTypeMappingServices.DeleteAsync(item.columnname).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    ], ColumnTypeMappingPage);
    return ColumnTypeMappingPage;
}());

//# sourceMappingURL=column-type-mapping.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ColumnTypeMappingListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_ColumnTypeMappingViewModel__ = __webpack_require__(1007);
...
var ColumnTypeMappingListResponse = /** @class */ (function (_super) {
    __extends(ColumnTypeMappingListResponse, _super);
    function ColumnTypeMappingListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_ColumnTypeMappingViewModel__["a" /* ColumnTypeMappingViewModel */]();
    ...
    return ColumnTypeMappingListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=ColumnTypeMappingListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ColumnTypeMappingResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_ColumnTypeMappingViewModel__ = __webpack_require__(1007);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var ColumnTypeMappingResponse = /** @class */ (function (_super) {
    __extends(ColumnTypeMappingResponse, _super);
    function ColumnTypeMappingResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_ColumnTypeMappingViewModel__["a" /* ColumnTypeMappingViewModel */]();
    ...
    return ColumnTypeMappingResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=ColumnTypeMappingResponse.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ColumnTypeMappingPageModule", function() { return ColumnTypeMappingPageModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__column_type_mapping__ = __webpack_require__(1297);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_column_type_mapping_services_column_type_mapping_services__ = __webpack_require__(1197);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ColumnTypeMappingPageModule = /** @class */ (function () {
    function ColumnTypeMappingPageModule() {
    }
    ColumnTypeMappingPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__column_type_mapping__["a" /* ColumnTypeMappingPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_column_type_mapping_services_column_type_mapping_services__["a" /* ColumnTypeMappingServicesProvider */],],
            imports: [
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__column_type_mapping__["a" /* ColumnTypeMappingPage */]),
                __WEBPACK_IMPORTED_MODULE_0__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], ColumnTypeMappingPageModule);
    return ColumnTypeMappingPageModule;
}());

//# sourceMappingURL=column-type-mapping.module.js.map
