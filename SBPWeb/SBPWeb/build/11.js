...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ParameterGroupPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_global_global__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_auth_services_auth_services__ = __webpack_require__(64);
...
/**
 * Generated class for the ParameterGroupPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var ParameterGroupPage = /** @class */ (function () {
    function ParameterGroupPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, ParameterGroupServices, modalCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.loadingCtrl = loadingCtrl;
        this.alertCtrl = alertCtrl;
    ...
    ParameterGroupPage.prototype.doInfinite = function () {
        var _this = this;
        console.log("Begin async operation");
        this.pageNumber += 1;
        return new Promise(function (resolve) {
    ...
    ParameterGroupPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.ParameterGroupServices.GetListsByAsync(_this.pageSize, _this.pageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    ParameterGroupPage.prototype.ShowModal = function (item) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ParameterGroupViewModel__["a" /* ParameterGroupViewModel */]();
    ...
    ParameterGroupPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.parameter_column_group),
    ...
    ParameterGroupPage.prototype.openNavParameterColumnPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.ParameterColumn_page, { item: item });
    ...
    ParameterGroupPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.ParameterGroupServices.GetSqlAsync(item.parameter_column_group, method).subscribe(function (data) {
    ...
    ParameterGroupPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad ParameterGroupPage");
    };
    ParameterGroupPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-parameter-group",template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\parameter-group\parameter-group.html"*/'<!--\n  Generated template for the RolePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <headerComponent [title]="\'參數群組\'" [permission_id]="\'CanCode\'"></headerComponent>\n</ion-header>\n<ion-content>\n  <ParameterGroupComponent></ParameterGroupComponent>\n</ion-content>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\parameter-group\parameter-group.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* LoadingController */],
...
var ParameterGroupPageModule = /** @class */ (function () {
    function ParameterGroupPageModule() {
    }
    ParameterGroupPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__parameter_group__["a" /* ParameterGroupPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__parameter_group__["a" /* ParameterGroupPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_parameter_group_components_module__["a" /* ParameterGroupComponentsModule */],
            ],
        })
    ], ParameterGroupPageModule);
    return ParameterGroupPageModule;
}());

//# sourceMappingURL=parameter-group.module.js.map
