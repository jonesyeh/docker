...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AuditTableServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_AuditTableListResponse__ = __webpack_require__(1262);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_Response_AuditTableResponse__ = __webpack_require__(1263);
...
/*
  Generated class for the AuditTableServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var AuditTableServicesProvider = /** @class */ (function () {
    function AuditTableServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "AuditTable";
        console.log("Hello AuditTableServiceProvider Provider");
    }
    AuditTableServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "AuditTable?PageSize={1}&PageNumber={2}&keyword={3}&order_type={4}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.AuditTables = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_AuditTableListResponse__["a" /* AuditTableListResponse */]({
            ...
            return _this.AuditTables;
        });
    };
    AuditTableServicesProvider.prototype.PostPutAsync = function (AuditTableViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "AuditTable";
        else
            sub_url = "AuditTable?schemaname={1}&tablename={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, AuditTableViewModel.schemaname, AuditTableViewModel.tablename);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, AuditTableViewModel, mode).map(function (item) {
            _this.AuditTable = new __WEBPACK_IMPORTED_MODULE_5__Model_Response_AuditTableResponse__["a" /* AuditTableResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.AuditTable;
        });
    };
    AuditTableServicesProvider.prototype.DeleteAsync = function (schemaname, tablename) {
        var _this = this;
        var sub_url;
        sub_url = "AuditTable?schemaname={1}&tablename={2}";
    ...
    AuditTableServicesProvider.prototype.GetSqlAsync = function (schemaname, tablename, method) {
        var sub_url;
        sub_url = "AuditTable/get_{3}_sql?schemaname={1}&tablename={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, schemaname, tablename, method);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
    ...
    AuditTableServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_services__["a" /* ServicesProvider */]])
    ], AuditTableServicesProvider);
    return AuditTableServicesProvider;
}());

//# sourceMappingURL=audit-table-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AuditTablePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_audit_table_services_audit_table_services__ = __webpack_require__(1194);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_AuditTableViewModel__ = __webpack_require__(993);
...
var AuditTablePage = /** @class */ (function () {
    function AuditTablePage(menuCtrl, navCtrl, navParams, AuditTableServices, loadingCtrl, global, authServices, modalCtrl, alertCtrl, platform, conf) {
        this.menuCtrl = menuCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.AuditTableServices = AuditTableServices;
        ...
        this.CanAuditTableExec = true;
        this.detail_page = "AuditTableDetailPage";
        this.log_page = "AuditLoggerPage";
    ...
    AuditTablePage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    AuditTablePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    AuditTablePage.prototype.setPage = function (pageInfo) {
    ...
    AuditTablePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    AuditTablePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    AuditTablePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.AuditTableServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    AuditTablePage.prototype.openNavDetailsPage = function (item) {
        var _this = this;
    ...
    AuditTablePage.prototype.openNavLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.log_page, { item: item });
        });
    };
    AuditTablePage.prototype.openNavSqlPage = function (item, method, is_exec) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.AuditTableServices.GetSqlAsync(item.schemaname, item.tablename, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    AuditTablePage.prototype.ShowModal = function (item) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_AuditTableViewModel__["a" /* AuditTableViewModel */]();
            item.loginserts = true;
            item.logdeletes = true;
        }
        else {
            this.mode = "PUT";
        }
        var modal = this.modalCtrl.create("AuditTableAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.AuditTableServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("資料表稽核", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    AuditTablePage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.AuditTableServices.DeleteAsync(item.schemaname, item.tablename).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    return AuditTablePage;
}());

//# sourceMappingURL=audit-table.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AuditTableListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_AuditTableViewModel__ = __webpack_require__(993);
...
var AuditTableListResponse = /** @class */ (function (_super) {
    __extends(AuditTableListResponse, _super);
    function AuditTableListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_AuditTableViewModel__["a" /* AuditTableViewModel */]();
                item.schemaname = data.schemaname;
                item.tablename = data.tablename;
                item.loginserts = data.loginserts;
                item.logdeletes = data.logdeletes;
    ...
    return AuditTableListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=AuditTableListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AuditTableResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_AuditTableViewModel__ = __webpack_require__(993);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var AuditTableResponse = /** @class */ (function (_super) {
    __extends(AuditTableResponse, _super);
    function AuditTableResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_AuditTableViewModel__["a" /* AuditTableViewModel */]();
            _this.Model.schemaname = obj.Model.schemaname;
            _this.Model.tablename = obj.Model.tablename;
            _this.Model.loginserts = obj.Model.loginserts;
            _this.Model.logdeletes = obj.Model.logdeletes;
...
//# sourceMappingURL=AuditTableResponse.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AuditTablePageModule", function() { return AuditTablePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__audit_table__ = __webpack_require__(1261);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_audit_table_services_audit_table_services__ = __webpack_require__(1194);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AuditTablePageModule = /** @class */ (function () {
    function AuditTablePageModule() {
    }
    AuditTablePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__audit_table__["a" /* AuditTablePage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_audit_table_services_audit_table_services__["a" /* AuditTableServicesProvider */],],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__audit_table__["a" /* AuditTablePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], AuditTablePageModule);
    return AuditTablePageModule;
}());

//# sourceMappingURL=audit-table.module.js.map
