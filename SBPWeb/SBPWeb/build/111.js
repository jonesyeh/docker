...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AuditTableDetailServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_AuditTableDetailListResponse__ = __webpack_require__(1258);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_AuditTableDetailResponse__ = __webpack_require__(1259);
...
/*
  Generated class for the AuditTableDetailServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var AuditTableDetailServicesProvider = /** @class */ (function () {
    function AuditTableDetailServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "AuditTableDetail";
        console.log("Hello AuditTableDetailServiceProvider Provider");
    }
    AuditTableDetailServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, schemaname, tablename, keyword, order_type) {
        var _this = this;
        var sub_url;
        sub_url =
            "AuditTableDetail?PageSize={1}&PageNumber={2}&schemaname={3}&tablename={4}&keyword={5}&order_type={6}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.AuditTableDetails = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_AuditTableDetailListResponse__["a" /* AuditTableDetailListResponse */]({
            ...
            return _this.AuditTableDetails;
        });
    };
    AuditTableDetailServicesProvider.prototype.PostPutAsync = function (item, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "AuditTableDetail";
        else
            sub_url = "AuditTableDetail?schemaname={1}&tablename={2}&columnname={3}";
        ...
        return this.Services.PostPutAsync(sub_url, this.ctl, true, item, mode).map(function (item) {
            _this.AuditTableDetail = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_AuditTableDetailResponse__["a" /* AuditTableDetailResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.AuditTableDetail;
        });
    };
    AuditTableDetailServicesProvider.prototype.DeleteAsync = function (schemaname, tablename, columnname) {
        var _this = this;
        var sub_url;
        sub_url = "AuditTableDetail?schemaname={1}&tablename={2}&columnname={3}";
    ...
    AuditTableDetailServicesProvider.prototype.GetSqlAsync = function (schemaname, tablename, columnname, method) {
        var _this = this;
        var sub_url;
        sub_url = "AuditTableDetail/get_{4}_sql?schemaname={1}&tablename={2}&columnname={3}";
    ...
    AuditTableDetailServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_services__["a" /* ServicesProvider */]])
    ], AuditTableDetailServicesProvider);
    return AuditTableDetailServicesProvider;
}());

//# sourceMappingURL=audit-table-detail-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AuditTableDetailPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_audit_table_detail_services_audit_table_detail_services__ = __webpack_require__(1193);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_AuditTableDetailViewModel__ = __webpack_require__(994);
...
var AuditTableDetailPage = /** @class */ (function () {
    function AuditTableDetailPage(menuCtrl, navCtrl, navParams, AuditTableDetailServices, loadingCtrl, global, authServices, modalCtrl, alertCtrl, platform, conf) {
        this.menuCtrl = menuCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.AuditTableDetailServices = AuditTableDetailServices;
        ...
        this.CanAuditTableDetailExec = true;
    ...
    AuditTableDetailPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    AuditTableDetailPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    AuditTableDetailPage.prototype.setPage = function (pageInfo) {
    ...
    AuditTableDetailPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    AuditTableDetailPage.prototype.onResize = function (event) {
        if (event.target.innerWidth > 0) {
            this.innerWidth = event.target.innerWidth;
            this.innerHeight = event.target.innerHeight;
        }
    };
    AuditTableDetailPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.AuditTableDetailServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.schemaname, _this.tablename, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    AuditTableDetailPage.prototype.openNavSqlPage = function (item, method, is_exec) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.AuditTableDetailServices.GetSqlAsync(item.schemaname, item.tablename, item.columnname, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    AuditTableDetailPage.prototype.ShowModal = function (item) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_AuditTableDetailViewModel__["a" /* AuditTableDetailViewModel */]();
        ...
        var modal = this.modalCtrl.create("AuditTableDetailAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.AuditTableDetailServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("資料表明細稽核", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    AuditTableDetailPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.AuditTableDetailServices.DeleteAsync(item.schemaname, item.tablename, item.columnname).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    ], AuditTableDetailPage);
    return AuditTableDetailPage;
}());

//# sourceMappingURL=audit-table-detail.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AuditTableDetailListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_AuditTableDetailViewModel__ = __webpack_require__(994);
...
var AuditTableDetailListResponse = /** @class */ (function (_super) {
    __extends(AuditTableDetailListResponse, _super);
    function AuditTableDetailListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_AuditTableDetailViewModel__["a" /* AuditTableDetailViewModel */]();
    ...
    return AuditTableDetailListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=AuditTableDetailListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AuditTableDetailResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_AuditTableDetailViewModel__ = __webpack_require__(994);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var AuditTableDetailResponse = /** @class */ (function (_super) {
    __extends(AuditTableDetailResponse, _super);
    function AuditTableDetailResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_AuditTableDetailViewModel__["a" /* AuditTableDetailViewModel */]();
    ...
    return AuditTableDetailResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=AuditTableDetailResponse.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AuditTableDetailPageModule", function() { return AuditTableDetailPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__audit_table_detail__ = __webpack_require__(1257);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_audit_table_detail_services_audit_table_detail_services__ = __webpack_require__(1193);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AuditTableDetailPageModule = /** @class */ (function () {
    function AuditTableDetailPageModule() {
    }
    AuditTableDetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__audit_table_detail__["a" /* AuditTableDetailPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_audit_table_detail_services_audit_table_detail_services__["a" /* AuditTableDetailServicesProvider */],],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__audit_table_detail__["a" /* AuditTableDetailPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], AuditTableDetailPageModule);
    return AuditTableDetailPageModule;
}());

//# sourceMappingURL=audit-table-detail.module.js.map
