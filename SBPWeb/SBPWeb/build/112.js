...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ApiUrlPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_api_url_services_api_url_services__ = __webpack_require__(285);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_global_global__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_ViewModel_ApiUrlViewModel__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_file__ = __webpack_require__(296);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_file_saver__ = __webpack_require__(940);
...
var ApiUrlPage = /** @class */ (function () {
    function ApiUrlPage(menuCtrl, navCtrl, navParams, ApiUrlServices, loadingCtrl, global, modalCtrl, alertCtrl, file, platform, conf) {
        ...
        this.CanApiUrlExec = true;
        this.is_app = true;
        this.detail_page = "ApiUrlDetailPage";
        this.step_page = "ApiUrlStepPage";
        this.loop_page = "ApiUrlLoopPage";
        this.sch_page = "SchByApiUrlPage";
        ...
        this.parent_page_name = navParams.data.parent_page_name;
        this.is_app = this.global.check_app();
        this.LoadData(true);
    }
    ApiUrlPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    ApiUrlPage.prototype.onMobileModeClick = function (mobile_mode) {
        this.conf.mobile_mode = mobile_mode;
    };
    ApiUrlPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    ApiUrlPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    ApiUrlPage.prototype.HtmlSave = function () {
        var filename = "api_url.json";
        var blob = new Blob([JSON.stringify(this.data_list)], {
            type: "application/json;charset=utf8"
        });
        __WEBPACK_IMPORTED_MODULE_7_file_saver__["saveAs"](blob, filename);
    };
    ApiUrlPage.prototype.SaveFile = function () {
        var _this = this;
        ...
        this.file
            ...
            .then(function (res) {
            _this.file
                .writeFile(path + directory, filename, JSON.stringify(_this.data_list), options)
                .then(function (res) {
                // this.global.showMessage("file url:",res.toURL());
                // this.ApiUrlServices.set_is_app(true);
                _this.global.showMessage("儲存", "儲存Url設定成功!");
            })
                .catch(function (err) {
                // this.ApiUrlServices.set_is_app(false);
                _this.is_app = false;
            ...
            _this.file
                ...
                .then(function (res) {
                // this.global.showMessage("dir url:",res.toURL());
                _this.file
                    .writeFile(path + directory, filename, JSON.stringify(_this.data_list), options)
                    .then(function (res) {
                    //this.ApiUrlServices.set_is_app(true);
    ...
    ApiUrlPage.prototype.CheckFile = function () {
        var _this = this;
        var path = this.file.dataDirectory;
        var directory = "";
        this.file
    ...
    ApiUrlPage.prototype.update_api_url = function (event) {
        this.global.dismissLoading();
        this.ApiUrlServices.Set_api_list(event.target.result);
        this.LoadData(true);
        this.global.showMessage("匯入", "匯入檔案Url設定成功!");
    };
    ApiUrlPage.prototype.onChange = function (event) {
        var _this = this;
        this.global.createLoader("匯入設定資料中...");
        this.global.loading.present().then(function () {
            var file = event.srcElement.files[0];
            var fileReader = new FileReader();
            fileReader.onloadend = _this.update_api_url.bind(_this);
            fileReader.readAsText(file, "UTF-8");
        });
    };
    ApiUrlPage.prototype.LoadFile = function () {
        var _this = this;
        var path = this.file.dataDirectory;
        var directory = "sbp";
        var filename = "api_url.json";
        this.file
            ...
            .then(function (res) {
            _this.file
                .readAsText(path + directory, filename)
                .then(function (res) {
                _this.ApiUrlServices.Set_api_list(res);
                _this.LoadData(true);
                _this.global.showMessage("匯入", "匯入檔案Url設定成功!");
            })
                .catch(function (err) {
                _this.global.showError("無法連上WebAPI伺服器-" + err.message);
            });
    ...
    ApiUrlPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.ApiUrlServices.GetListsAsync(_this.keyword, _this.order_type).subscribe(function (data) {
    ...
    ApiUrlPage.prototype.back = function () {
        this.navCtrl.setRoot(this.parent_page_name);
    };
    ApiUrlPage.prototype.get_board_class = function (item) {
        if (item.is_default === true)
            return "select_bordered";
        else
            return "bordered";
    };
    ApiUrlPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_4__Model_ViewModel_ApiUrlViewModel__["a" /* ApiUrlViewModel */]();
            item.is_default = false;
            item.is_url_forward = false;
        }
        else {
            this.mode = "PUT";
            if (change_mode === "c")
        ...
        var modal = this.modalCtrl.create("ApiUrlAddEditModalPage", {
            mode: this.mode,
            item: item,
            change_mode: change_mode,
            CanEditApiUrl: this.CanEditApiUrl
        });
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.ApiUrlServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.parent_page.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("Api Url設定", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    ApiUrlPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.id),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.ApiUrlServices.DeleteAsync(item.id).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.parent_page.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    ApiUrlPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad ApiUrl");
    };
    ApiUrlPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-api-url",template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\api-url\api-url.html"*/'<ion-header>\n  <headerComponent [title]="title" [is_modal]=true [permission_id]="\'\'" [show_table_select]=true ></headerComponent>\n</ion-header>\n\n<ion-content>\n  <ion-row>\n    <ion-col>\n\n      <ion-searchbar [ngClass]="[\'search\']" (keyup.enter)="LoadData(true)" placeholder="搜尋關鍵字(別名、url)"\n        [(ngModel)]="keyword">\n      </ion-searchbar>\n\n    </ion-col>\n  </ion-row>\n  <ion-grid *ngIf="conf.mobile_mode==false && selectedItem!=null" [ngClass]="\'bordered\'">\n    <ion-row >\n      <ion-col>\n          <button small title="編輯" ion-button color="light" icon-left (click)="ShowModal(selectedItem)">\n              <ion-icon name="create"></ion-icon>\n            </button>\n            <button small title="複製" ion-button color="light" icon-left (click)="ShowModal(selectedItem,\'c\')">\n              <ion-icon name="copy"></ion-icon>\n            </button>\n            <button small  title="刪除" [disabled]="selectedItem.is_default===true" ion-button color="dark" icon-left (click)="Delete(selectedItem)">\n              <ion-icon name="trash"></ion-icon>\n            </button>\n        </ion-col>\n        </ion-row>\n        </ion-grid>\n  <ngx-datatable NgxResizeWatcher class="bootstrap"\n  [limit]="8"\n  *ngIf="data_list!=null && conf.mobile_mode==false"\n  [selected]="selected"\n  [selectionType]="\'single\'"\n  (select)=\'onRowSelect($event)\'\n   [rows]="data_list"\n   [columnMode]="\'flex\'"\n   [rowHeight]="\'auto\'"\n   [footerHeight]="40"\n   [headerHeight]="\'auto\'"\n   >\n\n   <ngx-datatable-column\n  prop="id"\n   name="編號"\n   [flexGrow]="1"\n   [frozenLeft]="true">\n  </ngx-datatable-column>\n   <ngx-datatable-column\n   prop="disp_name"\n    name="顯示"\n    [flexGrow]="2"\n    [frozenLeft]="true">\n </ngx-datatable-column>\n <ngx-datatable-column\n   prop="url"\n    name="url"\n    [flexGrow]="4">\n </ngx-datatable-column>\n <ngx-datatable-column\n  prop="url_forward"\n   name="轉址"\n   [flexGrow]="1">\n  </ngx-datatable-column>\n  </ngx-datatable>\n  <div *ngIf="data_list!=null && conf.mobile_mode==true"  >\n    <ion-row>\n      <ion-col col-lg-4 col-md-6 col-sm-6 col-12 *ngFor="let item of data_list">\n        <ion-grid [ngClass]=get_board_class(item)>\n\n          <ion-row>\n            <ion-col>\n              <button small title="編輯" ion-button color="light" icon-left (click)="ShowModal(item)">\n                <ion-icon name="create"></ion-icon>\n              </button>\n              <button small title="複製" ion-button color="light" icon-left (click)="ShowModal(item,\'c\')">\n                <ion-icon name="copy"></ion-icon>\n              </button>\n              <button small  title="刪除" [disabled]="item.is_default==true" ion-button color="dark" icon-left (click)="Delete(item)">\n                <ion-icon name="trash"></ion-icon>\n              </button>\n\n            </ion-col>\n          </ion-row>\n\n          <ion-row>\n            <ion-col>\n              {{item.id}}\n            </ion-col>\n            <ion-col col-4 align-self-end>\n              <div text-right>\n\n                <div text-right>{{item.url_forward}}</div>\n              </div>\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              {{item.disp_name}}\n\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              {{item.url}}\n\n            </ion-col>\n          </ion-row>\n\n        </ion-grid>\n      </ion-col>\n    </ion-row>\n  </div>\n</ion-content>\n<ion-footer>\n  <ion-toolbar>\n    <ion-row>\n      <ion-col>\n        <div [ngClass]="[\'command\']">\n          <button small title="重新整理" ion-button color="dark" icon-left (click)="LoadData(true)">\n            <ion-checkbox name="order_type" title="遞增/遞減" color="dark" [(ngModel)]="order_type" (ionChange)="LoadData(true)"></ion-checkbox>\n            <ion-icon name="refresh"></ion-icon>\n          </button>\n          <button small title="返回" ion-button color="dark" icon-left (click)="back()">\n              <ion-icon name="backspace"></ion-icon>\n            </button>\n          <button small title="新增" ion-button color="dark" icon-left (click)="ShowModal(null)">\n            <ion-icon name="add"></ion-icon>\n          </button>\n          <button small title="儲存檔案" *ngIf="is_app==false"  ion-button color="secondary" icon-left (click)="HtmlSave()">\n            <ion-icon name="download"></ion-icon>\n          </button>\n          <button small title="儲存檔案" *ngIf="is_app==true" ion-button color="dark" icon-left (click)="SaveFile()">\n            <ion-icon name="download"></ion-icon>\n          </button>\n          <button small title="載入設定" *ngIf="is_app==true" ion-button color="dark" icon-left (click)="LoadFile()">\n            <ion-icon name="cloud-upload"></ion-icon>\n          </button>\n          <input hidden type="file" accept="application/json" id="fileInput" (change)="onChange($event)">\n          <label small color="secondary"  title="從外部檔案匯入" for="fileInput" icon-only ion-button>\n            <ion-icon name="cloud-upload"></ion-icon>\n        </label>\n        </div>\n        <!-- <button small title="新增" ion-button color="dark" icon-left (click)="global.showMessage(\'儲存\',platform.platforms()+platform.userAgent())">\n            <ion-icon name="add"></ion-icon>\n          </button> -->\n        <!-- <StatusComponent [pageNumber]="pageNumber" [totalPages]="totalPages" [totalRows]="totalRows"></StatusComponent> -->\n      </ion-col>\n\n    </ion-row>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\api-url\api-url.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* MenuController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__providers_api_url_services_api_url_services__["a" /* ApiUrlServicesProvider */],
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ApiUrlPageModule", function() { return ApiUrlPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api_url__ = __webpack_require__(1253);
...
var ApiUrlPageModule = /** @class */ (function () {
    function ApiUrlPageModule() {
    }
    ApiUrlPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__api_url__["a" /* ApiUrlPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__api_url__["a" /* ApiUrlPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], ApiUrlPageModule);
    return ApiUrlPageModule;
}());

//# sourceMappingURL=api-url.module.js.map
