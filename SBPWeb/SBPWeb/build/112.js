...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileContentLogPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_content_log_services_file_content_log_services__ = __webpack_require__(299);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_FileBrowserViewModel__ = __webpack_require__(134);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_file_browser_services_file_browser_services__ = __webpack_require__(284);
...
var FileContentLogPage = /** @class */ (function () {
    function FileContentLogPage(menuCtrl, navCtrl, navParams, FileContentLogServices, loadingCtrl, global, authServices, modalCtrl, alertCtrl, FileBrowserServices) {
        this.menuCtrl = menuCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.FileContentLogServices = FileContentLogServices;
    ...
    FileContentLogPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileContentLogPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileContentLogPage.prototype.ShowModal = function (Fitem, change_mode) {
        var _this = this;
        this.mode = "Rename";
        if (change_mode === "c") {
            this.mode = "Copy";
        }
        this.fb = new __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_FileBrowserViewModel__["a" /* FileBrowserViewModel */]();
        this.fb.filename = Fitem.filename;
        this.fb.file_size = Fitem.file_size;
        this.fb.filepath = Fitem.file_path;
        this.fb.filefullname = Fitem.fullpath_file;
        var modal = this.modalCtrl.create("FileBrowserCopyEditModalPage", {
            mode: this.mode,
            item: this.fb,
            change_mode: change_mode,
            CanEditFileBrowser: true,
        });
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileBrowserServices.PutAsync(_this.fb.filefullname, select_data, _this.mode).subscribe(function (data) {
    ...
    FileContentLogPage.prototype.LoadData = function (init) {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileContentLogServices.GetAsync(_this.item.exec_log_seq).subscribe(function (data) {
    ...
    FileContentLogPage.prototype.download = function (item) {
        var _this = this;
        this.global.createLoader("檔案下載中...");
        this.global.loading.present().then(function () {
            _this.FileBrowserServices.download(item.fullpath_file).subscribe(function (data) {
                _this.global.dismissLoading();
                __WEBPACK_IMPORTED_MODULE_8_file_saver__["saveAs"](data, item.filename);
            }, function (error) {
                _this.global.dismissLoading();
                _this.global.showError("查無檔案或下載發生異常" + error.message);
            });
        });
    };
    FileContentLogPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_7__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.filename),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileBrowserServices.DeleteAsync(item.fullpath_file).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileContentLogPage.prototype.onChange = function (event) {
        var _this = this;
        var file = event.srcElement.files[0];
        var formData = new FormData();
        formData.append('file', file, file.name);
        formData.append("filepath", this.data.file_path);
    ...
    FileContentLogPage.prototype.back = function () {
        this.navCtrl.pop();
    };
    FileContentLogPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad FileContentLog");
    };
    FileContentLogPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-FileContentLog",template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\file-content-log\file-content-log.html"*/'<ion-header>\n    <headerComponent [title]="\'檔案執行紀錄明細\'" [permission_id]="\'CanViewLog\'"></headerComponent>\n  </ion-header>\n\n\n  <ion-content padding (window:resize)="onResize($event)">\n      <ion-grid>\n          <ion-row>\n            <ion-col col-12 col-sm-2 col-md-3>\n            </ion-col>\n            <ion-col col-12 col-sm-8 col-md-6>\n\n              <ion-grid [ngClass]="[\'subject\']">\n                <ion-row>\n                  <ion-col>\n                    <div [ngClass]="[\'label90\']">\n                     轉檔紀錄序號\n                    </div>\n                    <b>{{title}}</b>\n                  </ion-col>\n                </ion-row>\n              </ion-grid>\n            </ion-col>\n            <ion-col col-12 col-sm-2 col-md-3>\n            </ion-col>\n          </ion-row>\n        </ion-grid>\n    <ion-grid *ngIf="data!=null">\n      <ion-row>\n        <ion-col col-12 col-sm-12 col-md-12>\n        </ion-col>\n        <ion-col col-12 col-sm-12 col-md-12>\n\n          <ion-grid [ngClass]="[\'bordered\']">\n              <ion-row>\n                  <ion-col >\n                   <b>檔案名稱</b> {{data.filename}}\n                  </ion-col>                 \n              </ion-row>\n             <ion-row>\n                  <ion-col >\n                   <b>檔案大小(byte)</b> {{data.file_size}}\n                  </ion-col>                 \n              </ion-row>\n              <ion-row>\n                  <ion-col >\n                   <b>檔案路徑</b> {{data.file_path}}\n                  </ion-col>                 \n              </ion-row>              \n              <ion-row>\n                  <ion-col>\n                  <b>完整檔名</b>\n                  </ion-col>\n              </ion-row>\n              <ion-row>\n                <ion-col>\n                  <ion-textarea autosize  [(ngModel)]="data.fullpath_file" >\n                  </ion-textarea>\n                </ion-col>\n              </ion-row>\n          </ion-grid>\n        </ion-col>\n        <ion-col col-12 col-sm-12 col-md-12>\n        </ion-col>\n      </ion-row>\n    </ion-grid>\n  </ion-content>\n  <ion-footer>\n  <ion-toolbar>\n    <ion-row *ngIf="item.func_key!=\'014|1\'" >\n      <ion-col>\n        <div [ngClass]="[\'command\']">\n          <button small title="變更" ion-button color="light" icon-left (click)="ShowModal(data)">\n          <ion-icon name="create"></ion-icon>\n        </button>\n        <button small title="複製" ion-button color="light" icon-left (click)="ShowModal(data,\'c\')">\n          <ion-icon name="copy"></ion-icon>\n        </button>\n        <button small title="下載" *ngIf="is_app==false" ion-button color="light" icon-left (click)="download(data)">\n          <ion-icon name="download"></ion-icon>\n        </button>\n       \n\n        <button small title="刪除" ion-button color="dark" icon-left (click)="Delete(data)">\n          <ion-icon name="trash"></ion-icon>\n        </button>\n          <input hidden type="file" id="fileInput" (change)="onChange($event)">\n          <label small color="light" title="上傳" for="fileInput" icon-only ion-button>\n            <ion-icon name="cloud-upload"></ion-icon>\n          </label>\n         \n        </div>\n        \n      </ion-col>\n\n    </ion-row>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\file-content-log\file-content-log.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* MenuController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_4__providers_file_content_log_services_file_content_log_services__["a" /* FileContentLogServicesProvider */],
            ...
            __WEBPACK_IMPORTED_MODULE_6__providers_file_browser_services_file_browser_services__["a" /* FileBrowserServicesProvider */]])
    ], FileContentLogPage);
    return FileContentLogPage;
}());

//# sourceMappingURL=file-content-log.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileContentLogPageModule", function() { return FileContentLogPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_components_module__ = __webpack_require__(813);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__file_content_log__ = __webpack_require__(1375);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileContentLogPageModule = /** @class */ (function () {
    function FileContentLogPageModule() {
    }
    FileContentLogPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__file_content_log__["a" /* FileContentLogPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__file_content_log__["a" /* FileContentLogPage */]),
                __WEBPACK_IMPORTED_MODULE_2__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileContentLogPageModule);
    return FileContentLogPageModule;
}());

//# sourceMappingURL=file-content-log.module.js.map
