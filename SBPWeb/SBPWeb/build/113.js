...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TableFkPage; });
...
var TableFkPage = /** @class */ (function () {
    function TableFkPage(menuCtrl, navCtrl, navParams, TableExtServices, loadingCtrl, global, authServices, modalCtrl, alertCtrl, platform, conf) {
        ...
        this.totalPages = 1;
        this.totalRows = 0;
        this.detail_page = "TableFKDetailPage";
        this.table_page = "TableExtPage";
        this.innerWidth = window.innerWidth;
        this.innerHeight = window.innerHeight;
        this.pageNumber = 1;
        this.title =
            navParams.data.schemaname + "." + navParams.data.tablename;
        this.schemaname = navParams.data.schemaname;
        this.tablename = navParams.data.tablename;
        this.order_type = true;
        this.fk_type = navParams.data.fk_type;
        if (this.fk_type == 0)
            this.title_type = "相依資料表";
        else
            this.title_type = "被相依資料表";
    ...
    TableFkPage.prototype.openNavTablePage = function (tablefullname) {
        var _this = this;
    ...
    TableFkPage.prototype.openNavTableDetailFKPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push("TableDetailFkPage", { item: item, fk_type: _this.fk_type });
        });
    };
    TableFkPage.prototype.openNavCreateFKSqlPage = function () {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.TableExtServices.GetTableCreateExtSqlAsync(_this.schemaname, _this.tablename).subscribe(function (data) {
                if (data.DidError === true) {
                    ...
                    _this.navCtrl.push("SqlPage", {
                        sql_statement: data.Model.create_fk_sql,
    ...
    TableFkPage.prototype.openNavCreateDependFKSqlPage = function () {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.TableExtServices.GetTableCreateExtSqlAsync(_this.schemaname, _this.tablename).subscribe(function (data) {
                if (data.DidError === true) {
                    ...
                    _this.navCtrl.push("SqlPage", {
                        sql_statement: data.Model.create_depend_fk_sql,
                        is_exec: _this.CanEditTable
                    });
                    _this.global.dismissLoading();
                }
    ...
    TableFkPage.prototype.openNavDropDependFKSqlPage = function () {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.TableExtServices.GetTableCreateExtSqlAsync(_this.schemaname, _this.tablename).subscribe(function (data) {
                if (data.DidError === true) {
                    ...
                    _this.navCtrl.push("SqlPage", {
                        sql_statement: data.Model.drop_depend_fk_sql,
                        is_exec: _this.CanEditTable
                    });
                    _this.global.dismissLoading();
                }
    ...
    TableFkPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit === Math.floor(this.pageSize / 3);
    };
    TableFkPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
        console.log("Select Event", selected, this.selected);
    };
    TableFkPage.prototype.setPage = function (pageInfo) {
    ...
    TableFkPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    TableFkPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    TableFkPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        if (this.fk_type === 0) {
            this.global.loading.present().then(function () {
                _this.TableExtServices.GetTableFKListsAsync(_this.pageSize, _this.pageNumber, _this.schemaname, _this.tablename, _this.keyword, _this.order_type).subscribe(function (data) {
                    if (data.DidError === true) {
                        _this.global.dismissLoading();
                        _this.global.showError(data.ErrorMessage);
                    }
            ...
            this.global.loading.present().then(function () {
                _this.TableExtServices.GetTableFKedListsAsync(_this.pageSize, _this.pageNumber, _this.schemaname, _this.tablename, _this.keyword, _this.order_type).subscribe(function (data) {
                    if (data.DidError === true) {
                        _this.global.dismissLoading();
                        _this.global.showError(data.ErrorMessage);
                    }
    ...
    TableFkPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad TableFK");
    };
    TableFkPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-table-fk",template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\table-fk\table-fk.html"*/'<ion-header>\n  <headerComponent [title]="title_type" [permission_id]="\'CanTable\'" [show_table_select]=true></headerComponent>\n\n</ion-header>\n<ion-content>\n  <ion-grid>\n    <ion-row>\n      <ion-col col-12 col-sm-2 col-md-3>\n      </ion-col>\n      <ion-col col-12 col-sm-8 col-md-6>\n\n        <ion-grid [ngClass]="[\'subject\']">\n          <ion-row>\n            <ion-col>\n              <div [ngClass]="[\'label80\']">\n                資料表\n              </div>\n              <b>{{title}}</b>\n            </ion-col>\n          </ion-row>\n        </ion-grid>\n      </ion-col>\n      <ion-col col-12 col-sm-2 col-md-3>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n  <ion-row>\n    <ion-col>\n\n      <ion-searchbar [ngClass]="[\'search\']" (keyup.enter)="LoadData(true)" placeholder="搜尋關鍵字(資料表名稱包含、相依資料表名稱包含)"\n        [(ngModel)]="keyword">\n      </ion-searchbar>\n\n    </ion-col>\n  </ion-row>\n  <ion-grid *ngIf="conf.mobile_mode==false && selectedItem!=null" [ngClass]="\'bordered\'">\n    <ion-row>\n      <ion-col>\n        <button small title="明細" ion-button color="secondary" icon-left (click)="openNavTableDetailFKPage(selectedItem)">\n          <ion-icon name="albums"></ion-icon>\n        </button>\n      </ion-col>\n\n    </ion-row>\n  </ion-grid>\n  <ngx-datatable NgxResizeWatcher class="bootstrap" *ngIf="totalRows>0 && conf.mobile_mode==false" [selected]="selected"\n    [selectionType]="\'single\'" (select)=\'onRowSelect($event)\' [rows]="data_list" [columnMode]="\'flex\'" [headerHeight]="40"\n    [rowHeight]="\'auto\'" [footerHeight]="40" [reorderable]=false [limit]="limit" [count]="totalRows" [offset]="offset"\n    (page)=\'setPage($event)\'>\n\n    <ngx-datatable-column prop="fk_cons" name="相依關聯限制" [flexGrow]="1" [frozenLeft]="true">\n    </ngx-datatable-column>\n\n\n    <ngx-datatable-column *ngIf="fk_type==1" prop="tablefullname" name="資料表全名" [flexGrow]="2" [frozenLeft]="true">\n      <ng-template let-row="row" let-value="value" ngx-datatable-cell-template>\n        <button [ngClass]="\'hyper_link\'" title="資料表檢視" (click)="openNavTablePage(value)">\n          {{value}}\n        </button>\n      </ng-template>\n    </ngx-datatable-column>\n    <ngx-datatable-column *ngIf="fk_type==0" prop="fk_tablefullname" name="相依資料表全名" [flexGrow]="2" [frozenLeft]="true">\n      <ng-template let-row="row" let-value="value" ngx-datatable-cell-template>\n        <button [ngClass]="\'hyper_link\'" title="資料表檢視" (click)="openNavTablePage(value)">\n          {{value}}\n        </button>\n      </ng-template>\n    </ngx-datatable-column>\n\n\n    <ngx-datatable-column prop="delete_action" name="刪除動作" [flexGrow]="1" *ngIf="innerWidth>=1024">\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="update_action" name="更新動作" [flexGrow]="1">\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="relation" name="相依關係" [flexGrow]="1">\n    </ngx-datatable-column>\n\n\n\n  </ngx-datatable>\n  <div *ngIf="totalRows>0 && conf.mobile_mode==true">\n    <ion-row>\n      <ion-col col-lg-4 col-md-6 col-sm-6 col-12 *ngFor="let item of data_list">\n        <ion-grid [ngClass]="[\'bordered\']">\n          <ion-row>\n            <ion-col>\n              <button small title="明細" ion-button color="secondary" icon-left (click)="openNavTableDetailFKPage(selectedItem)">\n                <ion-icon name="albums"></ion-icon>\n              </button>\n            </ion-col>\n\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              {{item.fk_cons}}\n            </ion-col>\n            <ion-col>\n              {{item.relation}}\n            </ion-col>\n\n          </ion-row>\n          <ion-row *ngIf="fk_type==1">\n            <ion-col>\n              <button [ngClass]="\'hyper_link\'" title="資料表檢視" (click)="openNavTablePage(item.tablefullname)">\n                {{item.tablefullname}}\n              </button>\n            </ion-col>\n\n          </ion-row>\n          <ion-row *ngIf="fk_type==0">\n            <ion-col>\n              <button [ngClass]="\'hyper_link\'" title="資料表檢視" (click)="openNavTablePage(item.fk_tablefullname)">\n                {{item.fk_tablefullname}}\n              </button>\n            </ion-col>\n\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              {{item.delete_action}}\n            </ion-col>\n            <ion-col>\n              {{item.update_action}}\n            </ion-col>\n          </ion-row>\n\n\n        </ion-grid>\n      </ion-col>\n    </ion-row>\n  </div>\n  <ion-infinite-scroll *ngIf="pageNumber < totalPages && conf.mobile_mode==true" (ionInfinite)="$event.waitFor(doInfinite())">\n    <ion-infinite-scroll-content loadingSpinner="bubbles">\n    </ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n</ion-content>\n<ion-footer>\n  <ion-toolbar>\n    <ion-row>\n      <ion-col>\n        <div [ngClass]="[\'command\']">\n          <button small title="重新整理" ion-button color="dark" icon-left (click)="LoadData(true)">\n            <ion-checkbox name="order_type" title="遞增/遞減" color="dark" [(ngModel)]="order_type" (ionChange)="LoadData(true)"></ion-checkbox>\n            <ion-icon name="refresh"></ion-icon>\n          </button>\n          <button small title="產生建立FK語法" *ngIf="fk_type==0" ion-button color="light" icon-left (click)="openNavCreateFKSqlPage()">\n            Crd\n          </button>\n          <button small title="產生建立FK語法" *ngIf="fk_type==1" ion-button color="light" icon-left (click)="openNavCreateDependFKSqlPage()">\n            Crd\n          </button>\n          <button small title="產生建立FK語法" *ngIf="fk_type==1" ion-button color="light" icon-left (click)="openNavDropDependFKSqlPage()">\n            Drop\n          </button>\n        </div>\n        <StatusComponent [pageNumber]="pageNumber" [totalPages]="totalPages" [totalRows]="totalRows"></StatusComponent>\n\n\n      </ion-col>\n\n    </ion-row>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\table-fk\table-fk.html"*/
        }),
...
//# sourceMappingURL=table-fk.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TableFkPageModule", function() { return TableFkPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__table_fk__ = __webpack_require__(1668);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_tableext_components_module__ = __webpack_require__(922);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TableFkPageModule = /** @class */ (function () {
    function TableFkPageModule() {
    }
    TableFkPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__table_fk__["a" /* TableFkPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__table_fk__["a" /* TableFkPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_tableext_components_module__["a" /* TableExtComponentsModule */],
            ],
        })
    ], TableFkPageModule);
    return TableFkPageModule;
}());

//# sourceMappingURL=table-fk.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__table_ext_table_ext__ = __webpack_require__(923);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__table_detail_ext_table_detail_ext__ = __webpack_require__(924);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_auth_services_auth_services__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_MyAppSharedSettings__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_prog_services_prog_services__ = __webpack_require__(277);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TableExtComponent = /** @class */ (function () {
    ...
    TableExtComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            outputs: ['onSelect'],template:/*ion-inline-start:"C:\jones\ionic\prod\src\components\table-ext\table-ext.html"*/'<ion-content>\n  <ion-row>\n    <ion-col col-12 col-sm-6>\n\n      <ion-searchbar [ngClass]="[\'search\']" (keyup.enter)="LoadData(true)" placeholder="資料表類別(包含)" [(ngModel)]="category">\n      </ion-searchbar>\n\n\n    </ion-col>\n    <ion-col col-12 col-sm-6>\n\n      <ion-select [ngClass]="[\'search\']" item-end [(ngModel)]="ttype" placeholder="資料表/檢視表" (ionChange)="LoadData(true)">\n        <ion-option value="table">table</ion-option>\n        <ion-option value="view">view</ion-option>\n      </ion-select>\n\n    </ion-col>\n  </ion-row>\n  <ion-row>\n    <ion-col>\n\n      <ion-searchbar [ngClass]="[\'search\']" (keyup.enter)="LoadData(true)" placeholder="搜尋關鍵字(資料表名稱(包含)、資料表說明(包含)、資料表類別(包含)"\n        [(ngModel)]="keyword">\n      </ion-searchbar>\n\n    </ion-col>\n  </ion-row>\n  <ion-grid *ngIf="conf.mobile_mode==false && selectedItem!=null" [ngClass]="\'bordered\'">\n    <ion-row>\n      <ion-col>\n        <button small title="明細" ion-button color="secondary" icon-left (click)="openNavDetailsPage(selectedItem)">\n          <ion-icon name="albums"></ion-icon>\n        </button>\n        <button small title="資料表設定" ion-button color="light" icon-left (click)="openNavConfigPage(selectedItem)">\n          <ion-icon name="albums"></ion-icon>\n        </button>\n        <button small title="欄位對應設定" ion-button color="primary" icon-left (click)="openNavColumnMappingPage(selectedItem)">\n          <ion-icon name="card"></ion-icon>\n        </button>\n        <button small title="相依資料表" ion-button color="light" icon-left (click)="openNavFKPage(selectedItem,0)">\n          <ion-icon name="log-out"></ion-icon>\n        </button>\n        <button small title="被相依資料表" ion-button color="light" icon-left (click)="openNavFKPage(selectedItem,1)">\n          <ion-icon name="log-in"></ion-icon>\n        </button>\n        <button small title="加入" *ngIf="show_select==true" ion-button color="danger" icon-left (click)="add(selectedItem)">\n          <ion-icon name="checkmark-circle"></ion-icon>\n        </button>\n      </ion-col>\n      <ion-col>\n\n        <button small title="產生中文名稱語法" ion-button color="light" icon-left (click)="openNavTablecnameSqlPage(selectedItem)">\n          中文\n        </button>\n        <button small title="產生類別語法" ion-button color="light" icon-left (click)="openNavCategorySqlPage(selectedItem)">\n          類別\n        </button>\n        <button small title="產生匯入資料表設定語法" ion-button color="light" icon-left (click)="openNavConfigSqlPage(selectedItem)">\n          匯入\n        </button>\n        <button small title="產生複製資料表設定語法" ion-button color="light" icon-left (click)="openNavCopyConfigSqlPage(selectedItem)">\n          複製\n        </button>\n        <button small title="程式語法" ion-button color="light" *ngIf="selectedItem.ttype==\'view\'" icon-left (click)="openNavProgSqlPage(selectedItem)">\n          <ion-icon name="expand"></ion-icon>\n        </button>\n      </ion-col>\n      <ion-col>\n          <button small title="產生建立資料表語法" ion-button color="light" icon-left (click)="openNavTableCreateSqlPage(selectedItem)">\n            Crd\n          </button>\n          <button small title="產生非叢集索引語法" ion-button color="light" icon-left (click)="openNavCreateIndexSqlPage(selectedItem)">\n              Idx\n            </button>\n      </ion-col>\n      <ion-col>\n\n        <button small title="產生Insert SQL語法" ion-button color="light" icon-left (click)="openNavInsertValueSqlPage(selectedItem)">\n          Ins\n        </button>\n        <button small title="產生Update SQL語法" ion-button color="light" icon-left (click)="openNavUpdateValueSqlPage(selectedItem)">\n          Upd\n        </button>\n        <button small title="產生Select value語法" ion-button color="light" icon-left (click)="openNavSelectValueSqlPage(selectedItem)">\n          Sel\n        </button>\n        <button small title="產生Merge value語法" ion-button color="light" icon-left (click)="openNavMergeSqlPage(selectedItem)">\n          Mge\n        </button>\n        <button small title="產生匯出檔案資料 value語法" ion-button color="light" icon-left (click)="openNavExportSqlPage(selectedItem)">\n          Exp\n        </button>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n  <ngx-datatable NgxResizeWatcher class="bootstrap" *ngIf="totalRows>0 && conf.mobile_mode==false" [selected]="selected"\n    [selectionType]="\'single\'" (select)=\'onRowSelect($event)\' [rows]="data_list" [columnMode]="\'flex\'" [headerHeight]="40"\n    [rowHeight]="\'auto\'" [footerHeight]="40" [reorderable]=false [limit]="limit" [count]="totalRows" [offset]="offset"\n    (page)=\'setPage($event)\'>\n\n    <ngx-datatable-column prop="category" name="類別" [flexGrow]="1" [frozenLeft]="true">\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="tablefullname" name="資料表全名" [flexGrow]="2" [frozenLeft]="true">\n      <ng-template let-row="row" let-value="value" ngx-datatable-cell-template>\n        <button [ngClass]="\'hyper_link\'" title="資料字典" (click)="openNavGlossaryPage(row[\'tablename\'])">\n          {{value}}\n        </button>\n      </ng-template>\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="tablecname" name="資料表說明" [flexGrow]="1">\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="ttype" name="類型" [flexGrow]="1">\n    </ngx-datatable-column>\n  </ngx-datatable>\n  <div *ngIf="totalRows>0 && conf.mobile_mode==true">\n    <ion-row>\n      <ion-col col-lg-4 col-md-6 col-sm-6 col-12 *ngFor="let item of data_list">\n        <ion-grid [ngClass]="[\'bordered\']">\n          <ion-row>\n            <ion-col>\n              <button small title="明細" ion-button color="secondary" icon-left (click)="openNavDetailsPage(item)">\n                <ion-icon name="albums"></ion-icon>\n              </button>\n              <button small title="資料表設定" ion-button color="light" icon-left (click)="openNavConfigPage(item)">\n                <ion-icon name="albums"></ion-icon>\n              </button>\n              <button small title="欄位對應設定" ion-button color="primary" icon-left (click)="openNavColumnMappingPage(item)">\n                <ion-icon name="card"></ion-icon>\n              </button>\n              <button small title="相依資料表" ion-button color="light" icon-left (click)="openNavFKPage(item,0)">\n                <ion-icon name="log-out"></ion-icon>\n              </button>\n              <button small title="被相依資料表" ion-button color="light" icon-left (click)="openNavFKPage(item,1)">\n                <ion-icon name="log-in"></ion-icon>\n              </button>\n              <button small title="加入" *ngIf="show_select==true" ion-button color="danger" icon-left (click)="add(item)">\n                <ion-icon name="checkmark-circle"></ion-icon>\n              </button>\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n\n              <button small title="產生中文名稱語法" ion-button color="light" icon-left (click)="openNavTablecnameSqlPage(item)">\n                中文\n              </button>\n              <button small title="產生類別語法" ion-button color="light" icon-left (click)="openNavCategorySqlPage(item)">\n                類別\n              </button>\n              <button small title="產生匯入資料表設定語法" ion-button color="light" icon-left (click)="openNavConfigSqlPage(item)">\n                匯入\n              </button>\n              <button small title="產生複製資料表設定語法" ion-button color="light" icon-left (click)="openNavCopyConfigSqlPage(item)">\n                複製\n              </button>\n              <button small title="程式語法" ion-button color="light" *ngIf="item.ttype==\'view\'" icon-left (click)="openNavProgSqlPage(item)">\n                <ion-icon name="expand"></ion-icon>\n              </button>\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n                <button small title="產生建立資料表語法" ion-button color="light" icon-left (click)="openNavTableCreateSqlPage(item)">\n                    Crd\n                  </button>\n                  <button small title="產生非叢集索引語法" ion-button color="light" icon-left (click)="openNavCreateIndexSqlPage(item)">\n                      Idx\n                    </button>\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n\n              <button small title="產生Insert value語法" ion-button color="light" icon-left (click)="openNavInsertValueSqlPage(item)">\n                Ins\n              </button>\n              <button small title="產生Update value 語法" ion-button color="light" icon-left (click)="openNavUpdateValueSqlPage(item)">\n                Upd\n              </button>\n              <button small title="產生Select value語法" ion-button color="light" icon-left (click)="openNavSelectValueSqlPage(item)">\n                Sel\n              </button>\n              <button small title="產生Merge value語法" ion-button color="light" icon-left (click)="openNavMergeSqlPage(item)">\n                Mge\n              </button>\n              <button small title="產生匯出檔案資料 value語法" ion-button color="light" icon-left (click)="openNavExportSqlPage(item)">\n                Exp\n              </button>\n\n\n\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              {{item.category}}\n            </ion-col>\n            <ion-col>\n              {{item.ttype}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              <button [ngClass]="\'hyper_link\'" title="資料字典" (click)="openNavGlossaryPage(item.tablename)">\n                {{item.tablefullname}}\n              </button>\n\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              {{item.tablecname}}\n\n            </ion-col>\n          </ion-row>\n        </ion-grid>\n      </ion-col>\n    </ion-row>\n  </div>\n  <ion-infinite-scroll *ngIf="pageNumber < totalPages && conf.mobile_mode==true" (ionInfinite)="$event.waitFor(doInfinite())">\n    <ion-infinite-scroll-content loadingSpinner="bubbles">\n    </ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n</ion-content>\n<ion-footer>\n  <ion-toolbar>\n    <ion-row>\n      <ion-col>\n        <div [ngClass]="[\'command\']">\n          <button small title="重新整理" ion-button color="dark" icon-left (click)="LoadData(true)">\n            <ion-checkbox name="order_type" title="遞增/遞減" color="dark" [(ngModel)]="order_type" (ionChange)="LoadData(true)"></ion-checkbox>\n            <ion-icon name="refresh"></ion-icon>\n          </button>\n          <button small title="取消" *ngIf="show_select==true" ion-button color="dark" icon-left (click)="close()">\n            <ion-icon name="backspace"></ion-icon>\n          </button>\n        </div>\n        <StatusComponent [pageNumber]="pageNumber" [totalPages]="totalPages" [totalRows]="totalRows"></StatusComponent>\n      </ion-col>\n\n    </ion-row>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\components\table-ext\table-ext.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* MenuController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_auth_services_auth_services__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_MyAppSharedSettings__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_table_detail_services_table_detail_services__ = __webpack_require__(269);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
