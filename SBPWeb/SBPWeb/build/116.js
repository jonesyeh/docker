...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TableDetailFkPage; });
...
var TableDetailFkPage = /** @class */ (function () {
    function TableDetailFkPage(menuCtrl, navCtrl, navParams, TableExtServices, loadingCtrl, global, authServices, modalCtrl, alertCtrl, platform, conf) {
        ...
        this.pageNumber = 1;
        this.title = (this.fk_type === 0 ?
            navParams.data.item.schemaname + "." + navParams.data.item.tablename : navParams.data.item.fk_schemaname + "." + navParams.data.item.fk_tablename);
        this.schemaname = navParams.data.item.schemaname;
        this.tablename = navParams.data.item.tablename;
        this.fk_schemaname = navParams.data.item.fk_schemaname;
        this.fk_tablename = navParams.data.item.fk_tablename;
    ...
    TableDetailFkPage.prototype.openNavTablePage = function (tablefullname) {
        var _this = this;
    ...
    TableDetailFkPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit === Math.floor(this.pageSize / 3);
    };
    TableDetailFkPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
        console.log("Select Event", selected, this.selected);
    };
    TableDetailFkPage.prototype.setPage = function (pageInfo) {
    ...
    TableDetailFkPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    TableDetailFkPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    TableDetailFkPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.TableExtServices.GetTableDetailFKListsAsync(_this.pageSize, _this.pageNumber, _this.schemaname, _this.tablename, _this.fk_schemaname, _this.fk_tablename, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    return TableDetailFkPage;
}());

//# sourceMappingURL=table-detail-fk.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TableDetailFkPageModule", function() { return TableDetailFkPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__table_detail_fk__ = __webpack_require__(1659);
...
var TableDetailFkPageModule = /** @class */ (function () {
    function TableDetailFkPageModule() {
    }
    TableDetailFkPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__table_detail_fk__["a" /* TableDetailFkPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__table_detail_fk__["a" /* TableDetailFkPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_tableext_components_module__["a" /* TableExtComponentsModule */],
            ],
        })
    ], TableDetailFkPageModule);
    return TableDetailFkPageModule;
}());

//# sourceMappingURL=table-detail-fk.module.js.map
