...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PermissionUserPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_permission_services_permission_services__ = __webpack_require__(930);
...
/**
 * Generated class for the UserPermissionPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var PermissionUserPage = /** @class */ (function () {
    function PermissionUserPage(navCtrl, navParams, loadingCtrl, global, authServices, UserServices, PermissionServices, modalCtrl, platform, conf) {
    ...
    PermissionUserPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    PermissionUserPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    PermissionUserPage.prototype.setPage = function (pageInfo) {
    ...
    PermissionUserPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    PermissionUserPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    PermissionUserPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.PermissionServices.GetAsync(_this.permission_no)
                ...
                if (data.DidError === true) {
                    ...
                    if (init) {
                        _this.data_list = data.Model.users;
                        _this.totalRows = data.Model.users.length;
                    }
    ...
    PermissionUserPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_5__providers_permission_services_permission_services__["a" /* PermissionServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* ModalController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Platform */],
            __WEBPACK_IMPORTED_MODULE_6__Model_MyAppSharedSettings__["a" /* MyAppSharedSettings */]])
    ], PermissionUserPage);
    return PermissionUserPage;
}());

//# sourceMappingURL=permission-user.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PermissionUserPageModule", function() { return PermissionUserPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__permission_user__ = __webpack_require__(1595);
...
var PermissionUserPageModule = /** @class */ (function () {
    function PermissionUserPageModule() {
    }
    PermissionUserPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__permission_user__["a" /* PermissionUserPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__permission_user__["a" /* PermissionUserPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], PermissionUserPageModule);
    return PermissionUserPageModule;
}());

//# sourceMappingURL=permission-user.module.js.map
