...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MenuServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_MenuListResponse__ = __webpack_require__(1186);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_MenuResponse__ = __webpack_require__(1187);
...
/*
  ...
  and Angular DI.
*/
var MenuServicesProvider = /** @class */ (function () {
    function MenuServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "Menu";
        console.log("Hello MenuServiceProvider Provider");
    }
    MenuServicesProvider.prototype.GetListsAsync = function (PageSize, PageNumber, keyword, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "Menu?PageSize={1}&PageNumber={2}&keyword={3}&order_type={4}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.Menus = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_MenuListResponse__["a" /* MenuListResponse */]({
    ...
    MenuServicesProvider.prototype.GetSelectListsByPageAsync = function (PageSize, PageNumber, keyword, page_name, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "Menu?PageSize={1}&PageNumber={2}&keyword={3}&page_name={4}&order_type={5}";
    ...
    MenuServicesProvider.prototype.GetAsync = function (Menu_no) {
        var _this = this;
        var sub_url;
        sub_url = "Menu/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, Menu_no);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.Menu = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_MenuResponse__["a" /* MenuResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
    ...
    MenuServicesProvider.prototype.PostPutAsync = function (MenuViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "Menu";
        else
            sub_url = "Menu/" + MenuViewModel.menu_no;
        return this.Services.PostPutAsync(sub_url, this.ctl, true, MenuViewModel, mode).map(function (item) {
            _this.Menu = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_MenuResponse__["a" /* MenuResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
    ...
    MenuServicesProvider.prototype.PostAsync = function (MenuViewModel) {
        var _this = this;
        var sub_url;
        sub_url = "Menu";
        return this.Services.PostAsync(sub_url, this.ctl, true, MenuViewModel).map(function (item) {
            _this.Menu = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_MenuResponse__["a" /* MenuResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
    ...
    MenuServicesProvider.prototype.PutAsync = function (MenuViewModel) {
        var _this = this;
        var sub_url;
        sub_url = "Menu/" + MenuViewModel.menu_no;
        return this.Services.PutAsync(sub_url, this.ctl, true, MenuViewModel).map(function (item) {
            _this.Menu = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_MenuResponse__["a" /* MenuResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
    ...
    MenuServicesProvider.prototype.DeleteAsync = function (menu_no) {
        var _this = this;
        var sub_url;
        sub_url = "Menu/" + menu_no;
    ...
    MenuServicesProvider = __decorate([
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MenuListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_MenuViewModel__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ListModelResponse__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ViewModel_ProgramPageMenuViewModel__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ViewModel_ProgramPageViewModel__ = __webpack_require__(48);
...
var MenuListResponse = /** @class */ (function (_super) {
    __extends(MenuListResponse, _super);
    // Model: any;
    function MenuListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_MenuViewModel__["a" /* MenuViewModel */]();
                item.menu_id = data.menu_no;
                item.menu_no = data.menu_no;
                item.menu_desc = data.menu_desc;
                item.ProgramPageMenuViewModel = [];
                if (data.ProgramPageMenuViewModel != null) {
                    data.program_page_menuViewModel.forEach(function (pm) {
                        var pm_item = new __WEBPACK_IMPORTED_MODULE_2__ViewModel_ProgramPageMenuViewModel__["a" /* ProgramPageMenuViewModel */]();
                        pm_item.menu_no = pm.menu_no || null;
                        pm_item.page_name = pm.page_name || null;
                        var pmp_item = new __WEBPACK_IMPORTED_MODULE_3__ViewModel_ProgramPageViewModel__["a" /* ProgramPageViewModel */]();
                        pmp_item.page_name =
                            (pm.program_pageViewModel &&
                                pm.program_pageViewModel.page_name) ||
                                null;
                        pmp_item.page_desc =
                            (pm.program_pageViewModel &&
                                pm.program_pageViewModel.page_desc) ||
                                null;
                        pmp_item.program_no =
                            (pm.program_pageViewModel &&
                                pm.program_pageViewModel.program_no) ||
                                null;
...
//# sourceMappingURL=MenuListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MenuResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_MenuViewModel__ = __webpack_require__(136);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var MenuResponse = /** @class */ (function (_super) {
    __extends(MenuResponse, _super);
    function MenuResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_MenuViewModel__["a" /* MenuViewModel */]();
            _this.Model.menu_id = obj.Model.menu_no;
            _this.Model.menu_no = obj.Model.menu_no;
            _this.Model.menu_desc = obj.Model.menu_desc;
...
//# sourceMappingURL=MenuResponse.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_menu_services_menu_services__ = __webpack_require__(1067);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_MenuViewModel__ = __webpack_require__(136);
...
var MenuPage = /** @class */ (function () {
    function MenuPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, MenuServices, modalCtrl, platform, conf) {
        ...
        this.totalPages = 1;
        this.totalRows = 0;
        this.Detail_page = "MenuDetailPage";
    ...
    MenuPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    MenuPage.prototype.setPage = function (pageInfo) {
    ...
    MenuPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    MenuPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    MenuPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.MenuServices.GetListsAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    MenuPage.prototype.ShowModal = function (item) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_MenuViewModel__["a" /* MenuViewModel */]();
        }
        else {
            this.mode = "PUT";
        }
        var modal = this.modalCtrl.create("MenuAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.MenuServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        if (_this.mode === "POST") {
                            _this.data_list.push(select_data);
                            _this.totalRows += 1;
                        }
                        else {
                            var index = _this.data_list.findIndex(function (d) { return d.menu_no === item.menu_no; });
                            _this.data_list[index] = select_data; //remove element from array
                        }
                        _this.global.dismissLoading();
                        _this.global.showPopup("權限", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    MenuPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.menu_no),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.MenuServices.DeleteAsync(item.menu_no).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    MenuPage.prototype.openNavDetailPage = function (item) {
        var _this = this;
    ...
    MenuPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_menu_services_menu_services__["a" /* MenuServicesProvider */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__menu__ = __webpack_require__(1581);
...
var MenuPageModule = /** @class */ (function () {
    ...
    MenuPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_menu_services_menu_services__["a" /* MenuServicesProvider */],
            ],
            imports: [
