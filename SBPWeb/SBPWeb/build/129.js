...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LoginLogServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_LoginLogListResponse__ = __webpack_require__(1582);
...
/*
  Generated class for the LoginLogServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var LoginLogServicesProvider = /** @class */ (function () {
    function LoginLogServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "LoginLog";
        console.log("Hello LoginLogServiceProvider Provider");
    }
    LoginLogServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, creator, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "LoginLog?PageSize={1}&PageNumber={2}&keyword={3}&creator={4}&order_type={5}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, PageSize, PageNumber, keyword, creator, order_type);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.LoginLogs = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_LoginLogListResponse__["a" /* LoginLogListResponse */]({
            ...
            return _this.LoginLogs;
        });
    };
    LoginLogServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_services__["a" /* ServicesProvider */]])
    ], LoginLogServicesProvider);
    return LoginLogServicesProvider;
}());

//# sourceMappingURL=login-log-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LoginLogPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_login_log_services_login_log_services__ = __webpack_require__(1236);
...
/**
 * Generated class for the LoginLogPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var LoginLogPage = /** @class */ (function () {
    function LoginLogPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, LoginLogServices, modalCtrl, platform, conf) {
        ...
        this.LoginLogServices = LoginLogServices;
        ...
        this.totalPages = 1;
        this.totalRows = 0;
        this.userName = "=" + navParams.data.item.userName;
        this.order_type = false;
        this.innerWidth = window.innerWidth;
        this.innerHeight = window.innerHeight;
        this.title = navParams.data.item.userName;
        if (this.authServices.authenticated() === true) {
            this.can_auth = this.authServices.CanAuth();
            this.LoadData(true);
        }
    }
    LoginLogPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    LoginLogPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    LoginLogPage.prototype.setPage = function (pageInfo) {
    ...
    LoginLogPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    LoginLogPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    LoginLogPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.LoginLogServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.userName, _this.order_type)
    ...
    LoginLogPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_login_log_services_login_log_services__["a" /* LoginLogServicesProvider */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_LoginLogViewModel__ = __webpack_require__(1583);
...
var LoginLogListResponse = /** @class */ (function (_super) {
    __extends(LoginLogListResponse, _super);
    function LoginLogListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_LoginLogViewModel__["a" /* LoginLogViewModel */]();
                item.login_log_seq = data.login_log_seq; //登入記錄流水號
                item.client_ip = data.client_ip; //使用者IP
                item.user_agent = data.user_agent; //用戶代理
                item.exec_status_key = data.exec_status_key; //執行狀態主鍵
                item.creator = data.creator; //鍵檔人員
                item.create_time = data.create_time; //建立時間
                item.modifier = data && data.modifier || null; //異動人員
                item.last_update_time = data && data.last_update_time || null; //最後更新時間
                item.exec_status = data.exec_status; //執行狀態
                item.exec_status_desc = data.exec_status_desc; //執行狀態
...
//# sourceMappingURL=LoginLogListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LoginLogViewModel; });
var LoginLogViewModel = /** @class */ (function () {
    function LoginLogViewModel() {
    }
    return LoginLogViewModel;
}());

//# sourceMappingURL=LoginLogViewModel.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__login_log__ = __webpack_require__(1581);
...
var LoginLogPageModule = /** @class */ (function () {
    function LoginLogPageModule() {
    }
    LoginLogPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__login_log__["a" /* LoginLogPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_login_log_services_login_log_services__["a" /* LoginLogServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__login_log__["a" /* LoginLogPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], LoginLogPageModule);
    return LoginLogPageModule;
}());
