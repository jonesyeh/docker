...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JobServicesProvider; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Model_Response_JobListResponse__ = __webpack_require__(1181);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_JobResponse__ = __webpack_require__(1182);
...
/*
  Generated class for the JobServicesProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var JobServicesProvider = /** @class */ (function () {
    function JobServicesProvider(Services, conf) {
        this.Services = Services;
        this.conf = conf;
        this.ctl = "job";
        console.log("Hello JobServicesProvider Provider");
    }
    JobServicesProvider.prototype.GetListsAsync = function (PageSize, PageNumber, keyword, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "job?PageSize={1}&PageNumber={2}&keyword={3}&order_type={4}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true)
            .map(function (item) {
            _this.jobs = new __WEBPACK_IMPORTED_MODULE_0__Model_Response_JobListResponse__["a" /* JobListResponse */]({
    ...
    JobServicesProvider.prototype.GetListsBySchAsync = function (PageSize, PageNumber, keyword, sch_no, is_filter, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "job?PageSize={1}&PageNumber={2}&keyword={3}&sch_no={4}&is_filter={5}&order_type={6}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, PageSize, PageNumber, keyword, sch_no, is_filter, order_type);
        return this.Services.GetAsync(sub_url, this.ctl, true)
            .map(function (item) {
            _this.jobs = new __WEBPACK_IMPORTED_MODULE_0__Model_Response_JobListResponse__["a" /* JobListResponse */]({
                Message: item.Message,
    ...
    JobServicesProvider.prototype.PostPutAsync = function (JobViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "Job";
        else
            sub_url = "Job/" + JobViewModel.ssis_job_no;
        return this.Services.PostPutAsync(sub_url, this.ctl, true, JobViewModel, mode).map(function (item) {
            _this.job = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_JobResponse__["a" /* JobResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
    ...
    JobServicesProvider.prototype.DeleteAsync = function (ssis_job_no) {
        var _this = this;
        var sub_url;
        sub_url = "Job/" + ssis_job_no;
    ...
    JobServicesProvider.prototype.GetSqlAsync = function (ssis_job_no, method) {
        var sub_url;
        sub_url = "Job/get_{2}_sql?ssis_job_no={1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, ssis_job_no, method);
    ...
    JobServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_services__["a" /* ServicesProvider */], __WEBPACK_IMPORTED_MODULE_6__Model_MyAppSharedSettings__["a" /* MyAppSharedSettings */]])
    ], JobServicesProvider);
    return JobServicesProvider;
}());
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JobListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_JobViewModel__ = __webpack_require__(279);
    ...
    function JobListResponse(obj) {
        ...
        if (obj.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_JobViewModel__["a" /* JobViewModel */]();
                ...
                item.last_exec_status = (data && data.last_exec_status) || null;
                item.last_exec_status_desc =
                    (data && data.last_exec_status_desc) || null;
                ...
                item.retry_cnt = data.retry_cnt; //重試次數
                item.delay_min = data.delay_min; //延遲分鐘數
                ...
                item.email_cnt = data.email_cnt;
                if (item.email_cnt > 0)
                    item.email_color = "danger";
                else
                    item.email_color = "light";
                item.loop_cnt = data.loop_cnt;
                if (item.loop_cnt > 0)
                    item.loop_color = "danger";
                else
                    item.loop_color = "light";
                if (item.sch_cnt > 0)
                    item.sch_color = "danger";
                else
                    item.sch_color = "light";
                item.processed_sql_cnt = data.processed_sql_cnt;
                if (item.processed_sql_cnt > 0)
...
//# sourceMappingURL=JobListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JobResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_JobViewModel__ = __webpack_require__(279);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
    ...
    function JobResponse(obj) {
        ...
        if (_this.DidError === false) {
            if (obj.Model.ssis_job_no) {
                _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_JobViewModel__["a" /* JobViewModel */]();
                _this.Model.ssis_job_no = obj.Model.ssis_job_no;
                _this.Model.ssis_job_name = obj.Model.ssis_job_name;
                ...
                _this.Model.retry_cnt = obj.Model.retry_cnt; //重試次數
                _this.Model.delay_min = obj.Model.delay_min; //延遲分鐘數
                _this.Model.email_cnt = obj.Model.email_cnt;
                _this.Model.loop_cnt = obj.Model.loop_cnt;
                _this.Model.processed_sql_cnt = obj.Model.processed_sql_cnt;
                if (_this.Model.sch_cnt > 0)
                    _this.Model.sch_color = "danger-left";
                else
                    _this.Model.sch_color = "light";
                if (_this.Model.email_cnt > 0)
                    _this.Model.email_color = "danger-left";
                else
                    _this.Model.email_color = "light";
                if (_this.Model.loop_cnt > 0)
                    _this.Model.loop_color = "danger-left";
                else
                    _this.Model.loop_color = "light";
                if (_this.Model.processed_sql_cnt > 0)
                    _this.Model.processed_sql_color = "danger-left";
                else
...
//# sourceMappingURL=JobResponse.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_job_services_job_services__ = __webpack_require__(1063);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_run_job_services_run_job_services__ = __webpack_require__(268);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_JobViewModel__ = __webpack_require__(279);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Model_String__ = __webpack_require__(3);
...
var JobPage = /** @class */ (function () {
    function JobPage(menuCtrl, navCtrl, navParams, JobServices, loadingCtrl, global, authServices, runjobServices, modalCtrl, alertCtrl, platform, conf) {
        ...
        this.CanJobExec = true;
        this.detail_page = "JobDetailPage";
        this.step_page = "JobStepPage";
        this.loop_page = "JobLoopPage";
        this.sch_page = "SchByJobPage";
        this.err_msg_log_page = "ErrMsgLogPage";
        this.log_page = "JobExecLogPage";
        this.file_log_page = "FileExecLogPage";
        this.table_log_page = "TableExecLogPage";
        this.innerWidth = window.innerWidth;
        this.innerHeight = window.innerHeight;
        this.order_type = true;
        if (navParams.data.item)
            this.keyword = navParams.data.item.ssis_job_no;
        if (this.authServices.authenticated() === true) {
            this.CanJobExec = this.authServices.CanJobExec();
            this.CanSch = this.authServices.CanSch();
            this.CanEmail = this.authServices.CanEmail();
            this.CanEditJob = this.authServices.CanEditJob();
            this.can_view_log = this.authServices.CanViewLog();
            this.LoadData(true);
        }
    }
    ...
    JobPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    JobPage.prototype.setPage = function (pageInfo) {
    ...
    JobPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    JobPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    JobPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.JobServices
                .GetListsAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type)
    ...
    JobPage.prototype.openNavLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.log_page, { item: item, seq_type: "ssis_job_no" });
        });
    };
    JobPage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.file_log_page, { item: item, seq_type: "ssis_job_no" });
        });
    };
    JobPage.prototype.openNavTableLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.table_log_page, { item: item, seq_type: "ssis_job_no" });
        });
    };
    JobPage.prototype.openNavDetailsPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    JobPage.prototype.openNavStepPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.step_page, { item: item });
        });
    };
    JobPage.prototype.openNavProcessedSqlPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push("JobProcessedSqlPage", { item: item });
        });
    };
    JobPage.prototype.openNavLoopPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.loop_page, { item: item });
        });
    };
    JobPage.prototype.openNavSchPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.sch_page, { item: item, src_type: "作業" });
        });
    };
    JobPage.prototype.openNavEventPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push("JobLoopEventPage", { item: item });
        });
    };
    JobPage.prototype.openNavEmailPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push("EmailPage", { exec_group: item.ssis_job_no });
        });
    };
    JobPage.prototype.openNavRunPage = function (item) {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.runjobServices.RunJobAsync(item.ssis_job_no)
                .subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
    ...
    JobPage.prototype.openNavErrMsgLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.err_msg_log_page, { item: item, seq_type: "ssis_job_no" });
        });
    };
    JobPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.JobServices.GetSqlAsync(item.ssis_job_no, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    JobPage.prototype.ShowModal = function (item) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_JobViewModel__["a" /* JobViewModel */]();
            item.retry_cnt = 0;
            item.delay_min = 1;
            item.is_active = true;
        }
        ...
        var modal = this.modalCtrl.create("JobAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.JobServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("作業", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    JobPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_7__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.ssis_job_no),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.JobServices.DeleteAsync(item.ssis_job_no).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    JobPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad Job");
    };
    JobPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-Job",template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\job\Job.html"*/'<ion-header>\n  <headerComponent [title]="\'作業\'" [permission_id]="\'CanJob\'" [show_table_select]=true></headerComponent>\n\n</ion-header>\n<ion-content (window:resize)="onResize($event)">\n  <ion-row>\n    <ion-col>\n\n      <ion-searchbar [ngClass]="[\'search\']" (keyup.enter)="LoadData(true)" placeholder="搜尋關鍵字(作業編號包含、作業說明包含 、執行狀態(012|R,012|S,012|F)"\n        [(ngModel)]="keyword">\n      </ion-searchbar>\n\n    </ion-col>\n  </ion-row>\n  <ion-grid *ngIf="conf.mobile_mode==false && selectedItem!=null" [ngClass]="\'bordered\'">\n    <ion-row>\n      <ion-col col-4>\n          <button small title="明細" *ngIf="innerWidth<768" ion-button color="secondary" icon-left (click)="openNavDetailsPage(selectedItem)">\n              <ion-icon name="albums"></ion-icon>\n            </button>\n        <button small title="編輯" ion-button color="light" icon-left (click)="ShowModal(selectedItem)">\n          <ion-icon name="create"></ion-icon>\n        </button>\n        <button small *ngIf="CanEditJob==true" title="刪除" ion-button color="dark" icon-left (click)="Delete(selectedItem)">\n          <ion-icon name="trash"></ion-icon>\n        </button>\n        <button small title="步驟" ion-button color="danger" icon-left (click)="openNavStepPage(selectedItem)">\n          <ion-icon name="list"></ion-icon>\n        </button>\n        <button small title="回圈" ion-button [color]="selectedItem.loop_color"  icon-left (click)="openNavLoopPage(selectedItem)">\n          <ion-icon name="list-box"></ion-icon>\n        </button>\n\n      </ion-col>\n      <ion-col col-4>\n          <button *ngIf="CanJobExec==true && selectedItem.ssis_job_no.substr(0,1)!=\'*\'"  small title="執行" ion-button color="dark" icon-left (click)="openNavRunPage(selectedItem)">\n              <ion-icon name="arrow-dropright-circle"></ion-icon>\n            </button>\n        <button small title="執行後SQL語法" [color]="selectedItem.processed_sql_color" ion-button icon-left (click)="openNavProcessedSqlPage(selectedItem)">\n          <ion-icon name="barcode"></ion-icon>\n        </button>\n\n        <button small *ngIf="CanSch==true" title="排程" ion-button [color]="selectedItem.sch_color" icon-left (click)="openNavSchPage(selectedItem)">\n          <ion-icon name="alarm"></ion-icon>\n        </button>\n\n        <button small *ngIf="CanEmail==true" title="寄發Email設定" ion-button [color]="selectedItem.email_color" icon-left\n          (click)="openNavEmailPage(selectedItem)">\n          <ion-icon name="mail"></ion-icon>\n        </button>\n        <button small title="事件" ion-button [color]="selectedItem.event_color" icon-left (click)="openNavEventPage(selectedItem)">\n            <ion-icon name="timer"></ion-icon>\n          </button>\n      </ion-col>\n      <ion-col col-4>\n        <button *ngIf="can_view_log==true  && innerWidth>=768" small title="歷史執行紀錄" ion-button color="primary"\n          icon-left (click)="openNavLogPage(selectedItem)">\n          <ion-icon name="logo-twitch"></ion-icon>\n        </button>\n        <button *ngIf="can_view_log==true  && innerWidth>=768" small title="檔案執行紀錄" ion-button color="light" icon-left\n          (click)="openNavFileLogPage(selectedItem)">\n          <ion-icon name="logo-twitch"></ion-icon>\n        </button>\n        <button *ngIf="can_view_log==true  && innerWidth>=768" small title="資料表執行紀錄" ion-button color="danger"\n          icon-left (click)="openNavTableLogPage(selectedItem)">\n          <ion-icon name="logo-twitch"></ion-icon>\n        </button>\n        <button small title="產生Insert SQL語法" ion-button color="light" icon-left (click)="openNavSqlPage(selectedItem,\'insert\')">\n          Ins\n        </button>\n        <button small title="產生Update SQL語法" ion-button color="light" icon-left (click)="openNavSqlPage(selectedItem,\'update\')">\n          Upd\n        </button>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n  <ngx-datatable NgxResizeWatcher class="bootstrap" *ngIf="totalRows>0 && conf.mobile_mode==false" [selected]="selected"\n    [selectionType]="\'single\'" (select)=\'onRowSelect($event)\' [rows]="data_list" [columnMode]="\'flex\'" [headerHeight]="40"\n    [rowHeight]="\'auto\'" [footerHeight]="40" [reorderable]=false [limit]="limit" [count]="totalRows" [offset]="offset"\n    (page)=\'setPage($event)\'>\n\n    <ngx-datatable-column prop="ssis_job_no" name="作業編號" [flexGrow]="2" [frozenLeft]="true">\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="ssis_job_name" name="作業名稱" [flexGrow]="3" [frozenLeft]="true">\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="last_exec_date" name="執行時間" [flexGrow]="2">\n      <ng-template let-value="value" ngx-datatable-cell-template>\n        <div *ngIf="platform.is(\'ios\')==true">\n          {{value | date:\'y/MM/dd HH:mm:ss \'}}\n        </div>\n        <div *ngIf="platform.is(\'ios\')!=true">\n          {{value | date:\'y/MM/dd HH:mm:ss\'}}\n        </div>\n      </ng-template>\n\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="last_update_time" name="執行結束時間" [flexGrow]="2" *ngIf="innerWidth>=1024">\n      <ng-template let-value="value" ngx-datatable-cell-template>\n        <div *ngIf="platform.is(\'ios\')==true">\n          {{value | date:\'y/MM/dd HH:mm:ss \'}}\n        </div>\n        <div *ngIf="platform.is(\'ios\')!=true">\n          {{value | date:\'y/MM/dd HH:mm:ss\'}}\n        </div>\n      </ng-template>\n\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="duration" name="持續" [flexGrow]="1">\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="last_exec_status_desc" name="執行狀態" [flexGrow]="1">\n      <ng-template let-row="row" let-value="value" ngx-datatable-cell-template>\n        <div>\n          <button [ngClass]="\'exec_fail\'" *ngIf="row[\'last_exec_status_key\']==\'012|F\'" (click)="openNavErrMsgLogPage(row)">\n            {{value}}\n          </button>\n          <div *ngIf="row[\'last_exec_status_key\']!=\'012|F\'" [ngClass]="row[\'last_exec_status_color\']">{{value}}</div>\n        </div>\n      </ng-template>\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="is_active_desc" name="啟用" [flexGrow]="1">\n      <ng-template let-row="row" let-value="value" ngx-datatable-cell-template>\n        <div [ngClass]="row[\'is_active_color\']">{{value}}</div>\n      </ng-template>\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="sch_cnt" name="排程數" [flexGrow]="1">\n      <ng-template let-row="row" let-value="value" ngx-datatable-cell-template>\n        <div [ngClass]="row[\'sch_color\']">{{value}}</div>\n      </ng-template>\n\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="email_cnt" name="Email通知" [flexGrow]="1">\n      <ng-template let-row="row" let-value="value" ngx-datatable-cell-template>\n        <div [ngClass]="row[\'email_color\']">{{value}}</div>\n      </ng-template>\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="event_cnt" name="事件數" [flexGrow]="1">\n      <ng-template let-row="row" let-value="value" ngx-datatable-cell-template>\n        <div [ngClass]="row[\'event_color\']">{{value}}</div>\n      </ng-template>\n    </ngx-datatable-column>\n  </ngx-datatable>\n  <div *ngIf="totalRows>0 && conf.mobile_mode==true">\n    <ion-row>\n      <ion-col col-lg-4 col-md-6 col-sm-6 col-12 *ngFor="let item of data_list">\n        <ion-grid [ngClass]="[\'bordered\']">\n          <ion-row>\n            <ion-col>\n              <button small title="明細" ion-button color="secondary" icon-left (click)="openNavDetailsPage(item)">\n                <ion-icon name="albums"></ion-icon>\n              </button>\n              <button small title="編輯" ion-button color="light" icon-left (click)="ShowModal(item)">\n                <ion-icon name="create"></ion-icon>\n              </button>\n              <button small *ngIf="CanEditJob==true" title="刪除" ion-button color="dark" icon-left (click)="Delete(item)">\n                <ion-icon name="trash"></ion-icon>\n              </button>\n              <button small title="步驟" ion-button color="danger" icon-left (click)="openNavStepPage(item)">\n                <ion-icon name="list"></ion-icon>\n              </button>\n              <button small title="回圈" ion-button [color]="item.loop_color" icon-left (click)="openNavLoopPage(item)">\n                <ion-icon name="list-box"></ion-icon>\n              </button>\n\n\n\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n\n              <button *ngIf="CanJobExec==true && item.ssis_job_no.substr(0,1)!=\'*\'" small title="執行" ion-button color="dark" icon-left (click)="openNavRunPage(item)">\n                <ion-icon name="arrow-dropright-circle"></ion-icon>\n              </button>\n              <button small title="執行後SQL語法" [color]="item.processed_sql_color" ion-button icon-left (click)="openNavProcessedSqlPage(item)">\n                  <ion-icon name="barcode"></ion-icon>\n                </button>\n              <button small *ngIf="CanSch==true" title="排程" ion-button [color]="item.sch_color" icon-left (click)="openNavSchPage(item)">\n                <ion-icon name="alarm"></ion-icon>\n              </button>\n              <button small *ngIf="CanEmail==true" title="寄發Email設定" ion-button [color]="item.email_color" icon-left\n                (click)="openNavEmailPage(item)">\n                <ion-icon name="mail"></ion-icon>\n              </button>\n              <button small title="事件" ion-button [color]="item.event_color" icon-left (click)="openNavEventPage(item)">\n                  <ion-icon name="timer"></ion-icon>\n                </button>\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              <button small title="產生Insert SQL語法" ion-button color="light" icon-left (click)="openNavSqlPage(item,\'insert\')">\n                Ins\n              </button>\n              <button small title="產生Update SQL語法" ion-button color="light" icon-left (click)="openNavSqlPage(item,\'update\')">\n                Upd\n              </button>\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              {{item.ssis_job_no}}\n            </ion-col>\n            <ion-col col-4 align-self-end>\n              <div text-right>\n                <button [ngClass]="\'exec_fail\'" *ngIf="item.last_exec_status_key==\'012|F\'" (click)="openNavErrMsgLogPage(item)">\n                  {{item.last_exec_status_desc}}\n                </button>\n                <div text-right *ngIf="item.last_exec_status_key!=\'012|F\'" [ngClass]="item.last_exec_status_color">{{item.last_exec_status_desc}}</div>\n              </div>\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              {{item.ssis_job_name}}\n\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col col-4>\n              <div [ngClass]="item.is_active_color">{{item.is_active_desc}}</div>\n            </ion-col>\n            <ion-col col-8 align-self-end>\n              <div *ngIf="platform.is(\'ios\')==true" text-right>\n                {{item.last_exec_date | date:\'y/MM/dd HH:mm:ss \'}}\n              </div>\n              <div *ngIf="platform.is(\'ios\')!=true" text-right>\n                {{item.last_exec_date | date:\'y/MM/dd HH:mm:ss\'}}\n              </div>\n            </ion-col>\n          </ion-row>\n        </ion-grid>\n      </ion-col>\n    </ion-row>\n  </div>\n  <ion-infinite-scroll *ngIf="pageNumber < totalPages" (ionInfinite)="$event.waitFor(doInfinite())">\n    <ion-infinite-scroll-content loadingSpinner="bubbles">\n    </ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n</ion-content>\n<ion-footer>\n  <ion-toolbar>\n    <ion-row>\n      <ion-col>\n        <div [ngClass]="[\'command\']">\n          <button small title="重新整理" ion-button color="dark" icon-left (click)="LoadData(true)">\n            <ion-checkbox name="order_type" title="遞增/遞減" color="dark" [(ngModel)]="order_type" (ionChange)="LoadData(true)"></ion-checkbox>\n            <ion-icon name="refresh"></ion-icon>\n          </button>\n          <button small *ngIf="CanEditJob==true" title="新增" ion-button color="dark" icon-left (click)="ShowModal(null)">\n            <ion-icon name="add"></ion-icon>\n          </button>\n        </div>\n        <StatusComponent [pageNumber]="pageNumber" [totalPages]="totalPages" [totalRows]="totalRows"></StatusComponent>\n      </ion-col>\n\n    </ion-row>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\job\Job.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* MenuController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__providers_job_services_job_services__["a" /* JobServicesProvider */],
            ...
            __WEBPACK_IMPORTED_MODULE_5__providers_run_job_services_run_job_services__["a" /* RunJobServicesProvider */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__job__ = __webpack_require__(1551);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_job_services_job_services__ = __webpack_require__(1063);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var JobPageModule = /** @class */ (function () {
    ...
    JobPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_job_services_job_services__["a" /* JobServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__job__["a" /* JobPage */]),
