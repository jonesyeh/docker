...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Model_Response_JobExecLogListResponse__ = __webpack_require__(1535);
...
/*
  Generated class for the JobExecLogServicesProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var JobExecLogServicesProvider = /** @class */ (function () {
    function JobExecLogServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "JobExecLog";
        console.log("Hello JobExecLogServicesProvider Provider");
    }
    JobExecLogServicesProvider.prototype.GetListsAsync = function (PageSize, PageNumber, ssis_job_no, order_type, keyword) {
        var _this = this;
        var sub_url;
        sub_url = "JobExecLog?PageSize={1}&PageNumber={2}&ssis_job_no={3}&order_type={4}&keyword={5}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, PageSize, PageNumber, ssis_job_no, order_type, keyword);
        return this.Services.GetAsync(sub_url, this.ctl, true)
            .map(function (item) {
            _this.JobExecLog = new __WEBPACK_IMPORTED_MODULE_0__Model_Response_JobExecLogListResponse__["a" /* JobExecLogListResponse */]({
            ...
            return _this.JobExecLog;
        });
    };
    JobExecLogServicesProvider.prototype.GetLoopListsAsync = function (PageSize, PageNumber, job_loop_replace_desc, order_type, keyword) {
        var _this = this;
        var sub_url;
        sub_url = "JobExecLog?PageSize={1}&PageNumber={2}&job_loop_replace_desc={3}&order_type={4}&keyword={5}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, PageSize, PageNumber, job_loop_replace_desc, order_type, keyword);
        return this.Services.GetAsync(sub_url, this.ctl, true)
            .map(function (item) {
            _this.JobExecLog = new __WEBPACK_IMPORTED_MODULE_0__Model_Response_JobExecLogListResponse__["a" /* JobExecLogListResponse */]({
                Message: item.Message,
    ...
    JobExecLogServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_services__["a" /* ServicesProvider */]])
    ], JobExecLogServicesProvider);
    return JobExecLogServicesProvider;
}());

//# sourceMappingURL=job-exec-log-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JobExecLogPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_job_exec_log_services_job_exec_log_services__ = __webpack_require__(1231);
...
var JobExecLogPage = /** @class */ (function () {
    function JobExecLogPage(menuCtrl, navCtrl, navParams, JobExecLogServices, loadingCtrl, global, authServices, platform, conf) {
        this.menuCtrl = menuCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.JobExecLogServices = JobExecLogServices;
        ...
        this.detail_page = "JobExecLogDetailPage";
    ...
    JobExecLogPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    JobExecLogPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    JobExecLogPage.prototype.setPage = function (pageInfo) {
    ...
    JobExecLogPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    JobExecLogPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    JobExecLogPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        if (this.seq_type === "ssis_job_no") {
            this.global.loading.present().then(function () {
                _this.JobExecLogServices.GetListsAsync(_this.pageSize, _this.loadPageNumber, _this.item.ssis_job_no, _this.order_type, _this.keyword)
        ...
        if (this.seq_type === "job_loop_replace_desc") {
            this.global.loading.present().then(function () {
                _this.JobExecLogServices.GetLoopListsAsync(_this.pageSize, _this.loadPageNumber, _this.item.job_loop_replace_desc, _this.order_type, _this.keyword).subscribe(function (data) {
                    _this.is_err = false;
                    if (init) {
                        _this.data_list = data.Model;
                        _this.totalRows = data.TotalRows;
    ...
    JobExecLogPage.prototype.openNavLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.log_page, { item: item, seq_type: "job_log_seq" });
        });
    };
    JobExecLogPage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.file_log_page, {
                item: item,
                seq_type: "job_log_seq"
            });
        });
    };
    JobExecLogPage.prototype.openNavTableLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    JobExecLogPage.prototype.openNavDetailsPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    JobExecLogPage.prototype.openNavErrMsgLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    return JobExecLogPage;
}());

//# sourceMappingURL=job-exec-log.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_JobExecLogViewModel__ = __webpack_require__(1536);
...
var JobExecLogListResponse = /** @class */ (function (_super) {
    __extends(JobExecLogListResponse, _super);
    function JobExecLogListResponse(obj) {
        ...
        if (_this.DidError === false) {
            ...
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_JobExecLogViewModel__["a" /* JobExecLogViewModel */]();
    ...
    return JobExecLogListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=JobExecLogListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JobExecLogViewModel; });
var JobExecLogViewModel = /** @class */ (function () {
    function JobExecLogViewModel() {
    }
    return JobExecLogViewModel;
}());

//# sourceMappingURL=JobExecLogViewModel.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__job_exec_log__ = __webpack_require__(1534);
...
var JobExecLogPageModule = /** @class */ (function () {
    function JobExecLogPageModule() {
    }
    JobExecLogPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__job_exec_log__["a" /* JobExecLogPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_job_exec_log_services_job_exec_log_services__["a" /* JobExecLogServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__job_exec_log__["a" /* JobExecLogPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], JobExecLogPageModule);
    return JobExecLogPageModule;
}());

//# sourceMappingURL=job-exec-log.module.js.map
