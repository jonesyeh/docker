...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileProcessedSqlViewModel; });
var FileProcessedSqlViewModel = /** @class */ (function () {
    function FileProcessedSqlViewModel() {
    }
    return FileProcessedSqlViewModel;
}());

//# sourceMappingURL=FileProcessedSqlViewModel.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileProcessedSqlServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileProcessedSqlResponse__ = __webpack_require__(1478);
...
/*
  Generated class for the FileProcessedSqlServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var FileProcessedSqlServicesProvider = /** @class */ (function () {
    function FileProcessedSqlServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "FileProcessedSql";
        console.log("Hello FileProcessedSqlServiceProvider Provider");
    }
    FileProcessedSqlServicesProvider.prototype.PostPutAsync = function (FileProcessedSqlViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "FileProcessedSql";
        else
            sub_url = "FileProcessedSql/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, FileProcessedSqlViewModel.exec_file_seq);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, FileProcessedSqlViewModel, mode).map(function (item) {
            _this.FileProcessedSql = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileProcessedSqlResponse__["a" /* FileProcessedSqlResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.FileProcessedSql;
        });
    };
    FileProcessedSqlServicesProvider.prototype.DeleteAsync = function (exec_file_seq) {
        var _this = this;
        var sub_url;
        sub_url = "FileProcessedSql/{1}";
    ...
    FileProcessedSqlServicesProvider.prototype.GetAsync = function (exec_file_seq) {
        var sub_url;
        sub_url = "FileProcessedSql/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, exec_file_seq);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            return new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileProcessedSqlResponse__["a" /* FileProcessedSqlResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
    ...
    FileProcessedSqlServicesProvider.prototype.GetSqlAsync = function (exec_file_seq, method) {
        var sub_url;
        sub_url = "FileProcessedSql/get_{2}_sql/{1}";
    ...
    FileProcessedSqlServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_services__["a" /* ServicesProvider */]])
    ], FileProcessedSqlServicesProvider);
    return FileProcessedSqlServicesProvider;
}());

//# sourceMappingURL=file-processed-sql-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileProcessedSqlAddEditPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_ViewModel_FileProcessedSqlViewModel__ = __webpack_require__(1226);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_file_processed_sql_services_file_processed_sql_services__ = __webpack_require__(1227);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/**
 * Generated class for the FileProcessedSqlModalPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var FileProcessedSqlAddEditPage = /** @class */ (function () {
    function FileProcessedSqlAddEditPage(navCtrl, navParams, viewCtrl, modalCtrl, global, authServices, FileProcessedSqlServices, alertCtrl) {
        ...
        this.item = new __WEBPACK_IMPORTED_MODULE_3__Model_ViewModel_FileProcessedSqlViewModel__["a" /* FileProcessedSqlViewModel */]();
    ...
    FileProcessedSqlAddEditPage.prototype.openNavParameterColumnPage = function (item) {
        var _this = this;
    ...
    FileProcessedSqlAddEditPage.prototype.LoadData = function () {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileProcessedSqlServices.GetAsync(_this.exec_file_seq).subscribe(function (data) {
    ...
    FileProcessedSqlAddEditPage.prototype.Save = function () {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileProcessedSqlServices.PostPutAsync(_this.item, _this.mode).subscribe(function (data) {
    ...
    FileProcessedSqlAddEditPage.prototype.Help = function () {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
    ...
    FileProcessedSqlAddEditPage.prototype.Delete = function (item) {
        var _this = this;
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        _this.global.loading.present().then(function () {
                            _this.FileProcessedSqlServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                _this.global.dismissLoading();
                                if (data.DidError === false) {
    ...
    FileProcessedSqlAddEditPage.prototype.close = function () {
        this.navCtrl.pop();
        // this.viewCtrl.dismiss();
    };
    FileProcessedSqlAddEditPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileProcessedSqlServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileProcessedSqlAddEditPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_6__providers_file_processed_sql_services_file_processed_sql_services__["a" /* FileProcessedSqlServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */]])
    ], FileProcessedSqlAddEditPage);
    return FileProcessedSqlAddEditPage;
}());

//# sourceMappingURL=file-processed-sql-add-edit.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileProcessedSqlResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileProcessedSqlViewModel__ = __webpack_require__(1226);
...
var FileProcessedSqlResponse = /** @class */ (function (_super) {
    __extends(FileProcessedSqlResponse, _super);
    function FileProcessedSqlResponse(obj) {
        ...
        if (_this.DidError === false) {
            if (obj.Model != null) {
                _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileProcessedSqlViewModel__["a" /* FileProcessedSqlViewModel */]();
    ...
    return FileProcessedSqlResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=FileProcessedSqlResponse.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileProcessedSqlAddEditPageModule", function() { return FileProcessedSqlAddEditPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_processed_sql_add_edit__ = __webpack_require__(1477);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_processed_sql_services_file_processed_sql_services__ = __webpack_require__(1227);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileProcessedSqlAddEditPageModule = /** @class */ (function () {
    function FileProcessedSqlAddEditPageModule() {
    }
    FileProcessedSqlAddEditPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_processed_sql_add_edit__["a" /* FileProcessedSqlAddEditPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_processed_sql_services_file_processed_sql_services__["a" /* FileProcessedSqlServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_processed_sql_add_edit__["a" /* FileProcessedSqlAddEditPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], FileProcessedSqlAddEditPageModule);
    return FileProcessedSqlAddEditPageModule;
}());

//# sourceMappingURL=file-processed-sql-add-edit.module.js.map
