...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileProcessedExecGroupServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileProcessedExecGroupResponse__ = __webpack_require__(1472);
...
/*
  Generated class for the FileProcessedExecGroupServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var FileProcessedExecGroupServicesProvider = /** @class */ (function () {
    function FileProcessedExecGroupServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "FileProcessedExecGroup";
        console.log("Hello FileProcessedExecGroupServiceProvider Provider");
    }
    FileProcessedExecGroupServicesProvider.prototype.PostPutAsync = function (FileProcessedExecGroupViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "FileProcessedExecGroup";
        else
            sub_url = "FileProcessedExecGroup/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, FileProcessedExecGroupViewModel.exec_file_seq);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, FileProcessedExecGroupViewModel, mode).map(function (item) {
            _this.FileProcessedExecGroup = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileProcessedExecGroupResponse__["a" /* FileProcessedExecGroupResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.FileProcessedExecGroup;
        });
    };
    FileProcessedExecGroupServicesProvider.prototype.DeleteAsync = function (exec_file_seq) {
        var _this = this;
        var sub_url;
        sub_url = "FileProcessedExecGroup/{1}";
    ...
    FileProcessedExecGroupServicesProvider.prototype.GetAsync = function (exec_file_seq) {
        var sub_url;
        sub_url = "FileProcessedExecGroup/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, exec_file_seq);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            return new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileProcessedExecGroupResponse__["a" /* FileProcessedExecGroupResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
    ...
    FileProcessedExecGroupServicesProvider.prototype.GetSqlAsync = function (exec_file_seq, method) {
        var sub_url;
        sub_url = "FileProcessedExecGroup/get_{2}_sql/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, exec_file_seq, method);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
    ...
    FileProcessedExecGroupServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_services__["a" /* ServicesProvider */]])
    ], FileProcessedExecGroupServicesProvider);
    return FileProcessedExecGroupServicesProvider;
}());

//# sourceMappingURL=file-processed-exec-group-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileProcessedExecGroupAddEditPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_ViewModel_FileProcessedExecGroupViewModel__ = __webpack_require__(1471);
...
/**
 * Generated class for the FileProcessedExecGroupModalPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var FileProcessedExecGroupAddEditPage = /** @class */ (function () {
    function FileProcessedExecGroupAddEditPage(navCtrl, navParams, viewCtrl, modalCtrl, global, authServices, FileProcessedExecGroupServices, alertCtrl) {
        ...
        this.FileProcessedExecGroupServices = FileProcessedExecGroupServices;
        ...
        this.item = new __WEBPACK_IMPORTED_MODULE_3__Model_ViewModel_FileProcessedExecGroupViewModel__["a" /* FileProcessedExecGroupViewModel */]();
    ...
    FileProcessedExecGroupAddEditPage.prototype.LoadData = function () {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileProcessedExecGroupServices.GetAsync(_this.exec_file_seq).subscribe(function (data) {
                if (data.DidError === true) {
                    ...
                    if (data.Model == null) {
                        ...
                        _this.item.ssis_program_set_no = "export_filelist";
                        _this.item.ssis_program_set_desc =
                            "取出要匯出檔案清單並匯出成檔案";
                        _this.item.exec_group = "";
                        _this.program_func_no = "";
                        _this.title = "新增";
                    }
                    else {
                        _this.mode = "PUT";
                        ...
                        if (_this.item.ssis_program_set_no === "import_filelist")
                            _this.program_func_no = "import_" + _this.item.exec_group;
                        else if (_this.item.ssis_program_set_no === "exec_sql_filelist")
                            _this.program_func_no = "exec_sql_" + _this.item.exec_group;
                        else if (_this.item.ssis_program_set_no === "exec_ssis_packagelist")
                            _this.program_func_no =
                                "exec_ssis_package_" + _this.item.exec_group;
                        else if (_this.item.ssis_program_set_no === "export_filelist")
                            _this.program_func_no = "export_" + _this.item.exec_group;
                        else if (_this.item.ssis_program_set_no === "ftp_downloadlist")
                            _this.program_func_no = "ftp_download_" + _this.item.exec_group;
                        else if (_this.item.ssis_program_set_no === "ftp_uploadlist")
                            _this.program_func_no = "ftp_upload_" + _this.item.exec_group;
                        else if (_this.item.ssis_program_set_no === "http_upload_list")
                            _this.program_func_no = "http_upload_" + _this.item.exec_group;
                        else if (_this.item.ssis_program_set_no === "odata_export_filelist")
                            _this.program_func_no = "odata_export_" + _this.item.exec_group;
                        else if (_this.item.ssis_program_set_no === "run_ssis_job_list")
                            _this.program_func_no = "run_ssis_" + _this.item.exec_group;
                        else if (_this.item.ssis_program_set_no === "sp_tablelist")
                            _this.program_func_no = "sp_" + _this.item.exec_group;
                        else if (_this.item.ssis_program_set_no === "import_tablelist")
                            _this.program_func_no = "table_" + _this.item.exec_group;
                        else if (_this.item.ssis_program_set_no === "sp_delete_tablelist")
                            _this.program_func_no = "del_table_" + _this.item.exec_group;
                        else
                            _this.program_func_no =
                                _this.item.ssis_program_set_no + "_" + _this.item.exec_group;
                    }
                    _this.global.dismissLoading();
                }
            }, function (err) {
    ...
    FileProcessedExecGroupAddEditPage.prototype.Save = function () {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileProcessedExecGroupServices.PostPutAsync(_this.item, _this.mode).subscribe(function (data) {
    ...
    FileProcessedExecGroupAddEditPage.prototype.Delete = function (item) {
        var _this = this;
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        _this.global.loading.present().then(function () {
                            _this.FileProcessedExecGroupServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                _this.global.dismissLoading();
                                if (data.DidError === false) {
    ...
    FileProcessedExecGroupAddEditPage.prototype.SelectBatchExecProgram = function () {
        var _this = this;
        var modal = this.modalCtrl.create("BatchExecProgramSelectModalPage", {
            select_item: this.program_func_no,
            is_filter: true
        });
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
            _this.item.ssis_program_set_no = select_data.ssis_program_set_no;
            _this.item.exec_group = select_data.exec_group;
            _this.item.note = select_data.note;
        });
        modal.present();
    };
    FileProcessedExecGroupAddEditPage.prototype.close = function () {
        this.navCtrl.pop();
        // this.viewCtrl.dismiss();
    };
    FileProcessedExecGroupAddEditPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileProcessedExecGroupServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileProcessedExecGroupAddEditPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad FileProcessedExecGroupModalPage");
    };
    FileProcessedExecGroupAddEditPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_6__providers_file_processed_exec_group_services_file_processed_exec_group_services__["a" /* FileProcessedExecGroupServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */]])
    ], FileProcessedExecGroupAddEditPage);
    return FileProcessedExecGroupAddEditPage;
}());

//# sourceMappingURL=file-processed-exec-group-add-edit.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileProcessedExecGroupViewModel; });
var FileProcessedExecGroupViewModel = /** @class */ (function () {
    function FileProcessedExecGroupViewModel() {
    }
    return FileProcessedExecGroupViewModel;
}());

//# sourceMappingURL=FileProcessedExecGroupViewModel.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileProcessedExecGroupResponse; });
...
var FileProcessedExecGroupResponse = /** @class */ (function (_super) {
    __extends(FileProcessedExecGroupResponse, _super);
    function FileProcessedExecGroupResponse(obj) {
        ...
        if (_this.DidError === false) {
            if (obj.Model != null) {
                ...
                _this.Model.note = obj.Model.note;
            }
        }
        return _this;
    }
    return FileProcessedExecGroupResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=FileProcessedExecGroupResponse.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_processed_exec_group_add_edit__ = __webpack_require__(1470);
...
var FileProcessedExecGroupAddEditPageModule = /** @class */ (function () {
    function FileProcessedExecGroupAddEditPageModule() {
    }
    FileProcessedExecGroupAddEditPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_processed_exec_group_add_edit__["a" /* FileProcessedExecGroupAddEditPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_processed_exec_group_services_file_processed_exec_group_services__["a" /* FileProcessedExecGroupServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_processed_exec_group_add_edit__["a" /* FileProcessedExecGroupAddEditPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileProcessedExecGroupAddEditPageModule);
    return FileProcessedExecGroupAddEditPageModule;
}());

//# sourceMappingURL=file-processed-exec-group-add-edit.module.js.map
