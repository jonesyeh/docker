...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportDataExpressionViewModel; });
var FileImportDataExpressionViewModel = /** @class */ (function () {
    function FileImportDataExpressionViewModel() {
    }
    return FileImportDataExpressionViewModel;
}());

//# sourceMappingURL=FileImportDataExpressionViewModel.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportDataExpressionServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileImportDataExpressionResponse__ = __webpack_require__(1446);
...
/*
  Generated class for the FileImportDataExpressionServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var FileImportDataExpressionServicesProvider = /** @class */ (function () {
    function FileImportDataExpressionServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "FileImportDataExpression";
        console.log("Hello FileImportDataExpressionServiceProvider Provider");
    }
    FileImportDataExpressionServicesProvider.prototype.PostPutAsync = function (FileImportDataExpressionViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "FileImportDataExpression";
        else
            sub_url = "FileImportDataExpression?schemaname={1}&tablename={2}&columnname={3}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, FileImportDataExpressionViewModel.schemaname, FileImportDataExpressionViewModel.tablename, FileImportDataExpressionViewModel.columnname);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, FileImportDataExpressionViewModel, mode).map(function (item) {
            _this.FileImportDataExpression = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileImportDataExpressionResponse__["a" /* FileImportDataExpressionResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.FileImportDataExpression;
        });
    };
    FileImportDataExpressionServicesProvider.prototype.DeleteAsync = function (schemaname, tablename, columnname) {
        var _this = this;
        var sub_url;
        sub_url = "FileImportDataExpression?schemaname={1}&tablename={2}&columnname={3}";
    ...
    FileImportDataExpressionServicesProvider.prototype.GetAsync = function (schemaname, tablename, columnname) {
        var sub_url;
        sub_url = "FileImportDataExpression?schemaname={1}&tablename={2}&columnname={3}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, schemaname, tablename, columnname);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            return new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileImportDataExpressionResponse__["a" /* FileImportDataExpressionResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
    ...
    FileImportDataExpressionServicesProvider.prototype.GetSqlAsync = function (schemaname, tablename, columnname, method) {
        var sub_url;
        sub_url = "FileImportDataExpression/get_{4}_sql?schemaname={1}&tablename={2}&columnname={3}";
    ...
    FileImportDataExpressionServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_services__["a" /* ServicesProvider */]])
    ], FileImportDataExpressionServicesProvider);
    return FileImportDataExpressionServicesProvider;
}());

//# sourceMappingURL=file-import-data-expression-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportDataExpressionAddEditPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_ViewModel_FileImportDataExpressionViewModel__ = __webpack_require__(1219);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_file_import_data_expression_services_file_import_data_expression_services__ = __webpack_require__(1220);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/**
 * Generated class for the FileImportDataExpressionModalPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var FileImportDataExpressionAddEditPage = /** @class */ (function () {
    function FileImportDataExpressionAddEditPage(navCtrl, navParams, viewCtrl, modalCtrl, global, authServices, FileImportDataExpressionServices, alertCtrl) {
        ...
        this.FileImportDataExpressionServices = FileImportDataExpressionServices;
        ...
        this.subject = __WEBPACK_IMPORTED_MODULE_2__Model_String__["a" /* String */].Format("{0}", this.columnname);
        this.item = new __WEBPACK_IMPORTED_MODULE_3__Model_ViewModel_FileImportDataExpressionViewModel__["a" /* FileImportDataExpressionViewModel */]();
    ...
    FileImportDataExpressionAddEditPage.prototype.LoadData = function () {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileImportDataExpressionServices.GetAsync(_this.schemaname, _this.tablename, _this.columnname).subscribe(function (data) {
                if (data.DidError === true) {
                    ...
                    if (data.Model == null) {
                        _this.mode = "POST";
                        _this.item.schemaname = _this.schemaname;
                        _this.item.tablename = _this.tablename;
                        _this.item.columnname = _this.columnname;
                        _this.item.operation = "+";
                        _this.item.opera_value = 0;
                        _this.title = "新增";
                    }
                    else {
                        _this.mode = "PUT";
    ...
    FileImportDataExpressionAddEditPage.prototype.Save = function () {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileImportDataExpressionServices.PostPutAsync(_this.item, _this.mode).subscribe(function (data) {
    ...
    FileImportDataExpressionAddEditPage.prototype.Delete = function (item) {
        var _this = this;
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        _this.global.loading.present().then(function () {
                            _this.FileImportDataExpressionServices.DeleteAsync(_this.schemaname, _this.tablename, _this.columnname).subscribe(function (data) {
                                _this.global.dismissLoading();
                                if (data.DidError === false) {
    ...
    // }
    FileImportDataExpressionAddEditPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileImportDataExpressionServices.GetSqlAsync(_this.schemaname, _this.tablename, _this.columnname, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileImportDataExpressionAddEditPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad FileImportDataExpressionModalPage");
    };
    FileImportDataExpressionAddEditPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-file-import-data-expression-add-edit",template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\file-import-data-expression-add-edit\file-import-data-expression-add-edit.html"*/'<ion-header>\n  <headerComponent [title]="title" [permission_id]="\'CanBatch\'"></headerComponent>\n</ion-header>\n\n<ion-content padding>\n  <ion-grid>\n    <ion-row>\n      <ion-col col-12 col-sm-2 col-md-3>\n      </ion-col>\n      <ion-col col-12 col-sm-8 col-md-6>\n\n        <ion-grid [ngClass]="[\'subject\']">\n          <ion-row>\n            <ion-col>\n\n              {{subject}}\n            </ion-col>\n          </ion-row>\n\n        </ion-grid>\n      </ion-col>\n      <ion-col col-12 col-sm-2 col-md-3>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n  <form #Form="ngForm">\n    <ion-row>\n      <ion-col>\n        <ion-item>\n          <ion-label stacked>運算子</ion-label>\n          <ion-select name="operation" [(ngModel)]="item.operation">\n            <ion-option value="+">+</ion-option>\n            <ion-option value="-">-</ion-option>\n            <ion-option value="*">*</ion-option>\n            <ion-option value="/">/</ion-option>\n          </ion-select>\n\n\n        </ion-item>\n\n      </ion-col>\n    </ion-row>\n    <ion-row>\n      <ion-col>\n        <ion-item>\n          <ion-label stacked>運算元</ion-label>\n          <ion-input type="number" [disabled]="CanEditBatch==false" name="opera_value" #opera_value="ngModel" [(ngModel)]="item.opera_value"></ion-input>\n        </ion-item>\n      </ion-col>\n    </ion-row>\n  </form>\n\n</ion-content>\n<ion-footer>\n  <ion-toolbar>\n    <ion-row>\n      <ion-col>\n        <div [ngClass]="[\'command\']">\n          <!-- <button small title="取消" ion-button color="dark" icon-left (click)="close()">\n            <ion-icon name="backspace"></ion-icon>\n          </button> -->\n          <button *ngIf="CanEditBatch==true && mode==\'PUT\'" small title="刪除" ion-button color="dark" icon-left (click)="Delete(item)">\n            <ion-icon name="trash"></ion-icon>\n          </button>\n          <button small title="確認" [disabled]="CanEditBatch==false" ion-button color="dark" [disabled]="!Form.form.valid" icon-left\n            (click)="Save()">\n            <ion-icon name="checkmark-circle"></ion-icon>\n          </button>\n\n        </div>\n      </ion-col>\n    </ion-row>\n    <ion-row *ngIf="CanEditBatch==true && mode==\'PUT\'">\n      <ion-col>\n        <button small title="產生Insert SQL語法" ion-button color="light" icon-left (click)="openNavSqlPage(item,\'insert\')">\n          Ins\n        </button>\n        <button small title="產生Update SQL語法" ion-button color="light" icon-left (click)="openNavSqlPage(item,\'update\')">\n          Upd\n        </button>\n      </ion-col>\n    </ion-row>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\file-import-data-expression-add-edit\file-import-data-expression-add-edit.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_6__providers_file_import_data_expression_services_file_import_data_expression_services__["a" /* FileImportDataExpressionServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */]])
    ], FileImportDataExpressionAddEditPage);
    return FileImportDataExpressionAddEditPage;
}());

//# sourceMappingURL=file-import-data-expression-add-edit.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportDataExpressionResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileImportDataExpressionViewModel__ = __webpack_require__(1219);
...
var FileImportDataExpressionResponse = /** @class */ (function (_super) {
    __extends(FileImportDataExpressionResponse, _super);
    function FileImportDataExpressionResponse(obj) {
        ...
        if (_this.DidError === false) {
            if (obj.Model != null) {
                _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileImportDataExpressionViewModel__["a" /* FileImportDataExpressionViewModel */]();
                ...
                _this.Model.operation = obj.Model.operation;
                _this.Model.opera_value = obj.Model.opera_value;
    ...
    return FileImportDataExpressionResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=FileImportDataExpressionResponse.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileImportDataExpressionAddEditPageModule", function() { return FileImportDataExpressionAddEditPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_import_data_expression_add_edit__ = __webpack_require__(1445);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_import_data_expression_services_file_import_data_expression_services__ = __webpack_require__(1220);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileImportDataExpressionAddEditPageModule = /** @class */ (function () {
    function FileImportDataExpressionAddEditPageModule() {
    }
    FileImportDataExpressionAddEditPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_import_data_expression_add_edit__["a" /* FileImportDataExpressionAddEditPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_import_data_expression_services_file_import_data_expression_services__["a" /* FileImportDataExpressionServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_import_data_expression_add_edit__["a" /* FileImportDataExpressionAddEditPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileImportDataExpressionAddEditPageModule);
    return FileImportDataExpressionAddEditPageModule;
}());

//# sourceMappingURL=file-import-data-expression-add-edit.module.js.map
