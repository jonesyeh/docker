...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportBeforeSqlViewModel; });
var FileImportBeforeSqlViewModel = /** @class */ (function () {
    function FileImportBeforeSqlViewModel() {
    }
    return FileImportBeforeSqlViewModel;
}());

//# sourceMappingURL=FileImportBeforeSqlViewModel.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportBeforeSqlServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileImportBeforeSqlResponse__ = __webpack_require__(1441);
...
/*
  Generated class for the FileImportBeforeSqlServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var FileImportBeforeSqlServicesProvider = /** @class */ (function () {
    function FileImportBeforeSqlServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "FileImportBeforeSql";
        console.log("Hello FileImportBeforeSqlServiceProvider Provider");
    }
    FileImportBeforeSqlServicesProvider.prototype.PostPutAsync = function (FileImportBeforeSqlViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "FileImportBeforeSql";
        else
            sub_url = "FileImportBeforeSql?exec_file_seq={1}&schemaname={2}&tablename={3}&db_conn_id={4}&parameter_column_group={5}";
        var exec_file_seq = FileImportBeforeSqlViewModel.exec_file_seq;
        var schemaname = FileImportBeforeSqlViewModel.schemaname;
        var tablename = FileImportBeforeSqlViewModel.tablename;
        var db_conn_id = FileImportBeforeSqlViewModel.db_conn_id;
        var parameter_column_group = FileImportBeforeSqlViewModel.parameter_column_group;
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, exec_file_seq, schemaname, tablename, db_conn_id, parameter_column_group);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, FileImportBeforeSqlViewModel, mode).map(function (item) {
            _this.FileImportBeforeSql = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileImportBeforeSqlResponse__["a" /* FileImportBeforeSqlResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.FileImportBeforeSql;
        });
    };
    FileImportBeforeSqlServicesProvider.prototype.DeleteAsync = function (exec_file_seq, schemaname, tablename, db_conn_id, parameter_column_group) {
        var _this = this;
        var sub_url;
        sub_url = "FileImportBeforeSql?exec_file_seq={1}&schemaname={2}&tablename={3}&db_conn_id={4}&parameter_column_group={5}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, exec_file_seq, schemaname, tablename, db_conn_id, parameter_column_group);
    ...
    FileImportBeforeSqlServicesProvider.prototype.GetAsync = function (exec_file_seq, schemaname, tablename, db_conn_id, parameter_column_group) {
        var sub_url;
        sub_url = "FileImportBeforeSql?exec_file_seq={1}&schemaname={2}&tablename={3}&db_conn_id={4}&parameter_column_group={5}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, exec_file_seq, schemaname, tablename, db_conn_id, parameter_column_group);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            return new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileImportBeforeSqlResponse__["a" /* FileImportBeforeSqlResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
    ...
    FileImportBeforeSqlServicesProvider.prototype.GetSqlAsync = function (exec_file_seq, schemaname, tablename, db_conn_id, parameter_column_group, method) {
        var sub_url;
        sub_url = "FileImportBeforeSql/get_{6}_sql?exec_file_seq={1}&schemaname={2}&tablename={3}&db_conn_id={4}&parameter_column_group={5}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, exec_file_seq, schemaname, tablename, db_conn_id, parameter_column_group, method);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
    ...
    FileImportBeforeSqlServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_services__["a" /* ServicesProvider */]])
    ], FileImportBeforeSqlServicesProvider);
    return FileImportBeforeSqlServicesProvider;
}());

//# sourceMappingURL=file-import-before-sql-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportBeforeSqlAddEditPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_ViewModel_FileImportBeforeSqlViewModel__ = __webpack_require__(1216);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_file_import_before_sql_services_file_import_before_sql_services__ = __webpack_require__(1217);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/**
 * Generated class for the FileImportBeforeSqlModalPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var FileImportBeforeSqlAddEditPage = /** @class */ (function () {
    function FileImportBeforeSqlAddEditPage(navCtrl, navParams, viewCtrl, modalCtrl, global, authServices, FileImportBeforeSqlServices, alertCtrl) {
        ...
        this.FileImportBeforeSqlServices = FileImportBeforeSqlServices;
        ...
        this.tablefullname = navParams.data.item.tablefullname;
        this.item = new __WEBPACK_IMPORTED_MODULE_3__Model_ViewModel_FileImportBeforeSqlViewModel__["a" /* FileImportBeforeSqlViewModel */]();
    ...
    FileImportBeforeSqlAddEditPage.prototype.Help = function () {
        var _this = this;
    ...
    FileImportBeforeSqlAddEditPage.prototype.LoadData = function () {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileImportBeforeSqlServices.GetAsync(_this.exec_file_seq, _this.schemaname, _this.tablename, _this.db_conn_id, _this.parameter_column_group).subscribe(function (data) {
                if (data.DidError === true) {
                    ...
                    if (data.Model == null) {
                        _this.mode = "POST";
                        _this.item.exec_file_seq = _this.exec_file_seq;
                        _this.item.schemaname = _this.schemaname;
                        _this.item.tablename = _this.tablename;
                        _this.item.db_conn_id = _this.db_conn_id;
                        _this.item.parameter_column_group = _this.parameter_column_group;
    ...
    FileImportBeforeSqlAddEditPage.prototype.Save = function () {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileImportBeforeSqlServices.PostPutAsync(_this.item, _this.mode).subscribe(function (data) {
    ...
    FileImportBeforeSqlAddEditPage.prototype.Delete = function (item) {
        var _this = this;
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        _this.global.loading.present().then(function () {
                            _this.FileImportBeforeSqlServices.DeleteAsync(_this.exec_file_seq, _this.schemaname, _this.tablename, _this.db_conn_id, _this.parameter_column_group).subscribe(function (data) {
                                _this.global.dismissLoading();
                                if (data.DidError === false) {
    ...
    // }
    FileImportBeforeSqlAddEditPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileImportBeforeSqlServices.GetSqlAsync(_this.exec_file_seq, _this.schemaname, _this.tablename, _this.db_conn_id, _this.parameter_column_group, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileImportBeforeSqlAddEditPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_6__providers_file_import_before_sql_services_file_import_before_sql_services__["a" /* FileImportBeforeSqlServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */]])
    ], FileImportBeforeSqlAddEditPage);
    return FileImportBeforeSqlAddEditPage;
}());

//# sourceMappingURL=file-import-before-sql-add-edit.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportBeforeSqlResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileImportBeforeSqlViewModel__ = __webpack_require__(1216);
...
var FileImportBeforeSqlResponse = /** @class */ (function (_super) {
    __extends(FileImportBeforeSqlResponse, _super);
    function FileImportBeforeSqlResponse(obj) {
        ...
        if (_this.DidError === false) {
            if (obj.Model != null) {
                _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileImportBeforeSqlViewModel__["a" /* FileImportBeforeSqlViewModel */]();
    ...
    return FileImportBeforeSqlResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=FileImportBeforeSqlResponse.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_import_before_sql_add_edit__ = __webpack_require__(1440);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_import_before_sql_services_file_import_before_sql_services__ = __webpack_require__(1217);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileImportBeforeSqlAddEditPageModule = /** @class */ (function () {
    function FileImportBeforeSqlAddEditPageModule() {
    }
    FileImportBeforeSqlAddEditPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_import_before_sql_add_edit__["a" /* FileImportBeforeSqlAddEditPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_import_before_sql_services_file_import_before_sql_services__["a" /* FileImportBeforeSqlServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_import_before_sql_add_edit__["a" /* FileImportBeforeSqlAddEditPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileImportBeforeSqlAddEditPageModule);
    return FileImportBeforeSqlAddEditPageModule;
}());

//# sourceMappingURL=file-import-before-sql-add-edit.module.js.map
