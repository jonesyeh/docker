...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileExportedSqlViewModel; });
var FileExportedSqlViewModel = /** @class */ (function () {
    function FileExportedSqlViewModel() {
    }
    return FileExportedSqlViewModel;
}());

//# sourceMappingURL=FileExportedSqlViewModel.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileExportedSqlServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileExportedSqlResponse__ = __webpack_require__(1402);
...
/*
  Generated class for the FileExportedSqlServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var FileExportedSqlServicesProvider = /** @class */ (function () {
    function FileExportedSqlServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "FileExportedSql";
        console.log("Hello FileExportedSqlServiceProvider Provider");
    }
    FileExportedSqlServicesProvider.prototype.PostPutAsync = function (FileExportedSqlViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "FileExportedSql";
        else
            sub_url = "FileExportedSql?exec_file_seq={1}&schemaname={2}&tablename={3}&db_conn_id={4}&parameter_column_group={5}&src_export_type_key={6}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, FileExportedSqlViewModel.exec_file_seq, FileExportedSqlViewModel.schemaname, FileExportedSqlViewModel.tablename, FileExportedSqlViewModel.db_conn_id, FileExportedSqlViewModel.parameter_column_group, FileExportedSqlViewModel.src_export_type_key);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, FileExportedSqlViewModel, mode).map(function (item) {
            _this.FileExportedSql = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileExportedSqlResponse__["a" /* FileExportedSqlResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.FileExportedSql;
        });
    };
    FileExportedSqlServicesProvider.prototype.DeleteAsync = function (exec_file_seq, schemaname, tablename, db_conn_id, parameter_column_group, src_export_type_key) {
        var _this = this;
        var sub_url;
        sub_url = "FileExportedSql?exec_file_seq={1}&schemaname={2}&tablename={3}&db_conn_id={4}&parameter_column_group={5}&src_export_type_key={6}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, exec_file_seq, schemaname, tablename, db_conn_id, parameter_column_group, src_export_type_key);
    ...
    FileExportedSqlServicesProvider.prototype.GetAsync = function (exec_file_seq, schemaname, tablename, db_conn_id, parameter_column_group, src_export_type_key) {
        var sub_url;
        sub_url = "FileExportedSql?exec_file_seq={1}&schemaname={2}&tablename={3}&db_conn_id={4}&parameter_column_group={5}&src_export_type_key={6}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, exec_file_seq, schemaname, tablename, db_conn_id, parameter_column_group, src_export_type_key);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            return new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileExportedSqlResponse__["a" /* FileExportedSqlResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
    ...
    FileExportedSqlServicesProvider.prototype.GetSqlAsync = function (exec_file_seq, schemaname, tablename, db_conn_id, parameter_column_group, src_export_type_key, method) {
        var sub_url;
        sub_url = "FileExportedSql/get_{7}_sql?exec_file_seq={1}&schemaname={2}&tablename={3}&db_conn_id={4}&parameter_column_group={5}&src_export_type_key={6}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, exec_file_seq, schemaname, tablename, db_conn_id, parameter_column_group, src_export_type_key, method);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
    ...
    FileExportedSqlServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_services__["a" /* ServicesProvider */]])
    ], FileExportedSqlServicesProvider);
    return FileExportedSqlServicesProvider;
}());

//# sourceMappingURL=file-exported-sql-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileExportedSqlAddEditPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_ViewModel_FileExportedSqlViewModel__ = __webpack_require__(1211);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_file_exported_sql_services_file_exported_sql_services__ = __webpack_require__(1212);
...
/**
 * Generated class for the FileExportedSqlModalPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var FileExportedSqlAddEditPage = /** @class */ (function () {
    function FileExportedSqlAddEditPage(navCtrl, navParams, viewCtrl, modalCtrl, global, authServices, FileExportedSqlServices, alertCtrl, ConnServices) {
        ...
        this.FileExportedSqlServices = FileExportedSqlServices;
        ...
        this.item = new __WEBPACK_IMPORTED_MODULE_3__Model_ViewModel_FileExportedSqlViewModel__["a" /* FileExportedSqlViewModel */]();
    ...
    FileExportedSqlAddEditPage.prototype.LoadData = function () {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileExportedSqlServices.GetAsync(_this.item.exec_file_seq, _this.item.schemaname, _this.item.tablename, _this.item.db_conn_id, _this.item.parameter_column_group, _this.item.src_export_type_key).subscribe(function (data) {
                if (data.DidError === true) {
                    ...
                    if (data.Model == null) {
                        _this.mode = "POST";
                        _this.item.is_active = true;
                        _this.item.target_table_type_key = "069|0";
                        _this.item.target_table_type = "無";
                        _this.item.target_db_conn_id = "localdb";
                        _this.get_conn_string("localdb");
                        _this.title = "新增";
                    }
                    else {
                        _this.mode = "PUT";
    ...
    FileExportedSqlAddEditPage.prototype.SelectTargetTableType = function () {
        var _this = this;
        var modal = this.modalCtrl.create("CodeSelectModalPage", {
            select_key: this.item.target_table_type_key,
            code_type: "069"
        });
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
            _this.item.target_table_type_key = select_data.code_key;
            _this.item.target_table_type = select_data.code_desc;
        });
        modal.present();
    };
    FileExportedSqlAddEditPage.prototype.SelectTable = function () {
        var _this = this;
        var modal = this.modalCtrl.create("TableSelectModalPage", {
            select_item: this.item.target_tablefullname
        });
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
            _this.item.target_schemaname = select_data.schemaname;
            _this.item.target_tablename = select_data.tablename;
            _this.item.target_tablefullname = select_data.tablefullname;
        });
        modal.present();
    };
    FileExportedSqlAddEditPage.prototype.Save = function () {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileExportedSqlServices.PostPutAsync(_this.item, _this.mode).subscribe(function (data) {
                if (data.DidError === false) {
                    _this.LoadData();
                    _this.global.dismissLoading();
                    _this.global.showPopup("匯出檔案", data.Message);
                }
                else
                    _this.global.showError(data.ErrorMessage);
            }, function (err) {
    ...
    FileExportedSqlAddEditPage.prototype.Help = function () {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
    ...
    FileExportedSqlAddEditPage.prototype.openNavParameterColumnPage = function (item) {
        var _this = this;
    ...
    FileExportedSqlAddEditPage.prototype.Delete = function (item) {
        var _this = this;
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        _this.global.loading.present().then(function () {
                            _this.FileExportedSqlServices.DeleteAsync(_this.item.exec_file_seq, _this.item.schemaname, _this.item.tablename, _this.item.db_conn_id, _this.item.parameter_column_group, _this.item.src_export_type_key).subscribe(function (data) {
                                _this.global.dismissLoading();
                                if (data.DidError === false) {
    ...
    FileExportedSqlAddEditPage.prototype.get_conn_string = function (remote_conn_id) {
        var _this = this;
        ...
        this.global.loading.present().then(function () {
            _this.ConnServices.GetConnAsync(remote_conn_id).subscribe(function (data) {
                if (data.DidError === true) {
                    ...
                    _this.item.target_db_conn_string =
    ...
    FileExportedSqlAddEditPage.prototype.SelectConn = function () {
        var _this = this;
        var modal = this.modalCtrl.create("ConnSelectModalPage", {
            select_remote_conn_id: this.item.target_db_conn_id,
            conn_type_key: "065|001"
        });
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
            _this.item.target_db_conn_id = select_data.remote_conn_id;
            _this.item.target_db_conn_string = select_data.conn_string;
        });
        modal.present();
    };
    FileExportedSqlAddEditPage.prototype.close = function () {
        this.navCtrl.pop();
        //  this.viewCtrl.dismiss();
    };
    FileExportedSqlAddEditPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileExportedSqlServices.GetSqlAsync(_this.item.exec_file_seq, _this.item.schemaname, _this.item.tablename, _this.item.db_conn_id, _this.item.parameter_column_group, _this.item.src_export_type_key, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileExportedSqlAddEditPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad FileExportedSqlModalPage");
    };
    FileExportedSqlAddEditPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-file-exported-sql-add-edit",template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\file-exported-sql-add-edit\file-exported-sql-add-edit.html"*/'<ion-header>\n  <headerComponent [title]="title" [permission_id]="\'CanBatch\'"></headerComponent>\n</ion-header>\n\n<ion-content padding>\n  <ion-grid>\n    <ion-row>\n      <ion-col col-12 col-sm-2 col-md-3>\n      </ion-col>\n      <ion-col col-12 col-sm-8 col-md-6>\n\n        <ion-grid [ngClass]="[\'subject\']">\n          <ion-row>\n            <ion-col>\n\n              {{subject}}\n            </ion-col>\n          </ion-row>\n\n        </ion-grid>\n      </ion-col>\n      <ion-col col-12 col-sm-2 col-md-3>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n  <form #Form="ngForm">\n    <ion-row>\n      <ion-col>\n        <ion-item>\n          <ion-label stacked>啟用</ion-label>\n          <ion-checkbox [disabled]="CanEditBatch==false" name="is_active" #is_active="ngModel" [(ngModel)]="item.is_active"></ion-checkbox>\n        </ion-item>\n\n      </ion-col>\n    </ion-row>\n    <ion-row *ngIf="item.src_export_type_key!=\'008|BLOB\'" >\n      <ion-col col-12 col-sm-4>\n        <ion-item>\n          <ion-label stacked>目標資料表類型</ion-label>\n          <ion-input type="text" maxlength=10 readonly=true [disabled]="CanEditBatch==false " name="target_table_type_key" #target_table_type_key="ngModel" [(ngModel)]="item.target_table_type_key"\n            required></ion-input>\n\n          <button ion-button outline item-end *ngIf="CanEditBatch==true" icon-right (click)="SelectTargetTableType()">\n            <ion-icon name="arrow-dropdown"></ion-icon>\n          </button>\n        </ion-item>\n\n        <div *ngIf="target_table_type_key.errors && target_table_type_key.touched " class="error-message">\n          目標資料表類型不能為空白\n        </div>\n      </ion-col>\n      <ion-col col-12 col-sm-8>\n        <ion-item>\n          <ion-label stacked>目標資料表類型</ion-label>\n          <ion-input type="text" [disabled]=true name="target_table_type" #target_table_type="ngModel" [(ngModel)]="item.target_table_type"\n            required></ion-input>\n        </ion-item>\n      </ion-col>\n    </ion-row>\n    <ion-row>\n        <ion-col>\n            <ion-item>\n              <ion-label stacked>連線編號</ion-label>\n              <ion-input type="text" readonly=true [disabled]="CanEditBatch==false || mode==\'PUT\'" name="target_db_conn_id" #target_db_conn_id="ngModel" [(ngModel)]="item.target_db_conn_id"\n                required maxlength="20"></ion-input>\n\n              <button ion-button outline item-end *ngIf="CanEditBatch==true" icon-right (click)="SelectConn()">\n                <ion-icon name="arrow-dropdown"></ion-icon>\n              </button>\n            </ion-item>\n\n            <div *ngIf="target_db_conn_id.errors && target_db_conn_id.touched " class="error-message">\n              連線編號不能為空白\n            </div>\n          </ion-col>\n  </ion-row>\n  <ion-row >\n      <ion-col col-12>\n        <ion-item>\n          <ion-label stacked>連線字串</ion-label>\n          <ion-textarea rows=4 [disabled]=true name="target_db_conn_string" #target_db_conn_string="ngModel" [(ngModel)]="item.target_db_conn_string" required></ion-textarea>\n\n        </ion-item>\n\n      </ion-col>\n  </ion-row>\n\n    <ion-row *ngIf="item.target_table_type_key>\'069|1\'">\n      <ion-col col-12 col-sm-4>\n        <ion-item>\n          <ion-label stacked>結構描述</ion-label>\n          <ion-input type="text"  [disabled]="CanEditBatch==false" name="target_schemaname" #target_schemaname="ngModel" [(ngModel)]="item.target_schemaname"\n            maxlength="30"></ion-input>\n        </ion-item>\n\n      </ion-col>\n      <ion-col col-12 col-sm-8>\n        <ion-item>\n          <ion-label stacked>目標資料表名稱</ion-label>\n          <ion-input type="text"  [disabled]="CanEditBatch==false" name="target_tablename" #target_tablename="ngModel" [(ngModel)]="item.target_tablename"\n            required maxlength="50"></ion-input>\n          <button ion-button outline item-end icon-right *ngIf="CanEditBatch==true" (click)="SelectTable()">\n            <ion-icon name="arrow-dropdown"></ion-icon>\n          </button>\n        </ion-item>\n        <div *ngIf="target_tablename.errors && target_tablename.touched" class="error-message">\n          目標資料表名稱不能為空白\n        </div>\n\n      </ion-col>\n    </ion-row>\n    <ion-row>\n      <ion-col>\n        <ion-item>\n          <ion-label stacked>SQL</ion-label>\n          <ion-textarea rows=20 [disabled]="CanEditBatch==false" name="sql_statement" #note="ngModel" [(ngModel)]="item.sql_statement"></ion-textarea>\n        </ion-item>\n      </ion-col>\n    </ion-row>\n  </form>\n</ion-content>\n<ion-footer>\n  <ion-toolbar>\n    <ion-row>\n      <ion-col>\n        <div [ngClass]="[\'command\']">\n          <button small title="取消" ion-button color="dark" icon-left (click)="close()">\n            <ion-icon name="backspace"></ion-icon>\n          </button>\n          <button *ngIf="CanEditBatch==true && mode==\'PUT\'" small title="刪除" ion-button color="dark" icon-left (click)="Delete(item)">\n            <ion-icon name="trash"></ion-icon>\n          </button>\n          <button small title="確認" [disabled]="CanEditBatch==false" ion-button color="dark" [disabled]="!Form.form.valid" icon-left\n            (click)="Save()">\n            <ion-icon name="checkmark-circle"></ion-icon>\n          </button>\n          <button small title="複製SQL語法" ion-button color="dark" icon-left (click)="global.copyTextToClipboard(item.sql_statement)">\n            <ion-icon name="copy"></ion-icon>\n          </button>\n          <button small title="變數說明" [disabled]="CanEditBatch==false" ion-button color="dark"  icon-left\n          (click)="Help()">\n          <ion-icon name="help"></ion-icon>\n        </button>\n        <button small title="參數群組" ion-button color="dark" icon-left (click)="openNavParameterColumnPage(item)">\n          <ion-icon name="outlet"></ion-icon>\n        </button>\n        </div>\n      </ion-col>\n    </ion-row>\n    <ion-row *ngIf="CanEditBatch==true && mode==\'PUT\'">\n      <ion-col>\n        <button small title="產生Insert SQL語法" ion-button color="light" icon-left (click)="openNavSqlPage(item,\'insert\')">\n          Ins\n        </button>\n        <button small title="產生Update SQL語法" ion-button color="light" icon-left (click)="openNavSqlPage(item,\'update\')">\n          Upd\n        </button>\n      </ion-col>\n    </ion-row>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\file-exported-sql-add-edit\file-exported-sql-add-edit.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_6__providers_file_exported_sql_services_file_exported_sql_services__["a" /* FileExportedSqlServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */],
            __WEBPACK_IMPORTED_MODULE_7__providers_conn_services_conn_services__["a" /* ConnServicesProvider */]])
    ], FileExportedSqlAddEditPage);
    return FileExportedSqlAddEditPage;
}());

//# sourceMappingURL=file-exported-sql-add-edit.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileExportedSqlResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileExportedSqlViewModel__ = __webpack_require__(1211);
...
var FileExportedSqlResponse = /** @class */ (function (_super) {
    __extends(FileExportedSqlResponse, _super);
    function FileExportedSqlResponse(obj) {
        ...
        if (_this.DidError === false) {
            if (obj.Model != null) {
                _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileExportedSqlViewModel__["a" /* FileExportedSqlViewModel */]();
                ...
                _this.Model.target_db_conn_id = obj.Model.target_db_conn_id;
                _this.Model.target_table_type_key = obj.Model.target_table_type_key;
                _this.Model.target_schemaname =
                    (obj && obj.Model.target_schemaname) || null;
                _this.Model.target_tablename =
                    (obj && obj.Model.target_tablename) || null;
                _this.Model.sql_statement = (obj && obj.Model.sql_statement) || null;
                ...
                _this.Model.target_table_type = obj.Model.target_table_type;
                _this.Model.target_tablefullname = obj.Model.target_tablefullname;
                _this.Model.target_db_conn_string = obj.Model.target_db_conn_string;
            }
        }
        return _this;
    }
    return FileExportedSqlResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=FileExportedSqlResponse.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_exported_sql_add_edit__ = __webpack_require__(1401);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_exported_sql_services_file_exported_sql_services__ = __webpack_require__(1212);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileExportedSqlAddEditPageModule = /** @class */ (function () {
    function FileExportedSqlAddEditPageModule() {
    }
    FileExportedSqlAddEditPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_exported_sql_add_edit__["a" /* FileExportedSqlAddEditPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_exported_sql_services_file_exported_sql_services__["a" /* FileExportedSqlServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_exported_sql_add_edit__["a" /* FileExportedSqlAddEditPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileExportedSqlAddEditPageModule);
    return FileExportedSqlAddEditPageModule;
}());

//# sourceMappingURL=file-exported-sql-add-edit.module.js.map
