...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Model_Response_FileExecLogListResponse__ = __webpack_require__(1125);
...
var FileExecLogServicesProvider = /** @class */ (function () {
    ...
    FileExecLogServicesProvider.prototype.GetFileExecListsAsync = function (PageSize, PageNumber, begin_date, end_date, func_key, keyword, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "FileExecLog?PageSize={1}&PageNumber={2}&begin_date={3}&end_date={4}&func_key={5}&keyword={6}&order_type={7}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, PageSize, PageNumber, begin_date, end_date, func_key, keyword, order_type);
        return this.Services.GetAsync(sub_url, this.ctl, true)
            .map(function (item) {
            _this.FileExecLog = new __WEBPACK_IMPORTED_MODULE_0__Model_Response_FileExecLogListResponse__["a" /* FileExecLogListResponse */]({
                Message: item.Message,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileExecLogViewModel__ = __webpack_require__(1126);
    ...
    function FileExecLogListResponse(obj) {
        ...
        if (_this.DidError === false) {
            ...
            obj.Model.forEach(function (data) {
                ...
                item.cmd_log_flag = data.cmd_log_flag;
                switch (data.func_key) {
                    case "014|9":
                    case "014|12":
                    case "014|10":
                        {
                            item.has_content_log = false;
                            break;
                        }
                    default:
                        item.has_content_log = true;
                }
                ...
                switch (data.cmd_log_flag) {
                    case true: {
                        item.cmd_log_color = "danger";
                        break;
                    }
                    case false: {
                        item.cmd_log_color = "light";
                        break;
                    }
                    default:
                        item.exec_status_color = "normal-left";
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileDateExecLogPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_exec_log_services_file_exec_log_services__ = __webpack_require__(1035);
...
/**
 * Generated class for the FileDateExecLogPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var FileDateExecLogPage = /** @class */ (function () {
    function FileDateExecLogPage(menuCtrl, navCtrl, navParams, FileExecLogServices, loadingCtrl, global, authServices, platform, modalCtrl, conf) {
        ...
        this.date = new Date();
        this.bdate = new Date(new Date().setDate(this.date.getDate() - 1)); //前一天
        this.end_date = global.ConvertDate(this.date).toISOString();
        this.begin_date = global.ConvertDate(this.bdate).toISOString(); //前一天
        if (this.authServices.authenticated() === true)
            this.LoadData(true);
    }
    FileDateExecLogPage.prototype.SelectFunc = function () {
        var _this = this;
        var modal = this.modalCtrl.create("CodeSelectModalPage", {
            select_key: this.func_key,
            code_key: "014|1,014|2,014|3,014|4,014|5,014|6,014|8,014|9,014|10,014|11,014|12,014|13"
        });
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
            _this.func_key = select_data.code_key;
            _this.func_desc = select_data.code_desc;
            _this.LoadData(true);
        });
        modal.present();
    };
    FileDateExecLogPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit === Math.floor(this.pageSize / 3);
    };
    FileDateExecLogPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
        console.log("Select Event", selected, this.selected);
    };
    FileDateExecLogPage.prototype.setPage = function (pageInfo) {
    ...
    FileDateExecLogPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileDateExecLogPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileDateExecLogPage.prototype.parseISOString = function (s) {
        var b = s.split(/\D+/);
        return new Date(Date.UTC(b[0], --b[1], b[2], b[3], b[4], b[5], b[6])).toLocaleDateString();
    };
    FileDateExecLogPage.prototype.openNavSetPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            var page;
            if (item.func_key === "014|2")
                page = "FileImportPage";
            if (item.func_key === "014|1")
                page = "FileFtpDownPage";
            if (item.func_key === "014|4")
                page = "FileFtpUpPage";
            if (item.func_key === "014|5")
                page = "FileUnZipPage";
            if (item.func_key === "014|9")
                page = "FileCmdPage";
            if (item.func_key === "014|12")
                page = "FileSsisPage";
            if (item.func_key === "014|11")
                page = "FileSqlPage";
            if (item.func_key === "014|6")
                page = "FileZipListPage";
            if (item.func_key === "014|3")
                page = "FileExportAllPage";
            if (item.func_key === "014|8")
                page = "FileManagementAllPage";
            if (item.func_key === "014|10")
                page = "FileHttpDownAllPage";
            if (item.func_key === "014|13")
                page = "FileHttpUpPage";
            if (item.func_key === "014|7") {
                page = "EmailPage";
    ...
    FileDateExecLogPage.prototype.openNavContentPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push("FileContentLogPage", { item: item });
            _this.global.dismissLoading();
        });
    };
    FileDateExecLogPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.FileExecLogServices.GetFileExecListsAsync(_this.pageSize, _this.pageNumber, _this.parseISOString(_this.begin_date), _this.parseISOString(_this.end_date), _this.func_key, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    FileDateExecLogPage.prototype.openNavDetailPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileDateExecLogPage.prototype.openNavCmdLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.cmd_log_page, { item: item });
            _this.global.dismissLoading();
        });
    };
    FileDateExecLogPage.prototype.openNavErrMsgLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileDateExecLogPage.prototype.openNavErrDataLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    return FileDateExecLogPage;
}());

//# sourceMappingURL=file-date-exec-log.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileDateExecLogPageModule", function() { return FileDateExecLogPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_components_module__ = __webpack_require__(813);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__file_date_exec_log__ = __webpack_require__(1379);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_exec_log_services_file_exec_log_services__ = __webpack_require__(1035);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var FileDateExecLogPageModule = /** @class */ (function () {
    function FileDateExecLogPageModule() {
    }
    FileDateExecLogPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__file_date_exec_log__["a" /* FileDateExecLogPage */],
            ],
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__file_date_exec_log__["a" /* FileDateExecLogPage */]),
                __WEBPACK_IMPORTED_MODULE_2__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileDateExecLogPageModule);
    return FileDateExecLogPageModule;
}());

//# sourceMappingURL=file-date-exec-log.module.js.map
