...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Model_Response_ErrDataSrcResponse__ = __webpack_require__(1349);
...
/*
  Generated class for the ErrDataSrcServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var ErrDataSrcServicesProvider = /** @class */ (function () {
    function ErrDataSrcServicesProvider(Services) {
        this.Services = Services;
        console.log("Hello ErrDataSrcServicesProvider Provider");
        this.ctl = "ErrDataSrc";
    }
    ErrDataSrcServicesProvider.prototype.GetAsync = function (exec_log_seq, line_no) {
        var _this = this;
        var sub_url;
        sub_url = "ErrDataSrc?exec_log_seq={1}&line_no={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_3__Model_String__["a" /* String */].Format(sub_url, this.ctl, exec_log_seq, line_no);
        return this.Services.GetAsync(sub_url, this.ctl, true)
            .map(function (item) {
            _this.res = new __WEBPACK_IMPORTED_MODULE_2__Model_Response_ErrDataSrcResponse__["a" /* ErrDataSrcResponse */]({
    ...
    ErrDataSrcServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_services__["a" /* ServicesProvider */]])
    ], ErrDataSrcServicesProvider);
    return ErrDataSrcServicesProvider;
}());

//# sourceMappingURL=err-data-src-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ErrDataSrcPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_err_data_src_services_err_data_src_services__ = __webpack_require__(1203);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ErrDataSrcPage = /** @class */ (function () {
    function ErrDataSrcPage(menuCtrl, navCtrl, navParams, ErrDataSrcServices, loadingCtrl, global, authServices) {
        this.menuCtrl = menuCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.ErrDataSrcServices = ErrDataSrcServices;
        ...
        this.title = navParams.data.item.line_no;
    ...
    ErrDataSrcPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    ErrDataSrcPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    ErrDataSrcPage.prototype.LoadData = function (init) {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.ErrDataSrcServices.GetAsync(_this.item.exec_log_seq, _this.item.line_no).subscribe(function (data) {
    ...
    ErrDataSrcPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad ErrDataSrc");
    };
    ErrDataSrcPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* MenuController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_err_data_src_services_err_data_src_services__["a" /* ErrDataSrcServicesProvider */],
    ...
    return ErrDataSrcPage;
}());

//# sourceMappingURL=err-data-src.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_ErrDataSrcViewModel__ = __webpack_require__(1350);
...
var ErrDataSrcResponse = /** @class */ (function (_super) {
    __extends(ErrDataSrcResponse, _super);
    function ErrDataSrcResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        var item = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_ErrDataSrcViewModel__["a" /* ErrDataSrcViewModel */]();
        var data = obj.Model;
        item.exec_log_seq = data.exec_log_seq;
        item.line_no = data.line_no;
        item.data = data.data;
        item.data_desc = (data && data.data_desc) || null;
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ErrDataSrcViewModel; });
var ErrDataSrcViewModel = /** @class */ (function () {
    function ErrDataSrcViewModel() {
    }
    return ErrDataSrcViewModel;
}());

//# sourceMappingURL=ErrDataSrcViewModel.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__err_data_src__ = __webpack_require__(1348);
...
var ErrDataSrcPageModule = /** @class */ (function () {
    function ErrDataSrcPageModule() {
    }
    ErrDataSrcPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__err_data_src__["a" /* ErrDataSrcPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_err_data_src_services_err_data_src_services__["a" /* ErrDataSrcServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__err_data_src__["a" /* ErrDataSrcPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], ErrDataSrcPageModule);
    return ErrDataSrcPageModule;
}());

//# sourceMappingURL=err-data-src.module.js.map
