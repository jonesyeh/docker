...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ErrDataLogServicesProvider; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Model_Response_ErrDataLogListResponse__ = __webpack_require__(1340);
...
/*
  Generated class for the ErrDataLogServicesProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var ErrDataLogServicesProvider = /** @class */ (function () {
    function ErrDataLogServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "ErrDataLog";
        console.log("Hello ErrDataLogServicesProvider Provider");
    }
    ErrDataLogServicesProvider.prototype.GetListsAsync = function (PageSize, PageNumber, exec_log_seq, keyword, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "ErrDataLog?PageSize={1}&PageNumber={2}&exec_log_seq={3}&keyword={4}&order_type={5}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, PageSize, PageNumber, exec_log_seq, keyword, order_type);
        return this.Services.GetAsync(sub_url, this.ctl, true)
            .map(function (item) {
            _this.ErrDataLog = new __WEBPACK_IMPORTED_MODULE_0__Model_Response_ErrDataLogListResponse__["a" /* ErrDataLogListResponse */]({
            ...
            return _this.ErrDataLog;
        });
    };
    ErrDataLogServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_services__["a" /* ServicesProvider */]])
    ], ErrDataLogServicesProvider);
    return ErrDataLogServicesProvider;
}());

//# sourceMappingURL=err-data-log-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ErrDataLogPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_err_data_log_services_err_data_log_services__ = __webpack_require__(1201);
...
var ErrDataLogPage = /** @class */ (function () {
    function ErrDataLogPage(menuCtrl, navCtrl, navParams, ErrDataLogServices, loadingCtrl, global, authServices, platform, conf) {
        this.menuCtrl = menuCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.ErrDataLogServices = ErrDataLogServices;
        ...
        this.title = navParams.data.item.exec_log_seq;
        this.detail_page = "ErrDataLogDetailPage";
        this.err_data_src_page = "ErrDataSrcPage";
    ...
    ErrDataLogPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit === Math.floor(this.pageSize / 3);
    };
    ErrDataLogPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
        console.log("Select Event", selected, this.selected);
    };
    ErrDataLogPage.prototype.setPage = function (pageInfo) {
    ...
    ErrDataLogPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    ErrDataLogPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    ErrDataLogPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.ErrDataLogServices.GetListsAsync(_this.pageSize, _this.loadPageNumber, _this.item.exec_log_seq, _this.keyword, _this.order_type)
    ...
    ErrDataLogPage.prototype.openNavErrDataSrcPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.err_data_src_page, { item: item });
        });
    };
    ErrDataLogPage.prototype.openNavDetailPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    return ErrDataLogPage;
}());

//# sourceMappingURL=err-data-log.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ErrDataLogListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_ErrDataLogViewModel__ = __webpack_require__(1341);
...
var ErrDataLogListResponse = /** @class */ (function (_super) {
    __extends(ErrDataLogListResponse, _super);
    function ErrDataLogListResponse(obj) {
        ...
        if (_this.DidError === false) {
            ...
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_ErrDataLogViewModel__["a" /* ErrDataLogViewModel */]();
                item.err_log_seq = data.err_log_seq;
                item.exec_log_seq = data.exec_log_seq;
                item.line_no = data.line_no;
                item.column_id = data.column_id;
                item.columnname = data.columnname;
                item.err_content = (data && data.err_content) || null;
                item.err_key = data.err_key;
                item.tablename = (data && data.tablename) || null;
                item.ext_column = (data && data.ext_column) || null;
                item.ext_column_value = (data && data.ext_column_value) || null;
                item.create_time = data.create_time;
                item.col_index = data.col_index;
                item.column_desc = data.column_desc;
                item.err_desc = data.err_desc;
                item.err_type = data.err_type;
                item.err_type_desc = data.err_type_desc;
                item.filename = data.filename;
                item.tablecname = (data && data.tablecname) || null;
                item.ext_column_desc = (data && data.ext_column_desc) || null;
                switch (data.err_type) {
                    case "E": {
                        item.err_type_color = "danger";
                        break;
                    }
                    default:
                        item.err_type_color = "normal";
                }
    ...
    return ErrDataLogListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=ErrDataLogListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ErrDataLogViewModel; });
var ErrDataLogViewModel = /** @class */ (function () {
    function ErrDataLogViewModel() {
    }
    return ErrDataLogViewModel;
}());

//# sourceMappingURL=ErrDataLogViewModel.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ErrDataLogPageModule", function() { return ErrDataLogPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__err_data_log__ = __webpack_require__(1339);
...
var ErrDataLogPageModule = /** @class */ (function () {
    function ErrDataLogPageModule() {
    }
    ErrDataLogPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__err_data_log__["a" /* ErrDataLogPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_err_data_log_services_err_data_log_services__["a" /* ErrDataLogServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__err_data_log__["a" /* ErrDataLogPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], ErrDataLogPageModule);
    return ErrDataLogPageModule;
}());

//# sourceMappingURL=err-data-log.module.js.map
