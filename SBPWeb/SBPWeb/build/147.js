...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LinePage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ConnHttpViewModel__ = __webpack_require__(274);
...
var LinePage = /** @class */ (function () {
    function LinePage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, ConnServices, modalCtrl, platform, conf, viewCtrl) {
        ...
        this.detail_page = "ConnDetailByConnPage";
        this.ConnExt_page = "ConnExtPage";
    ...
    LinePage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    LinePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    LinePage.prototype.setPage = function (pageInfo) {
    ...
    LinePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    LinePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.ConnServices.GetListsLineByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    LinePage.prototype.get_board_class = function (item) {
        return "bordered";
    };
    LinePage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ConnHttpViewModel__["a" /* ConnHttpViewModel */]();
            item.conn_type_key = "065|004";
            item.conn_string = "";
            item.pwd = "Bearer {token}";
            item.db_provider = "";
            item.remote_conn_id = "";
        }
        else {
        ...
        this.AddEditPage = "LineAddEditModalPage";
        var modal = this.modalCtrl.create(this.AddEditPage, {
            mode: this.mode,
            change_mode: change_mode,
            item: item,
            id_list: this.id_list,
            CanEditConn: this.CanEditConn
        });
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.ConnServices.PostPutLineAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("Line訊息", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    LinePage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.remote_conn_id),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.ConnServices.DeleteAsync(item.remote_conn_id).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    LinePage.prototype.GetIDList = function () {
        var _this = this;
        this.global.createLoader("讀取資料中...");
        this.global.loading.present().then(function () {
            _this.ConnServices.GetIDListsByAsync().subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    LinePage.prototype.close = function () {
        this.viewCtrl.dismiss();
    };
    LinePage.prototype.openNavLineMessagePage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push("LineMessagePage", { tokenname: item.remote_conn_id });
        });
    };
    LinePage.prototype.Help = function () {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__line__ = __webpack_require__(1567);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_conn_components_module__ = __webpack_require__(909);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LinePageModule = /** @class */ (function () {
    ...
    LinePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__line__["a" /* LinePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__line__["a" /* LinePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_conn_components_module__["a" /* ConnComponentsModule */],
            ],
        })
    ], LinePageModule);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ConnComponentsModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__conn_conn__ = __webpack_require__(910);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_module__ = __webpack_require__(797);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ConnComponentsModule = /** @class */ (function () {
    function ConnComponentsModule() {
    }
    ConnComponentsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__conn_conn__["a" /* ConnComponent */],
            ],
            providers: [],
    ...
    return ConnComponentsModule;
}());

//# sourceMappingURL=conn.components.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ConnComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_global_global__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_auth_services_auth_services__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_conn_services_conn_services__ = __webpack_require__(266);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ConnViewModel__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Model_ViewModel_ConnFtpViewModel__ = __webpack_require__(275);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__Model_ViewModel_ConnSmtpViewModel__ = __webpack_require__(276);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__Model_ViewModel_ConnHttpViewModel__ = __webpack_require__(274);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__Model_MyAppSharedSettings__ = __webpack_require__(47);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/**
 * Generated class for the ConnComponent component.
 *
 * See https://angular.io/api/core/Component for more info on Angular
 * Components.
 */
var ConnComponent = /** @class */ (function () {
    function ConnComponent(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, ConnServices, modalCtrl, platform, conf) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.loadingCtrl = loadingCtrl;
        this.alertCtrl = alertCtrl;
        ...
        this.Conn_page = "ConnSelectModalPage";
        ...
        if (this.authServices.authenticated() === true) {
            this.can_auth = this.authServices.CanAuth();
            this.CanEditConn = this.authServices.CanEditConn();
            this.LoadData(true);
        }
    }
    ConnComponent.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    ConnComponent.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    ConnComponent.prototype.setPage = function (pageInfo) {
        this.pageNumber = Math.floor(pageInfo.offset / 3) + 1;
        if ((pageInfo.offset + 1) % 3 === 0) {
            if ((pageInfo.offset + 1) / 3 + 1 > this.loadPages) {
                this.loadPageNumber = this.pageNumber + 1;
    ...
    ConnComponent.prototype.doInfinite = function () {
        var _this = this;
        console.log("Begin async operation");
        if (this.loadPages < this.totalPages) {
            this.pageNumber++;
    ...
    ConnComponent.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            if (_this.conn_type_key === "065|002") {
                //ftp
                _this.ConnServices.GetListsFtpByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
                    if (data.DidError === true) {
                        _this.global.dismissLoading();
                        _this.global.showError(data.ErrorMessage);
                    }
            ...
            else if (_this.conn_type_key === "065|003") {
                //smtp
                _this.ConnServices.GetListsSmtpByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
                    if (data.DidError === true) {
                        _this.global.dismissLoading();
                        _this.global.showError(data.ErrorMessage);
                    }
            ...
            else if (_this.conn_type_key === "065|004") {
                //http
                _this.ConnServices.GetListsHttpByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
                    if (data.DidError === true) {
                        _this.global.dismissLoading();
                        _this.global.showError(data.ErrorMessage);
                    }
                ...
                _this.ConnServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.conn_type_key, _this.order_type).subscribe(function (data) {
                    if (data.DidError === true) {
                        _this.global.dismissLoading();
                        _this.global.showError(data.ErrorMessage);
                    }
    ...
    ConnComponent.prototype.get_board_class = function (item) {
        if (item.remote_conn_id === this.select_remote_conn_id)
            return "select_bordered";
        else
            return "bordered";
    };
    ConnComponent.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            if (this.conn_type_key === "065|002")
                item = new __WEBPACK_IMPORTED_MODULE_7__Model_ViewModel_ConnFtpViewModel__["a" /* ConnFtpViewModel */]();
            else if (this.conn_type_key === "065|003")
                item = new __WEBPACK_IMPORTED_MODULE_8__Model_ViewModel_ConnSmtpViewModel__["a" /* ConnSmtpViewModel */]();
            else if (this.conn_type_key === "065|004")
                item = new __WEBPACK_IMPORTED_MODULE_9__Model_ViewModel_ConnHttpViewModel__["a" /* ConnHttpViewModel */]();
            else
                item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ConnViewModel__["a" /* ConnViewModel */]();
            item.conn_type_key = this.conn_type_key;
            item.conn_string = "";
            item.pwd = "";
            item.db_provider = "";
            item.remote_conn_id = "";
            if (this.conn_type_key === "065|002") {
                item.port = 21;
                item.passive_mode = false;
            }
            if (this.conn_type_key === "065|003") {
                item.port = 25;
                item.ssl = false;
            }
        }
        ...
        if (this.conn_type_key === "065|000")
            this.AddEditPage = "ConnOtherAddEditModalPage";
        if (this.conn_type_key === "065|001" || this.conn_type_key === "065|006")
            this.AddEditPage = "ConnDbAddEditModalPage";
        if (this.conn_type_key === "065|002")
            this.AddEditPage = "ConnFtpAddEditModalPage";
        if (this.conn_type_key === "065|003")
            this.AddEditPage = "ConnSmtpAddEditModalPage";
        if (this.conn_type_key === "065|004")
            this.AddEditPage = "ConnHttpAddEditModalPage";
        if (this.conn_type_key === "065|005")
            this.AddEditPage = "ConnSbpAddEditModalPage";
        // if (this.conn_type_key === "065|006")
        //   this.AddEditPage = "ConnSSISAddEditModalPage";
        var modal = this.modalCtrl.create(this.AddEditPage, {
            mode: this.mode,
            change_mode: change_mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.createLoader();
            _this.global.loading.present().then(function () {
                _this.ConnServices.PostPutAsync(select_data, _this.mode, _this.conn_type_key).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("連線設定", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    ConnComponent.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.remote_conn_id),
    ...
    ConnComponent.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.ConnServices.GetSqlAsync(item.remote_conn_id, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    ConnComponent.prototype.add = function (item) {
        // this.viewCtrl.dismiss(item);
        this.onSelect.emit(item);
    };
    ConnComponent.prototype.close = function () {
        //this.viewCtrl.dismiss();
        this.onSelect.emit(null);
    };
    ConnComponent.prototype.ionViewDidLoad = function () {
        console.log("Hello ConnComponent Component");
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */])
    ], ConnComponent.prototype, "conn_type_key", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */])
    ], ConnComponent.prototype, "select_remote_conn_id", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */])
    ], ConnComponent.prototype, "subject", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Boolean)
    ], ConnComponent.prototype, "show_select_add", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Boolean)
    ], ConnComponent.prototype, "show_select", void 0);
    ConnComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "ConnComponent",
            outputs: ["onSelect"],template:/*ion-inline-start:"C:\jones\ionic\prod\src\components\conn\conn.html"*/'\n<!--\n  Generated template for the RolePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n\n\n\n<ion-content padding>\n  <ion-row>\n    <ion-col>\n\n      <ion-searchbar [ngClass]="[\'search\']" (keyup.enter)="LoadData(true)" placeholder="搜尋關鍵字(連線編號包含、連線字串包含)" [(ngModel)]="keyword">\n      </ion-searchbar>\n    </ion-col>\n  </ion-row>\n  <ion-grid *ngIf="subject>\'\'">\n    <ion-row>\n      <ion-col col-12 col-sm-2 col-md-3>\n      </ion-col>\n      <ion-col col-12 col-sm-8 col-md-6>\n\n        <ion-grid [ngClass]="[\'subject\']">\n          <ion-row>\n            <ion-col>\n\n              <b>{{subject}}</b>\n            </ion-col>\n          </ion-row>\n\n        </ion-grid>\n      </ion-col>\n      <ion-col col-12 col-sm-2 col-md-3>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n  <ion-grid *ngIf="conf.mobile_mode==false && selectedItem!=null" [ngClass]="\'bordered\'">\n    <ion-row>\n      <ion-col>\n        <button small title="編輯" ion-button color="light" icon-left (click)="ShowModal(selectedItem,\'e\')">\n          <ion-icon name="create"></ion-icon>\n        </button>\n        <button small *ngIf="CanEditConn==true && conn_type_key!=\'065|005\'" title="變更密碼" ion-button color="light" icon-left (click)="ShowModal(selectedItem,\'password\')">\n          <ion-icon name="key"></ion-icon>\n        </button>\n        <button small title="複製" *ngIf="CanEditConn==true && conn_type_key!=\'065|003\'" ion-button color="light" icon-left (click)="ShowModal(selectedItem,\'c\')">\n          <ion-icon name="copy"></ion-icon>\n        </button>\n    <button *ngIf="CanEditConn==true && conn_type_key!=\'065|003\'" small title="刪除" ion-button color="dark" icon-left (click)="Delete(selectedItem)">\n      <ion-icon name="trash"></ion-icon>\n    </button>\n    <button small  title="加入" *ngIf="show_select_add==true && show_select==true" ion-button color="danger" icon-left (click)="add(selectedItem)">\n      <ion-icon name="checkmark-circle"></ion-icon>\n    </button>\n      </ion-col>\n      <ion-col>\n          <button small title="產生Insert SQL語法" *ngIf="conn_type_key!=\'065|003\'"  ion-button color="light" icon-left (click)="openNavSqlPage(selectedItem,\'insert\')">\n          Ins\n         </button>\n         <button small title="產生Update SQL語法" ion-button color="light" icon-left (click)="openNavSqlPage(selectedItem,\'update\')">\n          Upd\n         </button>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n  <ngx-datatable NgxResizeWatcher class="bootstrap" *ngIf="totalRows>0 && conf.mobile_mode==false" [selected]="selected" [selectionType]="\'single\'"\n    (select)=\'onRowSelect($event)\'   [rows]="data_list" [columnMode]="\'flex\'" [headerHeight]="40" [rowHeight]="\'auto\'" [footerHeight]="40"\n    [reorderable]=false [limit]="limit" [count]="totalRows" [offset]="offset" (page)=\'setPage($event)\'>\n\n    <ngx-datatable-column prop="remote_conn_id" name="連線編號" [flexGrow]="1" [frozenLeft]="true">\n    </ngx-datatable-column>\n    <ngx-datatable-column *ngIf="conn_type_key==\'065|001\' || conn_type_key==\'065|006\'" prop="db_provider" name="資料庫提供者" [flexGrow]="1"  >\n      </ngx-datatable-column>\n      <ngx-datatable-column prop="conn_string" name="連線字串" [flexGrow]="4" >\n        </ngx-datatable-column>\n        <ngx-datatable-column prop="user_name" *ngIf="conn_type_key==\'065|004\'" name="連線帳號" [flexGrow]="1" >\n          </ngx-datatable-column>\n\n    <ngx-datatable-column prop="modifier" name="更新者" [flexGrow]="1" >\n      </ngx-datatable-column>\n    <ngx-datatable-column prop="last_update_time" name="更新時間" [flexGrow]="2" >\n      <ng-template let-value="value" ngx-datatable-cell-template>\n        <div *ngIf="platform.is(\'ios\')==true">\n          {{value | date:\'y/MM/dd HH:mm:ss \'}}\n        </div>\n        <div *ngIf="platform.is(\'ios\')!=true">\n          {{value | date:\'y/MM/dd HH:mm:ss\'}}\n        </div>\n      </ng-template>\n\n    </ngx-datatable-column>\n\n  </ngx-datatable>\n<div *ngIf="totalRows>0 && conf.mobile_mode==true">\n    <ion-row>\n\n      <ion-col col-lg-4 col-md-6 col-sm-6 col-12 *ngFor="let item of data_list">\n\n             <ion-grid [ngClass]=get_board_class(item)>\n          <ion-row>\n            <ion-col>\n                <button small title="編輯" ion-button color="light" icon-left (click)="ShowModal(item,\'e\')">\n                    <ion-icon name="create"></ion-icon>\n                  </button>\n                  <button small *ngIf="CanEditConn==true && conn_type_key!=\'065|005\'" title="變更密碼" ion-button color="light" icon-left (click)="ShowModal(item,\'password\')">\n                    <ion-icon name="key"></ion-icon>\n                  </button>\n                  <button small title="複製" *ngIf="CanEditConn==true && conn_type_key!=\'065|003\'" ion-button color="light" icon-left (click)="ShowModal(item,\'c\')">\n                    <ion-icon name="copy"></ion-icon>\n                  </button>\n              <button *ngIf="CanEditConn==true && conn_type_key!=\'065|003\'" small title="刪除" ion-button color="dark" icon-left (click)="Delete(item)">\n                <ion-icon name="trash"></ion-icon>\n              </button>\n              <button small  title="加入" *ngIf="show_select_add==true && show_select==true" ion-button color="danger" icon-left (click)="add(item)">\n                <ion-icon name="checkmark-circle"></ion-icon>\n              </button>\n\n\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n                <button small title="產生Insert SQL語法" *ngIf="conn_type_key!=\'065|003\'"  ion-button color="light" icon-left (click)="openNavSqlPage(item,\'insert\')">\n                Ins\n               </button>\n               <button small title="產生Update SQL語法" ion-button color="light" icon-left (click)="openNavSqlPage(item,\'update\')">\n                Upd\n               </button>\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              {{item.remote_conn_id}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              {{item.conn_string}}\n            </ion-col>\n          </ion-row>\n          <ion-row *ngIf="item.db_provider>\'\'" >\n            <ion-col>\n              {{item.db_provider}}\n            </ion-col>\n          </ion-row>\n          <ion-row *ngIf="item.user_name>\'\'" >\n            <ion-col>\n              {{item.user_name}}\n            </ion-col>\n          </ion-row>\n        </ion-grid>\n      </ion-col>\n\n    </ion-row>\n  </div>\n  <ion-infinite-scroll *ngIf="pageNumber < totalPages && conf.mobile_mode==true" (ionInfinite)="$event.waitFor(doInfinite())">\n    <ion-infinite-scroll-content loadingSpinner="bubbles">\n    </ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n\n</ion-content>\n<ion-footer>\n  <ion-toolbar>\n    <ion-row>\n      <ion-col>\n        <div [ngClass]="[\'command\']">\n            <button small title="重新整理" ion-button color="dark" icon-left (click)="LoadData(true)">\n                <ion-checkbox name="order_type" title="遞增/遞減" color="dark" [(ngModel)]="order_type" (ionChange)="LoadData(true)" ></ion-checkbox>\n                 <ion-icon name="refresh"></ion-icon>\n              </button>\n          <button *ngIf="CanEditConn==true && conn_type_key!=\'065|003\'" small title="新增" ion-button color="dark" icon-left (click)="ShowModal(null,\'password\')">\n            <ion-icon name="add"></ion-icon>\n          </button>\n          <button small title="取消" *ngIf="show_select==true" ion-button color="dark" icon-left (click)="close()">\n            <ion-icon name="backspace"></ion-icon>\n          </button>\n\n        </div>\n        <StatusComponent [pageNumber]="pageNumber" [totalPages]="totalPages" [totalRows]="totalRows"></StatusComponent>\n      </ion-col>\n    </ion-row>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\components\conn\conn.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["m" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["h" /* LoadingController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["j" /* ModalController */],
            __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["n" /* Platform */],
            __WEBPACK_IMPORTED_MODULE_10__Model_MyAppSharedSettings__["a" /* MyAppSharedSettings */]])
    ], ConnComponent);
