...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__code_check_type_detail_code_check_type_detail__ = __webpack_require__(1005);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_code_check_services_code_check_services__ = __webpack_require__(280);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CodeCheckPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_code_check_services_code_check_services__ = __webpack_require__(280);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_CodeCheckViewModel__ = __webpack_require__(138);
...
var CodeCheckPage = /** @class */ (function () {
    function CodeCheckPage(menuCtrl, navCtrl, navParams, CodeCheckServices, loadingCtrl, global, authServices, modalCtrl, alertCtrl, platform, conf) {
        ...
        this.CanCodeCheckExec = true;
        this.detail_page = "CodeCheckDetailPage";
        this.CheckType_page = "CodeCheckTypeDetailPage";
    ...
    CodeCheckPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    CodeCheckPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    CodeCheckPage.prototype.setPage = function (pageInfo) {
        this.pageNumber = Math.floor(pageInfo.offset / 3) + 1;
        if ((pageInfo.offset + 1) % 3 === 0) {
            if ((pageInfo.offset + 1) / 3 + 1 > this.loadPages) {
                this.loadPageNumber = this.pageNumber + 1;
    ...
    CodeCheckPage.prototype.doInfinite = function () {
        var _this = this;
        console.log("Begin async operation");
        if (this.loadPages < this.totalPages) {
            this.pageNumber++;
    ...
    CodeCheckPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    CodeCheckPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.CodeCheckServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.schemaname, _this.tablename, _this.keyword, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    CodeCheckPage.prototype.openNavDetailsPage = function (item) {
        var _this = this;
    ...
    CodeCheckPage.prototype.openNavSqlPage = function (item, method, is_exec) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.CodeCheckServices.GetSqlAsync(item.schemaname, item.tablename, item.columnname, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    CodeCheckPage.prototype.ShowModal = function (item) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_CodeCheckViewModel__["a" /* CodeCheckViewModel */]();
        ...
        var modal = this.modalCtrl.create("CodeCheckAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.CodeCheckServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("代碼檢核欄位", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    CodeCheckPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.CodeCheckServices.DeleteAsync(item.schemaname, item.tablename, item.columnname).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CodeCheckPageModule", function() { return CodeCheckPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__code_check__ = __webpack_require__(1291);
...
var CodeCheckPageModule = /** @class */ (function () {
    function CodeCheckPageModule() {
    }
    CodeCheckPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__code_check__["a" /* CodeCheckPage */],
            ],
            providers: [],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__code_check__["a" /* CodeCheckPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_codecheck_components_module__["a" /* CodeCheckComponentsModule */],
            ],
        })
    ], CodeCheckPageModule);
    return CodeCheckPageModule;
}());

//# sourceMappingURL=code-check.module.js.map
