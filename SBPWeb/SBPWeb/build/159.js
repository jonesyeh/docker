...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BatchProgramComponentsModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__batch_program_batch_program__ = __webpack_require__(1090);
...
var BatchProgramComponentsModule = /** @class */ (function () {
    function BatchProgramComponentsModule() {
    }
    BatchProgramComponentsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__batch_program_batch_program__["a" /* BatchProgramComponent */],
            ],
    ...
    ], BatchProgramComponentsModule);
    return BatchProgramComponentsModule;
}());

//# sourceMappingURL=batchprogram.components.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BatchProgramComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_program_services_program_services__ = __webpack_require__(281);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ProgramViewModel__ = __webpack_require__(49);
 ...
 */
var BatchProgramComponent = /** @class */ (function () {
    function BatchProgramComponent(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, ProgramServices, modalCtrl, platform, conf) {
        ...
        this.detail_page = "ProgramDetailByBatchProgramPage";
        this.Batch_page = "BatchProgramBatchPage";
    ...
    BatchProgramComponent.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    BatchProgramComponent.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    BatchProgramComponent.prototype.setPage = function (pageInfo) {
    ...
    BatchProgramComponent.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    BatchProgramComponent.prototype.doInfinite = function () {
        var _this = this;
    ...
    BatchProgramComponent.prototype.get_board_class = function (item) {
        if (item.program_no === this.select_item)
            return "select_bordered";
        else
            return "bordered";
    };
    BatchProgramComponent.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.ProgramServices.GetSqlAsync(item.program_no, method).subscribe(function (data) {
    ...
    BatchProgramComponent.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.ProgramServices.GetSqlListsAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    BatchProgramComponent.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ProgramViewModel__["a" /* ProgramViewModel */]();
            item.program_no = "auto";
            item.program_type_key = "013|SQL";
            item.is_active = true;
        }
        else {
            this.mode = "PUT";
        ...
        var modal = this.modalCtrl.create("BatchProgramAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.ProgramServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    BatchProgramComponent.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.ProgramServices.DeleteAsync(item.program_no).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    BatchProgramComponent.prototype.openNavBatchPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    BatchProgramComponent.prototype.openNavDetailPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    BatchProgramComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_program_services_program_services__["a" /* ProgramServicesProvider */],
    ...
    return BatchProgramComponent;
}());

//# sourceMappingURL=batch-program.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BatchProgramSelectModalPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
/**
 * Generated class for the BatchProgramSelectModalPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var BatchProgramSelectModalPage = /** @class */ (function () {
    function BatchProgramSelectModalPage(navCtrl, navParams, viewCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.viewCtrl = viewCtrl;
        this.select_item = navParams.data.select_item;
    }
    BatchProgramSelectModalPage.prototype.onSelect = function (item) {
        this.viewCtrl.dismiss(item);
    };
    BatchProgramSelectModalPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad BatchProgramSelectModalPage');
    };
    BatchProgramSelectModalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-batch-program-select-modal',template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\batch-program-select-modal\batch-program-select-modal.html"*/'<!--\n  Generated template for the BatchProgramSelectModalPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>程式選取</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n<BatchProgramComponent [show_select]=true (onSelect)="onSelect($event)" [select_item]="select_item"  ></BatchProgramComponent>\n</ion-content>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\batch-program-select-modal\batch-program-select-modal.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* ViewController */]])
    ], BatchProgramSelectModalPage);
    return BatchProgramSelectModalPage;
}());

//# sourceMappingURL=batch-program-select-modal.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BatchProgramSelectModalPageModule", function() { return BatchProgramSelectModalPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__batch_program_select_modal__ = __webpack_require__(1281);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_batchprogram_components_module__ = __webpack_require__(1089);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BatchProgramSelectModalPageModule = /** @class */ (function () {
    function BatchProgramSelectModalPageModule() {
    }
    BatchProgramSelectModalPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__batch_program_select_modal__["a" /* BatchProgramSelectModalPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__batch_program_select_modal__["a" /* BatchProgramSelectModalPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_batchprogram_components_module__["a" /* BatchProgramComponentsModule */],
            ],
        })
    ], BatchProgramSelectModalPageModule);
    return BatchProgramSelectModalPageModule;
}());

//# sourceMappingURL=batch-program-select-modal.module.js.map
