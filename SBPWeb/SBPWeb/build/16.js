...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EmailUserServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_EmailUserListResponse__ = __webpack_require__(1100);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_Response_EmailUserResponse__ = __webpack_require__(1101);
...
/*
  Generated class for the EmailUserServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var EmailUserServicesProvider = /** @class */ (function () {
    function EmailUserServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "EmailUser";
        console.log("Hello EmailUserServiceProvider Provider");
    }
    EmailUserServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "EmailUser?PageSize={1}&PageNumber={2}&keyword={3}&order_type={4}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.EmailUsers = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_EmailUserListResponse__["a" /* EmailUserListResponse */]({
            ...
            return _this.EmailUsers;
        });
    };
    EmailUserServicesProvider.prototype.PostPutAsync = function (EmailUserViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "EmailUser";
        else
            sub_url = "EmailUser?email_id={1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, EmailUserViewModel.email_id);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, EmailUserViewModel, mode).map(function (item) {
            _this.EmailUser = new __WEBPACK_IMPORTED_MODULE_5__Model_Response_EmailUserResponse__["a" /* EmailUserResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.EmailUser;
        });
    };
    EmailUserServicesProvider.prototype.DeleteAsync = function (email_id) {
        var _this = this;
        var sub_url;
        sub_url = "EmailUser?email_id={1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, email_id);
    ...
    EmailUserServicesProvider.prototype.GetSqlAsync = function (email_id, method) {
        var sub_url;
        sub_url = "EmailUser/get_{2}_sql?email_id={1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, email_id, method);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
    ...
    EmailUserServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_services__["a" /* ServicesProvider */]])
    ], EmailUserServicesProvider);
    return EmailUserServicesProvider;
}());

//# sourceMappingURL=email-user-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EmailUserComponentsModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__email_user_email_user__ = __webpack_require__(1099);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_email_user_services_email_user_services__ = __webpack_require__(1012);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var EmailUserComponentsModule = /** @class */ (function () {
    function EmailUserComponentsModule() {
    }
    EmailUserComponentsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__email_user_email_user__["a" /* EmailUserComponent */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_email_user_services_email_user_services__["a" /* EmailUserServicesProvider */],
            ],
    ...
    ], EmailUserComponentsModule);
    return EmailUserComponentsModule;
}());

//# sourceMappingURL=email-user.components.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EmailUserComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_email_user_services_email_user_services__ = __webpack_require__(1012);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_EmailUserViewModel__ = __webpack_require__(931);
...
/**
 * Generated class for the EmailUserComponent component.
 *
 * See https://angular.io/api/core/Component for more info on Angular
 * Components.
 */
var EmailUserComponent = /** @class */ (function () {
    function EmailUserComponent(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, EmailUserServices, modalCtrl, platform, conf) {
        ...
        this.EmailUserServices = EmailUserServices;
        ...
        this.EmailUser_page = "EmailUserSelectModalPage";
        this.onSelect = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        this.detail_page = "EmailUserDetailByEmailUserPage";
        this.sql_page = "SqlPage";
        this.innerWidth = window.innerWidth;
        this.innerHeight = window.innerHeight;
        this.order_type = true;
    }
    EmailUserComponent.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
        if (this.select_id > "")
            this.keyword = this.select_id;
        if (this.authServices.authenticated() === true) {
            this.can_auth = this.authServices.CanAuth();
            this.CanEditEmail = this.authServices.CanEditEmail();
            this.LoadData(true);
        }
    };
    EmailUserComponent.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    EmailUserComponent.prototype.setPage = function (pageInfo) {
    ...
    EmailUserComponent.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    EmailUserComponent.prototype.doInfinite = function () {
        var _this = this;
    ...
    EmailUserComponent.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.EmailUserServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    EmailUserComponent.prototype.get_board_class = function (item) {
        if (item.email_id === this.select_id)
            return "select_bordered";
        else
            return "bordered";
    };
    EmailUserComponent.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_EmailUserViewModel__["a" /* EmailUserViewModel */]();
            item.parameter_column_group = "001";
            item.send_status_key = "071|WAIT";
            item.send_status = "等待寄送";
            item.can_rerun = true;
        }
        else {
            this.mode = "PUT";
        ...
        if (change_mode === "c")
            this.mode = "POST";
        var modal = this.modalCtrl.create("EmailUserAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.EmailUserServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    EmailUserComponent.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.email_id),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.EmailUserServices.DeleteAsync(item.email_id).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    EmailUserComponent.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.EmailUserServices.GetSqlAsync(item.email_id, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    EmailUserComponent.prototype.openNavEmailUserPage = function (item) {
        var modal = this.modalCtrl.create(this.EmailUser_page, {
            EmailUser_type: item.EmailUser_no,
    ...
    EmailUserComponent.prototype.add = function (item) {
        // this.viewCtrl.dismiss(item);
        this.onSelect.emit(item);
    };
    EmailUserComponent.prototype.close = function () {
        //this.viewCtrl.dismiss();
        this.onSelect.emit(null);
    };
    EmailUserComponent.prototype.openNavPage = function (parent_path) {
        var _this = this;
        var page;
    ...
    EmailUserComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_email_user_services_email_user_services__["a" /* EmailUserServicesProvider */],
    ...
    return EmailUserComponent;
}());

//# sourceMappingURL=email-user.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EmailUserListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_EmailUserViewModel__ = __webpack_require__(931);
...
var EmailUserListResponse = /** @class */ (function (_super) {
    __extends(EmailUserListResponse, _super);
    function EmailUserListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_EmailUserViewModel__["a" /* EmailUserViewModel */]();
                item.email_id = data.email_id;
                item.email_desc = data.email_desc;
                item.fromaddress = data.fromaddress;
                item.toaddress = data.toaddress;
                item.ccaddress = (data && data.ccaddress) || null;
                item.bccaddress = (data && data.bccaddress) || null;
                ...
                item.send_status_key = data.send_status_key;
                item.can_rerun = data.can_rerun;
                item.send_status = data.send_status;
                item.email_full_desc = data.email_id + "-" + data.email_desc;
                _this.Model.push(item);
            }) || null;
        }
        return _this;
    }
    return EmailUserListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=EmailUserListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EmailUserResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_EmailUserViewModel__ = __webpack_require__(931);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var EmailUserResponse = /** @class */ (function (_super) {
    __extends(EmailUserResponse, _super);
    function EmailUserResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_EmailUserViewModel__["a" /* EmailUserViewModel */]();
            _this.Model.email_id = obj.Model.email_id;
            _this.Model.email_desc = obj.Model.email_desc;
            _this.Model.fromaddress = obj.Model.fromaddress;
            _this.Model.toaddress = obj.Model.toaddress;
            _this.Model.ccaddress = (obj && obj.Model.ccaddress) || null;
            _this.Model.bccaddress = (obj && obj.Model.bccaddress) || null;
            _this.Model.subject = obj.Model.subject;
            _this.Model.body = obj.Model.body;
            ...
            _this.Model.send_status_key = obj.Model.send_status_key;
            _this.Model.can_rerun = obj.Model.can_rerun;
            _this.Model.send_status = obj.Model.send_status;
            _this.Model.email_full_desc = obj.Model.email_id + "-" + obj.Model.email_desc;
        }
        return _this;
    }
...
//# sourceMappingURL=EmailUserResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EmailUserSelectModelPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
/**
 * Generated class for the EmailUserSelectModelPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var EmailUserSelectModelPage = /** @class */ (function () {
    function EmailUserSelectModelPage(navCtrl, navParams, viewCtrl, modalCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        ...
        this.select_id = navParams.data.select_id;
        this.show_select_add = navParams.data.show_select_add;
        this.title = navParams.data.title;
        this.order_type = true;
    }
    EmailUserSelectModelPage.prototype.onSelect = function (item) {
        this.viewCtrl.dismiss(item);
    };
    EmailUserSelectModelPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad EmailUserSelectModelPage');
    };
    EmailUserSelectModelPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-email-user-select-model',template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\email-user-select-model\email-user-select-model.html"*/'<EmailUserComponent [title]="\'接收使用者\'" [subject]="\'\'" (onSelect)="onSelect($event)" [select_id]="select_id" [show_select]=true [show_select_add]="show_select_add" ></EmailUserComponent>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\email-user-select-model\email-user-select-model.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* ViewController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* ModalController */]])
    ], EmailUserSelectModelPage);
    return EmailUserSelectModelPage;
}());

//# sourceMappingURL=email-user-select-model.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EmailUserSelectModelPageModule", function() { return EmailUserSelectModelPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__email_user_select_model__ = __webpack_require__(1331);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_email_user_components_module__ = __webpack_require__(1098);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var EmailUserSelectModelPageModule = /** @class */ (function () {
    function EmailUserSelectModelPageModule() {
    }
    EmailUserSelectModelPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__email_user_select_model__["a" /* EmailUserSelectModelPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__email_user_select_model__["a" /* EmailUserSelectModelPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_email_user_components_module__["a" /* EmailUserComponentsModule */],
            ],
        })
    ], EmailUserSelectModelPageModule);
    return EmailUserSelectModelPageModule;
}());

//# sourceMappingURL=email-user-select-model.module.js.map
