...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FtpFileBrowserUploadPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__providers_ftp_file_browser_services_ftp_file_browser_services__ = __webpack_require__(282);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_ViewModel_FileBrowserViewModel__ = __webpack_require__(134);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_FtpDirectoryBrowserViewModel__ = __webpack_require__(916);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FtpFileBrowserViewModel__ = __webpack_require__(927);
 ...
 */
var FtpFileBrowserUploadPage = /** @class */ (function () {
    function FtpFileBrowserUploadPage(navCtrl, navParams, viewCtrl, loadingCtrl, global, FtpFileBrowserServices, modalCtrl) {
        ...
        if (navParams.data.upload_file != null)
            this.upload_file = navParams.data.upload_file;
        else {
            this.upload_file = new __WEBPACK_IMPORTED_MODULE_4__Model_ViewModel_FileBrowserViewModel__["a" /* FileBrowserViewModel */]();
            this.upload_file.filepath = "";
        }
        if (navParams.data.ftpDirectory != null)
            this.ftpDirectory = navParams.data.ftpDirectory;
        else {
            this.ftpDirectory = new __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_FtpDirectoryBrowserViewModel__["a" /* FtpDirectoryBrowserViewModel */]();
            this.ftpDirectory.filepath = "";
        }
        this.title = "ftp上傳檔案";
    }
    FtpFileBrowserUploadPage.prototype.get_local_file = function () {
        var _this = this;
        var modal = this.modalCtrl.create("DirectoryBrowserSelectModalPage", {
            parent_path: this.upload_file.filepath,
            show_select_type: "F"
        });
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
            _this.upload_file = select_data;
        });
        modal.present();
    };
    FtpFileBrowserUploadPage.prototype.get_filepath = function () {
        var _this = this;
        var modal = this.modalCtrl.create("FtpDirectoryBrowserSelectModalPage", {
            parent_path: this.ftpDirectory.filepath,
            show_select_type: "D"
        });
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
            _this.ftpDirectory = select_data;
        });
        modal.present();
    };
    FtpFileBrowserUploadPage.prototype.Save = function () {
        var _this = this;
        // this.viewCtrl.dismiss(this.item);
        this.FtpFileBrowserViewModel = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FtpFileBrowserViewModel__["a" /* FtpFileBrowserViewModel */]();
        this.FtpFileBrowserViewModel.local_filepath = this.upload_file.filepath;
        this.FtpFileBrowserViewModel.filename = this.upload_file.filename;
        this.FtpFileBrowserViewModel.filepath = this.ftpDirectory.filepath;
        this.FtpFileBrowserViewModel.remote_conn_id = this.ftpDirectory.remote_conn_id;
        this.FtpFileBrowserViewModel.conn_type_key = this.ftpDirectory.conn_type_key;
        this.FtpFileBrowserViewModel.encrypt_method_key = this.ftpDirectory.encrypt_method_key;
        this.global.createLoader("上傳檔案中...");
        this.global.loading.present().then(function () {
            _this.FtpFileBrowserServices.Upload(_this.FtpFileBrowserViewModel).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
                else {
                    if (_this.parent_page != null)
                        _this.parent_page.LoadData(true);
                    _this.global.dismissLoading();
                    _this.global.showMessage("上傳檔案", data.Message);
                }
            }, function (err) {
                _this.global.dismissLoading();
    ...
    FtpFileBrowserUploadPage.prototype.close = function () {
        // this.viewCtrl.dismiss();
        this.navCtrl.pop();
    };
    FtpFileBrowserUploadPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad CodeModalPage");
        this.global.dismissLoading();
    };
    FtpFileBrowserUploadPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["Component"])({
            selector: "page-ftp-file-browser-upload",template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\ftp-file-browser-upload\ftp-file-browser-upload.html"*/'<ion-header>\n  <headerComponent [title]="\'Ftp上傳檔案\'" [permission_id]="\'CanUploadFtpFileBrowser\'"></headerComponent>\n</ion-header>\n\n<ion-content  padding>\n    <form #Form="ngForm">\n\n        <ion-row>\n          <ion-col>\n            <ion-item>\n              <ion-label stacked >上傳檔案</ion-label>\n              <ion-input type="text"  name="filefullname" #filefullname="ngModel" [(ngModel)]="upload_file.filefullname"\n                required></ion-input>\n                <button ion-button outline item-end  icon-right (click)="get_local_file()">\n                  <ion-icon name="arrow-dropdown"></ion-icon>\n                </button>\n            </ion-item>\n            <div *ngIf="filefullname.errors && filefullname.touched" class="error-message">\n              上傳檔案不能為空白\n            </div>\n          </ion-col>\n        </ion-row>\n        <ion-row>\n          <ion-col>\n            <ion-item>\n              <ion-label stacked >Ftp路徑</ion-label>\n              <ion-input type="text"  name="filepath" #filepath="ngModel" [(ngModel)]="ftpDirectory.filepath"\n                required></ion-input>\n                <button ion-button outline item-end  icon-right (click)="get_filepath()">\n                  <ion-icon name="arrow-dropdown"></ion-icon>\n                </button>\n            </ion-item>\n            <div *ngIf="filepath.errors && filepath.touched" class="error-message">\n              Ftp路徑不能為空白\n            </div>\n          </ion-col>\n        </ion-row>\n\n      </form>\n\n</ion-content>\n<ion-footer>\n  <ion-toolbar>\n    <ion-row>\n      <ion-col>\n        <div [ngClass]="[\'command\']">\n          <button small title="取消" *ngIf="navCtrl.canGoBack()" ion-button color="dark" icon-left (click)="close()">\n            <ion-icon name="backspace"></ion-icon>\n          </button>\n          <button small title="確認"  ion-button color="dark" [disabled]="!Form.form.valid" icon-left (click)="Save()">\n            <ion-icon name="checkmark-circle"></ion-icon>\n          </button>\n        </div>\n      </ion-col>\n    </ion-row>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\ftp-file-browser-upload\ftp-file-browser-upload.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_0__providers_ftp_file_browser_services_ftp_file_browser_services__["a" /* FtpFileBrowserServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["j" /* ModalController */]])
    ], FtpFileBrowserUploadPage);
    return FtpFileBrowserUploadPage;
}());

//# sourceMappingURL=ftp-file-browser-upload.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FtpFileBrowserUploadPageModule", function() { return FtpFileBrowserUploadPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ftp_file_browser_upload__ = __webpack_require__(1514);
...
var FtpFileBrowserUploadPageModule = /** @class */ (function () {
    function FtpFileBrowserUploadPageModule() {
    }
    FtpFileBrowserUploadPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__ftp_file_browser_upload__["a" /* FtpFileBrowserUploadPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__ftp_file_browser_upload__["a" /* FtpFileBrowserUploadPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FtpFileBrowserUploadPageModule);
    return FtpFileBrowserUploadPageModule;
}());

//# sourceMappingURL=ftp-file-browser-upload.module.js.map
