...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchByJobSelectModalPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_SchSelectViewModel__ = __webpack_require__(1619);
 ...
 */
var SchByJobSelectModalPage = /** @class */ (function () {
    function SchByJobSelectModalPage(navCtrl, navParams, global, authServices, SchServices, viewCtrl, modalCtrl, ConnServices) {
        ...
        this.totalPages = 1;
        this.totalRows = 0;
        this.ssis_job_no = navParams.data.ssis_job_no;
        this.SchSelect = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_SchSelectViewModel__["a" /* SchSelectViewModel */]();
        this.SchSelect.remote_conn_id = "SBP";
    ...
    SchByJobSelectModalPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    SchByJobSelectModalPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.SchServices.GetSelectListsAsync(_this.pageSize, _this.pageNumber, _this.keyword, _this.ssis_job_no, _this.order_type)
    ...
    SchByJobSelectModalPage.prototype.SelectConn = function () {
        var _this = this;
        var modal = this.modalCtrl.create("ConnSelectModalPage", {
            select_remote_conn_id: this.SchSelect.remote_conn_id,
            conn_type_key: "065|005"
        });
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
            _this.SchSelect.remote_conn_id = select_data.remote_conn_id;
            _this.SchSelect.remote_conn_string = select_data.conn_string;
        });
        modal.present();
    };
    SchByJobSelectModalPage.prototype.get_sbp_conn_string = function (remote_conn_id) {
        var _this = this;
        ...
        this.global.loading.present().then(function () {
            _this.ConnServices.GetConnAsync(remote_conn_id).subscribe(function (data) {
                if (data.DidError === true) {
                    ...
                    _this.SchSelect.remote_conn_string =
    ...
    SchByJobSelectModalPage.prototype.add = function () {
        var data = this.data_list.filter(function (obj) { return obj.checked === true; });
        if (data.length === 0)
            this.global.showError("最少勾選一個");
        else {
            this.SchSelect.Sch = data.slice();
            this.viewCtrl.dismiss(this.SchSelect);
        }
    };
    SchByJobSelectModalPage.prototype.close = function () {
        this.viewCtrl.dismiss();
    };
    SchByJobSelectModalPage.prototype.ionViewDidLoad = function () {
    ...
    SchByJobSelectModalPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_sch_services_sch_services__["a" /* SchServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* ViewController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* ModalController */],
            __WEBPACK_IMPORTED_MODULE_5__providers_conn_services_conn_services__["a" /* ConnServicesProvider */]])
    ], SchByJobSelectModalPage);
    return SchByJobSelectModalPage;
}());

//# sourceMappingURL=sch-by-job-select-modal.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchSelectViewModel; });
var SchSelectViewModel = /** @class */ (function () {
    function SchSelectViewModel() {
    }
    return SchSelectViewModel;
}());

//# sourceMappingURL=SchSelectViewModel.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sch_by_job_select_modal__ = __webpack_require__(1618);
...
var SchByJobSelectModalPageModule = /** @class */ (function () {
    function SchByJobSelectModalPageModule() {
    }
    SchByJobSelectModalPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__sch_by_job_select_modal__["a" /* SchByJobSelectModalPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__sch_by_job_select_modal__["a" /* SchByJobSelectModalPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], SchByJobSelectModalPageModule);
    return SchByJobSelectModalPageModule;
}());

//# sourceMappingURL=sch-by-job-select-modal.module.js.map
