...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FtpFileBrowserDownloadPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_FtpFileBrowserViewModel__ = __webpack_require__(927);
 ...
 */
var FtpFileBrowserDownloadPage = /** @class */ (function () {
    function FtpFileBrowserDownloadPage(navCtrl, navParams, viewCtrl, loadingCtrl, global, FtpFileBrowserServices, modalCtrl) {
        ...
        if (navParams.data.download_file != null)
            this.download_file = navParams.data.download_file;
        else {
            this.download_file = new __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_FtpFileBrowserViewModel__["a" /* FtpFileBrowserViewModel */]();
            this.download_file.filepath = "";
        }
        if (navParams.data.Directory != null)
            this.Directory = navParams.data.Directory;
        else {
            this.Directory = new __WEBPACK_IMPORTED_MODULE_4__Model_ViewModel_DirectoryBrowserViewModel__["a" /* DirectoryBrowserViewModel */]();
            this.Directory.filepath = "";
        }
        this.title = "ftp下載檔案";
    }
    FtpFileBrowserDownloadPage.prototype.get_local_path = function () {
        var _this = this;
        var modal = this.modalCtrl.create("DirectoryBrowserSelectModalPage", {
            parent_path: this.Directory.filepath,
            show_select_type: "D"
        });
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
            _this.Directory = select_data;
        });
        modal.present();
    };
    FtpFileBrowserDownloadPage.prototype.get_download_file = function () {
        var _this = this;
        var modal = this.modalCtrl.create("FtpDirectoryBrowserSelectModalPage", {
            parent_path: this.download_file.filepath,
            show_select_type: "F"
        });
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
            _this.download_file = select_data;
        });
        modal.present();
    };
    FtpFileBrowserDownloadPage.prototype.Save = function () {
        var _this = this;
        this.global.createLoader("下載檔案中...");
        this.global.loading.present().then(function () {
            _this.FtpFileBrowserServices.Download(_this.download_file.filepath, _this.Directory.filepath, _this.download_file.filename, _this.download_file.remote_conn_id, _this.download_file.conn_type_key, _this.download_file.encrypt_method_key).subscribe(function (data) {
                if (data.DidError === true) {
                    ...
                    _this.global.dismissLoading();
                    _this.global.showMessage("下載檔案", data.Message);
                }
            }, function (err) {
                _this.global.dismissLoading();
    ...
    FtpFileBrowserDownloadPage.prototype.close = function () {
        // this.viewCtrl.dismiss();
        this.navCtrl.pop();
    };
    FtpFileBrowserDownloadPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad CodeModalPage");
        this.global.dismissLoading();
    };
    FtpFileBrowserDownloadPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["Component"])({
            selector: "page-ftp-file-browser-download",template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\ftp-file-browser-download\ftp-file-browser-download.html"*/'<ion-header>\n  <headerComponent [title]="\'Ftp下載檔案\'" [permission_id]="\'CanDownloadFtpFileBrowser\'"></headerComponent>\n</ion-header>\n\n<ion-content  padding>\n    <form #Form="ngForm">\n\n        <ion-row>\n          <ion-col>\n            <ion-item>\n              <ion-label stacked >下載路徑</ion-label>\n              <ion-input type="text"  name="filepath" #filepath="ngModel" [(ngModel)]="Directory.filepath"\n                required></ion-input>\n                <button ion-button outline item-end  icon-right (click)="get_local_path()">\n                  <ion-icon name="arrow-dropdown"></ion-icon>\n                </button>\n            </ion-item>\n            <div *ngIf="filepath.errors && filepath.touched" class="error-message">\n              下載路徑不能為空白\n            </div>\n          </ion-col>\n        </ion-row>\n        <ion-row>\n          <ion-col>\n            <ion-item>\n              <ion-label stacked >Ftp檔名</ion-label>\n              <ion-input type="text"  name="filefullname" #filefullname="ngModel" [(ngModel)]="download_file.filefullname"\n                required></ion-input>\n                <button ion-button outline item-end  icon-right (click)="get_download_file()">\n                  <ion-icon name="arrow-dropdown"></ion-icon>\n                </button>\n            </ion-item>\n            <div *ngIf="filefullname.errors && filefullname.touched" class="error-message">\n              Ftp檔名不能為空白\n            </div>\n          </ion-col>\n        </ion-row>\n\n      </form>\n\n</ion-content>\n<ion-footer>\n  <ion-toolbar>\n    <ion-row>\n      <ion-col>\n        <div [ngClass]="[\'command\']">\n          <button small title="取消" *ngIf="navCtrl.canGoBack()" ion-button color="dark" icon-left (click)="close()">\n            <ion-icon name="backspace"></ion-icon>\n          </button>\n          <button small title="確認"  ion-button color="dark" [disabled]="!Form.form.valid" icon-left (click)="Save()">\n            <ion-icon name="checkmark-circle"></ion-icon>\n          </button>\n        </div>\n      </ion-col>\n    </ion-row>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\ftp-file-browser-download\ftp-file-browser-download.html"*/
        }),
    ...
    ], FtpFileBrowserDownloadPage);
    return FtpFileBrowserDownloadPage;
}());

//# sourceMappingURL=ftp-file-browser-download.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FtpFileBrowserDownloadPageModule", function() { return FtpFileBrowserDownloadPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ftp_file_browser_download__ = __webpack_require__(1515);
...
var FtpFileBrowserDownloadPageModule = /** @class */ (function () {
    function FtpFileBrowserDownloadPageModule() {
    }
    FtpFileBrowserDownloadPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__ftp_file_browser_download__["a" /* FtpFileBrowserDownloadPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__ftp_file_browser_download__["a" /* FtpFileBrowserDownloadPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FtpFileBrowserDownloadPageModule);
    return FtpFileBrowserDownloadPageModule;
}());

//# sourceMappingURL=ftp-file-browser-download.module.js.map
