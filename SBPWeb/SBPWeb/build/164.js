...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_user_services_user_services__ = __webpack_require__(273);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_UserViewModel__ = __webpack_require__(50);
...
var UserPage = /** @class */ (function () {
    function UserPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, UserServices, modalCtrl, platform, conf) {
        ...
        this.totalPages = 1;
        this.totalRows = 0;
        this.role_page = "UserRolePage";
        this.permission_page = "UserPermissionPage";
    ...
    UserPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    UserPage.prototype.setPage = function (pageInfo) {
    ...
    UserPage.prototype.onResize = function (event) {
    ...
    UserPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.UserServices.GetListsAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    UserPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_UserViewModel__["a" /* UserViewModel */]();
        }
        else {
            this.mode = "PUT";
        }
        var modal = this.modalCtrl.create("UserAddEditModalPage", {
            mode: this.mode,
            change_mode: change_mode,
            item: item,
            CanEditAuth: this.CanEditAuth,
        });
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.UserServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        if (_this.mode === "POST") {
                            ...
                            var index = _this.data_list.findIndex(function (d) { return d.userName === item.userName; });
    ...
    UserPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.userName),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.UserServices.DeleteAsync(item.userName).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    UserPage.prototype.openNavLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push("LoginLogPage", { item: item });
        });
    };
    UserPage.prototype.openNavRolePage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.role_page, { item: item });
        });
    };
    UserPage.prototype.openNavPermissionPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    UserPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-User",template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\user\User.html"*/'<!--\n  Generated template for the RolePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <headerComponent [title]="\'使用者維護\'" [permission_id]="\'CanAuth\'" [show_table_select]=true></headerComponent>\n</ion-header>\n\n<ion-content (window:resize)="onResize($event)">\n  <ion-row>\n    <ion-col>\n\n      <ion-searchbar [ngClass]="[\'search\']" (keyup.enter)="LoadData(true)" placeholder="搜尋關鍵字(權限編號(開始)、權限名稱(包含)、權限描述(包含))"\n        [(ngModel)]="keyword">\n      </ion-searchbar>\n    </ion-col>\n  </ion-row>\n  <ion-grid *ngIf="conf.mobile_mode==false && selectedItem!=null" [ngClass]="\'bordered\'">\n    <ion-row>\n      <ion-col>\n        <button small title="編輯" ion-button color="light" icon-left (click)="ShowModal(selectedItem,\'detail\')">\n          <ion-icon name="create"></ion-icon>\n        </button>\n        <button small *ngIf="CanEditAuth==true" title="變更密碼" ion-button color="light" icon-left (click)="ShowModal(selectedItem,\'password\')">\n          <ion-icon name="paw"></ion-icon>\n        </button>\n\n        <button small *ngIf="CanEditAuth==true" title="刪除" ion-button color="dark" icon-left (click)="Delete(selectedItem)">\n          <ion-icon name="trash"></ion-icon>\n        </button>\n\n      </ion-col>\n\n\n      <ion-col>\n        <button small title="角色" ion-button color="secondary" icon-left (click)="openNavRolePage(selectedItem)">\n          <ion-icon name="people"></ion-icon>\n        </button>\n        <button small title="權限" ion-button color="primary" icon-left (click)="openNavPermissionPage(selectedItem)">\n          <ion-icon name="checkbox"></ion-icon>\n        </button>\n\n        <button small title="登入紀錄" ion-button color="light" icon-left (click)="openNavLogPage(selectedItem)">\n          <ion-icon name="logo-twitch"></ion-icon>\n        </button>\n\n      </ion-col>\n\n    </ion-row>\n  </ion-grid>\n  <ngx-datatable NgxResizeWatcher class="bootstrap" *ngIf="totalRows>0 && conf.mobile_mode==false" [selected]="selected"\n    [selectionType]="\'single\'" (select)=\'onRowSelect($event)\' [rows]="data_list" [columnMode]="\'flex\'" [headerHeight]="40"\n    [rowHeight]="\'auto\'" [footerHeight]="40" [reorderable]=false [limit]="limit" [count]="totalRows" [offset]="offset"\n    (page)=\'setPage($event)\'>\n\n    <ngx-datatable-column prop="userName" name="使用者" [flexGrow]="1" [frozenLeft]="true">\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="Email" name="Email" [flexGrow]="3" [frozenLeft]="true">\n    </ngx-datatable-column>\n\n\n  </ngx-datatable>\n  <div *ngIf="totalRows>0 && conf.mobile_mode==true">\n    <ion-row>\n\n      <ion-col col-lg-4 col-md-6 col-sm-6 col-12 *ngFor="let item of data_list">\n\n        <ion-grid [ngClass]="[\'bordered\']">\n          <ion-row>\n            <ion-col>\n              <button small title="編輯" ion-button color="light" icon-left (click)="ShowModal(item,\'detail\')">\n                <ion-icon name="create"></ion-icon>\n              </button>\n              <button small *ngIf="CanEditAuth==true" title="變更密碼" ion-button color="light" icon-left (click)="ShowModal(item,\'password\')">\n                <ion-icon name="paw"></ion-icon>\n              </button>\n              <button small *ngIf="CanEditAuth==true" title="刪除" ion-button color="dark" icon-left (click)="Delete(item)">\n                <ion-icon name="trash"></ion-icon>\n              </button>\n            </ion-col>\n          </ion-row>\n          <ion-row>\n              <ion-col>\n\n                <button small title="角色" ion-button color="secondary" icon-left (click)="openNavRolePage(item)">\n                  <ion-icon name="people"></ion-icon>\n                </button>\n                <button small title="權限" ion-button color="primary" icon-left (click)="openNavPermissionPage(item)">\n                  <ion-icon name="checkbox"></ion-icon>\n                </button>\n                <button small title="登入紀錄" ion-button color="light" icon-left (click)="openNavLogPage(item)">\n                    <ion-icon name="logo-twitch"></ion-icon>\n                  </button>\n              </ion-col>\n            </ion-row>\n          <ion-row>\n            <ion-col>\n              {{item.userName}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              {{item.Email}}\n            </ion-col>\n          </ion-row>\n        </ion-grid>\n      </ion-col>\n\n    </ion-row>\n  </div>\n  <ion-infinite-scroll *ngIf="pageNumber < totalPages && conf.mobile_mode==true" (ionInfinite)="$event.waitFor(doInfinite())">\n    <ion-infinite-scroll-content loadingSpinner="bubbles">\n    </ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n\n</ion-content>\n<ion-footer>\n  <ion-toolbar>\n    <ion-row>\n      <ion-col>\n        <div [ngClass]="[\'command\']">\n          <button small title="重新整理" ion-button color="dark" icon-left (click)="LoadData(true)">\n            <ion-checkbox name="order_type" title="遞增/遞減" color="dark" [(ngModel)]="order_type" (ionChange)="LoadData(true)"></ion-checkbox>\n            <ion-icon name="refresh"></ion-icon>\n          </button>\n          <button small *ngIf="CanEditAuth==true" title="新增" ion-button color="dark" icon-left (click)="ShowModal(null,\'password\')">\n            <ion-icon name="add"></ion-icon>\n          </button>\n        </div>\n        <StatusComponent [pageNumber]="pageNumber" [totalPages]="totalPages" [totalRows]="totalRows"></StatusComponent>\n      </ion-col>\n    </ion-row>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\user\User.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_user_services_user_services__["a" /* UserServicesProvider */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__user__ = __webpack_require__(1686);
...
var UserPageModule = /** @class */ (function () {
    ...
    UserPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_user_services_user_services__["a" /* UserServicesProvider */],
            ],
            imports: [
