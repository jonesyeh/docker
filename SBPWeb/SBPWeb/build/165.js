...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UserRolePage; });
 ...
 */
var UserRolePage = /** @class */ (function () {
    function UserRolePage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, UserRoleServices, UserServices, modalCtrl, platform, conf) {
    ...
    UserRolePage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    UserRolePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    UserRolePage.prototype.setPage = function (pageInfo) {
    ...
    UserRolePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    UserRolePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    UserRolePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.UserRoleServices.GetRoleListsAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.userName, _this.order_type)
    ...
    UserRolePage.prototype.Add = function () {
        var _this = this;
        var add_role_list = [];
        var modal = this.modalCtrl.create("UserRoleModalPage", {
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            select_data.forEach(function (element) {
                ...
                ur.userName = _this.userName;
                ur.roleName = element.roleName;
                add_role_list.push(ur);
            });
            _this.global.createLoader();
            _this.global.loading.present().then(function () {
                _this.UserRoleServices.PostListAsync(add_role_list).subscribe(function (data) {
    ...
    UserRolePage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.UserRoleServices.DeleteAsync(_this.userName, item.roleName).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    UserRolePage.prototype.openNavDelPage = function (item) {
        var _this = this;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__user_role__ = __webpack_require__(1684);
...
var UserRolePageModule = /** @class */ (function () {
    function UserRolePageModule() {
    }
    UserRolePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__user_role__["a" /* UserRolePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__user_role__["a" /* UserRolePage */]),
