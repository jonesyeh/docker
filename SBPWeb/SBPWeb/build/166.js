...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UserPermissionPage; });
 ...
 */
var UserPermissionPage = /** @class */ (function () {
    function UserPermissionPage(navCtrl, navParams, loadingCtrl, global, authServices, UserServices, modalCtrl, platform, conf) {
    ...
    UserPermissionPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    UserPermissionPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    UserPermissionPage.prototype.setPage = function (pageInfo) {
    ...
    UserPermissionPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    UserPermissionPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    UserPermissionPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.UserServices.GetAsync(_this.userName)
                ...
                if (data.DidError === true) {
                    ...
                    if (init) {
                        _this.data_list = data.Model.PermissionViewModel;
                        _this.totalRows = data.Model.PermissionViewModel.length;
                    }
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UserPermissionPageModule", function() { return UserPermissionPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__user_permission__ = __webpack_require__(1682);
...
var UserPermissionPageModule = /** @class */ (function () {
    function UserPermissionPageModule() {
    }
    UserPermissionPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__user_permission__["a" /* UserPermissionPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__user_permission__["a" /* UserPermissionPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], UserPermissionPageModule);
    return UserPermissionPageModule;
}());
