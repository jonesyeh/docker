...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UrlManagementPage; });
...
/**
 * Generated class for the UrlManagementPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var UrlManagementPage = /** @class */ (function () {
    function UrlManagementPage(menuCtrl, navCtrl, navParams, global) {
        this.menuCtrl = menuCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.global = global;
        this.title = "Url管理";
        this.menu_no = "UrlManagement";
    }
    UrlManagementPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad UrlManagementPage');
...
var UrlManagementPageModule = /** @class */ (function () {
    function UrlManagementPageModule() {
    }
    UrlManagementPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__url_management__["a" /* UrlManagementPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__url_management__["a" /* UrlManagementPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], UrlManagementPageModule);
    return UrlManagementPageModule;
}());

//# sourceMappingURL=url-management.module.js.map
