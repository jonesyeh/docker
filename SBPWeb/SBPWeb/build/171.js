...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TableColumnExtSelectModalPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_table_detail_ext_services_table_detail_ext_services__ = __webpack_require__(272);
...
/**
 * Generated class for the PermissionTableColumnPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var TableColumnExtSelectModalPage = /** @class */ (function () {
    function TableColumnExtSelectModalPage(navCtrl, navParams, global, authServices, modalCtrl, TableDetailExtServices, viewCtrl, alertCtrl, platform, conf) {
    ...
    TableColumnExtSelectModalPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    TableColumnExtSelectModalPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    TableColumnExtSelectModalPage.prototype.setPage = function (pageInfo) {
    ...
    TableColumnExtSelectModalPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    TableColumnExtSelectModalPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    TableColumnExtSelectModalPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.TableDetailExtServices.GetTableDetailExtListsAsync(_this.pageSize, _this.loadPageNumber, _this.item.schemaname, _this.item.tablename, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    TableColumnExtSelectModalPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_table_detail_ext_services_table_detail_ext_services__["a" /* TableDetailExtServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* ViewController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Platform */],
            __WEBPACK_IMPORTED_MODULE_5__Model_MyAppSharedSettings__["a" /* MyAppSharedSettings */]])
    ], TableColumnExtSelectModalPage);
    return TableColumnExtSelectModalPage;
}());

//# sourceMappingURL=table-column-ext-select-modal.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TableColumnExtSelectModalPageModule", function() { return TableColumnExtSelectModalPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__table_column_ext_select_modal__ = __webpack_require__(1664);
...
var TableColumnExtSelectModalPageModule = /** @class */ (function () {
    function TableColumnExtSelectModalPageModule() {
    }
    TableColumnExtSelectModalPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__table_column_ext_select_modal__["a" /* TableColumnExtSelectModalPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__table_column_ext_select_modal__["a" /* TableColumnExtSelectModalPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], TableColumnExtSelectModalPageModule);
    return TableColumnExtSelectModalPageModule;
}());

//# sourceMappingURL=table-column-ext-select-modal.module.js.map
