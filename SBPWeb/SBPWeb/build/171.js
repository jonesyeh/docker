...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SqlSetPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_sql_services_sql_services__ = __webpack_require__(290);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_SqlViewModel__ = __webpack_require__(144);
 ...
 * Components.
 */
var SqlSetPage = /** @class */ (function () {
    function SqlSetPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, SqlServices, modalCtrl, viewCtrl, platform, conf) {
    ...
    SqlSetPage.prototype.openNavTableLogPage = function (item) {
        var _this = this;
    ...
    SqlSetPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    SqlSetPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    SqlSetPage.prototype.openNavMergeSqlPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    SqlSetPage.prototype.setPage = function (pageInfo) {
    ...
    SqlSetPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    SqlSetPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    SqlSetPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.SqlServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    SqlSetPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_SqlViewModel__["a" /* SqlViewModel */]();
            item.is_active = true;
        ...
        var modal = this.modalCtrl.create("SqlSetAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.SqlServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    SqlSetPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.SqlServices.DeleteAsync(item.exec_table_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    SqlSetPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.SqlServices.GetSqlAsync(item.exec_table_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    SqlSetPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    SqlSetPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_sql_services_sql_services__["a" /* SqlServicesProvider */],
...
//# sourceMappingURL=sql-set.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SqlSetPageModule", function() { return SqlSetPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sql_set__ = __webpack_require__(1644);
...
var SqlSetPageModule = /** @class */ (function () {
    function SqlSetPageModule() {
    }
    SqlSetPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__sql_set__["a" /* SqlSetPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__sql_set__["a" /* SqlSetPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], SqlSetPageModule);
    return SqlSetPageModule;
}());

//# sourceMappingURL=sql-set.module.js.map
