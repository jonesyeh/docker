...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ShowMessagePage; });
 ...
 */
var ShowMessagePage = /** @class */ (function () {
    function ShowMessagePage(navCtrl, navParams, global, viewCtrl) {
        ...
        this.error = navParams.data.error;
        if (this.error === true) {
            if (this.message === "TimeOut") {
                this.time_out = true;
                this.title = "逾時";
                this.message = "登入逾時，請重新登入";
                this.global.timeout();
            }
            this.title_class = "error-message";
        }
        else {
            this.title_class = "title";
        }
    }
    ShowMessagePage.prototype.close = function () {
        this.viewCtrl.dismiss();
    };
    ShowMessagePage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad ShowMessagePage');
    };
    ShowMessagePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-show-message',template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\show-message\show-message.html"*/'<ion-header>\n\n    <ion-navbar>\n\n      <ion-title> <div [ngClass]="title_class">{{title}}</div> </ion-title>\n    </ion-navbar>\n  </ion-header>\n\n  <ion-content padding>\n      <ion-textarea autosize  [(ngModel)]="message" >\n\n        </ion-textarea>\n\n  </ion-content>\n  <ion-footer>\n    <ion-toolbar>\n      <ion-row>\n        <ion-col>\n          <div [ngClass]="[\'command\']">\n            <button small title="關閉" ion-button color="dark" icon-left (click)="close()">\n              <ion-icon name="backspace"></ion-icon>\n            </button>\n\n            <button small title="複製到剪貼簿" ion-button color="dark" icon-left (click)="global.copyTextToClipboard(message)">\n                <ion-icon name="copy"></ion-icon>\n              </button>\n\n          </div>\n        </ion-col>\n      </ion-row>\n    </ion-toolbar>\n  </ion-footer>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\show-message\show-message.html"*/,
        }),
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShowMessagePageModule", function() { return ShowMessagePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__show_message__ = __webpack_require__(1636);
...
var ShowMessagePageModule = /** @class */ (function () {
    function ShowMessagePageModule() {
    }
    ShowMessagePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__show_message__["a" /* ShowMessagePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__show_message__["a" /* ShowMessagePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], ShowMessagePageModule);
    return ShowMessagePageModule;
}());

//# sourceMappingURL=show-message.module.js.map
