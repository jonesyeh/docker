...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchByJobPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Model_ViewModel_SchViewModel__ = __webpack_require__(145);
 ...
 */
var SchByJobPage = /** @class */ (function () {
    function SchByJobPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, JobSchServices, modalCtrl, platform, conf) {
        ...
        this.totalRows = 0;
        this.src_type = "作業";
        this.ssis_job_no = navParams.data.item.ssis_job_no;
        this.src_type = navParams.data.item.src_type;
        ...
        if (this.authServices.authenticated() === true) {
            ...
            this.CanEditSch = this.authServices.CanEditSch();
            this.CanViewLog = this.authServices.CanViewLog();
            this.LoadData(true);
        }
    }
    SchByJobPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit === Math.floor(this.pageSize / 3);
    };
    SchByJobPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
        console.log("Select Event", selected, this.selected);
    };
    SchByJobPage.prototype.setPage = function (pageInfo) {
    ...
    SchByJobPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    SchByJobPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    SchByJobPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.JobSchServices.GetSchListsAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.ssis_job_no, _this.order_type).subscribe(function (data) {
    ...
    SchByJobPage.prototype.Add = function () {
        var _this = this;
        var add_JobSch_list = [];
        var modal = this.modalCtrl.create("SchByJobSelectModalPage", {
            ssis_job_no: this.ssis_job_no
        });
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
            select_data.Sch.forEach(function (element) {
                var item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_JobSchViewModel__["a" /* JobSchViewModel */]();
                item.sch_no = element.sch_no;
                item.sch_name = element.sch_name;
                item.ssis_job_no = _this.ssis_job_no;
                item.remote_conn_id = select_data.remote_conn_id;
                item.remote_conn_string = select_data.remote_conn_string;
                var t = new __WEBPACK_IMPORTED_MODULE_7__Model_ViewModel_SchViewModel__["a" /* SchViewModel */]();
                {
                    t.sch_no = element.sch_no;
                    t.sch_name = element.sch_name;
                    t.sch_description = element.sch_description;
                }
                item.SchViewModel = t;
            ...
            _this.global.loading.present().then(function () {
                _this.JobSchServices.PostListAsync(add_JobSch_list).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("加入排程", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    SchByJobPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.SchViewModel.sch_name),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.JobSchServices.DeleteAsync(_this.ssis_job_no, item.sch_no).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    SchByJobPage.prototype.openNavPage = function (item, page) {
        var _this = this;
...
//# sourceMappingURL=sch-by-job.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SchByJobPageModule", function() { return SchByJobPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sch_by_job__ = __webpack_require__(1613);
...
var SchByJobPageModule = /** @class */ (function () {
    function SchByJobPageModule() {
    }
    SchByJobPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__sch_by_job__["a" /* SchByJobPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__sch_by_job__["a" /* SchByJobPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], SchByJobPageModule);
    return SchByJobPageModule;
}());

//# sourceMappingURL=sch-by-job.module.js.map
