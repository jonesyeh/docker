...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RoleUserPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Model_ViewModel_UserRoleViewModel__ = __webpack_require__(137);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_user_role_services_user_role_services__ = __webpack_require__(295);
 ...
 */
var RoleUserPage = /** @class */ (function () {
    function RoleUserPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, UserRoleServices, UserServices, modalCtrl, platform, conf) {
    ...
    RoleUserPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    RoleUserPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    RoleUserPage.prototype.setPage = function (pageInfo) {
    ...
    RoleUserPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    RoleUserPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    RoleUserPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.UserRoleServices.GetUserListsAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.roleName, _this.order_type)
    ...
    RoleUserPage.prototype.Add = function () {
        var _this = this;
        var add_user_list = [];
        var modal = this.modalCtrl.create("RoleUserSelectModalPage", {
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            select_data.forEach(function (element) {
                var ur = new __WEBPACK_IMPORTED_MODULE_0__Model_ViewModel_UserRoleViewModel__["a" /* UserRoleViewModel */]();
                ur.userName = element.userName;
                ur.roleName = _this.roleName;
                add_user_list.push(ur);
            });
            _this.global.createLoader();
            _this.global.loading.present().then(function () {
                _this.UserRoleServices.PostListAsync(add_user_list).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("加入成員", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    RoleUserPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_6__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.userName),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.UserRoleServices.DeleteAsync(item.userName, _this.roleName).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    RoleUserPage.prototype.openNavDelPage = function (item) {
        var _this = this;
    ...
    RoleUserPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_5__providers_user_role_services_user_role_services__["a" /* UserRoleServicesProvider */],
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RoleUserPageModule", function() { return RoleUserPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__role_user__ = __webpack_require__(1611);
...
var RoleUserPageModule = /** @class */ (function () {
    function RoleUserPageModule() {
    }
    RoleUserPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__role_user__["a" /* RoleUserPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__role_user__["a" /* RoleUserPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], RoleUserPageModule);
    return RoleUserPageModule;
}());

//# sourceMappingURL=role-user.module.js.map
