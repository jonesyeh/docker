...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RoleUserSelectModalPage; });
 ...
 */
var RoleUserSelectModalPage = /** @class */ (function () {
    function RoleUserSelectModalPage(navCtrl, navParams, global, authServices, UserServices, viewCtrl) {
    ...
    RoleUserSelectModalPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    RoleUserSelectModalPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.UserServices.GetAddSelectListsAsync(_this.pageSize, _this.pageNumber, _this.keyword, _this.roleName, _this.order_type)
    ...
    RoleUserSelectModalPage.prototype.add = function () {
    ...
    RoleUserSelectModalPage.prototype.close = function () {
        this.viewCtrl.dismiss();
    };
    RoleUserSelectModalPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad RoleUserModalPage");
    };
    RoleUserSelectModalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-role-user-select-modal",template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\role-user-select-modal\role-user-select-modal.html"*/'\n<ion-header>\n  <ion-title>勾選使用者加入角色</ion-title>\n</ion-header>\n<ion-content>\n  <ion-row>\n    <ion-col>\n\n      <ion-searchbar [ngClass]="[\'search\']" (keyup.enter)="LoadData(true)" placeholder="使用者包含"\n        [(ngModel)]="keyword">\n      </ion-searchbar>\n\n    </ion-col>\n  </ion-row>\n  <div *ngIf="data_list">\n    <ion-row>\n\n      <ion-col col-lg-4 col-md-6 col-sm-6 col-12 *ngFor="let item of data_list">\n\n        <ion-grid [ngClass]="[\'bordered\']">\n\n          <ion-row>\n            <ion-col>\n            <ion-checkbox checked="false" [(ngModel)]="item.checked"></ion-checkbox> {{item.userName}}\n            </ion-col>\n\n          </ion-row>\n\n        </ion-grid>\n      </ion-col>\n\n    </ion-row>\n  </div>\n  <ion-infinite-scroll *ngIf="pageNumber < totalPages" (ionInfinite)="$event.waitFor(doInfinite())">\n    <ion-infinite-scroll-content loadingSpinner="bubbles">\n    </ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n</ion-content>\n<ion-footer>\n  <ion-toolbar>\n    <ion-row>\n      <ion-col>\n          <div [ngClass]="[\'command\']">\n            <button small title="重新整理" ion-button color="dark" icon-left (click)="LoadData(true)">\n              <ion-checkbox name="order_type" title="遞增/遞減" color="dark" [(ngModel)]="order_type" (ionChange)="LoadData(true)" ></ion-checkbox>\n               <ion-icon name="refresh"></ion-icon>\n            </button>\n        <button small title="取消" ion-button color="dark" icon-left (click)="close()">\n          <ion-icon name="backspace"></ion-icon>\n        </button>\n        <button small title="加入" ion-button color="dark" icon-left (click)="add()">\n          <ion-icon name="checkmark-circle"></ion-icon>\n        </button>\n        </div>\n        <StatusComponent [pageNumber]="pageNumber" [totalPages]="totalPages" [totalRows]="totalRows"></StatusComponent>\n\n      </ion-col>\n    </ion-row>\n  </ion-toolbar>\n</ion-footer>\n\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\role-user-select-modal\role-user-select-modal.html"*/
        }),
    ...
    ], RoleUserSelectModalPage);
    return RoleUserSelectModalPage;
}());

//# sourceMappingURL=role-user-select-modal.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RoleUserSelectModalPageModule", function() { return RoleUserSelectModalPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__role_user_select_modal__ = __webpack_require__(1608);
...
var RoleUserSelectModalPageModule = /** @class */ (function () {
    function RoleUserSelectModalPageModule() {
    }
    RoleUserSelectModalPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__role_user_select_modal__["a" /* RoleUserSelectModalPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__role_user_select_modal__["a" /* RoleUserSelectModalPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], RoleUserSelectModalPageModule);
    return RoleUserSelectModalPageModule;
}());

//# sourceMappingURL=role-user-select-modal.module.js.map
