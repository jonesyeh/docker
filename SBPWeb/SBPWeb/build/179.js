...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RolePermissionPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Model_ViewModel_RolePermissionViewModel__ = __webpack_require__(142);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_role_permission_services_role_permission_services__ = __webpack_require__(294);
...
/**
 * Generated class for the RolePermissionPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var RolePermissionPage = /** @class */ (function () {
    function RolePermissionPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, RolePermissionServices, UserServices, modalCtrl, platform, conf) {
        ...
        this.totalPages = 1;
        this.totalRows = 0;
        this.RoleName = navParams.data.item.roleName;
        this.title = navParams.data.item.roleName;
    ...
    RolePermissionPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    RolePermissionPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    RolePermissionPage.prototype.setPage = function (pageInfo) {
    ...
    RolePermissionPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    RolePermissionPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    RolePermissionPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.RolePermissionServices.GetPermissionListsAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.RoleName, _this.order_type)
    ...
    RolePermissionPage.prototype.Add = function () {
        var _this = this;
        var add_permission_list = [];
        var modal = this.modalCtrl.create("RolePermissionSelectModalPage", {
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            select_data.forEach(function (element) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__Model_ViewModel_RolePermissionViewModel__["a" /* RolePermissionViewModel */]();
                item.permission_no = element.permission_no;
                item.RoleName = _this.RoleName;
            ...
            _this.global.loading.present().then(function () {
                _this.RolePermissionServices.PostListAsync(add_permission_list).subscribe(function (data) {
    ...
    RolePermissionPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.RolePermissionServices.DeleteAsync(_this.RoleName, item.permission_no).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    RolePermissionPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_5__providers_role_permission_services_role_permission_services__["a" /* RolePermissionServicesProvider */],
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RolePermissionPageModule", function() { return RolePermissionPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__role_permission__ = __webpack_require__(1609);
...
var RolePermissionPageModule = /** @class */ (function () {
    function RolePermissionPageModule() {
    }
    RolePermissionPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__role_permission__["a" /* RolePermissionPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__role_permission__["a" /* RolePermissionPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], RolePermissionPageModule);
    return RolePermissionPageModule;
}());
