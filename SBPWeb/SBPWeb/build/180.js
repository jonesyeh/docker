...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return QuoteColumnPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_quote_column_services_quote_column_services__ = __webpack_require__(299);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_QuoteColumnViewModel__ = __webpack_require__(143);
...
var QuoteColumnPage = /** @class */ (function () {
    function QuoteColumnPage(menuCtrl, navCtrl, navParams, QuoteColumnServices, loadingCtrl, global, authServices, modalCtrl, alertCtrl, platform, conf) {
        this.menuCtrl = menuCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.QuoteColumnServices = QuoteColumnServices;
        ...
        this.CanQuoteColumnExec = true;
        this.detail_page = "QuoteColumnDetailPage";
        this.CheckType_page = "QuoteColumnTypeDetailPage";
    ...
    QuoteColumnPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    QuoteColumnPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    QuoteColumnPage.prototype.setPage = function (pageInfo) {
    ...
    QuoteColumnPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    QuoteColumnPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    QuoteColumnPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.QuoteColumnServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.schemaname, _this.tablename, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    QuoteColumnPage.prototype.openNavDetailsPage = function (item) {
        var _this = this;
    ...
    QuoteColumnPage.prototype.openNavSqlPage = function (item, method, is_exec) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.QuoteColumnServices.GetSqlAsync(item.schemaname, item.tablename, item.columnname, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    QuoteColumnPage.prototype.ShowModal = function (item) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_QuoteColumnViewModel__["a" /* QuoteColumnViewModel */]();
        ...
        var modal = this.modalCtrl.create("QuoteColumnAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.QuoteColumnServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("雙引號", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    QuoteColumnPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.QuoteColumnServices.DeleteAsync(item.schemaname, item.tablename, item.columnname).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    QuoteColumnPage.prototype.openNavCheckTypePage = function (check_type) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    return QuoteColumnPage;
}());

//# sourceMappingURL=quote-column.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QuoteColumnPageModule", function() { return QuoteColumnPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__quote_column__ = __webpack_require__(1606);
...
var QuoteColumnPageModule = /** @class */ (function () {
    function QuoteColumnPageModule() {
    }
    QuoteColumnPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__quote_column__["a" /* QuoteColumnPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__quote_column__["a" /* QuoteColumnPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], QuoteColumnPageModule);
    return QuoteColumnPageModule;
}());

//# sourceMappingURL=quote-column.module.js.map
