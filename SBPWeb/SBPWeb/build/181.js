...
var ProgramDetailPage = /** @class */ (function () {
    function ProgramDetailPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, ProgramPageServices, modalCtrl, platform, conf) {
        ...
        if (this.authServices.authenticated() === true) {
            ...
            this.menu_page = "MenuByProgramDetailPage";
            this.LoadData(true);
        }
    }
    ProgramDetailPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    ProgramDetailPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    ProgramDetailPage.prototype.setPage = function (pageInfo) {
    ...
    ProgramDetailPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    ProgramDetailPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    ProgramDetailPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.ProgramPageServices.GetListsAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    ProgramDetailPage.prototype.ShowModal = function (item) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
        ...
        var modal = this.modalCtrl.create("ProgramDetailAddEditModalPage", {
            mode: this.mode,
            item: item,
    ...
    ProgramDetailPage.prototype.Delete = function (item) {
        var _this = this;
    ...
    ProgramDetailPage.prototype.openNavMenuPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.menu_page, { item: item });
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__program_detail__ = __webpack_require__(1601);
...
var ProgramDetailPageModule = /** @class */ (function () {
    ...
    ProgramDetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__program_detail__["a" /* ProgramDetailPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__program_detail__["a" /* ProgramDetailPage */]),
