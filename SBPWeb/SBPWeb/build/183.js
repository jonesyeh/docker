...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProgramDetailByIonicProgramPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_program_page_services_program_page_services__ = __webpack_require__(284);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ProgramPageViewModel__ = __webpack_require__(48);
...
/**
 * Generated class for the ProgramPagePage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var ProgramDetailByIonicProgramPage = /** @class */ (function () {
    function ProgramDetailByIonicProgramPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, ProgramPageServices, modalCtrl, platform, conf) {
        ...
        this.ProgramPageServices = ProgramPageServices;
    ...
    ProgramDetailByIonicProgramPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    ProgramDetailByIonicProgramPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    ProgramDetailByIonicProgramPage.prototype.setPage = function (pageInfo) {
    ...
    ProgramDetailByIonicProgramPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    ProgramDetailByIonicProgramPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    ProgramDetailByIonicProgramPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.ProgramPageServices.GetPageListsAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.program_no, _this.order_type).subscribe(function (data) {
    ...
    ProgramDetailByIonicProgramPage.prototype.ShowModal = function (item) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ProgramPageViewModel__["a" /* ProgramPageViewModel */]();
            item.program_no = this.program_no;
        }
        else {
            this.mode = "PUT";
        }
        var modal = this.modalCtrl.create("IonicProgramDetailAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.ProgramPageServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        if (_this.mode === "POST") {
                            _this.data_list.push(data.Model);
                            _this.totalRows += 1;
                        }
                        else {
                            var index = _this.data_list.findIndex(function (d) { return d.page_name === item.page_name; });
    ...
    ProgramDetailByIonicProgramPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.page_name),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.ProgramPageServices.DeleteAsync(item.page_name).subscribe(function (data) {
                                _this.global.dismissLoading();
                                if (data.DidError === false) {
                                    var index = _this.data_list.findIndex(function (d) { return d.page_name === item.page_name; });
    ...
    ProgramDetailByIonicProgramPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_program_page_services_program_page_services__["a" /* ProgramPageServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* ModalController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Platform */],
            __WEBPACK_IMPORTED_MODULE_7__Model_MyAppSharedSettings__["a" /* MyAppSharedSettings */]])
    ], ProgramDetailByIonicProgramPage);
    return ProgramDetailByIonicProgramPage;
}());

//# sourceMappingURL=program-detail-by-ionic-program.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProgramDetailByIonicProgramPageModule", function() { return ProgramDetailByIonicProgramPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__program_detail_by_ionic_program__ = __webpack_require__(1607);
...
var ProgramDetailByIonicProgramPageModule = /** @class */ (function () {
    function ProgramDetailByIonicProgramPageModule() {
    }
    ProgramDetailByIonicProgramPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__program_detail_by_ionic_program__["a" /* ProgramDetailByIonicProgramPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__program_detail_by_ionic_program__["a" /* ProgramDetailByIonicProgramPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], ProgramDetailByIonicProgramPageModule);
    return ProgramDetailByIonicProgramPageModule;
}());

//# sourceMappingURL=program-detail-by-ionic-program.module.js.map
