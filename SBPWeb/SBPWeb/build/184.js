...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_prog_services_prog_services__ = __webpack_require__(277);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_ProgViewModel__ = __webpack_require__(146);
...
var ProgPage = /** @class */ (function () {
    function ProgPage(menuCtrl, navCtrl, navParams, ProgServices, loadingCtrl, global, authServices, modalCtrl, alertCtrl, platform, conf) {
        ...
        this.CanProgExec = true;
        this.detail_page = "ProgDetailPage";
        this.CheckType_page = "ProgTypeDetailPage";
        ...
        if (navParams.data.item) {
            ...
            this.title =
                navParams.data.item.schemaname + "." + navParams.data.item.name;
            this.schemaname = navParams.data.item.schemaname;
            this.name = navParams.data.item.name;
            this.type = navParams.data.item.type;
        }
        else {
            this.title = "程式物件";
            this.schemaname = "";
    ...
    ProgPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    ProgPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    ProgPage.prototype.setPage = function (pageInfo) {
    ...
    ProgPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    ProgPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    ProgPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.ProgServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.schemaname, _this.name, _this.type, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    ProgPage.prototype.openNavSqlPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.ProgServices.GetSqlAsync(item.schemaname, item.name).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    ProgPage.prototype.ShowModal = function (item) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_ProgViewModel__["a" /* ProgViewModel */]();
        ...
        var modal = this.modalCtrl.create("ProgAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.ProgServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("程式物件", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    ProgPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_6__Model_String__["a" /* String */].Format("確認要刪除{0}.{1}嗎?", item.schemaname, item.name),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.ProgServices.DeleteAsync(item.schemaname, item.name).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    ProgPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad Prog");
    };
    ProgPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-prog",template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\prog\prog.html"*/'<ion-header>\n  <headerComponent [title]="\'程式物件\'" [permission_id]="\'CanTable\'" [show_table_select]=true></headerComponent>\n\n</ion-header>\n<ion-content>\n  <ion-row>\n    <ion-col col-12 col-sm-6>\n\n      <ion-searchbar [ngClass]="[\'search\']" (keyup.enter)="LoadData(true)" placeholder="結構描述" [(ngModel)]="schemaname">\n      </ion-searchbar>\n\n\n    </ion-col>\n    <ion-col col-12 col-sm-6>\n\n      <ion-select [ngClass]="[\'search\']" item-end [(ngModel)]="type" placeholder="程式物件類別" (ionChange)="LoadData(true)">\n        <ion-option value="U">Table</ion-option>\n        <ion-option value="V">VIEW</ion-option>\n        <ion-option value="P ">SQL_STORED_PROCEDURE</ion-option>\n        <ion-option value="TF">SQL_TABLE_VALUED_FUNCTION</ion-option>\n        <ion-option value="IF">SQL_INLINE_TABLE_VALUED_FUNCTION</ion-option>\n        <ion-option value="FN">SQL_SCALAR_FUNCTION</ion-option>\n        <ion-option value="TR">SQL_TRIGGER</ion-option>\n      </ion-select>\n\n    </ion-col>\n  </ion-row>\n  <ion-row>\n    <ion-col col-12 col-sm-6>\n\n      <ion-searchbar [ngClass]="[\'search\']" (keyup.enter)="LoadData(true)" placeholder="物件名稱" [(ngModel)]="name">\n      </ion-searchbar>\n\n    </ion-col>\n    <ion-col col-12 col-sm-6>\n\n      <ion-searchbar [ngClass]="[\'search\']" (keyup.enter)="LoadData(true)" placeholder="搜尋關鍵字(程式語法)" [(ngModel)]="keyword">\n      </ion-searchbar>\n\n    </ion-col>\n  </ion-row>\n  <ion-grid *ngIf="conf.mobile_mode==false && selectedItem!=null" [ngClass]="\'bordered\'">\n    <ion-row>\n      <ion-col>\n        <button small title="程式語法" ion-button color="light" icon-left (click)="openNavSqlPage(selectedItem)">\n          <ion-icon name="expand"></ion-icon>\n        </button>\n      </ion-col>\n\n    </ion-row>\n  </ion-grid>\n  <ngx-datatable NgxResizeWatcher class="bootstrap" *ngIf="totalRows>0 && conf.mobile_mode==false" [selected]="selected" [selectionType]="\'single\'"\n    (select)=\'onRowSelect($event)\' [rows]="data_list" [columnMode]="\'flex\'" [headerHeight]="40" [rowHeight]="\'auto\'"\n    [footerHeight]="40" [reorderable]=false [limit]="limit" [count]="totalRows" [offset]="offset" (page)=\'setPage($event)\'>\n\n    <ngx-datatable-column prop="category" name="類別" [flexGrow]="1" [frozenLeft]="true">\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="type_desc" name="程式物件類別" [flexGrow]="2">\n    </ngx-datatable-column>\n\n    <ngx-datatable-column prop="fullname" name="物件名稱" [flexGrow]="2">\n    </ngx-datatable-column>\n\n\n\n    <ngx-datatable-column prop="object_desc" name="物件說明" [flexGrow]="3" *ngIf="innerWidth>=1024">\n    </ngx-datatable-column>\n\n    <ngx-datatable-column prop="create_date" name="建立時間" [flexGrow]="2" >\n      <ng-template let-value="value" ngx-datatable-cell-template>\n        <div *ngIf="platform.is(\'ios\')==true">\n          {{value | date:\'y/MM/dd HH:mm:ss \'}}\n        </div>\n        <div *ngIf="platform.is(\'ios\')!=true">\n          {{value | date:\'y/MM/dd HH:mm:ss\'}}\n        </div>\n      </ng-template>\n\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="modify_date" name="更新時間" [flexGrow]="2" >\n      <ng-template let-value="value" ngx-datatable-cell-template>\n        <div *ngIf="platform.is(\'ios\')==true">\n          {{value | date:\'y/MM/dd HH:mm:ss \'}}\n        </div>\n        <div *ngIf="platform.is(\'ios\')!=true">\n          {{value | date:\'y/MM/dd HH:mm:ss\'}}\n        </div>\n      </ng-template>\n\n    </ngx-datatable-column>\n  </ngx-datatable>\n  <div *ngIf="totalRows>0 && conf.mobile_mode==true">\n    <ion-row>\n      <ion-col col-lg-4 col-md-6 col-sm-6 col-12 *ngFor="let item of data_list">\n        <ion-grid [ngClass]="[\'bordered\']">\n          <ion-row>\n            <ion-col>\n              <button small title="程式語法" ion-button color="secondary" icon-left (click)="openNavSqlPage(item)">\n                <ion-icon name="albums"></ion-icon>\n              </button>\n\n            </ion-col>\n          </ion-row>\n\n          <ion-row>\n            <ion-col>\n              {{item.category}}\n            </ion-col>\n            <ion-col>\n              {{item.type_desc}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col col-6 col-xl-8>\n              {{item.fullname}}\n\n            </ion-col>\n            <ion-col col-6 col-xl-4 align-self-end>\n              <div title="建立時間" *ngIf="platform.is(\'ios\')==true" text-right>\n                {{item.create_date | date:\'y/MM/dd HH:mm:ss \'}}\n              </div>\n              <div title="建立時間" *ngIf="platform.is(\'ios\')!=true" text-right>\n                {{item.create_date | date:\'y/MM/dd HH:mm:ss\'}}\n              </div>\n            </ion-col>\n\n          </ion-row>\n          <ion-row>\n            <ion-col col-6 col-xl-8>\n              {{item.object_desc}}\n            </ion-col>\n            <ion-col col-6 col-xl-4 align-self-end>\n              <div title="更新時間" *ngIf="platform.is(\'ios\')==true" text-right>\n                {{item.modify_date | date:\'y/MM/dd HH:mm:ss \'}}\n              </div>\n              <div title="更新時間" *ngIf="platform.is(\'ios\')!=true" text-right>\n                {{item.modify_date | date:\'y/MM/dd HH:mm:ss\'}}\n              </div>\n            </ion-col>\n          </ion-row>\n\n        </ion-grid>\n      </ion-col>\n    </ion-row>\n  </div>\n  <ion-infinite-scroll *ngIf="pageNumber < totalPages" (ionInfinite)="$event.waitFor(doInfinite())">\n    <ion-infinite-scroll-content loadingSpinner="bubbles">\n    </ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n</ion-content>\n<ion-footer>\n  <ion-toolbar>\n    <ion-row>\n      <ion-col>\n        <div [ngClass]="[\'command\']">\n          <button small title="重新整理" ion-button color="dark" icon-left (click)="LoadData(true)">\n            <ion-checkbox name="order_type" title="遞增/遞減" color="dark" [(ngModel)]="order_type" (ionChange)="LoadData(true)"></ion-checkbox>\n            <ion-icon name="refresh"></ion-icon>\n          </button>\n        </div>\n        <StatusComponent [pageNumber]="pageNumber" [totalPages]="totalPages" [totalRows]="totalRows"></StatusComponent>\n      </ion-col>\n\n    </ion-row>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\prog\prog.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* MenuController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__providers_prog_services_prog_services__["a" /* ProgServicesProvider */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__prog__ = __webpack_require__(1598);
...
var ProgPageModule = /** @class */ (function () {
