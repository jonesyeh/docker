...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PermissionRolePage; });
 ...
 */
var PermissionRolePage = /** @class */ (function () {
    function PermissionRolePage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, RolePermissionServices, UserServices, modalCtrl, platform, conf) {
    ...
    PermissionRolePage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    PermissionRolePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    PermissionRolePage.prototype.setPage = function (pageInfo) {
    ...
    PermissionRolePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    PermissionRolePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    PermissionRolePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.RolePermissionServices.GetRoleListsAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.permission_no, _this.order_type)
    ...
    PermissionRolePage.prototype.Add = function () {
        var _this = this;
        var add_role_list = [];
        var modal = this.modalCtrl.create("PermissionRoleSelectModalPage", {
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            select_data.forEach(function (element) {
                ...
                add_role_list.push(item);
            });
            _this.global.createLoader();
            _this.global.loading.present().then(function () {
                _this.RolePermissionServices.PostListAsync(add_role_list).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("加入角色", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    PermissionRolePage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_6__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.RoleName),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.RolePermissionServices.DeleteAsync(item.RoleName, _this.permission_no).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    PermissionRolePage.prototype.openNavDelPage = function (item) {
        var _this = this;
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PermissionRolePageModule", function() { return PermissionRolePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__permission_role__ = __webpack_require__(1595);
...
var PermissionRolePageModule = /** @class */ (function () {
    function PermissionRolePageModule() {
    }
    PermissionRolePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__permission_role__["a" /* PermissionRolePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__permission_role__["a" /* PermissionRolePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], PermissionRolePageModule);
    return PermissionRolePageModule;
}());

//# sourceMappingURL=permission-role.module.js.map
