...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MergeSqlPage; });
...
/**
 * Generated class for the MergeSqlPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var MergeSqlPage = /** @class */ (function () {
    function MergeSqlPage(navCtrl, navParams, TableExtServices, loadingCtrl, global, authServices, modalCtrl, element) {
        ...
        this.import_mode_key = "042|M";
        this.LoadData(true);
    }
    MergeSqlPage.prototype.LoadData = function (init) {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.TableExtServices.GetMergeSqlAsync(_this.item.schemaname, _this.item.tablename, _this.import_mode_key)
    ...
    MergeSqlPage.prototype.SelectMode = function () {
        var _this = this;
        var modal = this.modalCtrl.create("CodeSelectModalPage", {
            select_key: this.import_mode_key,
            code_type: "002,042",
            code_key: "",
            title: "執行方法",
        });
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
            _this.import_mode_key = select_data.code_key;
            _this.LoadData(true);
        });
        modal.present();
    };
    MergeSqlPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad MergeSqlPage');
    };
    MergeSqlPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-merge-sql',template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\merge-sql\merge-sql.html"*/'<!--\n  Generated template for the SqlPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n    <headerComponent [title]="title" [permission_id]="\'CanTable\'"></headerComponent>\n\n  </ion-header>\n\n\n  <ion-content padding>\n      <ion-row>\n\n          <ion-col >\n\n              <ion-item>\n                  <ion-label> 執行方法</ion-label>\n                  <ion-input type="text" (keyup.enter)="LoadData(true)"  [(ngModel)]="import_mode_key" required></ion-input>\n\n                  <button ion-button outline item-end icon-left (click)="SelectMode()">\n                      <ion-icon name="arrow-dropdown"></ion-icon>\n                      選取\n                    </button>\n                </ion-item>\n\n          </ion-col>\n        </ion-row>\n    <ion-item>\n          <ion-textarea autosize  [ngModel]="sql" name="sql" >\n        </ion-textarea>\n      </ion-item>\n\n  </ion-content>\n  <ion-footer>\n    <ion-toolbar>\n      <ion-row>\n        <ion-col>\n          <div [ngClass]="[\'command\']">\n\n            <button small title="複製SQL語法" ion-button color="dark" icon-left (click)="global.copyTextToClipboard(sql)">\n              <ion-icon name="copy"></ion-icon>\n            </button>\n\n          </div>\n        </ion-col>\n      </ion-row>\n\n    </ion-toolbar>\n  </ion-footer>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\merge-sql\merge-sql.html"*/,
        }),
...
//# sourceMappingURL=merge-sql.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MergeSqlPageModule", function() { return MergeSqlPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__merge_sql__ = __webpack_require__(1582);
...
var MergeSqlPageModule = /** @class */ (function () {
    function MergeSqlPageModule() {
    }
    MergeSqlPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__merge_sql__["a" /* MergeSqlPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__merge_sql__["a" /* MergeSqlPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], MergeSqlPageModule);
    return MergeSqlPageModule;
}());

//# sourceMappingURL=merge-sql.module.js.map
