...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MenuDetailPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_program_page_menu_services_program_page_menu_services__ = __webpack_require__(293);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__Model_ViewModel_ProgramPageViewModel__ = __webpack_require__(48);
...
/**
 * Generated class for the ProgramPageMenuPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var MenuDetailPage = /** @class */ (function () {
    function MenuDetailPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, ProgramPageMenuServices, UserServices, modalCtrl, platform, conf) {
        ...
        this.ProgramPageMenuServices = ProgramPageMenuServices;
        ...
        this.totalPages = 1;
        this.totalRows = 0;
        this.max_display_order_no = 0;
        this.menu_no = navParams.data.item.menu_no;
        this.title = navParams.data.item.menu_desc;
    ...
    MenuDetailPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    MenuDetailPage.prototype.setPage = function (pageInfo) {
    ...
    MenuDetailPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    MenuDetailPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    MenuDetailPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.ProgramPageMenuServices.GetPageListsAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.menu_no, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    ...
                    if (init) {
                        ...
                        _this.set_max_display_order_no();
                    }
                    else
    ...
    MenuDetailPage.prototype.Add = function () {
        var _this = this;
        var add_page_list = [];
        var modal = this.modalCtrl.create("MenuDetailSelectModalPage", {
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            select_data.forEach(function (element) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__Model_ViewModel_ProgramPageMenuViewModel__["a" /* ProgramPageMenuViewModel */]();
                item.page_name = element.page_name;
                item.menu_no = _this.menu_no;
                _this.max_display_order_no += 1;
                item.display_order_no = _this.max_display_order_no;
                var t = new __WEBPACK_IMPORTED_MODULE_8__Model_ViewModel_ProgramPageViewModel__["a" /* ProgramPageViewModel */]();
                {
                    t.page_name = element.page_name;
                    t.page_desc = element.page_desc;
                    t.program_no = element.program_no;
                }
                item.ProgramPageViewModel = t;
                add_page_list.push(item);
                // this.LoadData(true);
            });
            _this.global.createLoader();
            _this.global.loading.present().then(function () {
                _this.ProgramPageMenuServices.PostListAsync(add_page_list).subscribe(function (data) {
                    if (data.DidError === false) {
                        // add_page_list.forEach(element => {
                        //   this.data_list.push(element);
                        //   this.totalRows += 1;
                        // });
                        // this.global.dismissLoading();
                        _this.LoadData(true);
                        _this.global.showPopup("加入功能", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    MenuDetailPage.prototype.set_max_display_order_no = function () {
        var _this = this;
        this.max_display_order_no = 0;
        this.data_list.forEach(function (element) {
            if (element.display_order_no > _this.max_display_order_no)
                _this.max_display_order_no = element.display_order_no;
        });
    };
    MenuDetailPage.prototype.ShowModal = function (item) {
        var _this = this;
        var modal = this.modalCtrl.create("MenuDetailEditModalPage", {
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.createLoader();
            _this.global.loading.present().then(function () {
                _this.ProgramPageMenuServices.PutAsync(select_data).subscribe(function (data) {
                    if (data.DidError === false) {
                        //  let index = this.data_list.findIndex(
                        //   d => d.menu_no === this.menu_no && d.page_name===item.page_name);
                        //  this.data_list[index] =select_data;
                        //  if(Number(select_data.display_order_no)>this.max_display_order_no)
                        //    this.max_display_order_no=Number(select_data.display_order_no);
                        _this.LoadData(true);
                        _this.global.dismissLoading();
    ...
    MenuDetailPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_6__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.page_name),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.ProgramPageMenuServices.DeleteAsync(item.page_name, _this.menu_no).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
                                    if (item.display_order_no === _this.max_display_order_no)
                                        _this.set_max_display_order_no();
    ...
    MenuDetailPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_5__providers_program_page_menu_services_program_page_menu_services__["a" /* ProgramPageMenuServicesProvider */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__menu_detail__ = __webpack_require__(1578);
...
var MenuDetailPageModule = /** @class */ (function () {
    ...
    MenuDetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__menu_detail__["a" /* MenuDetailPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__menu_detail__["a" /* MenuDetailPage */]),
