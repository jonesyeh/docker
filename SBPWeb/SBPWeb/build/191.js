...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MenuByProgramDetailPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_program_page_menu_services_program_page_menu_services__ = __webpack_require__(293);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ProgramPageMenuViewModel__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Model_ViewModel_MenuViewModel__ = __webpack_require__(136);
...
/**
 * Generated class for the MenuByProgramDetailPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var MenuByProgramDetailPage = /** @class */ (function () {
    function MenuByProgramDetailPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, ProgramPageMenuServices, modalCtrl, platform, conf) {
        ...
        this.totalPages = 1;
        this.totalRows = 0;
        this.page_name = navParams.data.item.page_name;
        this.title = navParams.data.item.page_desc;
    ...
    MenuByProgramDetailPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    MenuByProgramDetailPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    MenuByProgramDetailPage.prototype.setPage = function (pageInfo) {
    ...
    MenuByProgramDetailPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    MenuByProgramDetailPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    MenuByProgramDetailPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.ProgramPageMenuServices.GetMenuListsAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.page_name, _this.order_type).subscribe(function (data) {
    ...
    MenuByProgramDetailPage.prototype.Add = function () {
        var _this = this;
        var add_menu_list = [];
        var modal = this.modalCtrl.create("MenuByProgramDetailSelectModalPage", {
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            select_data.forEach(function (element) {
                var item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ProgramPageMenuViewModel__["a" /* ProgramPageMenuViewModel */]();
                item.menu_no = element.menu_no;
                item.page_name = _this.page_name;
                var m = new __WEBPACK_IMPORTED_MODULE_7__Model_ViewModel_MenuViewModel__["a" /* MenuViewModel */]();
                m.menu_desc = element.menu_desc;
                m.menu_no = element.menu_no;
                item.MenuViewModel = m;
                add_menu_list.push(item);
            });
            _this.global.createLoader();
            _this.global.loading.present().then(function () {
                _this.ProgramPageMenuServices.PostListAsync(add_menu_list).subscribe(function (data) {
                    if (data.DidError === false) {
                        add_menu_list.forEach(function (element) {
                            _this.data_list.push(element);
                            _this.totalRows += 1;
                        });
                        _this.global.dismissLoading();
                        _this.global.showPopup("加入選單", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    MenuByProgramDetailPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.ProgramPageMenuServices.DeleteAsync(_this.page_name, item.menu_no).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    MenuByProgramDetailPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_program_page_menu_services_program_page_menu_services__["a" /* ProgramPageMenuServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* ModalController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Platform */],
            __WEBPACK_IMPORTED_MODULE_8__Model_MyAppSharedSettings__["a" /* MyAppSharedSettings */]])
    ], MenuByProgramDetailPage);
    return MenuByProgramDetailPage;
}());

//# sourceMappingURL=menu-by-program-detail.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MenuByProgramDetailPageModule", function() { return MenuByProgramDetailPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__menu_by_program_detail__ = __webpack_require__(1576);
...
var MenuByProgramDetailPageModule = /** @class */ (function () {
    function MenuByProgramDetailPageModule() {
    }
    MenuByProgramDetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__menu_by_program_detail__["a" /* MenuByProgramDetailPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__menu_by_program_detail__["a" /* MenuByProgramDetailPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], MenuByProgramDetailPageModule);
    return MenuByProgramDetailPageModule;
}());

//# sourceMappingURL=menu-by-program-detail.module.js.map
