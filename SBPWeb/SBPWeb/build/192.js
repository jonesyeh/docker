...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LineMessagePage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_line_message_services_line_message_services__ = __webpack_require__(289);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_run_job_services_run_job_services__ = __webpack_require__(268);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Model_ViewModel_LineMessageViewModel__ = __webpack_require__(141);
...
/**
 * Generated class for the LineMessagePage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var LineMessagePage = /** @class */ (function () {
    function LineMessagePage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, LineMessageServices, modalCtrl, platform, conf, viewCtrl, runjobServices) {
        ...
        this.tokenname = navParams.data.tokenname;
        if (this.authServices.authenticated() === true) {
            this.CanSch = this.authServices.CanSch();
            this.LoadData(true);
        }
    }
    LineMessagePage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    LineMessagePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    LineMessagePage.prototype.setPage = function (pageInfo) {
    ...
    LineMessagePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    LineMessagePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    LineMessagePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.LineMessageServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.tokenname, _this.order_type).subscribe(function (data) {
    ...
    LineMessagePage.prototype.get_board_class = function (item) {
        return "bordered";
    };
    LineMessagePage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_7__Model_ViewModel_LineMessageViewModel__["a" /* LineMessageViewModel */]();
            item.tokenname = this.tokenname;
            item.subject_no = this.conf.token.substr(this.conf.token.length - 30, 30);
            item.subject = "";
            item.message = "";
        }
        else {
        ...
        this.AddEditPage = "LineMessageAddEditModalPage";
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.LineMessageServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    LineMessagePage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_6__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.subject_no),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.LineMessageServices.DeleteAsync(item.subject_no).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    LineMessagePage.prototype.openNavSchPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push("SchByJobPage", { item: item, src_type: 'LINE' });
        });
    };
    LineMessagePage.prototype.openNavLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push("LineMessageLogPage", { item: item });
        });
    };
    LineMessagePage.prototype.openNavRunPage = function (item) {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.runjobServices.RunJobAsync(item.subject_no)
    ...
    LineMessagePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_5_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_line_message_services_line_message_services__["a" /* LineMessageServicesProvider */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_run_job_services_run_job_services__["a" /* RunJobServicesProvider */]])
    ], LineMessagePage);
    return LineMessagePage;
}());
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LineMessagePageModule", function() { return LineMessagePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__line_message__ = __webpack_require__(1566);
...
var LineMessagePageModule = /** @class */ (function () {
    function LineMessagePageModule() {
    }
    LineMessagePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__line_message__["a" /* LineMessagePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__line_message__["a" /* LineMessagePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], LineMessagePageModule);
    return LineMessagePageModule;
}());

//# sourceMappingURL=line-message.module.js.map
