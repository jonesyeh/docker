...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LineMessageLogPage; });
 ...
 */
var LineMessageLogPage = /** @class */ (function () {
    function LineMessageLogPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, LineMessageServices, modalCtrl, platform, conf, viewCtrl) {
        ...
        this.keyword = "";
        this.subject_no = "";
        this.subject_no = navParams.data.item.subject_no;
        this.title = navParams.data.item.subject_no;
    ...
    LineMessageLogPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    LineMessageLogPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    LineMessageLogPage.prototype.setPage = function (pageInfo) {
    ...
    LineMessageLogPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    LineMessageLogPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    LineMessageLogPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.LineMessageServices.GetLogListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.subject_no, _this.order_type).subscribe(function (data) {
    ...
    return LineMessageLogPage;
}());

//# sourceMappingURL=line-message-log.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LineMessageLogPageModule", function() { return LineMessageLogPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__line_message_log__ = __webpack_require__(1565);
...
var LineMessageLogPageModule = /** @class */ (function () {
    function LineMessageLogPageModule() {
    }
    LineMessageLogPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__line_message_log__["a" /* LineMessageLogPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__line_message_log__["a" /* LineMessageLogPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], LineMessageLogPageModule);
    return LineMessageLogPageModule;
}());

//# sourceMappingURL=line-message-log.module.js.map
