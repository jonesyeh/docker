...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MaskColumnPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_mask_column_services_mask_column_services__ = __webpack_require__(301);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_MaskColumnViewModel__ = __webpack_require__(142);
...
var MaskColumnPage = /** @class */ (function () {
    function MaskColumnPage(menuCtrl, navCtrl, navParams, MaskColumnServices, loadingCtrl, global, authServices, modalCtrl, alertCtrl, platform, conf) {
        this.menuCtrl = menuCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.MaskColumnServices = MaskColumnServices;
        ...
        this.CanMaskColumnExec = true;
        this.detail_page = "MaskColumnDetailPage";
        this.CheckType_page = "MaskColumnTypeDetailPage";
    ...
    MaskColumnPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    MaskColumnPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    MaskColumnPage.prototype.setPage = function (pageInfo) {
    ...
    MaskColumnPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    MaskColumnPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    MaskColumnPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.MaskColumnServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.schemaname, _this.tablename, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    MaskColumnPage.prototype.openNavDetailsPage = function (item) {
        var _this = this;
    ...
    MaskColumnPage.prototype.openNavSqlPage = function (item, method, is_exec) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.MaskColumnServices.GetSqlAsync(item.schemaname, item.tablename, item.columnname, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    MaskColumnPage.prototype.ShowModal = function (item) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_MaskColumnViewModel__["a" /* MaskColumnViewModel */]();
            item.schemaname = this.schemaname;
            item.tablename = this.tablename;
            item.col_start_loc = 2;
            item.col_length = 2;
            item.mask = "*";
        }
        else {
        ...
        var modal = this.modalCtrl.create("MaskColumnAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.MaskColumnServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("欄位遮罩", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    MaskColumnPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.MaskColumnServices.DeleteAsync(item.schemaname, item.tablename, item.columnname).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    MaskColumnPage.prototype.openNavCheckTypePage = function (check_type) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    return MaskColumnPage;
}());

//# sourceMappingURL=mask-column.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MaskColumnPageModule", function() { return MaskColumnPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mask_column__ = __webpack_require__(1590);
...
var MaskColumnPageModule = /** @class */ (function () {
    function MaskColumnPageModule() {
    }
    MaskColumnPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__mask_column__["a" /* MaskColumnPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__mask_column__["a" /* MaskColumnPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], MaskColumnPageModule);
    return MaskColumnPageModule;
}());

//# sourceMappingURL=mask-column.module.js.map
