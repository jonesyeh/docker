...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JobStepDetailPage; });
...
/**
 * Generated class for the JobStepDetailPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var JobStepDetailPage = /** @class */ (function () {
    function JobStepDetailPage(navCtrl, navParams, global, platform) {
    ...
    JobStepDetailPage.prototype.openNavErrMsgLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.err_msg_log_page, { item: item, seq_type: "job_step_id" });
        });
    };
    JobStepDetailPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad JobStepDetailPage');
    };
    JobStepDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-job-step-detail',template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\job-step-detail\job-step-detail.html"*/'<ion-header>\n    <headerComponent [title]="\'作業步驟明細\'" [permission_id]="\'CanJob\'"></headerComponent>\n\n  </ion-header>\n\n<ion-content padding>\n  <ion-grid>\n    <ion-row>\n      <ion-col col-12 col-sm-1 col-md-1>\n      </ion-col>\n      <ion-col col-12 col-sm-10 col-md-10>\n\n        <ion-grid *ngIf="item" [ngClass]="[\'bordered\']">\n          <ion-row>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label80\']">\n                作業編號\n              </div>\n              {{item.ssis_job_no}}\n            </ion-col>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label80\']">\n                功能別\n              </div>\n              {{item.program_type}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label80\']">\n                步驟編號\n              </div>\n              <b>{{item.job_step_id}}</b>\n            </ion-col>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label80\']">\n                步驟\n              </div>\n              {{item.step}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label80\']">\n                功能編號\n              </div>\n              {{item.program_func_no}}\n            </ion-col>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label80\']">\n                功能說明\n              </div>\n              {{item.program_func_desc}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label80\']">\n                成功步驟\n              </div>\n              <div [ngClass]="item.success_step_color"> {{item.success_step_desc}}</div>\n            </ion-col>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label80\']">\n                失敗步驟\n              </div>\n              <div [ngClass]="item.fail_step_color"> {{item.fail_step_desc}}</div>\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label80\']">\n                執行結果\n              </div>\n              <div>\n                <button [ngClass]="\'exec_fail\'" *ngIf="item.last_exec_status_key==\'012|F\'" (click)="openNavErrMsgLogPage(item)">\n                  {{item.last_exec_status_desc}}\n                </button>\n                <div *ngIf="item.last_exec_status_key!=\'012|F\'" [ngClass]="item.last_exec_status_color">{{item.last_exec_status_desc}}</div>\n              </div>\n            </ion-col>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label80\']">\n                花費\n              </div>\n              {{item.duration}}\n            </ion-col>\n\n          </ion-row>\n          <ion-row>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label80\']">\n                是否啟用\n              </div>\n              <div [ngClass]="item.is_active_color">{{item.is_active_desc}}</div>\n            </ion-col>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label80\']">\n                執行時間\n              </div>\n              <div *ngIf="platform.is(\'ios\')==true">\n                  {{item.last_exec_date | date:\'y/MM/dd HH:mm:ss \'}}\n                </div>\n              <div *ngIf="platform.is(\'ios\')!=true">\n                  {{item.last_exec_date | date:\'y/MM/dd HH:mm:ss\'}}\n                </div>\n              <!-- {{item.last_exec_date | date:\'short\'}} -->\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label80\']">\n                更新者\n              </div>\n              {{item.modifier}}\n            </ion-col>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label80\']">\n                更新時間\n              </div>\n              <div *ngIf="platform.is(\'ios\')==true">\n                  {{item.last_update_time | date:\'y/MM/dd HH:mm:ss \'}}\n                </div>\n              <div *ngIf="platform.is(\'ios\')!=true">\n                  {{item.last_update_time | date:\'y/MM/dd HH:mm:ss\'}}\n                </div>\n              <!-- {{item.last_update_time | date:\'short\'}} -->\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label80\']">\n                建立者\n              </div>\n              {{item.creator}}\n            </ion-col>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label80\']">\n                建立時間\n              </div>\n              <div *ngIf="platform.is(\'ios\')==true">\n                  {{item.create_time | date:\'y/MM/dd HH:mm:ss \'}}\n                </div>\n              <div *ngIf="platform.is(\'ios\')!=true">\n                  {{item.create_time | date:\'y/MM/dd HH:mm:ss\'}}\n                </div>\n              <!-- {{item.create_time | date:\'short\'}} -->\n            </ion-col>\n          </ion-row>\n        </ion-grid>\n      </ion-col>\n      <ion-col col-12 col-sm-1 col-md-1>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n</ion-content>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\job-step-detail\job-step-detail.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__components_global_global__["a" /* GlobalComponent */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Platform */]])
    ], JobStepDetailPage);
    return JobStepDetailPage;
}());

//# sourceMappingURL=job-step-detail.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JobStepDetailPageModule", function() { return JobStepDetailPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__job_step_detail__ = __webpack_require__(1550);
...
var JobStepDetailPageModule = /** @class */ (function () {
    function JobStepDetailPageModule() {
    }
    JobStepDetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__job_step_detail__["a" /* JobStepDetailPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__job_step_detail__["a" /* JobStepDetailPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], JobStepDetailPageModule);
    return JobStepDetailPageModule;
}());

//# sourceMappingURL=job-step-detail.module.js.map
