...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JobProcessedSqlPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_job_processed_sql_services_job_processed_sql_services__ = __webpack_require__(298);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_JobProcessedSqlViewModel__ = __webpack_require__(140);
...
var JobProcessedSqlPage = /** @class */ (function () {
    function JobProcessedSqlPage(menuCtrl, navCtrl, navParams, JobProcessedSqlServices, loadingCtrl, global, authServices, modalCtrl, alertCtrl, platform, conf) {
        this.menuCtrl = menuCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.JobProcessedSqlServices = JobProcessedSqlServices;
    ...
    JobProcessedSqlPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    JobProcessedSqlPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    JobProcessedSqlPage.prototype.setPage = function (pageInfo) {
    ...
    JobProcessedSqlPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    JobProcessedSqlPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    JobProcessedSqlPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.JobProcessedSqlServices.GetListsAsync(_this.item.ssis_job_no, _this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    JobProcessedSqlPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.JobProcessedSqlServices.GetSqlAsync(item.ssis_job_no, item.exec_status_key, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    JobProcessedSqlPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_JobProcessedSqlViewModel__["a" /* JobProcessedSqlViewModel */]();
            item.ssis_job_no = this.item.ssis_job_no;
            item.is_active = true;
            item.exec_status_key = "012|F";
            item.exec_status = "失敗";
            item.exec_status_desc = "F-失敗";
        }
        else {
            this.mode = "PUT";
            if (change_mode === "c")
        ...
        if (change_mode === "e" || change_mode === "c" || change_mode === "n") {
            var modal = this.modalCtrl.create("JobProcessedSqlAddEditModalPage", {
                mode: this.mode,
                item: item,
            ...
            modal.onDidDismiss(function (select_data) {
                ...
                _this.global.loading.present().then(function () {
                    _this.JobProcessedSqlServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                        if (data.DidError === false) {
                            _this.LoadData(true);
                            _this.global.dismissLoading();
                            _this.global.showPopup("作業執行後SQL語法", data.Message);
                        }
                        else
                            _this.global.showError(data.ErrorMessage);
                    }, function (err) {
    ...
    JobProcessedSqlPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_6__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.exec_status_key),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.JobProcessedSqlServices.DeleteAsync(item.ssis_job_no, item.exec_status_key).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    return JobProcessedSqlPage;
}());

//# sourceMappingURL=job-processed-sql.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JobProcessedSqlPageModule", function() { return JobProcessedSqlPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__job_processed_sql__ = __webpack_require__(1548);
...
var JobProcessedSqlPageModule = /** @class */ (function () {
    function JobProcessedSqlPageModule() {
    }
    JobProcessedSqlPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__job_processed_sql__["a" /* JobProcessedSqlPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__job_processed_sql__["a" /* JobProcessedSqlPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], JobProcessedSqlPageModule);
    return JobProcessedSqlPageModule;
}());

//# sourceMappingURL=job-processed-sql.module.js.map
