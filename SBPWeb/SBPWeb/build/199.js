...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JobLoopDetailPage; });
...
/**
 * Generated class for the JobLoopDetailPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var JobLoopDetailPage = /** @class */ (function () {
    function JobLoopDetailPage(navCtrl, navParams, global, platform) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.global = global;
        this.platform = platform;
        this.item = navParams.data.item;
        this.title = __WEBPACK_IMPORTED_MODULE_2__Model_String__["a" /* String */].Format("作業迴圈序號：{0}", navParams.data.item && navParams.data.item.loop_seq || null);
        this.err_msg_log_page = "ErrMsgLogPage";
    }
    JobLoopDetailPage.prototype.openNavErrMsgLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.err_msg_log_page, { item: item, seq_type: "job_loop_replace_desc" });
        });
    };
    JobLoopDetailPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad JobLoopDetailPage');
    };
    JobLoopDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-job-loop-detail',template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\job-loop-detail\job-loop-detail.html"*/'<ion-header>\n    <headerComponent [title]="\'作業迴圈明細\'" [permission_id]="\'CanJob\'"></headerComponent>\n\n  </ion-header>\n\n<ion-content padding>\n  <ion-grid>\n    <ion-row>\n      <ion-col col-12 col-sm-1 col-md-2>\n      </ion-col>\n      <ion-col col-12 col-sm-10 col-md-8>\n\n        <ion-grid *ngIf="item" [ngClass]="[\'bordered\']">\n          <ion-row>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label100\']">\n                迴圈序號\n              </div>\n              <b>{{item.loop_seq}}</b>\n            </ion-col>\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label100\']">\n                執行順序\n              </div>\n              {{item.exec_seq}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label100\']">\n                作業編號\n              </div>\n              {{item.ssis_job_no}}\n            </ion-col>\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label100\']">\n                job01\n              </div>\n              {{item.job01}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label100\']">\n                job02\n              </div>\n              {{item.job02}}\n            </ion-col>\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label100\']">\n                job03\n              </div>\n              {{item.job03}}\n            </ion-col>\n\n\n          </ion-row>\n          <ion-row>\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label100\']">\n                說明設定\n              </div>\n              {{item.job_loop_desc}}\n            </ion-col>\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label100\']">\n                說明取代\n              </div>\n              {{item.job_loop_replace_desc}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label100\']">\n                遠端連線編號\n              </div>\n              {{item.remote_conn_id}}\n            </ion-col>\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label100\']">\n                遠端連線字串\n              </div>\n              {{item.remote_conn_string}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label100\']">\n                執行結果\n              </div>\n              <div>\n                <button [ngClass]="\'exec_fail\'" *ngIf="item.last_exec_status_key==\'012|F\'" (click)="openNavErrMsgLogPage(item)">\n                  {{item.last_exec_status_desc}}\n                </button>\n                <div *ngIf="item.last_exec_status_key!=\'012|F\'" [ngClass]="item.last_exec_status_color">{{item.last_exec_status_desc}}</div>\n              </div>\n            </ion-col>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label100\']">\n                花費\n              </div>\n              {{item.duration}}\n            </ion-col>\n\n          </ion-row>\n          <ion-row>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label100\']">\n                是否啟用\n              </div>\n              <div [ngClass]="item.is_active_color">{{item.is_active_desc}}</div>\n            </ion-col>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label100\']">\n                執行時間\n              </div>\n              <div *ngIf="platform.is(\'ios\')==true">\n                  {{item.last_exec_date | date:\'y/MM/dd HH:mm:ss \'}}\n                </div>\n              <div *ngIf="platform.is(\'ios\')!=true">\n                  {{item.last_exec_date | date:\'y/MM/dd HH:mm:ss\'}}\n                </div>\n              <!-- {{item.last_exec_date | date:\'short\'}} -->\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label100\']">\n                更新者\n              </div>\n              {{item.modifier}}\n            </ion-col>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label100\']">\n                更新時間\n              </div>\n              <div *ngIf="platform.is(\'ios\')==true">\n                {{item.last_update_time | date:\'y/MM/dd HH:mm:ss \'}}\n              </div>\n            <div *ngIf="platform.is(\'ios\')!=true">\n                {{item.last_update_time | date:\'y/MM/dd HH:mm:ss\'}}\n              </div>\n              <!-- {{item.last_update_time | date:\'short\'}} -->\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label100\']">\n                建立者\n              </div>\n              {{item.creator}}\n            </ion-col>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label100\']">\n                建立時間\n              </div>\n              <div *ngIf="platform.is(\'ios\')==true">\n                {{item.create_time | date:\'y/MM/dd HH:mm:ss \'}}\n              </div>\n            <div *ngIf="platform.is(\'ios\')!=true">\n                {{item.create_time | date:\'y/MM/dd HH:mm:ss\'}}\n              </div>\n              <!-- {{item.create_time | date:\'short\'}} -->\n            </ion-col>\n          </ion-row>\n        </ion-grid>\n      </ion-col>\n      <ion-col col-12 col-sm-1 col-md-2>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n</ion-content>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\job-loop-detail\job-loop-detail.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_3__components_global_global__["a" /* GlobalComponent */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Platform */]])
    ], JobLoopDetailPage);
    return JobLoopDetailPage;
}());

//# sourceMappingURL=job-loop-detail.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JobLoopDetailPageModule", function() { return JobLoopDetailPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__job_loop_detail__ = __webpack_require__(1539);
...
var JobLoopDetailPageModule = /** @class */ (function () {
    function JobLoopDetailPageModule() {
    }
    JobLoopDetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__job_loop_detail__["a" /* JobLoopDetailPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__job_loop_detail__["a" /* JobLoopDetailPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], JobLoopDetailPageModule);
    return JobLoopDetailPageModule;
}());

//# sourceMappingURL=job-loop-detail.module.js.map
