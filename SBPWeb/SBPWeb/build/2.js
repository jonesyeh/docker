...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportAfterServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileImportAfterListResponse__ = __webpack_require__(1436);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileImportAfterResponse__ = __webpack_require__(1437);
...
/*
  Generated class for the FileImportAfterServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var FileImportAfterServicesProvider = /** @class */ (function () {
    function FileImportAfterServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "FileImportAfter";
        console.log("Hello FileImportAfterServiceProvider Provider");
    }
    FileImportAfterServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, exec_file_seq, schemaname, tablename, db_conn_id, parameter_column_group, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "FileImportAfter?PageSize={1}&PageNumber={2}&keyword={3}&exec_file_seq={4}&schemaname={5}&tablename={6}&db_conn_id={7}&parameter_column_group={8}&order_type={9}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.FileImportAfters = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileImportAfterListResponse__["a" /* FileImportAfterListResponse */]({
            ...
            return _this.FileImportAfters;
        });
    };
    FileImportAfterServicesProvider.prototype.PostPutAsync = function (FileImportAfterViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "FileImportAfter";
        else
            sub_url = "FileImportAfter/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, FileImportAfterViewModel.import_sql_seq);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, FileImportAfterViewModel, mode).map(function (item) {
            _this.FileImportAfter = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileImportAfterResponse__["a" /* FileImportAfterResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.FileImportAfter;
        });
    };
    FileImportAfterServicesProvider.prototype.DeleteAsync = function (import_sql_seq) {
        var sub_url;
        sub_url = "FileImportAfter/{1}";
    ...
    FileImportAfterServicesProvider.prototype.GetSqlAsync = function (import_sql_seq, method) {
        var sub_url;
        sub_url = "FileImportAfter/get_{2}_sql/{1}";
    ...
    FileImportAfterServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_services__["a" /* ServicesProvider */]])
    ], FileImportAfterServicesProvider);
    return FileImportAfterServicesProvider;
}());

//# sourceMappingURL=file-import-after-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportAfterPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_import_after_services_file_import_after_services__ = __webpack_require__(1215);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileImportAfterViewModel__ = __webpack_require__(1040);
 ...
 * Components.
 */
var FileImportAfterPage = /** @class */ (function () {
    function FileImportAfterPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileImportAfterServices, modalCtrl, platform, conf) {
        ...
        this.FileImportAfterServices = FileImportAfterServices;
    ...
    FileImportAfterPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    FileImportAfterPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileImportAfterPage.prototype.setPage = function (pageInfo) {
    ...
    FileImportAfterPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileImportAfterPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileImportAfterPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.FileImportAfterServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_file_seq, _this.schemaname, _this.tablename, _this.db_conn_id, _this.parameter_column_group, _this.order_type).subscribe(function (data) {
    ...
    FileImportAfterPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileImportAfterViewModel__["a" /* FileImportAfterViewModel */]();
        ...
        var modal = this.modalCtrl.create("FileImportAfterAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileImportAfterServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    FileImportAfterPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileImportAfterServices.DeleteAsync(item.import_sql_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileImportAfterPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileImportAfterServices.GetSqlAsync(item.import_sql_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileImportAfterPage.prototype.openNavFileMapPage = function (item) {
    ...
    FileImportAfterPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_import_after_services_file_import_after_services__["a" /* FileImportAfterServicesProvider */],
    ...
    return FileImportAfterPage;
}());

//# sourceMappingURL=file-import-after.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportAfterListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileImportAfterViewModel__ = __webpack_require__(1040);
...
var FileImportAfterListResponse = /** @class */ (function (_super) {
    __extends(FileImportAfterListResponse, _super);
    function FileImportAfterListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileImportAfterViewModel__["a" /* FileImportAfterViewModel */]();
    ...
    return FileImportAfterListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=FileImportAfterListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportAfterResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileImportAfterViewModel__ = __webpack_require__(1040);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var FileImportAfterResponse = /** @class */ (function (_super) {
    __extends(FileImportAfterResponse, _super);
    function FileImportAfterResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileImportAfterViewModel__["a" /* FileImportAfterViewModel */]();
    ...
    return FileImportAfterResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=FileImportAfterResponse.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileImportAfterPageModule", function() { return FileImportAfterPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_import_after__ = __webpack_require__(1435);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_file_import_components_module__ = __webpack_require__(970);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_import_after_services_file_import_after_services__ = __webpack_require__(1215);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileImportAfterPageModule = /** @class */ (function () {
    function FileImportAfterPageModule() {
    }
    FileImportAfterPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_import_after__["a" /* FileImportAfterPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_import_after_services_file_import_after_services__["a" /* FileImportAfterServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_import_after__["a" /* FileImportAfterPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_file_import_components_module__["a" /* FileImportComponentsModule */],
            ],
        })
    ], FileImportAfterPageModule);
    return FileImportAfterPageModule;
}());

//# sourceMappingURL=file-import-after.module.js.map
