...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JobExecLogDetailPage; });
...
/**
 * Generated class for the JobExecLogDetailPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var JobExecLogDetailPage = /** @class */ (function () {
    function JobExecLogDetailPage(navCtrl, navParams, global, platform) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.global = global;
        this.platform = platform;
        this.item = navParams.data.item;
        this.title = __WEBPACK_IMPORTED_MODULE_2__Model_String__["a" /* String */].Format("作業紀錄序號：{0}", navParams.data.item && navParams.data.item.job_log_seq || null);
        this.err_msg_log_page = "ErrMsgLogPage";
    }
    JobExecLogDetailPage.prototype.openNavErrMsgLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.err_msg_log_page, { item: item, seq_type: "job_log_seq" });
        });
    };
    JobExecLogDetailPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad JobExecLogDetailPage');
    };
    JobExecLogDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-job-exec-log-detail',template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\job-exec-log-detail\job-exec-log-detail.html"*/'<ion-header>\n    <headerComponent [title]="\'作業執行紀錄明細\'" [permission_id]="\'CanViewLog\'"></headerComponent>\n  </ion-header>\n\n\n<ion-content padding>\n  <ion-grid>\n    <ion-row>\n      <ion-col col-12 col-sm-2 col-md-3>\n      </ion-col>\n      <ion-col col-12 col-sm-8 col-md-6>\n\n        <ion-grid [ngClass]="[\'bordered\']">\n          <ion-row>\n\n            <ion-col>\n              <div [ngClass]="[\'label100\']">\n                作業紀錄序號\n              </div>\n              <b>{{item.job_log_seq}}</b>\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n              <ion-col>\n                <div [ngClass]="[\'label80\']">\n                  作業編號\n                </div>\n                {{item.ssis_job_no}}\n              </ion-col>\n            </ion-row>\n          <ion-row>\n\n            <ion-col>\n              <div [ngClass]="[\'label80\']">\n                作業說明\n              </div>\n              {{item.ssis_job_name}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col>\n              <div [ngClass]="[\'label80\']">\n                狀態碼\n              </div>\n              {{item.exec_status_key}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col>\n              <div [ngClass]="[\'label80\']">\n                執行狀態\n              </div>\n              {{item.exec_status}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col>\n              <div [ngClass]="[\'label80\']">\n                執行結果\n              </div>\n              <div>\n                <button [ngClass]="\'exec_fail\'" *ngIf="item.exec_status_key==\'012|F\'" (click)="openNavErrMsgLogPage(item)">\n                  {{item.exec_status_desc}}\n                </button>\n                <div *ngIf="item.exec_status_key!=\'012|F\'" [ngClass]="item.exec_status_color">{{item.exec_status_desc}}</div>\n              </div>\n            </ion-col>\n          </ion-row>\n\n          <ion-row>\n\n            <ion-col>\n              <div [ngClass]="[\'label80\']">\n                花費\n              </div>\n              {{item.duration}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col>\n              <div [ngClass]="[\'label80\']">\n                建立者\n              </div>\n              {{item.creator}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col>\n              <div [ngClass]="[\'label80\']">\n                建立時間\n              </div>\n              <div *ngIf="platform.is(\'ios\')==true">\n                  {{item.create_time | date:\'y/MM/dd HH:mm:ss \'}}\n                </div>\n              <div *ngIf="platform.is(\'ios\')!=true">\n                  {{item.create_time | date:\'y/MM/dd HH:mm:ss\'}}\n                </div>\n              <!-- {{item.create_time | date:\'short\'}} -->\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col>\n              <div [ngClass]="[\'label80\']">\n                更新者\n              </div>\n              {{item.modifier}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col>\n              <div [ngClass]="[\'label80\']">\n                更新時間\n              </div>\n              <div *ngIf="platform.is(\'ios\')==true">\n                  {{item.last_update_time | date:\'y/MM/dd HH:mm:ss \'}}\n                </div>\n              <div *ngIf="platform.is(\'ios\')!=true">\n                  {{item.last_update_time | date:\'y/MM/dd HH:mm:ss\'}}\n                </div>\n              <!-- {{item.last_update_time | date:\'short\'}} -->\n            </ion-col>\n          </ion-row>\n\n        </ion-grid>\n      </ion-col>\n      <ion-col col-12 col-sm-2 col-md-3>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n\n\n\n\n</ion-content>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\job-exec-log-detail\job-exec-log-detail.html"*/,
        }),
    ...
    ], JobExecLogDetailPage);
    return JobExecLogDetailPage;
}());

//# sourceMappingURL=job-exec-log-detail.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JobExecLogDetailPageModule", function() { return JobExecLogDetailPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__job_exec_log_detail__ = __webpack_require__(1533);
...
var JobExecLogDetailPageModule = /** @class */ (function () {
    function JobExecLogDetailPageModule() {
    }
    JobExecLogDetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__job_exec_log_detail__["a" /* JobExecLogDetailPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__job_exec_log_detail__["a" /* JobExecLogDetailPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], JobExecLogDetailPageModule);
    return JobExecLogDetailPageModule;
}());

//# sourceMappingURL=job-exec-log-detail.module.js.map
