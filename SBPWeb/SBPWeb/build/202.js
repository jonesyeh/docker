...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JobBySchPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_job_sch_services_job_sch_services__ = __webpack_require__(291);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_JobSchViewModel__ = __webpack_require__(292);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Model_ViewModel_JobViewModel__ = __webpack_require__(279);
...
/**
 * Generated class for the JobSchPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var JobBySchPage = /** @class */ (function () {
    function JobBySchPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, JobSchServices, modalCtrl, platform, conf) {
        ...
        this.JobSchServices = JobSchServices;
        ...
        this.totalPages = 1;
        this.totalRows = 0;
        this.sch_no = navParams.data.item.sch_no;
        this.title = navParams.data.item.sch_name;
        this.job_page = "JobPage";
        ...
        if (this.authServices.authenticated() === true) {
            ...
            this.CanViewLog = this.authServices.CanViewLog();
            this.CanJob = this.authServices.CanJob();
            this.LoadData(true);
        }
    }
    JobBySchPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit === Math.floor(this.pageSize / 3);
    };
    JobBySchPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
        console.log("Select Event", selected, this.selected);
    };
    JobBySchPage.prototype.setPage = function (pageInfo) {
    ...
    JobBySchPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    JobBySchPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    JobBySchPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.JobSchServices.GetJobListsAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.sch_no, _this.order_type).subscribe(function (data) {
    ...
    JobBySchPage.prototype.Add = function () {
        var _this = this;
        var add_JobSch_list = [];
        var modal = this.modalCtrl.create("JobBySchSelectModalPage", {
            sch_no: this.sch_no
        });
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
            select_data.job.forEach(function (element) {
                var item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_JobSchViewModel__["a" /* JobSchViewModel */]();
                item.ssis_job_no = element.ssis_job_no;
                item.ssis_job_name = element.ssis_job_name;
                item.sch_no = _this.sch_no;
                item.remote_conn_id = select_data.remote_conn_id;
                item.remote_conn_string = select_data.remote_conn_string;
                var t = new __WEBPACK_IMPORTED_MODULE_7__Model_ViewModel_JobViewModel__["a" /* JobViewModel */]();
                {
                    t.ssis_job_no = element.ssis_job_no;
                    t.ssis_job_name = element.ssis_job_name;
                }
                item.JobViewModel = t;
                add_JobSch_list.push(item);
            });
            _this.global.createLoader();
            _this.global.loading.present().then(function () {
                _this.JobSchServices.PostListAsync(add_JobSch_list).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("加入作業", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    JobBySchPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.ssis_job_no),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.JobSchServices.DeleteAsync(item.ssis_job_no, _this.sch_no).subscribe(function (data) {
                                _this.global.dismissLoading();
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    JobBySchPage.prototype.openNavPage = function (item, page) {
        var _this = this;
    ...
    JobBySchPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_job_sch_services_job_sch_services__["a" /* JobSchServicesProvider */],
...
//# sourceMappingURL=job-by-sch.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JobBySchPageModule", function() { return JobBySchPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__job_by_sch__ = __webpack_require__(1531);
...
var JobBySchPageModule = /** @class */ (function () {
    function JobBySchPageModule() {
    }
    JobBySchPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__job_by_sch__["a" /* JobBySchPage */],
            ],
            providers: [],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__job_by_sch__["a" /* JobBySchPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], JobBySchPageModule);
    return JobBySchPageModule;
}());

//# sourceMappingURL=job-by-sch.module.js.map
