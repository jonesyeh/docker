...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileExecLogDetailPage; });
...
/**
 * Generated class for the FileExecLogDetailPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var FileExecLogDetailPage = /** @class */ (function () {
    function FileExecLogDetailPage(navCtrl, navParams, global, platform) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.global = global;
        this.platform = platform;
        this.item = navParams.data.item;
        this.title = __WEBPACK_IMPORTED_MODULE_2__Model_String__["a" /* String */].Format("轉檔紀錄序號：{0}", navParams.data.item && navParams.data.item.exec_log_seq || null);
        this.err_msg_log_page = "ErrMsgLogPage";
    }
    FileExecLogDetailPage.prototype.openNavErrMsgLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.err_msg_log_page, { item: item, seq_type: "exec_log_seq" });
        });
    };
    FileExecLogDetailPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad FileExecLogDetailPage');
    };
    FileExecLogDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-file-exec-log-detail',template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\file-exec-log-detail\file-exec-log-detail.html"*/'<ion-header>\n  <headerComponent [title]="\'檔案執行紀錄明細\'" [permission_id]="\'CanViewLog\'"></headerComponent>\n</ion-header>\n\n<ion-content padding>\n  <ion-grid>\n    <ion-row>\n      <ion-col col-12 col-sm-1 col-md-1>\n      </ion-col>\n      <ion-col col-12 col-sm-10 col-md-10>\n\n        <ion-grid *ngIf="item" [ngClass]="[\'bordered\']">\n          <ion-row>\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label90\']">\n                轉檔紀錄序號\n              </div>\n              <b>{{item.exec_log_seq}}</b>\n            </ion-col>\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label90\']">\n                步驟紀錄序號\n              </div>\n              {{item.job_step_log_seq}}\n            </ion-col>\n\n          </ion-row>\n          <ion-row>\n\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label90\']">\n                轉檔序號\n              </div>\n              {{item.exec_file_seq}}\n            </ion-col>\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label90\']">\n                花費\n              </div>\n              {{item.duration}}\n            </ion-col>\n\n          </ion-row>\n          <ion-row>\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label90\']">\n                處理類型碼\n              </div>\n              {{item.func_key}}\n            </ion-col>\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label90\']">\n                處理類型\n              </div>\n              {{item.func_desc}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label90\']">\n                工作表名稱\n              </div>\n              {{item.sheetname}}\n            </ion-col>\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label90\']">\n                檔案名稱\n              </div>\n              {{item.filename}}\n            </ion-col>\n          </ion-row>\n          <ion-row *ngIf="item.func_key==\'014|2\'">\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label90\']">\n                總筆數\n              </div>\n              {{item.total_cnt}}\n            </ion-col>\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label90\']">\n                成功數\n              </div>\n              {{item.success_cnt}}\n            </ion-col>\n          </ion-row>\n          <ion-row *ngIf="item.func_key==\'014|2\'">\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label90\']">\n                失敗數\n              </div>\n              {{item.fail_cnt}}\n            </ion-col>\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label90\']">\n                執行狀態\n              </div>\n              {{item.exec_status}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label90\']">\n                執行結果碼\n              </div>\n              {{item.exec_status_key}}\n            </ion-col>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label90\']">\n                執行結果\n              </div>\n              <div>\n                <button [ngClass]="\'exec_fail\'" *ngIf="item.exec_status_key==\'012|F\'" (click)="openNavErrMsgLogPage(item)">\n                  {{item.exec_status_desc}}\n                </button>\n                <div *ngIf="item.exec_status_key!=\'012|F\'" [ngClass]="item.exec_status_color">{{item.exec_status_desc}}</div>\n              </div>\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n\n            <ion-col>\n              <div [ngClass]="[\'label90\']">\n                備註\n              </div>\n              {{item.note}}\n            </ion-col>\n\n          </ion-row>\n          <ion-row>\n\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label90\']">\n                更新時間\n              </div>\n              <div *ngIf="platform.is(\'ios\')==true">\n                  {{item.last_update_time | date:\'y/MM/dd HH:mm:ss \'}}\n                </div>\n              <div *ngIf="platform.is(\'ios\')!=true">\n                  {{item.last_update_time | date:\'y/MM/dd HH:mm:ss\'}}\n                </div>\n              <!-- {{item.last_update_time | date:\'short\'}} -->\n            </ion-col>\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label90\']">\n                建立時間\n              </div>\n              <div *ngIf="platform.is(\'ios\')==true">\n                  {{item.create_time | date:\'y/MM/dd HH:mm:ss \'}}\n                </div>\n              <div *ngIf="platform.is(\'ios\')!=true">\n                  {{item.create_time | date:\'y/MM/dd HH:mm:ss\'}}\n                </div>\n              <!-- {{item.create_time | date:\'short\'}} -->\n            </ion-col>\n          </ion-row>\n        </ion-grid>\n      </ion-col>\n      <ion-col col-12 col-sm-1 col-md-1>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n</ion-content>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\file-exec-log-detail\file-exec-log-detail.html"*/,
        }),
    ...
    ], FileExecLogDetailPage);
    return FileExecLogDetailPage;
}());

//# sourceMappingURL=file-exec-log-detail.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileExecLogDetailPageModule", function() { return FileExecLogDetailPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_exec_log_detail__ = __webpack_require__(1370);
...
var FileExecLogDetailPageModule = /** @class */ (function () {
    function FileExecLogDetailPageModule() {
    }
    FileExecLogDetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_exec_log_detail__["a" /* FileExecLogDetailPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_exec_log_detail__["a" /* FileExecLogDetailPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileExecLogDetailPageModule);
    return FileExecLogDetailPageModule;
}());

//# sourceMappingURL=file-exec-log-detail.module.js.map
