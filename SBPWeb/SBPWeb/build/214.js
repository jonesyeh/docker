...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileDirectoryPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_management_services_file_management_services__ = __webpack_require__(283);
 ...
 * Components.
 */
var FileDirectoryPage = /** @class */ (function () {
    function FileDirectoryPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileManagementServices, modalCtrl, viewCtrl, TableServices, runjobServices, platform, conf) {
    ...
    FileDirectoryPage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
    ...
    FileDirectoryPage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
    ...
    FileDirectoryPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileDirectoryPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileDirectoryPage.prototype.setPage = function (pageInfo) {
    ...
    FileDirectoryPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileDirectoryPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileDirectoryPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileManagementServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_file_seq, true, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileDirectoryPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
        ...
        var modal = this.modalCtrl.create("FileDirectoryAddEditModalPage", {
            mode: this.mode,
            item: item,
            ...
            _this.global.loading.present().then(function () {
                _this.FileManagementServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("資料夾管理", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileDirectoryPage.prototype.Delete = function (item) {
        var _this = this;
    ...
    FileDirectoryPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileDirectoryPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileDirectoryPageModule", function() { return FileDirectoryPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_directory__ = __webpack_require__(1368);
...
var FileDirectoryPageModule = /** @class */ (function () {
    function FileDirectoryPageModule() {
    }
    FileDirectoryPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_directory__["a" /* FileDirectoryPage */],
            ],
            providers: [],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_directory__["a" /* FileDirectoryPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileDirectoryPageModule);
    return FileDirectoryPageModule;
}());

//# sourceMappingURL=file-directory.module.js.map
