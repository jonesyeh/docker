...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ErrMsgLogDetailPage; });
...
/**
 * Generated class for the ErrMsgLogDetailPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var ErrMsgLogDetailPage = /** @class */ (function () {
    function ErrMsgLogDetailPage(navCtrl, navParams, platform) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.platform = platform;
        this.item = navParams.data.item;
        this.title = navParams.data.item && navParams.data.item.err_msg_seq || null;
    }
    ErrMsgLogDetailPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad ErrMsgLogDetailPage');
    };
    ErrMsgLogDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-err-msg-log-detail',template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\err-msg-log-detail\err-msg-log-detail.html"*/'<ion-header>\n    <headerComponent [title]="\'錯誤訊息紀錄明細\'" [permission_id]="\'CanJob\'"></headerComponent>\n  </ion-header>\n\n\n<ion-content padding>\n  <ion-grid>\n    <ion-row>\n      <ion-col col-12 col-sm-2 col-md-2>\n      </ion-col>\n      <ion-col col-12 col-sm-8 col-md-8>\n\n        <ion-grid [ngClass]="[\'bordered\']">\n            <ion-row>\n\n                <ion-col>\n                  <div [ngClass]="[\'label\']">\n                    異常訊息序號\n                  </div>\n                  <b>{{item.err_msg_seq}}</b>\n                </ion-col>\n              </ion-row>\n          <ion-row>\n\n            <ion-col>\n              <div [ngClass]="[\'label\']">\n                批次紀錄序號\n              </div>\n              {{item.batch_log_seq}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              <div [ngClass]="[\'label\']">\n                作業紀錄序號\n              </div>\n              {{item.job_log_seq}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              <div [ngClass]="[\'label\']">\n                作業編號\n              </div>\n              {{item.ssis_job_no}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              <div [ngClass]="[\'label\']">\n                步驟紀錄序號\n              </div>\n              {{item.job_step_log_seq}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              <div [ngClass]="[\'label\']">\n                作業步驟\n              </div>\n              {{item.step}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              <div [ngClass]="[\'label\']">\n                程式說明\n              </div>\n              {{item.program_func_desc}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              <div [ngClass]="[\'label\']">\n                建立時間\n              </div>\n              <div *ngIf="platform.is(\'ios\')==true">\n                  {{item.create_time | date:\'y/MM/dd HH:mm:ss \'}}\n                </div>\n              <div *ngIf="platform.is(\'ios\')!=true">\n                  {{item.create_time | date:\'y/MM/dd HH:mm:ss\'}}\n                </div>\n              <!-- {{item.create_time | date:\'short\'}} -->\n            </ion-col>\n          </ion-row>\n          <ion-row *ngIf="item.exec_log_seq>0">\n            <ion-col >\n              <div [ngClass]="[\'label\']">\n                轉檔紀錄序號\n              </div>\n              {{item.exec_log_seq}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n              <ion-col>\n                <div [ngClass]="[\'label\']">\n                  異常訊息\n                </div>\n                <ion-textarea autosize  [(ngModel)]="item.err_msg" >\n\n                </ion-textarea>\n\n              </ion-col>\n            </ion-row>\n        </ion-grid>\n      </ion-col>\n      <ion-col col-12 col-sm-2 col-md-2>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n</ion-content>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\err-msg-log-detail\err-msg-log-detail.html"*/,
        }),
    ...
    return ErrMsgLogDetailPage;
}());

//# sourceMappingURL=err-msg-log-detail.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ErrMsgLogDetailPageModule", function() { return ErrMsgLogDetailPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__err_msg_log_detail__ = __webpack_require__(1342);
...
var ErrMsgLogDetailPageModule = /** @class */ (function () {
    function ErrMsgLogDetailPageModule() {
    }
    ErrMsgLogDetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__err_msg_log_detail__["a" /* ErrMsgLogDetailPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__err_msg_log_detail__["a" /* ErrMsgLogDetailPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], ErrMsgLogDetailPageModule);
    return ErrMsgLogDetailPageModule;
}());

//# sourceMappingURL=err-msg-log-detail.module.js.map
