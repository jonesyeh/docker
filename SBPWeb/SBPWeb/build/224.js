...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CheckTypeSelectModalPage; });
 ...
 */
var CheckTypeSelectModalPage = /** @class */ (function () {
    function CheckTypeSelectModalPage(navCtrl, navParams, global, authServices, modalCtrl, CodeCheckServices, viewCtrl, alertCtrl, platform, conf) {
        ...
        this.pageNumber = 1;
        this.keyword = this.item.check_type;
        this.Detail_page = "CodeCheckTypeDetailModalPage";
    ...
    CheckTypeSelectModalPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    CheckTypeSelectModalPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    CheckTypeSelectModalPage.prototype.setPage = function (pageInfo) {
    ...
    CheckTypeSelectModalPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    CheckTypeSelectModalPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    CheckTypeSelectModalPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.CodeCheckServices.GetListsViewCodeTypeCheckByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    CheckTypeSelectModalPage.prototype.get_board_class = function (item) {
        if (item.code_type === this.item.check_type)
            return "select_bordered";
        else
            return "bordered";
    };
    CheckTypeSelectModalPage.prototype.ShowModal = function (item) {
        var modal = this.modalCtrl.create("CodeCheckTypeDetailModalPage", {
            check_type: item.code_type
        });
    ...
    ], CheckTypeSelectModalPage);
    return CheckTypeSelectModalPage;
}());

//# sourceMappingURL=check-type-select-modal.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CheckTypeSelectModalPageModule", function() { return CheckTypeSelectModalPageModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__check_type_select_modal__ = __webpack_require__(1285);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CheckTypeSelectModalPageModule = /** @class */ (function () {
    function CheckTypeSelectModalPageModule() {
    }
    CheckTypeSelectModalPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__check_type_select_modal__["a" /* CheckTypeSelectModalPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__check_type_select_modal__["a" /* CheckTypeSelectModalPage */]),
                __WEBPACK_IMPORTED_MODULE_0__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], CheckTypeSelectModalPageModule);
    return CheckTypeSelectModalPageModule;
}());

//# sourceMappingURL=check-type-select-modal.module.js.map
