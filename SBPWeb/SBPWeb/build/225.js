...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CheckCodeColumnSelectModalPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_table_detail_services_table_detail_services__ = __webpack_require__(269);
...
/**
 * Generated class for the PermissionCheckCodeColumnPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var CheckCodeColumnSelectModalPage = /** @class */ (function () {
    function CheckCodeColumnSelectModalPage(navCtrl, navParams, global, authServices, modalCtrl, TableDetailServices, viewCtrl, alertCtrl, platform, conf) {
        ...
        if (navParams.data.select_data > "")
            this.keyword = "=" + navParams.data.select_data;
    ...
    CheckCodeColumnSelectModalPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    CheckCodeColumnSelectModalPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    CheckCodeColumnSelectModalPage.prototype.setPage = function (pageInfo) {
    ...
    CheckCodeColumnSelectModalPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    CheckCodeColumnSelectModalPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    CheckCodeColumnSelectModalPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.TableDetailServices.GetCodecheckSelectListsAsync(_this.pageSize, _this.loadPageNumber, _this.item.schemaname, _this.item.tablename, "", _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    CheckCodeColumnSelectModalPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_table_detail_services_table_detail_services__["a" /* TableDetailServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* ViewController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Platform */],
            __WEBPACK_IMPORTED_MODULE_5__Model_MyAppSharedSettings__["a" /* MyAppSharedSettings */]])
    ], CheckCodeColumnSelectModalPage);
    return CheckCodeColumnSelectModalPage;
}());

//# sourceMappingURL=check-code-column-select-modal.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CheckCodeColumnSelectModalPageModule", function() { return CheckCodeColumnSelectModalPageModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__check_code_column_select_modal__ = __webpack_require__(1306);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CheckCodeColumnSelectModalPageModule = /** @class */ (function () {
    function CheckCodeColumnSelectModalPageModule() {
    }
    CheckCodeColumnSelectModalPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__check_code_column_select_modal__["a" /* CheckCodeColumnSelectModalPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__check_code_column_select_modal__["a" /* CheckCodeColumnSelectModalPage */]),
                __WEBPACK_IMPORTED_MODULE_0__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], CheckCodeColumnSelectModalPageModule);
    return CheckCodeColumnSelectModalPageModule;
}());

//# sourceMappingURL=check-code-column-select-modal.module.js.map
