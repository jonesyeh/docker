...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CmdLogPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_cmd_log_services_cmd_log_services__ = __webpack_require__(298);
...
/**
 * Generated class for the CmdLogPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var CmdLogPage = /** @class */ (function () {
    function CmdLogPage(navCtrl, navParams, loadingCtrl, global, authServices, CmdLogServices) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.loadingCtrl = loadingCtrl;
        this.global = global;
        this.authServices = authServices;
        this.CmdLogServices = CmdLogServices;
    ...
    CmdLogPage.prototype.LoadData = function (init) {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.CmdLogServices.GetAsync(_this.item.exec_log_seq).subscribe(function (data) {
    ...
    CmdLogPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad CmdLogPage');
    };
    CmdLogPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-cmd-log',template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\cmd-log\cmd-log.html"*/'<ion-header>\n  <headerComponent [title]="\'命令執行訊息\'" [permission_id]="\'CanViewLog\'"></headerComponent>\n</ion-header>\n\n<ion-content padding>\n  <ion-grid>\n    <ion-row>\n      \n      <ion-col col-12 col-sm-12 col-md-12>\n\n        <ion-grid *ngIf="data" [ngClass]="[\'bordered\']">\n          <ion-row>\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label90\']">\n                轉檔紀錄序號\n              </div>\n              <b>{{data.exec_log_seq}}</b>\n            </ion-col>\n            \n\n          </ion-row>\n         \n          <ion-row>\n\n\n            <ion-col>\n             \n              <ion-textarea autosize [(ngModel)]="data.msg" >\n\n              </ion-textarea>\n            </ion-col>\n\n          </ion-row>\n          \n        </ion-grid>\n      </ion-col>\n      \n    </ion-row>\n  </ion-grid>\n</ion-content>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\cmd-log\cmd-log.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* LoadingController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_auth_services_auth_services__["a" /* AuthServicesProvider */], __WEBPACK_IMPORTED_MODULE_5__providers_cmd_log_services_cmd_log_services__["a" /* CmdLogServicesProvider */]])
    ], CmdLogPage);
    return CmdLogPage;
}());
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CmdLogPageModule", function() { return CmdLogPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cmd_log__ = __webpack_require__(1298);
...
var CmdLogPageModule = /** @class */ (function () {
    function CmdLogPageModule() {
    }
    CmdLogPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__cmd_log__["a" /* CmdLogPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__cmd_log__["a" /* CmdLogPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], CmdLogPageModule);
    return CmdLogPageModule;
}());

//# sourceMappingURL=cmd-log.module.js.map
