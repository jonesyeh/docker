...
var ChangePasswordPage = /** @class */ (function () {
    function ChangePasswordPage(navCtrl, navParams, authServices, global) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.authServices = authServices;
        this.global = global;
        this.ChangePasswordCredentials = { userName: '', password: '' };
        this.title = "變更密碼";
        if (this.authServices.authenticated() === false) {
            navCtrl.setRoot("LoginPage");
        }
        else {
            this.ChangePasswordCredentials.userName = this.authServices.getUserInfo().Model.UserViewModel.userName;
            this.old_password = this.authServices.getUserInfo().Model.UserViewModel.password;
        }
    }
    ...
    ChangePasswordPage.prototype.ChangePassword = function () {
        var _this = this;
        if (this.old_password != this.src_password) {
            this.global.showPopup("原密碼錯誤", "密碼與原密碼不一樣");
            return;
        }
        if (this.confirm_password != this.ChangePasswordCredentials.password) {
        ...
        this.global.loading.present().then(function () {
            _this.authServices
                .ChangePasswordAsync(_this.ChangePasswordCredentials)
    ...
    ChangePasswordPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-ChangePassword',template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\change-password\change-password.html"*/'<ion-header>\n  <headerComponent [title]="title"></headerComponent>\n\n</ion-header>\n\n  <ion-content class="login-content" padding>\n      <ion-grid>\n          <ion-row>\n              <ion-col col-12 col-sm-2 col-md-3 col-lg-4 >\n            </ion-col>\n            <ion-col col-12 col-sm-8 col-md-6 col-lg-4>\n                <div class="login-box">\n                        <form  #registerForm="ngForm">\n                          <ion-row>\n                            <ion-col>\n                              <ion-list inset>\n                                <ion-item>\n                                  <ion-label>{{ChangePasswordCredentials.userName}}</ion-label>\n\n                    <!--               <ion-input type="text" disable placeholder="帳號" name="userName" #userName="ngModel" [(ngModel)]="ChangePasswordCredentials.userName" required  minlength="5" ></ion-input> -->\n                                </ion-item>\n                                  <ion-item>\n                                      <ion-input type="password" placeholder="原密碼" name="srcpassword" #srcpassword="ngModel" [(ngModel)]="src_password" required minlength="6"></ion-input>\n                                    </ion-item>\n                                   <div  *ngIf="srcpassword.errors && srcpassword.errors.required && srcpassword.touched"  class="error-message">\n                                      密碼不能為空白\n                                    </div>\n                                    <div  *ngIf="srcpassword.errors && srcpassword.errors.minlength && srcpassword.touched" class="error-message">\n                                      最少為6碼\n                                    </div>\n\n                                <ion-item>\n                                  <ion-input type="password" placeholder="密碼" name="password" #password="ngModel" [(ngModel)]="ChangePasswordCredentials.password" required minlength="6"></ion-input>\n                                </ion-item>\n                               <div  *ngIf="password.errors && password.errors.required && password.touched"  class="error-message">\n                                  密碼不能為空白\n                                </div>\n                                <div  *ngIf="password.errors && password.errors.minlength && password.touched" class="error-message">\n                                  最少為6碼\n                                </div>\n                                <ion-item>\n                                    <ion-input type="password" placeholder="確認密碼"  name="confirm_password" #confirmpassword="ngModel" [(ngModel)]="confirm_password" required minlength="6"></ion-input>\n                                    </ion-item>\n                                   <div  *ngIf="confirmpassword.errors && confirmpassword.errors.required && confirmpassword.touched"  class="error-message">\n                                      密碼不能為空白\n                                    </div>\n                                    <div  *ngIf="confirmpassword.errors && confirmpassword.errors.minlength && confirmpassword.touched" class="error-message">\n                                      最少為6碼\n                                    </div>\n                              </ion-list>\n                            </ion-col>\n                          </ion-row>\n\n                          <ion-row>\n                            <ion-col class="signup-col">\n                              <button ion-button class="submit-btn" full (click)="ChangePassword()" [disabled]="!registerForm.form.valid">確認</button>\n\n                            </ion-col>\n                          </ion-row>\n                        </form>\n                      </div>\n            </ion-col>\n            <ion-col col-12 col-sm-2 col-md-3 col-lg-4>\n            </ion-col>\n          </ion-row>\n        </ion-grid>\n\n  </ion-content>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\change-password\change-password.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__change_password__ = __webpack_require__(1281);
