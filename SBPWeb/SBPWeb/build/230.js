...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AuditLoggerDetailPage; });
...
/**
 * Generated class for the AuditLoggerDetailPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var AuditLoggerDetailPage = /** @class */ (function () {
    function AuditLoggerDetailPage(navCtrl, navParams, platform) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.platform = platform;
        this.item = navParams.data.item;
        this.title = __WEBPACK_IMPORTED_MODULE_2__Model_String__["a" /* String */].Format("稽核序號：{0}", navParams.data.item && navParams.data.item.data_seq || null);
        this.err_msg_log_page = "ErrMsgLogPage";
    }
    AuditLoggerDetailPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad AuditLoggerDetailPage');
    };
    AuditLoggerDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-audit-logger-detail',template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\audit-logger-detail\audit-logger-detail.html"*/'<ion-header>\n  <headerComponent [title]="\'稽核紀錄明細\'" [permission_id]="\'CanTable\'"></headerComponent>\n</ion-header>\n\n\n<ion-content padding>\n  <ion-grid>\n    <ion-row>\n      <ion-col col-12 col-sm-2 col-md-3>\n      </ion-col>\n      <ion-col col-12 col-sm-8 col-md-6>\n\n        <ion-grid [ngClass]="[\'bordered\']">\n          <ion-row>\n\n            <ion-col>\n              <div [ngClass]="[\'label80\']">\n                欄位名稱\n              </div>\n              <b>{{item.columnname}}</b>\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col>\n              <div [ngClass]="[\'label80\']">\n                稽核動作\n              </div>\n              {{item.audit_action_desc}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col>\n              <div [ngClass]="[\'label80\']">\n                主鍵內容\n              </div>\n              {{item.keyvalue}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col>\n              <div [ngClass]="[\'label100\']">\n                異動前內容\n              </div>\n              {{item.oldvalue}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col>\n              <div [ngClass]="[\'label100\']">\n                異動後內容\n              </div>\n              {{item.newvalue}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col>\n              <div [ngClass]="[\'label100\']">\n                修改使用者\n              </div>\n              {{item.modifyuser}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col>\n              <div [ngClass]="[\'label100\']">\n                使用者IP\n              </div>\n              {{item.client_ip}}\n\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              <div [ngClass]="[\'label80\']">\n                建立時間\n              </div>\n              <div *ngIf="platform.is(\'ios\')==true">\n                {{item.modifydate | date:\'y/MM/dd HH:mm:ss \'}}\n              </div>\n              <div *ngIf="platform.is(\'ios\')!=true">\n                {{item.modifydate | date:\'y/MM/dd HH:mm:ss\'}}\n              </div>\n            </ion-col>\n          </ion-row>\n\n          <ion-row>\n            <ion-col>\n              <div [ngClass]="[\'label100\']">\n                擴充欄位一\n              </div>\n              {{item.modifyextradata1}}\n            </ion-col>\n          </ion-row>\n\n          <ion-row>\n            <ion-col>\n              <div [ngClass]="[\'label100\']">\n                擴充欄位二\n              </div>\n              {{item.modifyextradata2}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              <div [ngClass]="[\'label100\']">\n                擴充欄位三\n              </div>\n              {{item.modifyextradata3}}\n            </ion-col>\n          </ion-row>\n           <ion-row>\n            <ion-col>\n              <div [ngClass]="[\'label100\']">\n                擴充欄位四\n              </div>\n              {{item.modifyextradata4}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              <div [ngClass]="[\'label100\']">\n                擴充欄位五\n              </div>\n              {{item.modifyextradata5}}\n            </ion-col>\n          </ion-row>\n        </ion-grid>\n      </ion-col>\n      <ion-col col-12 col-sm-2 col-md-3>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n\n\n\n\n</ion-content>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\audit-logger-detail\audit-logger-detail.html"*/,
        }),
    ...
    ], AuditLoggerDetailPage);
    return AuditLoggerDetailPage;
}());

//# sourceMappingURL=audit-logger-detail.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AuditLoggerDetailPageModule", function() { return AuditLoggerDetailPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__audit_logger_detail__ = __webpack_require__(1253);
...
var AuditLoggerDetailPageModule = /** @class */ (function () {
    function AuditLoggerDetailPageModule() {
    }
    AuditLoggerDetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__audit_logger_detail__["a" /* AuditLoggerDetailPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__audit_logger_detail__["a" /* AuditLoggerDetailPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], AuditLoggerDetailPageModule);
    return AuditLoggerDetailPageModule;
}());

//# sourceMappingURL=audit-logger-detail.module.js.map
