...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FtpDirectoryBrowserComponentsModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ftp_directory_browser_ftp_directory_browser__ = __webpack_require__(1060);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ftp_file_browser_ftp_file_browser__ = __webpack_require__(1061);
...
var FtpDirectoryBrowserComponentsModule = /** @class */ (function () {
    function FtpDirectoryBrowserComponentsModule() {
    }
    FtpDirectoryBrowserComponentsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__ftp_directory_browser_ftp_directory_browser__["a" /* FtpDirectoryBrowserComponent */],
                __WEBPACK_IMPORTED_MODULE_4__ftp_file_browser_ftp_file_browser__["a" /* FtpFileBrowserComponent */],
            ],
            imports: [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicModule */], __WEBPACK_IMPORTED_MODULE_2__components_module__["a" /* ComponentsModule */],],
            exports: [
                __WEBPACK_IMPORTED_MODULE_4__ftp_file_browser_ftp_file_browser__["a" /* FtpFileBrowserComponent */],
                __WEBPACK_IMPORTED_MODULE_3__ftp_directory_browser_ftp_directory_browser__["a" /* FtpDirectoryBrowserComponent */],
                __WEBPACK_IMPORTED_MODULE_2__components_module__["a" /* ComponentsModule */],
            ]
        })
    ], FtpDirectoryBrowserComponentsModule);
    return FtpDirectoryBrowserComponentsModule;
}());

//# sourceMappingURL=ftp-directory-browser.components.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FtpDirectoryBrowserComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Model_ViewModel_FtpDirectoryBrowserViewModel__ = __webpack_require__(916);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_ftp_directory_browser_services_ftp_directory_browser_services__ = __webpack_require__(288);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_conn_services_conn_services__ = __webpack_require__(266);
...
var FtpDirectoryBrowserComponent = /** @class */ (function () {
    function FtpDirectoryBrowserComponent(menuCtrl, navCtrl, navParams, FtpDirectoryBrowserServices, loadingCtrl, global, modalCtrl, alertCtrl, FilePathServices, authServices, ConnServices, platform, conf) {
        this.menuCtrl = menuCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.FtpDirectoryBrowserServices = FtpDirectoryBrowserServices;
        ...
        this.can_export_from_device = true;
        this.has_file = false;
        this.has_file_color = "danger";
        this.is_modal = false;
        this.show_select_type = "D"; //D:Direcotry,F:File
        this.show_select = false;
        this.onDirectorySelect = new __WEBPACK_IMPORTED_MODULE_1__angular_core__["EventEmitter"]();
        this.onFile = new __WEBPACK_IMPORTED_MODULE_1__angular_core__["EventEmitter"]();
        this.detail_page = "DirectoryBrowserDetailPage";
        this.step_page = "DirectoryBrowserStepPage";
        this.loop_page = "DirectoryBrowserLoopPage";
        this.sch_page = "SchByDirectoryBrowserPage";
    ...
    FtpDirectoryBrowserComponent.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit === Math.floor(this.pageSize / 4);
        if (this.authServices.authenticated() === true) {
            this.CanEditFtpFileBrowser = this.authServices.CanEditFtpFileBrowser();
            var user = this.authServices.getUserInfo();
            if (this.filter == null) {
                this.filter = new __WEBPACK_IMPORTED_MODULE_0__Model_ViewModel_FtpDirectoryBrowserViewModel__["a" /* FtpDirectoryBrowserViewModel */]();
                this.filter.remote_conn_id = user.Model.remote_conn_id;
                this.filter.conn_type_key = user.Model.conn_type_key;
                this.filter.conn_type = user.Model.conn_type;
                this.filter.encrypt_method_key = user.Model.encrypt_method_key;
                this.filter.encrypt_method = user.Model.encrypt_method;
                this.get_ftp_conn_string(user.Model.remote_conn_id);
            }
            else
                this.LoadData(true);
        }
    };
    FtpDirectoryBrowserComponent.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FtpDirectoryBrowserComponent.prototype.setPage = function (pageInfo) {
        this.pageNumber = Math.floor(pageInfo.offset / 4) + 1;
        if ((pageInfo.offset + 1) % 4 === 0) {
            if ((pageInfo.offset + 1) / 4 + 1 > this.loadPages) {
                this.loadPageNumber = this.pageNumber + 1;
                this.LoadData(false);
            }
        }
    };
    FtpDirectoryBrowserComponent.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FtpDirectoryBrowserComponent.prototype.add = function (filepath) {
        this.filter.filepath = filepath;
        this.onDirectorySelect.emit(this.filter);
    };
    FtpDirectoryBrowserComponent.prototype.close = function () {
        this.onDirectorySelect.emit(null);
    };
    FtpDirectoryBrowserComponent.prototype.doInfinite = function () {
        var _this = this;
    ...
    FtpDirectoryBrowserComponent.prototype.get_default_path = function () {
        var _this = this;
        this.global.createLoader("取得預設資料夾中...");
        this.global.loading.present().then(function () {
            _this.FilePathServices.GetPathAsync("004|RDN").subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
                else {
                    _this.parent_path = data.Model.file_path;
                    _this.global.dismissLoading();
                    _this.LoadData(true);
                }
            }, function (err) {
    ...
    FtpDirectoryBrowserComponent.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.FtpDirectoryBrowserServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.parent_path, _this.order_type, _this.filter.remote_conn_id, _this.filter.conn_type_key, _this.filter.encrypt_method_key).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FtpDirectoryBrowserComponent.prototype.CheckHasFile = function () {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FtpDirectoryBrowserServices.HasFile(_this.parent_path, _this.filter.remote_conn_id, _this.filter.conn_type_key, _this.filter.encrypt_method_key).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
                else {
                    _this.has_file = data.Model === "Y" ? true : false;
                    _this.has_file_color = data.Model === "Y" ? "danger" : "light";
                    _this.global.dismissLoading();
                }
            }, function (err) {
                _this.global.dismissLoading();
    ...
    FtpDirectoryBrowserComponent.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_0__Model_ViewModel_FtpDirectoryBrowserViewModel__["a" /* FtpDirectoryBrowserViewModel */]();
            item.filepath = this.parent_path;
            item.remote_conn_id = this.filter.remote_conn_id;
            item.conn_type_key = this.filter.conn_type_key;
            item.encrypt_method_key = this.filter.encrypt_method_key;
        }
        else {
            this.mode = "PUT";
            if (change_mode === "c") {
        ...
        var modal = this.modalCtrl.create("FtpDirectoryBrowserAddEditModalPage", {
            mode: this.mode,
            item: item,
            change_mode: change_mode,
            filter: this.filter,
            CanEditFtpFileBrowser: this.CanEditFtpFileBrowser
        });
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FtpDirectoryBrowserServices.PostPutAsync(item.filepath, select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("資料夾", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FtpDirectoryBrowserComponent.prototype.back = function () {
        try {
            this.parent_page.LoadData(true);
            this.parent_page.CheckHasFile();
        }
        catch (error) { }
        this.navCtrl.pop();
    };
    FtpDirectoryBrowserComponent.prototype.openNavPage = function (page, parent_path) {
        var _this = this;
        this.filter.filepath = parent_path;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(page, {
                parent_path: parent_path,
                parent_page: _this,
                is_modal: _this.is_modal,
                filter: _this.filter
            });
        });
    };
    FtpDirectoryBrowserComponent.prototype.openNavDirectorySelectPage = function (parent_path) {
        this.parent_path = parent_path;
        this.LoadData(true);
    };
    FtpDirectoryBrowserComponent.prototype.openNavFileSelectPage = function () {
        this.filter.filepath = this.parent_path;
        this.onFile.emit(this.filter);
    };
    FtpDirectoryBrowserComponent.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.directory_name),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FtpDirectoryBrowserServices.DeleteAsync(item.filepath, _this.filter.remote_conn_id, _this.filter.conn_type_key, _this.filter.encrypt_method_key).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FtpDirectoryBrowserComponent.prototype.get_ftp_conn_string = function (remote_conn_id) {
        var _this = this;
        ...
        this.global.loading.present().then(function () {
            _this.ConnServices.GetConnAsync(remote_conn_id).subscribe(function (data) {
                if (data.DidError === true) {
                    ...
                    _this.filter.remote_conn_string = data.Model.conn_string;
                    if (_this.parent_path === "")
                        _this.get_default_path();
                    else
                        _this.global.dismissLoading();
                }
            }, function (err) {
    ...
    FtpDirectoryBrowserComponent.prototype.SelectConn = function () {
        var _this = this;
        var modal = this.modalCtrl.create("ConnSelectModalPage", {
            select_remote_conn_id: this.filter.remote_conn_id,
            conn_type_key: "065|002"
        });
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
            _this.filter.remote_conn_id = select_data.remote_conn_id;
            _this.filter.remote_conn_string = select_data.conn_string;
        });
        modal.present();
    };
    FtpDirectoryBrowserComponent.prototype.SelectConnType = function () {
        var _this = this;
        var modal = this.modalCtrl.create("CodeSelectModalPage", {
            select_key: this.filter.conn_type_key,
            code_type: "006"
        });
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
            _this.filter.conn_type_key = select_data.code_key;
            _this.filter.conn_type = select_data.code_desc;
            if (_this.filter.conn_type_key === "006|3") {
                _this.filter.encrypt_method_key = "046|2";
                _this.filter.encrypt_method = "Explicit_SSL(外顯式)";
            }
            else {
                _this.filter.encrypt_method_key = "046|1";
                _this.filter.encrypt_method = "無";
            }
        });
        modal.present();
    };
    FtpDirectoryBrowserComponent.prototype.SelectEncryptMethod = function () {
        var _this = this;
        var modal = this.modalCtrl.create("CodeSelectModalPage", {
            select_key: this.filter.encrypt_method_key,
            code_type: "046"
        });
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
            _this.filter.encrypt_method_key = select_data.code_key;
            _this.filter.encrypt_method = select_data.code_desc;
        });
        modal.present();
    };
    FtpDirectoryBrowserComponent.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad DirectoryBrowser");
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Input"])(),
        __metadata("design:type", Boolean)
    ], FtpDirectoryBrowserComponent.prototype, "is_modal", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Input"])(),
        __metadata("design:type", Object)
    ], FtpDirectoryBrowserComponent.prototype, "parent_page", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Input"])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */])
    ], FtpDirectoryBrowserComponent.prototype, "parent_path", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Input"])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */])
    ], FtpDirectoryBrowserComponent.prototype, "show_select_type", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Input"])(),
        __metadata("design:type", Boolean)
    ], FtpDirectoryBrowserComponent.prototype, "show_select", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Input"])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__Model_ViewModel_FtpDirectoryBrowserViewModel__["a" /* FtpDirectoryBrowserViewModel */])
    ], FtpDirectoryBrowserComponent.prototype, "filter", void 0);
    FtpDirectoryBrowserComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Component"])({
            selector: "FtpDirectoryBrowserComponent",
            outputs: ["onDirectorySelect", "onFile"],template:/*ion-inline-start:"C:\jones\ionic\prod\src\components\ftp-directory-browser\ftp-directory-browser.html"*/'<ion-content (window:resize)="onResize($event)">\n    <ion-row>\n        <ion-col col-12 col-sm-4>\n          <ion-item>\n            <ion-label stacked>連線</ion-label>\n            <ion-input type="text" name="remote_conn_id" #remote_conn_id="ngModel" [(ngModel)]="filter.remote_conn_id"\n              required></ion-input>\n\n            <button ion-button outline item-end icon-right (click)="SelectConn()">\n              <ion-icon name="arrow-dropdown"></ion-icon>\n            </button>\n          </ion-item>\n\n          <div *ngIf="remote_conn_id.errors && remote_conn_id.touched " class="error-message">\n            連線不能為空白\n          </div>\n        </ion-col>\n        <ion-col col-12 col-sm-8>\n          <ion-item>\n            <ion-label stacked>連線</ion-label>\n\n            <ion-textarea [disabled]=true name="remote_conn_string" #remote_conn_string="ngModel" [(ngModel)]="filter.remote_conn_string" required>\n            </ion-textarea>\n          </ion-item>\n        </ion-col>\n      </ion-row>\n      <ion-row>\n        <ion-col col-12 col-sm-4>\n          <ion-item>\n            <ion-label stacked>連線類型</ion-label>\n            <ion-input type="text"  name="conn_type_key" #conn_type_key="ngModel" [(ngModel)]="filter.conn_type_key"\n              required></ion-input>\n\n            <button ion-button outline item-end  icon-right (click)="SelectConnType()">\n              <ion-icon name="arrow-dropdown"></ion-icon>\n            </button>\n          </ion-item>\n\n          <div *ngIf="conn_type_key.errors && conn_type_key.touched " class="error-message">\n            連線類型不能為空白\n          </div>\n        </ion-col>\n        <ion-col col-12 col-sm-8>\n          <ion-item>\n            <ion-label stacked>連線類型</ion-label>\n\n            <ion-textarea [disabled]=true name="conn_type" #conn_type="ngModel" [(ngModel)]="filter.conn_type" required>\n            </ion-textarea>\n          </ion-item>\n        </ion-col>\n      </ion-row>\n      <ion-row *ngIf="filter.conn_type_key==\'006|3\'" >\n        <ion-col col-12 col-sm-4>\n          <ion-item>\n            <ion-label stacked>壓密方法</ion-label>\n            <ion-input type="text" name="encrypt_method_key" #encrypt_method_key="ngModel" [(ngModel)]="filter.encrypt_method_key"\n              required></ion-input>\n\n            <button ion-button outline item-end  icon-right (click)="SelectEncryptMethod()">\n              <ion-icon name="arrow-dropdown"></ion-icon>\n            </button>\n          </ion-item>\n\n          <div *ngIf="encrypt_method_key.errors && encrypt_method_key.touched " class="error-message">\n            壓密方法不能為空白\n          </div>\n        </ion-col>\n        <ion-col col-12 col-sm-8>\n          <ion-item>\n            <ion-label stacked>壓密方法</ion-label>\n\n            <ion-textarea [disabled]=true name="encrypt_method" #encrypt_method="ngModel" [(ngModel)]="filter.encrypt_method" required>\n            </ion-textarea>\n          </ion-item>\n        </ion-col>\n      </ion-row>\n  <ion-row>\n    <ion-col col-12 col-sm-8>\n\n      <ion-searchbar [ngClass]="[\'search\']" (keyup.enter)="LoadData(true)" placeholder="資料夾路徑" [(ngModel)]="parent_path">\n      </ion-searchbar>\n\n    </ion-col>\n    <ion-col col-12 col-sm-4>\n\n      <ion-searchbar [ngClass]="[\'search\']" (keyup.enter)="LoadData(true)" placeholder="資料夾名稱包含" [(ngModel)]="keyword">\n      </ion-searchbar>\n\n    </ion-col>\n  </ion-row>\n  <ion-grid *ngIf="conf.mobile_mode==false && selectedItem!=null" [ngClass]="\'bordered\'">\n    <ion-row>\n      <ion-col>\n        <button small title="變更" ion-button color="light" icon-left (click)="ShowModal(selectedItem)">\n          <ion-icon name="create"></ion-icon>\n        </button>\n        <button small title="複製" ion-button color="light" icon-left (click)="ShowModal(selectedItem,\'c\')">\n          <ion-icon name="copy"></ion-icon>\n        </button>\n        <button small title="刪除" ion-button color="dark" icon-left (click)="Delete(selectedItem)">\n          <ion-icon name="trash"></ion-icon>\n        </button>\n        <button small title="下層" *ngIf="show_select==false" ion-button color="secondary" icon-left (click)="openNavPage(\'FtpDirectoryBrowserPage\',selectedItem.filepath)">\n          <ion-icon name="folder"></ion-icon>\n        </button>\n        <button small title="下層" *ngIf="show_select==true" ion-button color="secondary" icon-left (click)="openNavDirectorySelectPage(selectedItem.filepath)">\n          <ion-icon name="folder"></ion-icon>\n        </button>\n        <button small title="加入" *ngIf="show_select_type==\'D\' && show_select==true" ion-button color="danger" icon-left (click)="add(selectedItem.filepath)">\n          <ion-icon name="checkmark-circle"></ion-icon>\n        </button>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n  <ngx-datatable NgxResizeWatcher class="bootstrap" *ngIf="totalRows>0 && conf.mobile_mode==false" [selected]="selected" [selectionType]="\'single\'"\n    (select)=\'onRowSelect($event)\'   [rows]="data_list" [columnMode]="\'flex\'" [headerHeight]="40" [rowHeight]="\'auto\'" [footerHeight]="40"\n    [reorderable]=false [limit]="limit" [count]="totalRows" [offset]="offset" (page)=\'setPage($event)\'>\n\n    <ngx-datatable-column prop="directory_name" name="資料夾" [flexGrow]="1" [frozenLeft]="true">\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="create_time" name="建立時間" [flexGrow]="2" *ngIf="innerWidth>=1024">\n      <ng-template let-value="value" ngx-datatable-cell-template>\n        <div *ngIf="platform.is(\'ios\')==true">\n          {{value | date:\'y/MM/dd HH:mm:ss \'}}\n        </div>\n        <div *ngIf="platform.is(\'ios\')!=true">\n          {{value | date:\'y/MM/dd HH:mm:ss\'}}\n        </div>\n      </ng-template>\n\n    </ngx-datatable-column>\n\n  </ngx-datatable>\n  <div *ngIf="totalRows>0 && conf.mobile_mode==true">\n    <ion-row>\n      <ion-col col-lg-4 col-md-6 col-sm-6 col-12 *ngFor="let item of data_list">\n        <ion-grid [ngClass]="\'bordered\'">\n\n          <ion-row>\n            <ion-col>\n              <button small title="變更" ion-button color="light" icon-left (click)="ShowModal(item)">\n                <ion-icon name="create"></ion-icon>\n              </button>\n              <button small title="複製" ion-button color="light" icon-left (click)="ShowModal(item,\'c\')">\n                <ion-icon name="copy"></ion-icon>\n              </button>\n              <button small title="刪除" ion-button color="dark" icon-left (click)="Delete(item)">\n                <ion-icon name="trash"></ion-icon>\n              </button>\n              <button small title="下層" *ngIf="show_select==false" ion-button color="secondary" icon-left (click)="openNavPage(\'FtpDirectoryBrowserPage\',item.filepath)">\n                <ion-icon name="folder"></ion-icon>\n              </button>\n              <button small title="下層" *ngIf="show_select==true" ion-button color="secondary" icon-left (click)="openNavDirectorySelectPage(item.filepath)">\n                <ion-icon name="folder"></ion-icon>\n              </button>\n              <button small title="加入" *ngIf="show_select_type==\'D\' && show_select==true" ion-button color="danger" icon-left (click)="add(item.filepath)">\n                <ion-icon name="checkmark-circle"></ion-icon>\n              </button>\n            </ion-col>\n          </ion-row>\n\n          <ion-row>\n            <ion-col>\n              {{item.directory_name}}\n            </ion-col>\n          </ion-row>\n\n          <ion-row>\n            <ion-col>\n              {{item.create_time | date:\'short\'}}\n\n            </ion-col>\n          </ion-row>\n\n\n        </ion-grid>\n        </ion-col>\n    </ion-row>\n  </div>\n  <ion-infinite-scroll *ngIf="pageNumber < totalPages && conf.mobile_mode==true" (ionInfinite)="$event.waitFor(doInfinite())">\n    <ion-infinite-scroll-content loadingSpinner="bubbles">\n    </ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n</ion-content>\n<ion-footer>\n  <ion-toolbar>\n    <ion-row>\n      <ion-col>\n        <div [ngClass]="[\'command\']">\n          <button small title="重新整理" ion-button color="dark" icon-left (click)="LoadData(true)">\n            <ion-checkbox name="order_type" title="遞增/遞減" color="dark" [(ngModel)]="order_type" (ionChange)="LoadData(true)"></ion-checkbox>\n            <ion-icon name="refresh"></ion-icon>\n          </button>\n          <button small title="返回" *ngIf="navCtrl.canGoBack() && show_select==false" ion-button color="dark" icon-left (click)="back()">\n            <ion-icon name="backspace"></ion-icon>\n          </button>\n          <button small title="取消" *ngIf="show_select==true" ion-button color="dark" icon-left (click)="close()">\n            <ion-icon name="backspace"></ion-icon>\n          </button>\n          <button small title="新增" ion-button color="dark" icon-left (click)="ShowModal(null)">\n            <ion-icon name="add"></ion-icon>\n          </button>\n          <button small title="檔案" *ngIf="show_select==false" ion-button [color]="has_file_color" icon-left (click)="openNavPage(\'FtpFileBrowserPage\',parent_path)">\n            <ion-icon name="document"></ion-icon>\n          </button>\n          <button small title="檔案" *ngIf="show_select_type==\'F\'" ion-button [color]="has_file_color" icon-left (click)="openNavFileSelectPage()">\n            <ion-icon name="document"></ion-icon>\n          </button>\n          <button small title="加入" *ngIf="show_select_type==\'D\' && show_select==true" ion-button color="danger" icon-left (click)="add(parent_path)">\n            <ion-icon name="checkmark-circle"></ion-icon>\n          </button>\n\n        </div>\n        <StatusComponent [pageNumber]="pageNumber" [totalPages]="totalPages" [totalRows]="totalRows"></StatusComponent>\n      </ion-col>\n\n    </ion-row>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\components\ftp-directory-browser\ftp-directory-browser.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["i" /* MenuController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_ftp_directory_browser_services_ftp_directory_browser_services__["a" /* FtpDirectoryBrowserServicesProvider */],
            ...
            __WEBPACK_IMPORTED_MODULE_8__providers_conn_services_conn_services__["a" /* ConnServicesProvider */],
    ...
    ], FtpDirectoryBrowserComponent);
    return FtpDirectoryBrowserComponent;
}());

//# sourceMappingURL=ftp-directory-browser.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FtpFileBrowserComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_ftp_file_browser_services_ftp_file_browser_services__ = __webpack_require__(282);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_global_global__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_ViewModel_FtpFileBrowserViewModel__ = __webpack_require__(927);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_file_path_services_file_path_services__ = __webpack_require__(267);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_auth_services_auth_services__ = __webpack_require__(64);
...
var FtpFileBrowserComponent = /** @class */ (function () {
    function FtpFileBrowserComponent(menuCtrl, navCtrl, navParams, FtpFileBrowserServices, loadingCtrl, global, modalCtrl, alertCtrl, FilePathServices, authServices, platform, conf) {
        this.menuCtrl = menuCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.FtpFileBrowserServices = FtpFileBrowserServices;
        this.loadingCtrl = loadingCtrl;
        this.global = global;
        this.modalCtrl = modalCtrl;
        this.alertCtrl = alertCtrl;
        ...
        this.onDirectory = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        this.detail_page = "FileBrowserDetailPage";
        this.step_page = "FileBrowserStepPage";
        this.loop_page = "FileBrowserLoopPage";
        this.sch_page = "SchByFileBrowserPage";
        this.err_msg_log_page = "ErrMsgLogPage";
        this.innerWidth = window.innerWidth;
        this.innerHeight = window.innerHeight;
        this.pageNumber = 1;
        this.order_type = true;
        this.is_app = this.global.check_app();
    }
    FtpFileBrowserComponent.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
        if (this.authServices.authenticated() === true) {
            this.CanEditFileBrowser = this.authServices.CanEditFtpFileBrowser();
            this.CanDownloadFileBrowser = this.authServices.CanDownloadFtpFileBrowser();
            this.CanUploadFileBrowser = this.authServices.CanUploadFtpFileBrowser();
            if (this.parent_path > "") {
                this.LoadData(true);
            }
            else {
    ...
    FtpFileBrowserComponent.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FtpFileBrowserComponent.prototype.setPage = function (pageInfo) {
    ...
    FtpFileBrowserComponent.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FtpFileBrowserComponent.prototype.doInfinite = function () {
        var _this = this;
        console.log("Begin async operation");
        if (this.loadPages < this.totalPages) {
            this.pageNumber++;
    ...
    FtpFileBrowserComponent.prototype.ShowModal = function (item) {
        var _this = this;
        this.filter.filepath = item.filepath;
        this.filter.filename = item.filename;
        this.filter.filefullname = item.filefullname;
        var modal = this.modalCtrl.create("FtpFileBrowserEditModalPage", {
            item: this.filter,
            CanEditFileBrowser: this.CanEditFileBrowser
        });
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
            _this.global.createLoader();
            _this.global.loading.present().then(function () {
                _this.FtpFileBrowserServices.PutAsync(item.filefullname, select_data).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("檔案", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FtpFileBrowserComponent.prototype.add = function (item) {
        this.filter.filepath = item.filepath;
        this.filter.filename = item.filename;
        this.filter.filefullname = item.filefullname;
        this.onSelect.emit(this.filter);
    };
    FtpFileBrowserComponent.prototype.close = function () {
        this.onSelect.emit(null);
    };
    FtpFileBrowserComponent.prototype.get_default_path = function () {
        var _this = this;
        this.global.createLoader("取得預設資料夾中...");
        this.global.loading.present().then(function () {
            _this.FilePathServices.GetPathAsync("004|RDN").subscribe(function (data) {
    ...
    FtpFileBrowserComponent.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FtpFileBrowserServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.parent_path, _this.order_type, _this.filter.remote_conn_id, _this.filter.conn_type_key, _this.filter.encrypt_method_key).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FtpFileBrowserComponent.prototype.DownloadFile = function (item) {
        var _this = this;
        item.remote_conn_id = this.filter.remote_conn_id;
        item.conn_type_key = this.filter.conn_type_key;
        item.encrypt_method_key = this.filter.encrypt_method_key;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push("FtpFileBrowserDownloadPage", { download_file: item, parent_page: _this });
        });
    };
    FtpFileBrowserComponent.prototype.UploadFile = function () {
        var _this = this;
        this.filter.filepath = this.parent_path;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push("FtpFileBrowserUploadPage", { ftpDirectory: _this.filter, parent_page: _this });
        });
    };
    FtpFileBrowserComponent.prototype.back = function () {
        this.navCtrl.pop();
    };
    FtpFileBrowserComponent.prototype.openNavPage = function (page, parent_path) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(page, { path: parent_path });
        });
    };
    FtpFileBrowserComponent.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.filename),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FtpFileBrowserServices.DeleteAsync(item.filepath, item.filename, _this.filter.remote_conn_id, _this.filter.conn_type_key, _this.filter.encrypt_method_key).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
                                    _this.global.showPopup("刪除", data.Message);
    ...
    FtpFileBrowserComponent.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad FileBrowser");
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Boolean)
    ], FtpFileBrowserComponent.prototype, "is_modal", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Object)
    ], FtpFileBrowserComponent.prototype, "parent_page", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */])
    ], FtpFileBrowserComponent.prototype, "parent_path", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Boolean)
    ], FtpFileBrowserComponent.prototype, "show_select", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_4__Model_ViewModel_FtpFileBrowserViewModel__["a" /* FtpFileBrowserViewModel */])
    ], FtpFileBrowserComponent.prototype, "filter", void 0);
    FtpFileBrowserComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "FtpFileBrowserComponent",
            outputs: ['onSelect', 'onDirectory'],template:/*ion-inline-start:"C:\jones\ionic\prod\src\components\ftp-file-browser\ftp-file-browser.html"*/'<ion-content (window:resize)="onResize($event)">\n  <ion-row>\n    <ion-col col-12 >\n      <ion-searchbar [ngClass]="[\'search\']" (keyup.enter)="LoadData(true)" placeholder="檔案名稱包含"\n        [(ngModel)]="keyword">\n      </ion-searchbar>\n    </ion-col>\n  </ion-row>\n  <ion-grid >\n    <ion-row>\n      <ion-col col-12 col-sm-2 col-md-3>\n      </ion-col>\n      <ion-col col-12 col-sm-8 col-md-6>\n        <ion-grid [ngClass]="[\'subject\']">\n          <ion-row>\n            <ion-col>\n              <b>{{parent_path}}</b>\n            </ion-col>\n          </ion-row>\n\n        </ion-grid>\n      </ion-col>\n      <ion-col col-12 col-sm-2 col-md-3>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n  <ion-grid *ngIf="conf.mobile_mode==false && selectedItem!=null" [ngClass]="\'bordered\'">\n    <ion-row>\n      <ion-col>\n        <button small title="變更" ion-button color="light" icon-left (click)="ShowModal(selectedItem)">\n          <ion-icon name="create"></ion-icon>\n        </button>\n    <button small title="下載" *ngIf="CanDownloadFileBrowser==true " ion-button color="light" icon-left (click)="DownloadFile(selectedItem)">\n      <ion-icon name="download"></ion-icon>\n    </button>\n\n    <button small  title="刪除"  ion-button color="dark" icon-left (click)="Delete(selectedItem)">\n      <ion-icon name="trash"></ion-icon>\n    </button>\n    <button small  title="加入" *ngIf="show_select==true" ion-button color="danger" icon-left (click)="add(selectedItem)">\n      <ion-icon name="checkmark-circle"></ion-icon>\n    </button>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n  <ngx-datatable NgxResizeWatcher class="bootstrap" *ngIf="totalRows>0 && conf.mobile_mode==false" [selected]="selected" [selectionType]="\'single\'"\n    (select)=\'onRowSelect($event)\'   [rows]="data_list" [columnMode]="\'flex\'" [headerHeight]="40" [rowHeight]="\'auto\'" [footerHeight]="40"\n    [reorderable]=false [limit]="limit" [count]="totalRows" [offset]="offset" (page)=\'setPage($event)\'>\n\n    <ngx-datatable-column prop="filename" name="檔案名稱" [flexGrow]="1" [frozenLeft]="true">\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="file_size_desc" name="檔案容量" [flexGrow]="1" [frozenLeft]="true">\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="create_time" name="建立時間" [flexGrow]="2" *ngIf="innerWidth>=1024">\n      <ng-template let-value="value" ngx-datatable-cell-template>\n        <div *ngIf="platform.is(\'ios\')==true">\n          {{value | date:\'y/MM/dd HH:mm:ss \'}}\n        </div>\n        <div *ngIf="platform.is(\'ios\')!=true">\n          {{value | date:\'y/MM/dd HH:mm:ss\'}}\n        </div>\n      </ng-template>\n\n    </ngx-datatable-column>\n\n  </ngx-datatable>\n  <div *ngIf="totalRows>0 && conf.mobile_mode==true">\n    <ion-row>\n      <ion-col col-lg-4 col-md-6 col-sm-6 col-12 *ngFor="let item of data_list">\n        <ion-grid [ngClass]="[\'bordered\']">\n\n          <ion-row>\n            <ion-col>\n                <button small title="變更" ion-button color="light" icon-left (click)="ShowModal(item)">\n                    <ion-icon name="create"></ion-icon>\n                  </button>\n              <button small title="下載" *ngIf="CanDownloadFileBrowser==true " ion-button color="light" icon-left (click)="DownloadFile(item)">\n                <ion-icon name="download"></ion-icon>\n              </button>\n\n              <button small  title="刪除"  ion-button color="dark" icon-left (click)="Delete(item)">\n                <ion-icon name="trash"></ion-icon>\n              </button>\n              <button small  title="加入" *ngIf="show_select==true" ion-button color="danger" icon-left (click)="add(item)">\n                <ion-icon name="checkmark-circle"></ion-icon>\n              </button>\n            </ion-col>\n          </ion-row>\n\n          <ion-row>\n            <ion-col>\n              {{item.filename}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              {{item.file_size_desc}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              {{item.create_time | date:\'short\'}}\n\n            </ion-col>\n          </ion-row>\n\n\n        </ion-grid>\n      </ion-col>\n    </ion-row>\n  </div>\n  <ion-infinite-scroll *ngIf="pageNumber < totalPages && conf.mobile_mode==true" (ionInfinite)="$event.waitFor(doInfinite())">\n    <ion-infinite-scroll-content loadingSpinner="bubbles">\n    </ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n</ion-content>\n<ion-footer>\n  <ion-toolbar>\n    <ion-row>\n      <ion-col>\n        <div [ngClass]="[\'command\']">\n          <button small title="重新整理" ion-button color="dark" icon-left (click)="LoadData(true)">\n            <ion-checkbox name="order_type" title="遞增/遞減" color="dark" [(ngModel)]="order_type" (ionChange)="LoadData(true)"></ion-checkbox>\n            <ion-icon name="refresh"></ion-icon>\n          </button>\n          <button small title="返回" *ngIf="navCtrl.canGoBack() && show_select==false" ion-button color="dark" icon-left (click)="back()">\n            <ion-icon name="backspace"></ion-icon>\n          </button>\n          <button small title="取消" *ngIf="show_select==true" ion-button color="dark" icon-left (click)="close()">\n            <ion-icon name="backspace"></ion-icon>\n          </button>\n          <button small title="上傳" *ngIf="CanUploadFileBrowser==true "  ion-button color="dark" icon-left (click)="UploadFile()">\n            <ion-icon name="cloud-upload"></ion-icon>\n          </button>\n\n\n        </div>\n        <StatusComponent [pageNumber]="pageNumber" [totalPages]="totalPages" [totalRows]="totalRows"></StatusComponent>\n      </ion-col>\n\n    </ion-row>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\components\ftp-file-browser\ftp-file-browser.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* MenuController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__providers_ftp_file_browser_services_ftp_file_browser_services__["a" /* FtpFileBrowserServicesProvider */],
            ...
            __WEBPACK_IMPORTED_MODULE_8__Model_MyAppSharedSettings__["a" /* MyAppSharedSettings */]])
    ], FtpFileBrowserComponent);
    return FtpFileBrowserComponent;
}());

//# sourceMappingURL=ftp-file-browser.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FtpDirectoryBrowserSelectModalPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
/**
 * Generated class for the DirectoryBrowserSelectModalPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var FtpDirectoryBrowserSelectModalPage = /** @class */ (function () {
    function FtpDirectoryBrowserSelectModalPage(navCtrl, navParams, viewCtrl, modalCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.viewCtrl = viewCtrl;
        this.modalCtrl = modalCtrl;
        this.parent_page = this;
        this.select_mode = "Directory";
        this.parent_path = navParams.data.parent_path;
        this.show_select_type = navParams.data.show_select_type;
    }
    FtpDirectoryBrowserSelectModalPage.prototype.onDirSelect = function (item) {
        this.viewCtrl.dismiss(item);
    };
    FtpDirectoryBrowserSelectModalPage.prototype.onFileSelect = function (item) {
        this.viewCtrl.dismiss(item);
    };
    FtpDirectoryBrowserSelectModalPage.prototype.onFile = function (filter) {
        this.select_mode = "file";
        this.filter = filter;
        this.parent_path = filter.filepath;
    };
    FtpDirectoryBrowserSelectModalPage.prototype.onDirectory = function () {
        this.select_mode = "Directory";
    };
    FtpDirectoryBrowserSelectModalPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad FtpDirectoryBrowserSelectModalPage');
    };
    FtpDirectoryBrowserSelectModalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-ftp-directory-browser-select-modal',template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\ftp-directory-browser-select-modal\ftp-directory-browser-select-modal.html"*/'<FtpDirectoryBrowserComponent [title]="\'資料夾\'" *ngIf="select_mode!=\'file\'" (onFile)="onFile($event)" (onDirectorySelect)="onDirSelect($event)" [is_modal]=true [parent_path]="parent_path" [parent_page]="parent_page"  [show_select]=true [show_select_type]="show_select_type" ></FtpDirectoryBrowserComponent>\n<FtpFileBrowserComponent [title]="\'檔案\'" *ngIf="show_select_type==\'F\' && select_mode==\'file\'" (onDirectory)="onDirectory($event)" (onSelect)="onFileSelect($event)" [is_modal]=true [parent_path]="parent_path" [filter]="filter" [parent_page]="parent_page"  [show_select]=true ></FtpFileBrowserComponent>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\ftp-directory-browser-select-modal\ftp-directory-browser-select-modal.html"*/,
        }),
    ...
    ], FtpDirectoryBrowserSelectModalPage);
    return FtpDirectoryBrowserSelectModalPage;
}());

//# sourceMappingURL=ftp-directory-browser-select-modal.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FtpDirectoryBrowserSelectModalPageModule", function() { return FtpDirectoryBrowserSelectModalPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ftp_directory_browser_select_modal__ = __webpack_require__(1511);
...
var FtpDirectoryBrowserSelectModalPageModule = /** @class */ (function () {
    function FtpDirectoryBrowserSelectModalPageModule() {
    }
    FtpDirectoryBrowserSelectModalPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__ftp_directory_browser_select_modal__["a" /* FtpDirectoryBrowserSelectModalPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__ftp_directory_browser_select_modal__["a" /* FtpDirectoryBrowserSelectModalPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_ftp_directory_browser_components_module__["a" /* FtpDirectoryBrowserComponentsModule */],
            ],
        })
    ], FtpDirectoryBrowserSelectModalPageModule);
    return FtpDirectoryBrowserSelectModalPageModule;
}());

//# sourceMappingURL=ftp-directory-browser-select-modal.module.js.map
