...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchWeekTimeServicesProvider; });
...
/*
  Generated class for the SchWeekTimeServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var SchWeekTimeServicesProvider = /** @class */ (function (_super) {
    __extends(SchWeekTimeServicesProvider, _super);
    function SchWeekTimeServicesProvider(Services) {
        var _this = _super.call(this, Services) || this;
        _this.Services = Services;
        _this.ctl = "SchWeekTime";
        console.log("Hello SchWeekTimeServiceProvider Provider");
        return _this;
    }
    SchWeekTimeServicesProvider.prototype.GetListsAsync = function (PageSize, PageNumber, keyword, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "SchWeekTime?PageSize={1}&PageNumber={2}&keyword={3}&order_type={4}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.SchWeekTimes = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_SchWeekTimeListResponse__["a" /* SchWeekTimeListResponse */]({
            ...
            return _this.SchWeekTimes;
        });
    };
    SchWeekTimeServicesProvider.prototype.GetListsByJobAsync = function (PageSize, PageNumber, keyword, ssis_job_no, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "SchWeekTime?PageSize={1}&PageNumber={2}&keyword={3}&ssis_job_no={4}&order_type={5}";
    ...
    SchWeekTimeServicesProvider.prototype.GetAsync = function (sch_no) {
        var _this = this;
        var sub_url;
        sub_url = "SchWeekTime/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, sch_no);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.SchWeekTime = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_SchWeekTimeResponse__["a" /* SchWeekTimeResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.SchWeekTime;
        });
    };
    SchWeekTimeServicesProvider.prototype.PostPutAsync = function (SchWeekTimeViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "SchWeekTime";
            ...
            sub_url = "SchWeekTime/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, SchWeekTimeViewModel.sch_no);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, SchWeekTimeViewModel, mode).map(function (item) {
            _this.SchWeekTime = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_SchWeekTimeResponse__["a" /* SchWeekTimeResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchWeekTimePage; });
...
/**
 * Generated class for the SchWeekTimePage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var SchWeekTimePage = /** @class */ (function (_super) {
    __extends(SchWeekTimePage, _super);
    function SchWeekTimePage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, SchWeekTimeServices, modalCtrl, SchServices, platform, conf) {
        ...
        _this.SchWeekTimeServices = SchWeekTimeServices;
    ...
    SchWeekTimePage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    SchWeekTimePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    SchWeekTimePage.prototype.setPage = function (pageInfo) {
    ...
    SchWeekTimePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    SchWeekTimePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    SchWeekTimePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.SchWeekTimeServices.GetListsAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    SchWeekTimePage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_SchWeekTimeViewModel__["a" /* SchWeekTimeViewModel */]();
            item.sch_no = "auto";
        ...
        var modal = this.modalCtrl.create("SchWeekTimeAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
            select_data.freq_interval = null;
            _this.global.createLoader();
            _this.global.loading.present().then(function () {
                _this.SchWeekTimeServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    SchWeekTimePage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.SchWeekTimeServices.DeleteAsync(item.sch_no).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    SchWeekTimePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_sch_week_time_services_sch_week_time_services__["a" /* SchWeekTimeServicesProvider */],
    ...
    return SchWeekTimePage;
}(__WEBPACK_IMPORTED_MODULE_8__sch_sch__["a" /* SchPage */]));

//# sourceMappingURL=sch-week-time.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchWeekTimeListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ListModelResponse__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_SchWeekTimeViewModel__ = __webpack_require__(1077);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
 ...
 * @param   {Function}    [name]
 */
var SchWeekTimeListResponse = /** @class */ (function (_super) {
    __extends(SchWeekTimeListResponse, _super);
    function SchWeekTimeListResponse(obj) {
        ...
        if (obj.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_SchWeekTimeViewModel__["a" /* SchWeekTimeViewModel */]();
                item.sch_no = data.sch_no;
                item.sch_name = data.sch_name;
                item.freq_interval = data.freq_interval;
                item.freq_interval_desc = data.freq_interval_desc;
                item.Sun = data.Sun;
                item.Mon = data.Mon;
                item.Tue = data.Tue;
                item.Wed = data.Wed;
    ...
    return SchWeekTimeListResponse;
}(__WEBPACK_IMPORTED_MODULE_0__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=SchWeekTimeListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchWeekTimeResponse; });
...
var SchWeekTimeResponse = /** @class */ (function (_super) {
    __extends(SchWeekTimeResponse, _super);
    function SchWeekTimeResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_SchWeekTimeViewModel__["a" /* SchWeekTimeViewModel */]();
            ...
            _this.Model.freq_interval_desc = obj.Model.freq_interval_desc;
            _this.Model.Sun = obj.Model.Sun;
            _this.Model.Mon = obj.Model.Mon;
            _this.Model.Tue = obj.Model.Tue;
            _this.Model.Wed = obj.Model.Wed;
            _this.Model.Thu = obj.Model.Thu;
            _this.Model.Fri = obj.Model.Fri;
            _this.Model.Sat = obj.Model.Sat;
...
var SchWeekTimePageModule = /** @class */ (function () {
    function SchWeekTimePageModule() {
    }
    SchWeekTimePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__sch_week_time__["a" /* SchWeekTimePage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_sch_week_time_services_sch_week_time_services__["a" /* SchWeekTimeServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__sch_week_time__["a" /* SchWeekTimePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], SchWeekTimePageModule);
    return SchWeekTimePageModule;
}());

//# sourceMappingURL=sch-week-time.module.js.map
