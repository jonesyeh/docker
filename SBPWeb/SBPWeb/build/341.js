...
var FileDirectoryAddEditModalPage = /** @class */ (function () {
    function FileDirectoryAddEditModalPage(navCtrl, navParams, viewCtrl, FileManagementServices, FilePathServices, loadingCtrl, global, modalCtrl) {
        ...
        this.file_keyword_help = "\n  \u8CC7\u6599\u593E\u641C\u5C0B\u95DC\u9375\u5B57\u8AAA\u660E\uFF1A\n  \u4F7F\u7528*\u8868\u793A\u8CC7\u6599\u593E\u95DC\u9375\u5B57:\u4F8B\u59822019*\uFF1A\u8868\u793A2019\u4E4B\u5F8C\u4EFB\u4F55\u5B57\u5143\u90FD\u53EF\u4EE5\n  \u7B2C\u4E00\u78BC\u70BA\u7279\u6B8A\u63A7\u5236\u78BC\uFF0C\u53EF\u4F7F\u7528@<>\u4E09\u7A2E\u63A7\u5236\u78BC\n  @:\u8868\u793A\u5169\u8D77\u8FC4\u65E5\u671F\u5340\u9593\n  <:\u8868\u793A\u5C0F\u65BC\u65E5\u671F\n  >:\u8868\u793A\u5927\u65BC\u65E5\u671F\n  \u4EE5\u4E0A\u6BD4\u5C0D\u7686\u4F7F\u7528\u6587\u5B57\u5927\u5C0F\u6BD4\u5C0D\u65B9\u5F0F\n  \u4F8B\u5982\n  @20190101|20191231(\u67E5\u51FA\u4ECB\u65BC20190101\u523020191231\u7684\u8CC7\u6599\u593E)\n  <20190101(\u67E5\u51FA\u5C0F\u65BC20190101\u7684\u8CC7\u6599\u593E)\n  >20191231(\u67E5\u51FA\u5927\u65BC20191231\u7684\u8CC7\u6599\u593E)  \n  ";
    ...
    FileDirectoryAddEditModalPage.prototype.Help = function () {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.global.showMessage("資料夾搜尋關鍵字說明", _this.file_keyword_help);
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_directory_add_edit_modal__ = __webpack_require__(1380);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
