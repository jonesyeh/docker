...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchOneDayTimeServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_SchOneDayTimeListResponse__ = __webpack_require__(1630);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_SchOneDayTimeResponse__ = __webpack_require__(1631);
...
/*
  Generated class for the SchOneDayTimeServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var SchOneDayTimeServicesProvider = /** @class */ (function (_super) {
    __extends(SchOneDayTimeServicesProvider, _super);
    function SchOneDayTimeServicesProvider(Services) {
        var _this = _super.call(this, Services) || this;
        _this.Services = Services;
        _this.ctl = "SchOneDayTime";
        console.log("Hello SchOneDayTimeServiceProvider Provider");
        return _this;
    }
    SchOneDayTimeServicesProvider.prototype.GetListsAsync = function (PageSize, PageNumber, keyword, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "SchOneDayTime?PageSize={1}&PageNumber={2}&keyword={3}&order_type={4}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.SchOneDayTimes = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_SchOneDayTimeListResponse__["a" /* SchOneDayTimeListResponse */]({
            ...
            return _this.SchOneDayTimes;
        });
    };
    SchOneDayTimeServicesProvider.prototype.GetListsByJobAsync = function (PageSize, PageNumber, keyword, ssis_job_no, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "SchOneDayTime?PageSize={1}&PageNumber={2}&keyword={3}&ssis_job_no={4}&order_type={5}";
    ...
    SchOneDayTimeServicesProvider.prototype.GetAsync = function (sch_no) {
        var _this = this;
        var sub_url;
        sub_url = "SchOneDayTime/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, sch_no);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.SchOneDayTime = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_SchOneDayTimeResponse__["a" /* SchOneDayTimeResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.SchOneDayTime;
        });
    };
    SchOneDayTimeServicesProvider.prototype.PostPutAsync = function (SchOneDayTimeViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "SchOneDayTime";
        else
            sub_url = "SchOneDayTime/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, SchOneDayTimeViewModel.sch_no);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, SchOneDayTimeViewModel, mode).map(function (item) {
            _this.SchOneDayTime = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_SchOneDayTimeResponse__["a" /* SchOneDayTimeResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchOneDayTimePage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_sch_one_day_time_services_sch_one_day_time_services__ = __webpack_require__(1241);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_SchOneDayTimeViewModel__ = __webpack_require__(1076);
...
/**
 * Generated class for the SchOneDayTimePage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var SchOneDayTimePage = /** @class */ (function (_super) {
    __extends(SchOneDayTimePage, _super);
    function SchOneDayTimePage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, SchOneDayTimeServices, modalCtrl, SchServices, platform, conf) {
        ...
        _this.SchOneDayTimeServices = SchOneDayTimeServices;
    ...
    SchOneDayTimePage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    SchOneDayTimePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    SchOneDayTimePage.prototype.setPage = function (pageInfo) {
    ...
    SchOneDayTimePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    SchOneDayTimePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    SchOneDayTimePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.SchOneDayTimeServices.GetListsAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    SchOneDayTimePage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_SchOneDayTimeViewModel__["a" /* SchOneDayTimeViewModel */]();
            item.sch_no = "auto";
        ...
        // console.log(this.CanEditSch);
        var modal = this.modalCtrl.create("SchOneDayTimeAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.SchOneDayTimeServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    SchOneDayTimePage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.SchOneDayTimeServices.DeleteAsync(item.sch_no).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    SchOneDayTimePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_sch_one_day_time_services_sch_one_day_time_services__["a" /* SchOneDayTimeServicesProvider */],
    ...
    return SchOneDayTimePage;
}(__WEBPACK_IMPORTED_MODULE_8__sch_sch__["a" /* SchPage */]));

//# sourceMappingURL=sch-one-day-time.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchOneDayTimeListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ListModelResponse__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_SchOneDayTimeViewModel__ = __webpack_require__(1076);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
 ...
 * @param   {Function}    [name]
 */
var SchOneDayTimeListResponse = /** @class */ (function (_super) {
    __extends(SchOneDayTimeListResponse, _super);
    function SchOneDayTimeListResponse(obj) {
        ...
        if (obj.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_SchOneDayTimeViewModel__["a" /* SchOneDayTimeViewModel */]();
    ...
    return SchOneDayTimeListResponse;
}(__WEBPACK_IMPORTED_MODULE_0__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=SchOneDayTimeListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchOneDayTimeResponse; });
...
var SchOneDayTimeResponse = /** @class */ (function (_super) {
    __extends(SchOneDayTimeResponse, _super);
    function SchOneDayTimeResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_SchOneDayTimeViewModel__["a" /* SchOneDayTimeViewModel */]();
    ...
    return SchOneDayTimeResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=SchOneDayTimeResponse.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sch_one_day_time__ = __webpack_require__(1629);
...
var SchOneDayTimePageModule = /** @class */ (function () {
    function SchOneDayTimePageModule() {
    }
    SchOneDayTimePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__sch_one_day_time__["a" /* SchOneDayTimePage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_sch_one_day_time_services_sch_one_day_time_services__["a" /* SchOneDayTimeServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__sch_one_day_time__["a" /* SchOneDayTimePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], SchOneDayTimePageModule);
    return SchOneDayTimePageModule;
}());

//# sourceMappingURL=sch-one-day-time.module.js.map
