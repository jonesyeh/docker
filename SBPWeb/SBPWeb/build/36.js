...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchMonthTimeServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_SchMonthTimeListResponse__ = __webpack_require__(1626);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_SchMonthTimeResponse__ = __webpack_require__(1627);
...
/*
  Generated class for the SchMonthTimeServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var SchMonthTimeServicesProvider = /** @class */ (function (_super) {
    __extends(SchMonthTimeServicesProvider, _super);
    function SchMonthTimeServicesProvider(Services) {
        var _this = _super.call(this, Services) || this;
        _this.Services = Services;
        _this.ctl = "SchMonthTime";
        console.log("Hello SchMonthTimeServiceProvider Provider");
        return _this;
    }
    SchMonthTimeServicesProvider.prototype.GetListsAsync = function (PageSize, PageNumber, keyword, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "SchMonthTime?PageSize={1}&PageNumber={2}&keyword={3}&order_type={4}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.SchMonthTimes = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_SchMonthTimeListResponse__["a" /* SchMonthTimeListResponse */]({
            ...
            return _this.SchMonthTimes;
        });
    };
    SchMonthTimeServicesProvider.prototype.GetListsByJobAsync = function (PageSize, PageNumber, keyword, ssis_job_no, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "SchMonthTime?PageSize={1}&PageNumber={2}&keyword={3}&ssis_job_no={4}&order_type={5}";
    ...
    SchMonthTimeServicesProvider.prototype.GetAsync = function (sch_no) {
        var _this = this;
        var sub_url;
        sub_url = "SchMonthTime/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, sch_no);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.SchMonthTime = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_SchMonthTimeResponse__["a" /* SchMonthTimeResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.SchMonthTime;
        });
    };
    SchMonthTimeServicesProvider.prototype.PostPutAsync = function (SchMonthTimeViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "SchMonthTime";
        else
            sub_url = "SchMonthTime/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, SchMonthTimeViewModel.sch_no);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, SchMonthTimeViewModel, mode).map(function (item) {
            _this.SchMonthTime = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_SchMonthTimeResponse__["a" /* SchMonthTimeResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchMonthTimePage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_sch_month_time_services_sch_month_time_services__ = __webpack_require__(1240);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_SchMonthTimeViewModel__ = __webpack_require__(1075);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_sch_services_sch_services__ = __webpack_require__(270);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__sch_sch__ = __webpack_require__(928);
...
/**
 * Generated class for the SchMonthTimePage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var SchMonthTimePage = /** @class */ (function (_super) {
    __extends(SchMonthTimePage, _super);
    function SchMonthTimePage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, SchMonthTimeServices, modalCtrl, SchServices, platform, conf) {
        ...
        _this.SchMonthTimeServices = SchMonthTimeServices;
    ...
    SchMonthTimePage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    SchMonthTimePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    SchMonthTimePage.prototype.setPage = function (pageInfo) {
    ...
    SchMonthTimePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    SchMonthTimePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    SchMonthTimePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.SchMonthTimeServices.GetListsAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    SchMonthTimePage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_SchMonthTimeViewModel__["a" /* SchMonthTimeViewModel */]();
            item.sch_no = "auto";
            item.active_start_date = (new Date()).toISOString();
            item.active_end_date = "9999-12-31";
            item.active_start_time = "00:00:00";
            item.freq_interval = 1;
        ...
        var modal = this.modalCtrl.create("SchMonthTimeAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.SchMonthTimeServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    SchMonthTimePage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.SchMonthTimeServices.DeleteAsync(item.sch_no).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    SchMonthTimePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_sch_month_time_services_sch_month_time_services__["a" /* SchMonthTimeServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* ModalController */],
            __WEBPACK_IMPORTED_MODULE_7__providers_sch_services_sch_services__["a" /* SchServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Platform */],
            __WEBPACK_IMPORTED_MODULE_9__Model_MyAppSharedSettings__["a" /* MyAppSharedSettings */]])
    ], SchMonthTimePage);
    return SchMonthTimePage;
}(__WEBPACK_IMPORTED_MODULE_8__sch_sch__["a" /* SchPage */]));

//# sourceMappingURL=sch-month-time.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchMonthTimeListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ListModelResponse__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_SchMonthTimeViewModel__ = __webpack_require__(1075);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
 ...
 * @param   {Function}    [name]
 */
var SchMonthTimeListResponse = /** @class */ (function (_super) {
    __extends(SchMonthTimeListResponse, _super);
    function SchMonthTimeListResponse(obj) {
        ...
        if (obj.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_SchMonthTimeViewModel__["a" /* SchMonthTimeViewModel */]();
                item.sch_no = data.sch_no;
                item.sch_name = data.sch_name;
                item.freq_interval = data.freq_interval;
    ...
    return SchMonthTimeListResponse;
}(__WEBPACK_IMPORTED_MODULE_0__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=SchMonthTimeListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchMonthTimeResponse; });
...
var SchMonthTimeResponse = /** @class */ (function (_super) {
    __extends(SchMonthTimeResponse, _super);
    function SchMonthTimeResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_SchMonthTimeViewModel__["a" /* SchMonthTimeViewModel */]();
            _this.Model.sch_no = obj.Model.sch_no;
            _this.Model.sch_name = obj.Model.sch_name;
            _this.Model.freq_interval = obj.Model.freq_interval;
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SchMonthTimePageModule", function() { return SchMonthTimePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sch_month_time__ = __webpack_require__(1625);
...
var SchMonthTimePageModule = /** @class */ (function () {
    function SchMonthTimePageModule() {
    }
    SchMonthTimePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__sch_month_time__["a" /* SchMonthTimePage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_sch_month_time_services_sch_month_time_services__["a" /* SchMonthTimeServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__sch_month_time__["a" /* SchMonthTimePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], SchMonthTimePageModule);
    return SchMonthTimePageModule;
}());

//# sourceMappingURL=sch-month-time.module.js.map
