...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchMonthLastdayTimeServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_SchMonthLastdayTimeListResponse__ = __webpack_require__(1622);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_SchMonthLastdayTimeResponse__ = __webpack_require__(1623);
...
/*
  Generated class for the SchMonthLastdayTimeServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var SchMonthLastdayTimeServicesProvider = /** @class */ (function (_super) {
    __extends(SchMonthLastdayTimeServicesProvider, _super);
    function SchMonthLastdayTimeServicesProvider(Services) {
        var _this = _super.call(this, Services) || this;
        _this.Services = Services;
        _this.ctl = "SchMonthLastdayTime";
        console.log("Hello SchMonthLastdayTimeServiceProvider Provider");
        return _this;
    }
    SchMonthLastdayTimeServicesProvider.prototype.GetListsAsync = function (PageSize, PageNumber, keyword, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "SchMonthLastdayTime?PageSize={1}&PageNumber={2}&keyword={3}&order_type={4}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.SchMonthLastdayTimes = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_SchMonthLastdayTimeListResponse__["a" /* SchMonthLastdayTimeListResponse */]({
            ...
            return _this.SchMonthLastdayTimes;
        });
    };
    SchMonthLastdayTimeServicesProvider.prototype.GetListsByJobAsync = function (PageSize, PageNumber, keyword, ssis_job_no, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "SchMonthLastdayTime?PageSize={1}&PageNumber={2}&keyword={3}&ssis_job_no={4}&order_type={5}";
    ...
    SchMonthLastdayTimeServicesProvider.prototype.GetAsync = function (sch_no) {
        var _this = this;
        var sub_url;
        sub_url = "SchMonthLastdayTime/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, sch_no);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.SchMonthLastdayTime = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_SchMonthLastdayTimeResponse__["a" /* SchMonthLastdayTimeResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.SchMonthLastdayTime;
        });
    };
    SchMonthLastdayTimeServicesProvider.prototype.PostPutAsync = function (SchMonthLastdayTimeViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "SchMonthLastdayTime";
        else
            sub_url = "SchMonthLastdayTime/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, SchMonthLastdayTimeViewModel.sch_no);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, SchMonthLastdayTimeViewModel, mode).map(function (item) {
            _this.SchMonthLastdayTime = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_SchMonthLastdayTimeResponse__["a" /* SchMonthLastdayTimeResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
    ...
    SchMonthLastdayTimeServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_services__["a" /* ServicesProvider */]])
    ], SchMonthLastdayTimeServicesProvider);
    return SchMonthLastdayTimeServicesProvider;
}(__WEBPACK_IMPORTED_MODULE_5__sch_services_sch_services__["a" /* SchServicesProvider */]));

//# sourceMappingURL=sch-month-lastday-time-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchMonthLastdayTimePage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_sch_month_lastday_time_services_sch_month_lastday_time_services__ = __webpack_require__(1239);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_SchMonthLastdayTimeViewModel__ = __webpack_require__(1074);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__sch_sch__ = __webpack_require__(928);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_sch_services_sch_services__ = __webpack_require__(270);
...
/**
 * Generated class for the SchMonthLastdayTimePage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var SchMonthLastdayTimePage = /** @class */ (function (_super) {
    __extends(SchMonthLastdayTimePage, _super);
    function SchMonthLastdayTimePage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, SchMonthLastdayTimeServices, modalCtrl, SchServices, platform, conf) {
        var _this = _super.call(this, navCtrl, global, SchServices) || this;
        ...
        _this.SchMonthLastdayTimeServices = SchMonthLastdayTimeServices;
        _this.modalCtrl = modalCtrl;
        _this.SchServices = SchServices;
        ...
        _this.totalRows = 0;
        _this.title = "月底排程設定";
        _this.job_page = "JobBySchPage";
        _this.innerWidth = window.innerWidth;
        _this.innerHeight = window.innerHeight;
        _this.order_type = true;
        if (_this.authServices.authenticated() === true) {
            _this.can_auth = _this.authServices.CanAuth();
            _this.CanEditSch = _this.authServices.CanEditSch();
            _this.CanJob = _this.authServices.CanJob();
            _this.LoadData(true);
        }
        return _this;
    }
    SchMonthLastdayTimePage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    SchMonthLastdayTimePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    SchMonthLastdayTimePage.prototype.setPage = function (pageInfo) {
    ...
    SchMonthLastdayTimePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    SchMonthLastdayTimePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    SchMonthLastdayTimePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.SchMonthLastdayTimeServices.GetListsAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    SchMonthLastdayTimePage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_SchMonthLastdayTimeViewModel__["a" /* SchMonthLastdayTimeViewModel */]();
            item.sch_no = "auto";
            item.active_start_date = (new Date()).toISOString();
            item.active_end_date = "9999-12-31";
            item.active_start_time = "00:00:00";
            item.freq_recurrence_factor = 1;
            item.is_active = true;
            item.active_end_time = "23:59:00";
            item.freq_subday_type = 1;
            item.freq_subday_interval = 1;
        }
        else {
            this.mode = "PUT";
            if (change_mode === "c") {
        ...
        var modal = this.modalCtrl.create("SchMonthLastdayTimeAddEditModalPage", {
            mode: this.mode,
            item: item,
            CanEditSch: this.CanEditSch,
        });
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.SchMonthLastdayTimeServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        // if (this.mode === "POST") {
                        //   this.data_list.push(data.Model);
                        //   this.totalRows += 1;
                        // } else {
                        //   let index = this.data_list.findIndex(
                        //     d => d.sch_no === item.sch_no
                        //   );
                        //   this.data_list[index] =data.Model; //remove element from array
                        // }
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("排程", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    SchMonthLastdayTimePage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.sch_name),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.SchMonthLastdayTimeServices.DeleteAsync(item.sch_no).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    SchMonthLastdayTimePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_sch_month_lastday_time_services_sch_month_lastday_time_services__["a" /* SchMonthLastdayTimeServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* ModalController */],
            __WEBPACK_IMPORTED_MODULE_8__providers_sch_services_sch_services__["a" /* SchServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Platform */],
            __WEBPACK_IMPORTED_MODULE_9__Model_MyAppSharedSettings__["a" /* MyAppSharedSettings */]])
    ], SchMonthLastdayTimePage);
    return SchMonthLastdayTimePage;
}(__WEBPACK_IMPORTED_MODULE_7__sch_sch__["a" /* SchPage */]));

//# sourceMappingURL=sch-month-lastday-time.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchMonthLastdayTimeListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ListModelResponse__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_SchMonthLastdayTimeViewModel__ = __webpack_require__(1074);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
 ...
 * @param   {Function}    [name]
 */
var SchMonthLastdayTimeListResponse = /** @class */ (function (_super) {
    __extends(SchMonthLastdayTimeListResponse, _super);
    function SchMonthLastdayTimeListResponse(obj) {
        ...
        if (obj.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_SchMonthLastdayTimeViewModel__["a" /* SchMonthLastdayTimeViewModel */]();
                item.sch_no = data.sch_no;
                item.sch_name = data.sch_name;
                item.freq_recurrence_factor = data.freq_recurrence_factor;
                item.freq_subday_interval = data.freq_subday_interval;
                item.freq_subday_type = data.freq_subday_type;
                item.freq_subday_type_desc = data.freq_subday_type_desc;
                item.active_start_date = data.active_start_date;
                item.active_end_date = data.active_end_date;
                item.active_start_time = data.active_start_time;
                item.active_end_time = data.active_end_time;
                ...
                if (item.job_cnt > 0)
                    item.job_color = "danger";
                else
                    item.job_color = "light";
    ...
    return SchMonthLastdayTimeListResponse;
}(__WEBPACK_IMPORTED_MODULE_0__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=SchMonthLastdayTimeListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchMonthLastdayTimeResponse; });
...
var SchMonthLastdayTimeResponse = /** @class */ (function (_super) {
    __extends(SchMonthLastdayTimeResponse, _super);
    function SchMonthLastdayTimeResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_SchMonthLastdayTimeViewModel__["a" /* SchMonthLastdayTimeViewModel */]();
            _this.Model.sch_no = obj.Model.sch_no;
            _this.Model.sch_name = obj.Model.sch_name;
            _this.Model.freq_recurrence_factor = obj.Model.freq_recurrence_factor;
            _this.Model.freq_subday_interval = obj.Model.freq_subday_interval;
            _this.Model.freq_subday_type = obj.Model.freq_subday_type;
            _this.Model.freq_subday_type_desc = obj.Model.freq_subday_type_desc;
            _this.Model.active_start_date = obj.Model.active_start_date;
            _this.Model.active_end_date = obj.Model.active_end_date;
            _this.Model.active_start_time = obj.Model.active_start_time;
            _this.Model.active_end_time = obj.Model.active_end_time;
            ...
            _this.Model.job_cnt = obj.Model.job_cnt;
            _this.Model.sch_description = obj.Model.sch_description;
    ...
    return SchMonthLastdayTimeResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=SchMonthLastdayTimeResponse.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sch_month_lastday_time__ = __webpack_require__(1621);
...
var SchMonthLastdayTimePageModule = /** @class */ (function () {
    function SchMonthLastdayTimePageModule() {
    }
    SchMonthLastdayTimePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__sch_month_lastday_time__["a" /* SchMonthLastdayTimePage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_sch_month_lastday_time_services_sch_month_lastday_time_services__["a" /* SchMonthLastdayTimeServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__sch_month_lastday_time__["a" /* SchMonthLastdayTimePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], SchMonthLastdayTimePageModule);
    return SchMonthLastdayTimePageModule;
}());

//# sourceMappingURL=sch-month-lastday-time.module.js.map
