...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchDayTimeServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_SchDayTimeListResponse__ = __webpack_require__(1617);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_SchDayTimeResponse__ = __webpack_require__(1618);
...
/*
  Generated class for the SchDayTimeServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var SchDayTimeServicesProvider = /** @class */ (function (_super) {
    __extends(SchDayTimeServicesProvider, _super);
    function SchDayTimeServicesProvider(Services) {
        var _this = _super.call(this, Services) || this;
        _this.Services = Services;
        _this.ctl = "SchDayTime";
        console.log("Hello SchDayTimeServiceProvider Provider");
        return _this;
    }
    SchDayTimeServicesProvider.prototype.GetListsAsync = function (PageSize, PageNumber, keyword, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "SchDayTime?PageSize={1}&PageNumber={2}&keyword={3}&order_type={4}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.SchDayTimes = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_SchDayTimeListResponse__["a" /* SchDayTimeListResponse */]({
            ...
            return _this.SchDayTimes;
        });
    };
    SchDayTimeServicesProvider.prototype.GetListsByJobAsync = function (PageSize, PageNumber, keyword, ssis_job_no, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "SchDayTime?PageSize={1}&PageNumber={2}&keyword={3}&ssis_job_no={4}&order_type={5}";
    ...
    SchDayTimeServicesProvider.prototype.GetAsync = function (sch_no) {
        var _this = this;
        var sub_url;
        sub_url = "SchDayTime/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, sch_no);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.SchDayTime = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_SchDayTimeResponse__["a" /* SchDayTimeResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.SchDayTime;
        });
    };
    SchDayTimeServicesProvider.prototype.PostPutAsync = function (SchDayTimeViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "SchDayTime";
            ...
            sub_url = "SchDayTime/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, SchDayTimeViewModel.sch_no);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, SchDayTimeViewModel, mode).map(function (item) {
            _this.SchDayTime = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_SchDayTimeResponse__["a" /* SchDayTimeResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchDayTimePage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_sch_day_time_services_sch_day_time_services__ = __webpack_require__(1238);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_SchDayTimeViewModel__ = __webpack_require__(1073);
...
/**
 * Generated class for the SchDayTimePage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var SchDayTimePage = /** @class */ (function (_super) {
    __extends(SchDayTimePage, _super);
    function SchDayTimePage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, SchDayTimeServices, modalCtrl, SchServices, platform, conf) {
        ...
        _this.SchDayTimeServices = SchDayTimeServices;
    ...
    SchDayTimePage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
    ...
    SchDayTimePage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    SchDayTimePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    SchDayTimePage.prototype.setPage = function (pageInfo) {
    ...
    SchDayTimePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    SchDayTimePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    SchDayTimePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.SchDayTimeServices.GetListsAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    SchDayTimePage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_SchDayTimeViewModel__["a" /* SchDayTimeViewModel */]();
            item.sch_no = "auto";
            item.active_start_date = (new Date()).toISOString();
            item.active_end_date = "9999-12-31";
            item.active_start_time = "00:00:00";
            item.active_end_time = "23:59:59";
            item.freq_type = 4;
        ...
        var modal = this.modalCtrl.create("SchDayTimeAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.SchDayTimeServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    SchDayTimePage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.SchDayTimeServices.DeleteAsync(item.sch_no).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    SchDayTimePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_sch_day_time_services_sch_day_time_services__["a" /* SchDayTimeServicesProvider */],
    ...
    return SchDayTimePage;
}(__WEBPACK_IMPORTED_MODULE_8__sch_sch__["a" /* SchPage */]));

//# sourceMappingURL=sch-day-time.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchDayTimeListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ListModelResponse__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_SchDayTimeViewModel__ = __webpack_require__(1073);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
 ...
 * @param   {Function}    [name]
 */
var SchDayTimeListResponse = /** @class */ (function (_super) {
    __extends(SchDayTimeListResponse, _super);
    function SchDayTimeListResponse(obj) {
        ...
        if (obj.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_SchDayTimeViewModel__["a" /* SchDayTimeViewModel */]();
                item.sch_no = data.sch_no;
                item.sch_name = data.sch_name;
                item.freq_type = data.freq_type;
    ...
    return SchDayTimeListResponse;
}(__WEBPACK_IMPORTED_MODULE_0__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=SchDayTimeListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchDayTimeResponse; });
...
var SchDayTimeResponse = /** @class */ (function (_super) {
    __extends(SchDayTimeResponse, _super);
    function SchDayTimeResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_SchDayTimeViewModel__["a" /* SchDayTimeViewModel */]();
            _this.Model.sch_no = obj.Model.sch_no;
            _this.Model.sch_name = obj.Model.sch_name;
            _this.Model.freq_type = obj.Model.freq_type;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sch_day_time__ = __webpack_require__(1616);
...
var SchDayTimePageModule = /** @class */ (function () {
    function SchDayTimePageModule() {
    }
    SchDayTimePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__sch_day_time__["a" /* SchDayTimePage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_sch_day_time_services_sch_day_time_services__["a" /* SchDayTimeServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__sch_day_time__["a" /* SchDayTimePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], SchDayTimePageModule);
    return SchDayTimePageModule;
}());

//# sourceMappingURL=sch-day-time.module.js.map
