...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileSsisListResponse__ = __webpack_require__(1165);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileSsisResponse__ = __webpack_require__(1166);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileSsisViewModel__ = __webpack_require__(978);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ListModelResponse__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ViewModel_RemoteViewModel__ = __webpack_require__(979);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileSsisViewModel__ = __webpack_require__(978);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ViewModel_RemoteViewModel__ = __webpack_require__(979);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileSsisPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileSsisViewModel__ = __webpack_require__(978);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Model_ViewModel_RemoteViewModel__ = __webpack_require__(979);
 ...
 * Components.
 */
var FileSsisPage = /** @class */ (function () {
    function FileSsisPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileSsisServices, modalCtrl, viewCtrl, runjobServices, platform, conf) {
        ...
        this.File_page = "FileSsisTablePage";
    ...
    FileSsisPage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
    ...
    FileSsisPage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
    ...
    FileSsisPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileSsisPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileSsisPage.prototype.setPage = function (pageInfo) {
    ...
    FileSsisPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileSsisPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileSsisPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileSsisServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileSsisPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileSsisViewModel__["a" /* FileSsisViewModel */]();
            item.file_min_length = 0;
            item.file_max_length = 50;
            item.file_keyword = ".dtsx";
            item.is_active = true;
            item.is_fail_stop = true;
            item.parameter_column_group = "001";
            item.can_rerun = true;
            item.package_src_key = "067|FILE";
            item.package_src = "檔案系統";
            var t = new __WEBPACK_IMPORTED_MODULE_7__Model_ViewModel_RemoteViewModel__["a" /* RemoteViewModel */]();
            t.remote_conn_id = "SSIS-SSISDB";
            item.remoteViewModel = t;
        }
        else {
            this.mode = "PUT";
        ...
        var modal = this.modalCtrl.create("FileSsisAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileSsisServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("執行ssis設定", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileSsisPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileSsisServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileSsisPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileSsisServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileSsisPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileSsisPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_ssis_services_file_ssis_services__["a" /* FileSsisServicesProvider */],
...
//# sourceMappingURL=file-ssis.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileSsisPageModule", function() { return FileSsisPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_ssis__ = __webpack_require__(1492);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_ssis_services_file_ssis_services__ = __webpack_require__(1049);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileSsisPageModule = /** @class */ (function () {
    function FileSsisPageModule() {
    }
    FileSsisPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_ssis__["a" /* FileSsisPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_ssis_services_file_ssis_services__["a" /* FileSsisServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_ssis__["a" /* FileSsisPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileSsisPageModule);
    return FileSsisPageModule;
}());

//# sourceMappingURL=file-ssis.module.js.map
