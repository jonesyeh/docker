...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileFtpUpPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_ftp_up_services_file_ftp_up_services__ = __webpack_require__(1034);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Model_ViewModel_FileFtpUpViewModel__ = __webpack_require__(961);
 ...
 * Components.
 */
var FileFtpUpPage = /** @class */ (function () {
    function FileFtpUpPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileFtpUpServices, modalCtrl, viewCtrl, runjobServices, platform, conf) {
        ...
        this.File_page = "FileFtpUpTablePage";
    ...
    FileFtpUpPage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
    ...
    FileFtpUpPage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
    ...
    FileFtpUpPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileFtpUpPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileFtpUpPage.prototype.setPage = function (pageInfo) {
    ...
    FileFtpUpPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileFtpUpPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileFtpUpPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileFtpUpServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileFtpUpPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_7__Model_ViewModel_FileFtpUpViewModel__["a" /* FileFtpUpViewModel */]();
        ...
        var modal = this.modalCtrl.create("FileFtpUpAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileFtpUpServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("ftp上傳", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileFtpUpPage.prototype.ShowFileProcessedSqlModal = function (item) {
    ...
    FileFtpUpPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileFtpUpServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileFtpUpPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileFtpUpServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileFtpUpPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileFtpUpPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_5_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_file_ftp_up_services_file_ftp_up_services__["a" /* FileFtpUpServicesProvider */],
    ...
    return FileFtpUpPage;
}());

//# sourceMappingURL=file-ftp-up.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_ftp_up__ = __webpack_require__(1412);
...
var FileFtpUpPageModule = /** @class */ (function () {
    function FileFtpUpPageModule() {
    }
    FileFtpUpPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_ftp_up__["a" /* FileFtpUpPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_ftp_up_services_file_ftp_up_services__["a" /* FileFtpUpServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_ftp_up__["a" /* FileFtpUpPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileFtpUpPageModule);
    return FileFtpUpPageModule;
}());

//# sourceMappingURL=file-ftp-up.module.js.map
