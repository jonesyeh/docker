...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileFtpDownListResponse__ = __webpack_require__(1133);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileFtpDownResponse__ = __webpack_require__(1134);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileFtpDownViewModel__ = __webpack_require__(960);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileFtpDownViewModel__ = __webpack_require__(960);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ViewModel_FtpRemoteViewModel__ = __webpack_require__(911);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileFtpDownPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Model_ViewModel_FtpRemoteViewModel__ = __webpack_require__(911);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_ftp_down_services_file_ftp_down_services__ = __webpack_require__(1033);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Model_ViewModel_FileFtpDownViewModel__ = __webpack_require__(960);
 ...
 * Components.
 */
var FileFtpDownPage = /** @class */ (function () {
    function FileFtpDownPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileFtpDownServices, modalCtrl, viewCtrl, runjobServices, platform, conf) {
        ...
        this.File_page = "FileFtpDownTablePage";
    ...
    FileFtpDownPage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
    ...
    FileFtpDownPage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
    ...
    FileFtpDownPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileFtpDownPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileFtpDownPage.prototype.setPage = function (pageInfo) {
    ...
    FileFtpDownPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileFtpDownPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileFtpDownPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileFtpDownServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileFtpDownPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_7__Model_ViewModel_FileFtpDownViewModel__["a" /* FileFtpDownViewModel */]();
            ...
            item.can_rerun = true;
            var t = new __WEBPACK_IMPORTED_MODULE_0__Model_ViewModel_FtpRemoteViewModel__["a" /* FtpRemoteViewModel */]();
            t.remote_conn_id = "defaultftp";
            t.conn_type_key = "006|2";
            t.conn_type = "ftp(winscp元件)";
            t.encrypt_method_key = "046|1";
            t.encrypt_method = "無";
            item.remoteViewModel = t;
        }
        else {
        ...
        var modal = this.modalCtrl.create("FileFtpDownAddEditModalPage", {
            mode: this.mode,
            item: item,
            change_mode: change_mode,
            CanEditBatch: this.CanEditBatch,
            CanFileBrowser: this.CanFileBrowser,
            CanFtpFileBrowser: this.CanFtpFileBrowser,
        });
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileFtpDownServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("Ftp下載", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileFtpDownPage.prototype.ShowFileProcessedSqlModal = function (item) {
    ...
    FileFtpDownPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_6__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.exec_file_seq),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileFtpDownServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileFtpDownPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileFtpDownServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileFtpDownPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileFtpDownPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_5_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_file_ftp_down_services_file_ftp_down_services__["a" /* FileFtpDownServicesProvider */],
    ...
    return FileFtpDownPage;
}());

//# sourceMappingURL=file-ftp-down.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_ftp_down__ = __webpack_require__(1409);
...
var FileFtpDownPageModule = /** @class */ (function () {
    function FileFtpDownPageModule() {
    }
    FileFtpDownPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_ftp_down__["a" /* FileFtpDownPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_ftp_down_services_file_ftp_down_services__["a" /* FileFtpDownServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_ftp_down__["a" /* FileFtpDownPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileFtpDownPageModule);
    return FileFtpDownPageModule;
}());

//# sourceMappingURL=file-ftp-down.module.js.map
