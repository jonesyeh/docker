...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SelectValueSqlPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_table_ext_services_table_ext_services__ = __webpack_require__(271);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_column_mapping_services_column_mapping_services__ = __webpack_require__(1006);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/**
 * Generated class for the SelectValueSqlPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var SelectValueSqlPage = /** @class */ (function () {
    function SelectValueSqlPage(navCtrl, navParams, TableExtServices, loadingCtrl, global, authServices, ColumnMappingServices, modalCtrl, element) {
        ...
        this.lang_flag = "e";
        this.column_group_key = "077|DEF";
        this.LoadData(true);
    }
    SelectValueSqlPage.prototype.LoadData = function (init) {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            if (_this.lang_flag != "g") {
                ///非欄位群組查詢
                _this.TableExtServices.GetSelectSqlAsync(_this.item.schemaname, _this.item.tablename, _this.lang_flag, _this.table_alias).subscribe(function (data) {
                ...
                ///欄位群組查詢
                _this.ColumnMappingServices.GetSelectSqlAsync(_this.item.schemaname, _this.item.tablename, _this.column_group_key, _this.table_alias).subscribe(function (data) {
                    if (data.DidError === true) {
                        _this.global.dismissLoading();
                        _this.global.showError(data.ErrorMessage);
                    }
    ...
    SelectValueSqlPage.prototype.SelectColumnGroup = function () {
        var _this = this;
    ...
    SelectValueSqlPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad SelectValueSqlPage");
    };
    SelectValueSqlPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-select-value-sql",template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\select-value-sql\select-value-sql.html"*/'<!--\n  Generated template for the SqlPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <headerComponent [title]="title" [permission_id]="\'CanTable\'"></headerComponent>\n\n</ion-header>\n\n\n<ion-content padding>\n  <ion-row>\n    <ion-col col-12 col-sm-6>\n\n      <ion-searchbar [ngClass]="[\'search\']" (keyup.enter)="LoadData(true)" placeholder="資料表別名" [(ngModel)]="table_alias">\n      </ion-searchbar>\n\n\n    </ion-col>\n    <ion-col col-12 col-sm-3>\n\n      <ion-select [ngClass]="[\'search\']" [(ngModel)]="lang_flag" placeholder="註解/欄位/自訂" (ionChange)="LoadData(true)">\n        <ion-option value="e">中文註解</ion-option>\n        <ion-option value="c">中文欄位</ion-option>\n        <ion-option value="g">欄位群組</ion-option>\n      </ion-select>\n\n    </ion-col>\n    <ion-col col-12 col-sm-3>\n      <ion-searchbar [ngClass]="[\'search\']" *ngIf="lang_flag==\'g\' " (click)="SelectColumnGroup()" placeholder="欄位群組"\n        [(ngModel)]="column_group_key">\n      </ion-searchbar>\n    </ion-col>\n  </ion-row>\n  <ion-item>\n    <ion-textarea autosize [(ngModel)]="sql" name="sql">\n    </ion-textarea>\n  </ion-item>\n\n</ion-content>\n<ion-footer>\n  <ion-toolbar>\n    <ion-row>\n      <ion-col>\n        <div [ngClass]="[\'command\']">\n\n          <button small title="複製SQL語法" ion-button color="dark" icon-left (click)="global.copyTextToClipboard(sql)">\n            <ion-icon name="copy"></ion-icon>\n          </button>\n\n        </div>\n      </ion-col>\n    </ion-row>\n\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\select-value-sql\select-value-sql.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_5__providers_column_mapping_services_column_mapping_services__["a" /* ColumnMappingServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* ModalController */],
            __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"]])
    ], SelectValueSqlPage);
    return SelectValueSqlPage;
}());

//# sourceMappingURL=select-value-sql.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SelectValueSqlPageModule", function() { return SelectValueSqlPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__select_value_sql__ = __webpack_require__(1638);
...
var SelectValueSqlPageModule = /** @class */ (function () {
    function SelectValueSqlPageModule() {
    }
    SelectValueSqlPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__select_value_sql__["a" /* SelectValueSqlPage */],
            ],
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__select_value_sql__["a" /* SelectValueSqlPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], SelectValueSqlPageModule);
    return SelectValueSqlPageModule;
}());

//# sourceMappingURL=select-value-sql.module.js.map
