...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ColumnMappingServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_ColumnMappingListResponse__ = __webpack_require__(1091);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_ColumnMappingResponse__ = __webpack_require__(1093);
...
/*
  Generated class for the ColumnMappingServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var ColumnMappingServicesProvider = /** @class */ (function () {
    function ColumnMappingServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "TableColumnMapping";
        console.log("Hello ColumnMappingServiceProvider Provider");
    }
    ColumnMappingServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, schemaname, tablename, column_group_key, keyword, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "TableColumnMapping?PageSize={1}&PageNumber={2}&schemaname={3}&tablename={4}&column_group_key={5}&keyword={6}&order_type={7}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, PageSize, PageNumber, schemaname, tablename, column_group_key, keyword, order_type);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.ColumnMappings = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_ColumnMappingListResponse__["a" /* ColumnMappingListResponse */]({
            ...
            return _this.ColumnMappings;
        });
    };
    ColumnMappingServicesProvider.prototype.GetSelectSqlAsync = function (schemaname, tablename, column_group_key, table_alias) {
        var _this = this;
        var sub_url;
        sub_url = "TableColumnMapping/gen_select_sql?schemaname={1}&tablename={2}&column_group_key={3}&table_alias={4}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, schemaname, tablename, column_group_key, table_alias);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
    ...
    ColumnMappingServicesProvider.prototype.PostPutAsync = function (ColumnMappingViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "TableColumnMapping";
        else
            sub_url = "TableColumnMapping?schemaname={1}&tablename={2}&columnname={3}&column_group_key={4}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, ColumnMappingViewModel.schemaname, ColumnMappingViewModel.tablename, ColumnMappingViewModel.columnname, ColumnMappingViewModel.column_group_key);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, ColumnMappingViewModel, mode).map(function (item) {
            _this.ColumnMapping = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_ColumnMappingResponse__["a" /* ColumnMappingResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.ColumnMapping;
        });
    };
    ColumnMappingServicesProvider.prototype.PostTableAsync = function (ColumnMappingViewModel) {
        var _this = this;
        var sub_url;
        sub_url = "TableColumnMapping/AddList";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, ColumnMappingViewModel, "POST").map(function (item) {
            _this.ColumnMapping = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_ColumnMappingResponse__["a" /* ColumnMappingResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
    ...
    ColumnMappingServicesProvider.prototype.DeleteAsync = function (schemaname, tablename, columnname, column_group_key) {
        var _this = this;
        var sub_url;
        sub_url = "TableColumnMapping?schemaname={1}&tablename={2}&columnname={3}&column_group_key={4}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, schemaname, tablename, columnname, column_group_key);
    ...
    ColumnMappingServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_services__["a" /* ServicesProvider */]])
    ], ColumnMappingServicesProvider);
    return ColumnMappingServicesProvider;
}());

//# sourceMappingURL=column-mapping-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ColumnMappingListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_ColumnMappingSelectViewModel__ = __webpack_require__(1092);
...
var ColumnMappingListResponse = /** @class */ (function (_super) {
    __extends(ColumnMappingListResponse, _super);
    function ColumnMappingListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_ColumnMappingSelectViewModel__["a" /* ColumnMappingSelectViewModel */]();
                item.schemaname = data.schemaname;
                item.tablename = data.tablename;
                item.columnname = data.columnname;
                item.column_group_key = data.column_group_key;
                item.mapping_column = (data && data.mapping_column) || null;
                item.mapping_column_desc = data.mapping_column_desc;
                ...
                item.column_group = data.column_group;
...
//# sourceMappingURL=ColumnMappingListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ColumnMappingSelectViewModel; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ColumnMappingViewModel__ = __webpack_require__(929);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var ColumnMappingSelectViewModel = /** @class */ (function (_super) {
    __extends(ColumnMappingSelectViewModel, _super);
    function ColumnMappingSelectViewModel() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return ColumnMappingSelectViewModel;
}(__WEBPACK_IMPORTED_MODULE_0__ColumnMappingViewModel__["a" /* ColumnMappingViewModel */]));

//# sourceMappingURL=ColumnMappingSelectViewModel.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ColumnMappingResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_ColumnMappingViewModel__ = __webpack_require__(929);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var ColumnMappingResponse = /** @class */ (function (_super) {
    __extends(ColumnMappingResponse, _super);
    function ColumnMappingResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_ColumnMappingViewModel__["a" /* ColumnMappingViewModel */]();
            ...
            _this.Model.column_group_key = obj.Model.column_group_key;
            _this.Model.mapping_column = (obj && obj.Model.mapping_column) || null;
            _this.Model.mapping_column_desc = obj.Model.mapping_column_desc;
...
//# sourceMappingURL=ColumnMappingResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ColumnMappingPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_column_mapping_services_column_mapping_services__ = __webpack_require__(1006);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_ColumnMappingViewModel__ = __webpack_require__(929);
...
var ColumnMappingPage = /** @class */ (function () {
    function ColumnMappingPage(menuCtrl, navCtrl, navParams, ColumnMappingServices, loadingCtrl, global, authServices, modalCtrl, alertCtrl, platform, conf) {
        this.menuCtrl = menuCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.ColumnMappingServices = ColumnMappingServices;
        ...
        this.CanColumnMappingExec = true;
        this.column_group_key = "";
        this.detail_page = "ColumnMappingDetailPage";
        this.CheckType_page = "ColumnMappingTypeDetailPage";
    ...
    ColumnMappingPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    ColumnMappingPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    ColumnMappingPage.prototype.setPage = function (pageInfo) {
    ...
    ColumnMappingPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    ColumnMappingPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    ColumnMappingPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.ColumnMappingServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.schemaname, _this.tablename, _this.column_group_key, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    ColumnMappingPage.prototype.ShowModal = function (item) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_ColumnMappingViewModel__["a" /* ColumnMappingViewModel */]();
        ...
        var modal = this.modalCtrl.create("ColumnMappingAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.ColumnMappingServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("欄位對應設定", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    ColumnMappingPage.prototype.ShowTableModal = function (item) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_ColumnMappingViewModel__["a" /* ColumnMappingViewModel */]();
            item.schemaname = this.schemaname;
            item.tablename = this.tablename;
            item.column_group_key = "077|DEF";
        }
        else {
            this.mode = "PUT";
        }
        var modal = this.modalCtrl.create("ColumnMappingAddTableModalPage", {
            mode: this.mode,
            item: item,
            CanEditTable: this.CanEditTable
        });
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.createLoader();
            _this.global.loading.present().then(function () {
                _this.ColumnMappingServices.PostTableAsync(select_data).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("欄位對應設定", data.Message);
    ...
    ColumnMappingPage.prototype.SelectColumnGroup = function () {
        var _this = this;
        var modal = this.modalCtrl.create("CodeSelectModalPage", {
            select_key: this.column_group_key,
            code_type: "077",
            code_key: "",
            title: "欄位群組",
        });
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
            _this.column_group_key = select_data.code_key;
            _this.LoadData(true);
        });
        modal.present();
    };
    ColumnMappingPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.ColumnMappingServices.DeleteAsync(item.schemaname, item.tablename, item.columnname, item.column_group_key).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__column_mapping__ = __webpack_require__(1295);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_column_mapping_services_column_mapping_services__ = __webpack_require__(1006);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ColumnMappingPageModule = /** @class */ (function () {
    function ColumnMappingPageModule() {
    }
    ColumnMappingPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__column_mapping__["a" /* ColumnMappingPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_column_mapping_services_column_mapping_services__["a" /* ColumnMappingServicesProvider */],],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__column_mapping__["a" /* ColumnMappingPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], ColumnMappingPageModule);
    return ColumnMappingPageModule;
}());

//# sourceMappingURL=column-mapping.module.js.map
