...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ZipFileLoopPwdServicesProvider; });
...
/*
  Generated class for the ZipFileLoopPwdServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var ZipFileLoopPwdServicesProvider = /** @class */ (function () {
    function ZipFileLoopPwdServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "ZipFileLoopPwd";
        console.log("Hello ZipFileLoopPwdServiceProvider Provider");
    }
    ZipFileLoopPwdServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, zip_seq, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "ZipFileLoopPwd?PageSize={1}&PageNumber={2}&keyword={3}&zip_seq={4}&order_type={5}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, PageSize, PageNumber, keyword, zip_seq, order_type);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.ZipFileLoopPwds = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_ZipFileLoopPwdListResponse__["a" /* ZipFileLoopPwdListResponse */]({
            ...
            return _this.ZipFileLoopPwds;
        });
    };
    ZipFileLoopPwdServicesProvider.prototype.GetMaxFileLoopSeqAsync = function (zip_seq) {
        var sub_url;
        sub_url = "ZipFileLoopPwd/get_max_file_loop_seq?zip_seq={1}";
    ...
    ZipFileLoopPwdServicesProvider.prototype.PostPutAsync = function (ZipFileLoopPwdViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "ZipFileLoopPwd";
        else
            sub_url = "ZipFileLoopPwd/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, ZipFileLoopPwdViewModel.file_loop_seq);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, ZipFileLoopPwdViewModel, mode).map(function (item) {
            _this.ZipFileLoopPwd = new __WEBPACK_IMPORTED_MODULE_5__Model_Response_ZipFileLoopPwdResponse__["a" /* ZipFileLoopPwdResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.ZipFileLoopPwd;
        });
    };
    ZipFileLoopPwdServicesProvider.prototype.DeleteAsync = function (file_loop_seq) {
        var _this = this;
        var sub_url;
        sub_url = "ZipFileLoopPwd/{1}";
    ...
    ZipFileLoopPwdServicesProvider.prototype.GetSqlAsync = function (file_loop_seq, method) {
        var sub_url;
        sub_url = "ZipFileLoopPwd/get_{2}_sql/{1}";
    ...
    ZipFileLoopPwdServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_services__["a" /* ServicesProvider */]])
    ], ZipFileLoopPwdServicesProvider);
    return ZipFileLoopPwdServicesProvider;
}());

//# sourceMappingURL=zip-file-loop-pwd-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ZipFileLoopPwdPage; });
 ...
 * Components.
 */
var ZipFileLoopPwdPage = /** @class */ (function () {
    function ZipFileLoopPwdPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, ZipFileLoopPwdServices, TableServices, modalCtrl, platform, conf) {
        ...
        this.ZipFileLoopPwdServices = ZipFileLoopPwdServices;
    ...
    ZipFileLoopPwdPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    ZipFileLoopPwdPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    ZipFileLoopPwdPage.prototype.setPage = function (pageInfo) {
    ...
    ZipFileLoopPwdPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    ZipFileLoopPwdPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    ZipFileLoopPwdPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.ZipFileLoopPwdServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.zip_seq, _this.order_type).subscribe(function (data) {
    ...
    ZipFileLoopPwdPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ZipFileLoopPwdViewModel__["a" /* ZipFileLoopPwdViewModel */]();
        ...
        var modal = this.modalCtrl.create("ZipFileLoopPwdAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.ZipFileLoopPwdServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    ZipFileLoopPwdPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.ZipFileLoopPwdServices.DeleteAsync(item.file_loop_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    ZipFileLoopPwdPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.ZipFileLoopPwdServices.GetSqlAsync(item.file_loop_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    ZipFileLoopPwdPage.prototype.ionViewDidLoad = function () {
    ...
    ZipFileLoopPwdPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_zip_file_loop_pwd_services_zip_file_loop_pwd_services__["a" /* ZipFileLoopPwdServicesProvider */],
    ...
    return ZipFileLoopPwdPage;
}());

//# sourceMappingURL=zip-file-loop-pwd.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ZipFileLoopPwdListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_ZipFileLoopPwdViewModel__ = __webpack_require__(1082);
...
var ZipFileLoopPwdListResponse = /** @class */ (function (_super) {
    __extends(ZipFileLoopPwdListResponse, _super);
    function ZipFileLoopPwdListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_ZipFileLoopPwdViewModel__["a" /* ZipFileLoopPwdViewModel */]();
    ...
    return ZipFileLoopPwdListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=ZipFileLoopPwdListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ZipFileLoopPwdResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_ZipFileLoopPwdViewModel__ = __webpack_require__(1082);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var ZipFileLoopPwdResponse = /** @class */ (function (_super) {
    __extends(ZipFileLoopPwdResponse, _super);
    function ZipFileLoopPwdResponse(obj) {
        var _this = _super.call(this, obj) || this;
    ...
    return ZipFileLoopPwdResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=ZipFileLoopPwdResponse.js.map
...
var ZipFileLoopPwdPageModule = /** @class */ (function () {
    function ZipFileLoopPwdPageModule() {
    }
    ZipFileLoopPwdPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__zip_file_loop_pwd__["a" /* ZipFileLoopPwdPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_zip_file_loop_pwd_services_zip_file_loop_pwd_services__["a" /* ZipFileLoopPwdServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__zip_file_loop_pwd__["a" /* ZipFileLoopPwdPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], ZipFileLoopPwdPageModule);
    return ZipFileLoopPwdPageModule;
}());

//# sourceMappingURL=zip-file-loop-pwd.module.js.map
