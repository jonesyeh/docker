...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return WarningCheckServicesProvider; });
...
/*
  Generated class for the WarningCheckServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var WarningCheckServicesProvider = /** @class */ (function () {
    function WarningCheckServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "WarningCheck";
        console.log("Hello WarningCheckServiceProvider");
    }
    WarningCheckServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, schemaname, tablename, columnname, keyword, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "WarningCheck?PageSize={1}&PageNumber={2}&keyword={3}&schemaname={4}&tablename={5}&columnname={6}&order_type={7}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.WarningChecks = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_WarningCheckListResponse__["a" /* WarningCheckListResponse */]({
            ...
            return _this.WarningChecks;
        });
    };
    WarningCheckServicesProvider.prototype.PostPutAsync = function (WarningCheckViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "WarningCheck";
        else
            sub_url = "WarningCheck?schemaname={1}&tablename={2}&columnname={3}&check_key={4}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, WarningCheckViewModel.schemaname, WarningCheckViewModel.tablename, WarningCheckViewModel.columnname, WarningCheckViewModel.check_key);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, WarningCheckViewModel, mode).map(function (item) {
            _this.WarningCheck = new __WEBPACK_IMPORTED_MODULE_5__Model_Response_WarningCheckResponse__["a" /* WarningCheckResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.WarningCheck;
        });
    };
    WarningCheckServicesProvider.prototype.DeleteAsync = function (schemaname, tablename, columnname, check_key) {
        var _this = this;
        var sub_url;
        sub_url = "WarningCheck?schemaname={1}&tablename={2}&columnname={3}&check_key={4}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, schemaname, tablename, columnname, check_key);
    ...
    WarningCheckServicesProvider.prototype.GetSqlAsync = function (schemaname, tablename, columnname, check_key, method) {
        var sub_url;
        sub_url = "WarningCheck/get_{5}_sql?schemaname={1}&tablename={2}&columnname={3}&check_key={4}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, schemaname, tablename, columnname, check_key, method);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
    ...
    WarningCheckServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_services__["a" /* ServicesProvider */]])
    ], WarningCheckServicesProvider);
    return WarningCheckServicesProvider;
}());

//# sourceMappingURL=warning-check-services.js.map
...
var WarningCheckPage = /** @class */ (function () {
    function WarningCheckPage(menuCtrl, navCtrl, navParams, WarningCheckServices, loadingCtrl, global, authServices, modalCtrl, alertCtrl, platform, conf) {
        this.menuCtrl = menuCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.WarningCheckServices = WarningCheckServices;
        ...
        this.CanWarningCheckExec = true;
        this.detail_page = "WarningCheckDetailPage";
        this.CheckType_page = "WarningCheckTypeDetailPage";
        ...
        if (this.authServices.authenticated() === true) {
            this.CanJob = this.authServices.CanJob();
            this.CanEditJob = this.authServices.CanEditJob();
            this.LoadData(true);
        }
    }
    WarningCheckPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    WarningCheckPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    WarningCheckPage.prototype.setPage = function (pageInfo) {
    ...
    WarningCheckPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    WarningCheckPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    WarningCheckPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.WarningCheckServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.schemaname, _this.tablename, _this.columnname, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    WarningCheckPage.prototype.openNavSqlPage = function (item, method, is_exec) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.WarningCheckServices.GetSqlAsync(item.schemaname, item.tablename, item.columnname, item.check_key, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    WarningCheckPage.prototype.ShowModal = function (item) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_WarningCheckViewModel__["a" /* WarningCheckViewModel */]();
        ...
        var modal = this.modalCtrl.create("WarningCheckAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.WarningCheckServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("警訊檢核欄位", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    WarningCheckPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.WarningCheckServices.DeleteAsync(item.schemaname, item.tablename, item.columnname, item.check_key).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    return WarningCheckPage;
}());

//# sourceMappingURL=warning-check.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return WarningCheckListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_WarningCheckViewModel__ = __webpack_require__(1081);
...
var WarningCheckListResponse = /** @class */ (function (_super) {
    __extends(WarningCheckListResponse, _super);
    function WarningCheckListResponse(obj) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return WarningCheckResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_WarningCheckViewModel__ = __webpack_require__(1081);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var WarningCheckResponse = /** @class */ (function (_super) {
    __extends(WarningCheckResponse, _super);
    function WarningCheckResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_WarningCheckViewModel__["a" /* WarningCheckViewModel */]();
            ...
            _this.Model.check_key = obj.Model.check_key;
            ...
            _this.Model.check_desc = obj.Model.check_desc;
        }
        return _this;
    }
...
//# sourceMappingURL=WarningCheckResponse.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WarningCheckPageModule", function() { return WarningCheckPageModule; });
...
var WarningCheckPageModule = /** @class */ (function () {
    function WarningCheckPageModule() {
    }
    WarningCheckPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__warning_check__["a" /* WarningCheckPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_warning_check_services_warning_check_services__["a" /* WarningCheckServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__warning_check__["a" /* WarningCheckPage */]),
                __WEBPACK_IMPORTED_MODULE_0__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], WarningCheckPageModule);
    return WarningCheckPageModule;
}());

//# sourceMappingURL=warning-check.module.js.map
