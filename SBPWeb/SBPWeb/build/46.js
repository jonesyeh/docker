...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UnZipFileLoopPwdServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_UnZipFileLoopPwdListResponse__ = __webpack_require__(1675);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_Response_UnZipFileLoopPwdResponse__ = __webpack_require__(1676);
...
/*
  Generated class for the UnZipFileLoopPwdServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var UnZipFileLoopPwdServicesProvider = /** @class */ (function () {
    function UnZipFileLoopPwdServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "UnZipFileLoopPwd";
        console.log("Hello UnZipFileLoopPwdServiceProvider Provider");
    }
    UnZipFileLoopPwdServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, exec_file_seq, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "UnZipFileLoopPwd?PageSize={1}&PageNumber={2}&keyword={3}&exec_file_seq={4}&order_type={5}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.UnZipFileLoopPwds = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_UnZipFileLoopPwdListResponse__["a" /* UnZipFileLoopPwdListResponse */]({
            ...
            return _this.UnZipFileLoopPwds;
        });
    };
    UnZipFileLoopPwdServicesProvider.prototype.GetMaxFileLoopSeqAsync = function (exec_file_seq) {
        var sub_url;
        sub_url = "UnZipFileLoopPwd/get_max_file_loop_seq?exec_file_seq={1}";
    ...
    UnZipFileLoopPwdServicesProvider.prototype.PostPutAsync = function (UnZipFileLoopPwdViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "UnZipFileLoopPwd";
        else
            sub_url = "UnZipFileLoopPwd/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, UnZipFileLoopPwdViewModel.file_loop_seq);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, UnZipFileLoopPwdViewModel, mode).map(function (item) {
            _this.UnZipFileLoopPwd = new __WEBPACK_IMPORTED_MODULE_5__Model_Response_UnZipFileLoopPwdResponse__["a" /* UnZipFileLoopPwdResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.UnZipFileLoopPwd;
        });
    };
    UnZipFileLoopPwdServicesProvider.prototype.DeleteAsync = function (file_loop_seq) {
        var _this = this;
        var sub_url;
        sub_url = "UnZipFileLoopPwd/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, file_loop_seq);
    ...
    UnZipFileLoopPwdServicesProvider.prototype.GetSqlAsync = function (file_loop_seq, method) {
        var sub_url;
        sub_url = "UnZipFileLoopPwd/get_{2}_sql/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, file_loop_seq, method);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
    ...
    UnZipFileLoopPwdServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_services__["a" /* ServicesProvider */]])
    ], UnZipFileLoopPwdServicesProvider);
    return UnZipFileLoopPwdServicesProvider;
}());

//# sourceMappingURL=un-zip-file-loop-pwd-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UnZipFileLoopPwdPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_un_zip_file_loop_pwd_services_un_zip_file_loop_pwd_services__ = __webpack_require__(1245);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_UnZipFileLoopPwdViewModel__ = __webpack_require__(1080);
 ...
 * Components.
 */
var UnZipFileLoopPwdPage = /** @class */ (function () {
    function UnZipFileLoopPwdPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, UnZipFileLoopPwdServices, TableServices, modalCtrl, platform, conf) {
        ...
        this.UnZipFileLoopPwdServices = UnZipFileLoopPwdServices;
    ...
    UnZipFileLoopPwdPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    UnZipFileLoopPwdPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    UnZipFileLoopPwdPage.prototype.setPage = function (pageInfo) {
    ...
    UnZipFileLoopPwdPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    UnZipFileLoopPwdPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    UnZipFileLoopPwdPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.UnZipFileLoopPwdServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
    ...
    UnZipFileLoopPwdPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_UnZipFileLoopPwdViewModel__["a" /* UnZipFileLoopPwdViewModel */]();
            ...
            item.job02 = "";
            item.job03 = "";
            item.file_loop_seq = this.exec_file_seq * 100 + this.totalRows + 1;
        }
        else {
            this.mode = "PUT";
            if (change_mode === "c") {
        ...
        var modal = this.modalCtrl.create("UnZipFileLoopPwdAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.UnZipFileLoopPwdServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("檔案迴圈密碼", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    UnZipFileLoopPwdPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.file_loop_seq),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.UnZipFileLoopPwdServices.DeleteAsync(item.file_loop_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    UnZipFileLoopPwdPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.UnZipFileLoopPwdServices.GetSqlAsync(item.file_loop_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    UnZipFileLoopPwdPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_un_zip_file_loop_pwd_services_un_zip_file_loop_pwd_services__["a" /* UnZipFileLoopPwdServicesProvider */],
    ...
    ], UnZipFileLoopPwdPage);
    return UnZipFileLoopPwdPage;
}());

//# sourceMappingURL=un-zip-file-loop-pwd.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UnZipFileLoopPwdListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_UnZipFileLoopPwdViewModel__ = __webpack_require__(1080);
...
var UnZipFileLoopPwdListResponse = /** @class */ (function (_super) {
    __extends(UnZipFileLoopPwdListResponse, _super);
    function UnZipFileLoopPwdListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_UnZipFileLoopPwdViewModel__["a" /* UnZipFileLoopPwdViewModel */]();
                item.file_loop_seq = data.file_loop_seq;
                item.exec_file_seq = data.exec_file_seq;
                item.job01 = data.job01;
    ...
    return UnZipFileLoopPwdListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=UnZipFileLoopPwdListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UnZipFileLoopPwdResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_UnZipFileLoopPwdViewModel__ = __webpack_require__(1080);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var UnZipFileLoopPwdResponse = /** @class */ (function (_super) {
    __extends(UnZipFileLoopPwdResponse, _super);
    function UnZipFileLoopPwdResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_UnZipFileLoopPwdViewModel__["a" /* UnZipFileLoopPwdViewModel */]();
    ...
    return UnZipFileLoopPwdResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=UnZipFileLoopPwdResponse.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__un_zip_file_loop_pwd__ = __webpack_require__(1674);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_un_zip_file_loop_pwd_services_un_zip_file_loop_pwd_services__ = __webpack_require__(1245);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var UnZipFileLoopPwdPageModule = /** @class */ (function () {
    function UnZipFileLoopPwdPageModule() {
    }
    UnZipFileLoopPwdPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__un_zip_file_loop_pwd__["a" /* UnZipFileLoopPwdPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_un_zip_file_loop_pwd_services_un_zip_file_loop_pwd_services__["a" /* UnZipFileLoopPwdServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__un_zip_file_loop_pwd__["a" /* UnZipFileLoopPwdPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], UnZipFileLoopPwdPageModule);
    return UnZipFileLoopPwdPageModule;
}());

//# sourceMappingURL=un-zip-file-loop-pwd.module.js.map
