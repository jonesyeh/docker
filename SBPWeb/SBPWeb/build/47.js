...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Table2TablePage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_Table2TableViewModel__ = __webpack_require__(992);
 ...
 * Components.
 */
var Table2TablePage = /** @class */ (function () {
    function Table2TablePage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, Table2TableServices, modalCtrl, viewCtrl, platform, conf) {
        ...
        this.page_name = "Table2TablePage";
        this.File_page = "Table2TableTablePage";
    ...
    Table2TablePage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    Table2TablePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    Table2TablePage.prototype.setPage = function (pageInfo) {
    ...
    Table2TablePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    Table2TablePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    Table2TablePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.Table2TableServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    Table2TablePage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_Table2TableViewModel__["a" /* Table2TableViewModel */]();
            item.is_active = true;
        ...
        var modal = this.modalCtrl.create("Table2TableAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.Table2TableServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    Table2TablePage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.Table2TableServices.DeleteAsync(item.exec_table_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    Table2TablePage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.Table2TableServices.GetSqlAsync(item.exec_table_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    Table2TablePage.prototype.openNavMergeSqlPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.Table2TableServices.GetMergeSqlAsync(item.src_schema, item.src_tablename, item.where_condition, item.schemaname, item.tablename, item.import_mode_key, item.last_data_type_key, item.last_data_column_name, item.exec_group).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    Table2TablePage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    Table2TablePage.prototype.add = function (item) {
        this.viewCtrl.dismiss(item);
    };
    Table2TablePage.prototype.close = function () {
        this.viewCtrl.dismiss();
    };
    Table2TablePage.prototype.openNavTableLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    Table2TablePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_table2_table_services_table2_table_services__["a" /* Table2TableServicesProvider */],
    ...
    return Table2TablePage;
}());

//# sourceMappingURL=table2-table.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Table2TablePageModule", function() { return Table2TablePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__table2_table__ = __webpack_require__(1672);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_table2_table_services_table2_table_services__ = __webpack_require__(1079);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var Table2TablePageModule = /** @class */ (function () {
    function Table2TablePageModule() {
    }
    Table2TablePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__table2_table__["a" /* Table2TablePage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_table2_table_services_table2_table_services__["a" /* Table2TableServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__table2_table__["a" /* Table2TablePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], Table2TablePageModule);
    return Table2TablePageModule;
}());

//# sourceMappingURL=table2-table.module.js.map
