...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SqlAllViewModel; });
var SqlAllViewModel = /** @class */ (function () {
    function SqlAllViewModel() {
    }
    return SqlAllViewModel;
}());

//# sourceMappingURL=SqlAllViewModel.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SqlAllServicesProvider; });
...
/*
  Generated class for the SqlAllServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var SqlAllServicesProvider = /** @class */ (function (_super) {
    __extends(SqlAllServicesProvider, _super);
    function SqlAllServicesProvider(Services) {
        var _this = _super.call(this, Services) || this;
        _this.Services = Services;
        _this.ctl = "SqlAll";
        console.log("Hello SqlAllServiceProvider Provider");
        return _this;
    }
    SqlAllServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, exec_group, exec_table_seq, order_type) {
        var _this = this;
        var sub_url;
        if (exec_table_seq === 0) {
            sub_url = "SqlAll?PageSize={1}&PageNumber={2}&keyword={3}&pexec_group={4}&order_type={5}";
            ...
            sub_url = "SqlAll/Select?PageSize={1}&PageNumber={2}&keyword={3}&pexec_group={4}&exec_table_seq={5}&order_type={6}";
            sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, PageSize, PageNumber, keyword, exec_group, exec_table_seq, order_type);
        }
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.SqlAlls = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_SqlAllListResponse__["a" /* SqlAllListResponse */]({
            ...
            return _this.SqlAlls;
        });
    };
    SqlAllServicesProvider.prototype.PostPutAsync = function (controller, data, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = controller;
        ...
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, data.exec_table_seq);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, data, mode).map(function (item) {
            _this.SqlAll = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_SqlAllResponse__["a" /* SqlAllResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
    ...
    SqlAllServicesProvider.prototype.DeleteAsync = function (exec_table_seq) {
        var _this = this;
        var sub_url;
        sub_url = "SqlAll/{1}";
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SqlAllPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_sql_all_services_sql_all_services__ = __webpack_require__(1243);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_SqlAllViewModel__ = __webpack_require__(1190);
 ...
 * Components.
 */
var SqlAllPage = /** @class */ (function () {
    function SqlAllPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, SqlAllServices, modalCtrl, viewCtrl, platform, conf) {
        ...
        this.SqlAllServices = SqlAllServices;
        ...
        this.keyword = "";
        this.title = "執行SQL設定";
        this.exec_table_seq = 0;
        this.show_select = false;
        this.page_name = "SqlAllPage";
        this.File_page = "SqlAllTablePage";
    ...
    SqlAllPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    SqlAllPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    SqlAllPage.prototype.setPage = function (pageInfo) {
    ...
    SqlAllPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    SqlAllPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    SqlAllPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.SqlAllServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_table_seq, _this.order_type).subscribe(function (data) {
    ...
    SqlAllPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_SqlAllViewModel__["a" /* SqlAllViewModel */]();
            item.is_active = true;
            ...
            item.schemaname = "";
            item.tablename = "";
            item.import_mode_key = "042|M";
            item.import_mode = "Merge(Update/Insert)";
            item.last_data_type_key = "009|ALL";
            item.last_data_type = "全部";
            item.tran_flag = false;
        }
        else {
            this.mode = "PUT";
            if (change_mode === "c")
        ...
        if (item.func_sub_type === 1)
            page = "Table2TableAddEditModalPage";
        if (item.func_sub_type === 2)
            page = "SpAddEditModalPage";
        if (item.func_sub_type === 3)
            page = "SqlSetAddEditModalPage";
        if (item.func_sub_type === 4)
            page = "FordAddEditModalPage";
        if (item.func_sub_type === 5)
            page = "ForsAddEditModalPage";
        if (item.func_sub_type === 6)
            page = "ForAddEditModalPage";
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                ...
                if (item.func_sub_type === 6)
                    controller = "For";
                _this.SqlAllServices.PostPutAsync(controller, select_data, _this.mode).subscribe(function (data) {
    ...
    SqlAllPage.prototype.openNavMergeSqlPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push("MergeSqlPage", { item: item });
        });
        this.global.dismissLoading();
    };
    SqlAllPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.exec_table_seq),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.SqlAllServices.DeleteAsync(item.exec_table_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    SqlAllPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.SqlAllServices.GetSqlAsync(item.exec_table_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    SqlAllPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    SqlAllPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_sql_all_services_sql_all_services__["a" /* SqlAllServicesProvider */],
...
//# sourceMappingURL=sql-all.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SqlAllListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_SqlAllViewModel__ = __webpack_require__(1190);
...
var SqlAllListResponse = /** @class */ (function (_super) {
    __extends(SqlAllListResponse, _super);
    function SqlAllListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_SqlAllViewModel__["a" /* SqlAllViewModel */]();
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SqlAllResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_SqlAllViewModel__ = __webpack_require__(1190);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var SqlAllResponse = /** @class */ (function (_super) {
    __extends(SqlAllResponse, _super);
    function SqlAllResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_SqlAllViewModel__["a" /* SqlAllViewModel */]();
...
var SqlAllPageModule = /** @class */ (function () {
    function SqlAllPageModule() {
    }
    SqlAllPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__sql_all__["a" /* SqlAllPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_sql_all_services_sql_all_services__["a" /* SqlAllServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__sql_all__["a" /* SqlAllPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], SqlAllPageModule);
    return SqlAllPageModule;
}());

//# sourceMappingURL=sql-all.module.js.map
