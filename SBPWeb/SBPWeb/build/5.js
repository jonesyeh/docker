...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProgramSetListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_ProgramSetViewModel__ = __webpack_require__(1001);
...
var ProgramSetListResponse = /** @class */ (function (_super) {
    __extends(ProgramSetListResponse, _super);
    function ProgramSetListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_ProgramSetViewModel__["a" /* ProgramSetViewModel */]();
                item.ssis_program_set_no = data.ssis_program_set_no; //程式設定編號
                item.program_no = data.program_no; //程式編號
                item.file_exec_log_rpt_name =
                    (data && data.file_exec_log_rpt_name) || null; //檔案執行紀錄報表程式
                ...
                item.ssis_program_set_desc = data.ssis_program_set_desc; //程式設定說明
                _this.Model.push(item);
            }) || null;
        }
        return _this;
    }
    return ProgramSetListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=ProgramSetListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProgramSetViewModel; });
var ProgramSetViewModel = /** @class */ (function () {
    function ProgramSetViewModel() {
    }
    return ProgramSetViewModel;
}());

//# sourceMappingURL=ProgramSetViewModel.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BatchExecProgramSelectModalPage; });
...
/**
 * Generated class for the BatchExecProgramSelectModalPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var BatchExecProgramSelectModalPage = /** @class */ (function () {
    function BatchExecProgramSelectModalPage(navCtrl, navParams, viewCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.viewCtrl = viewCtrl;
        this.select_item = navParams.data.select_item;
        this.is_filter = navParams.data.is_filter;
        if (navParams.data.ssis_program_set_no != null)
            this.ssis_program_set_no = navParams.data.ssis_program_set_no;
        else
            this.ssis_program_set_no = "";
    }
    BatchExecProgramSelectModalPage.prototype.onSelect = function (item) {
        this.viewCtrl.dismiss(item);
    };
    BatchExecProgramSelectModalPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad BatchExecProgramSelectModalPage");
    };
    BatchExecProgramSelectModalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-batch-exec-program-select-modal",template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\batch-exec-program-select-modal\batch-exec-program-select-modal.html"*/'<!--\n  Generated template for the BatchProgramSelectModalPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>程式選取</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n    <ExecGroupFunctionComponent [is_filter]="is_filter" [show_select]=true (onSelect)="onSelect($event)" [ssis_program_set_no]="ssis_program_set_no"  [select_item]="select_item"  ></ExecGroupFunctionComponent>\n\n</ion-content>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\batch-exec-program-select-modal\batch-exec-program-select-modal.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* ViewController */]])
    ], BatchExecProgramSelectModalPage);
    return BatchExecProgramSelectModalPage;
}());

//# sourceMappingURL=batch-exec-program-select-modal.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BatchExecProgramSelectModalPageModule", function() { return BatchExecProgramSelectModalPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__batch_exec_program_select_modal__ = __webpack_require__(1269);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_exec_group_function_components_module__ = __webpack_require__(995);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BatchExecProgramSelectModalPageModule = /** @class */ (function () {
    function BatchExecProgramSelectModalPageModule() {
    }
    BatchExecProgramSelectModalPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__batch_exec_program_select_modal__["a" /* BatchExecProgramSelectModalPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__batch_exec_program_select_modal__["a" /* BatchExecProgramSelectModalPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_exec_group_function_components_module__["a" /* ExecGroupFunctionComponentsModule */],
            ],
        })
    ], BatchExecProgramSelectModalPageModule);
    return BatchExecProgramSelectModalPageModule;
}());

//# sourceMappingURL=batch-exec-program-select-modal.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ExecGroupFunctionServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_ExecGroupFunctionListResponse__ = __webpack_require__(997);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_Response_ExecGroupFunctionResponse__ = __webpack_require__(998);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/*
  Generated class for the ExecGroupFunctionServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var ExecGroupFunctionServicesProvider = /** @class */ (function () {
    function ExecGroupFunctionServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "ExecGroupFunction";
        console.log("Hello ExecGroupFunctionServiceProvider Provider");
    }
    ExecGroupFunctionServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, ssis_program_set_no, order_type, is_filter) {
        var _this = this;
        if (is_filter === void 0) { is_filter = false; }
        var sub_url;
        sub_url = "ExecGroupFunction?PageSize={1}&PageNumber={2}&keyword={3}&ssis_program_set_no={4}&order_type={5}&is_filter={6}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, PageSize, PageNumber, keyword, ssis_program_set_no, order_type, is_filter);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.ExecGroupFunctions = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_ExecGroupFunctionListResponse__["a" /* ExecGroupFunctionListResponse */]({
            ...
            return _this.ExecGroupFunctions;
        });
    };
    ExecGroupFunctionServicesProvider.prototype.PostPutAsync = function (ExecGroupFunctionViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "ExecGroupFunction";
        else
            sub_url = "ExecGroupFunction/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, ExecGroupFunctionViewModel.program_func_no);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, ExecGroupFunctionViewModel, mode).map(function (item) {
            _this.ExecGroupFunction = new __WEBPACK_IMPORTED_MODULE_5__Model_Response_ExecGroupFunctionResponse__["a" /* ExecGroupFunctionResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.ExecGroupFunction;
        });
    };
    ExecGroupFunctionServicesProvider.prototype.DeleteAsync = function (program_func_no) {
        var _this = this;
        var sub_url;
        sub_url = "ExecGroupFunction/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, program_func_no);
    ...
    ExecGroupFunctionServicesProvider.prototype.GetSqlAsync = function (program_func_no, method) {
        var sub_url;
        sub_url = "ExecGroupFunction/get_{2}_sql/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, program_func_no, method);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
    ...
    ExecGroupFunctionServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_services__["a" /* ServicesProvider */]])
    ], ExecGroupFunctionServicesProvider);
    return ExecGroupFunctionServicesProvider;
}());

//# sourceMappingURL=exec-group-function-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProgramSetServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_ProgramSetListResponse__ = __webpack_require__(1000);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/*
  Generated class for the ProgramSetServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var ProgramSetServicesProvider = /** @class */ (function () {
    function ProgramSetServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "ProgramSet";
        console.log("Hello ProgramSetServiceProvider Provider");
    }
    ProgramSetServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "ProgramSet?PageSize={1}&PageNumber={2}&keyword={3}&order_type={4}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.ProgramSets = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_ProgramSetListResponse__["a" /* ProgramSetListResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                PageSize: item.PageSize,
            ...
            return _this.ProgramSets;
        });
    };
    ProgramSetServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_services__["a" /* ServicesProvider */]])
    ], ProgramSetServicesProvider);
    return ProgramSetServicesProvider;
}());

//# sourceMappingURL=program-set-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ExecGroupFunctionComponentsModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__exec_group_function_exec_group_function__ = __webpack_require__(996);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__program_set_program_set__ = __webpack_require__(999);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_exec_group_function_services_exec_group_function_services__ = __webpack_require__(935);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_program_set_services_program_set_services__ = __webpack_require__(936);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ExecGroupFunctionComponentsModule = /** @class */ (function () {
    function ExecGroupFunctionComponentsModule() {
    }
    ExecGroupFunctionComponentsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__exec_group_function_exec_group_function__["a" /* ExecGroupFunctionComponent */], __WEBPACK_IMPORTED_MODULE_4__program_set_program_set__["a" /* ProgramSetComponent */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_5__providers_exec_group_function_services_exec_group_function_services__["a" /* ExecGroupFunctionServicesProvider */], __WEBPACK_IMPORTED_MODULE_6__providers_program_set_services_program_set_services__["a" /* ProgramSetServicesProvider */],
            ],
            ...
            exports: [
                __WEBPACK_IMPORTED_MODULE_3__exec_group_function_exec_group_function__["a" /* ExecGroupFunctionComponent */],
                __WEBPACK_IMPORTED_MODULE_2__components_module__["a" /* ComponentsModule */],
                __WEBPACK_IMPORTED_MODULE_4__program_set_program_set__["a" /* ProgramSetComponent */],
            ]
        })
    ], ExecGroupFunctionComponentsModule);
    return ExecGroupFunctionComponentsModule;
}());

//# sourceMappingURL=exec_group_function.components.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ExecGroupFunctionComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_global_global__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_auth_services_auth_services__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_exec_group_function_services_exec_group_function_services__ = __webpack_require__(935);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ExecGroupFunctionViewModel__ = __webpack_require__(915);
...
/**
 * Generated class for the ExecGroupFunctionComponent component.
 *
 * See https://angular.io/api/core/Component for more info on Angular
 * Components.
 */
var ExecGroupFunctionComponent = /** @class */ (function () {
    function ExecGroupFunctionComponent(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, ExecGroupFunctionServices, modalCtrl, platform, conf) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        ...
        this.global = global;
        this.authServices = authServices;
        this.ExecGroupFunctionServices = ExecGroupFunctionServices;
        ...
        this.is_filter = true;
        this.ExecGroupFunction_page = "ExecGroupFunctionSelectModalPage";
        this.onSelect = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        this.detail_page = "ExecGroupFunctionDetailByExecGroupFunctionPage";
        this.ExecGroupFunctionExt_page = "ExecGroupFunctionExtPage";
        this.sql_page = "SqlPage";
        this.order_type = true;
        this.innerWidth = window.innerWidth;
        this.innerHeight = window.innerHeight;
    }
    ExecGroupFunctionComponent.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    ExecGroupFunctionComponent.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    ExecGroupFunctionComponent.prototype.setPage = function (pageInfo) {
    ...
    ExecGroupFunctionComponent.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    ExecGroupFunctionComponent.prototype.doInfinite = function () {
        var _this = this;
    ...
    ExecGroupFunctionComponent.prototype.SelectProramSetNo = function () {
        var _this = this;
        var modal = this.modalCtrl.create("ProgramSetSelectModalPage", {
            title: "執行程式",
        });
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
            _this.ssis_program_set_no = select_data.ssis_program_set_no;
            _this.LoadData(true);
        });
        modal.present();
    };
    ExecGroupFunctionComponent.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.ExecGroupFunctionServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.ssis_program_set_no, _this.order_type, _this.is_filter).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    ExecGroupFunctionComponent.prototype.get_board_class = function (item) {
        if (item.program_func_no === this.select_item)
            return "select_bordered";
        else
            return "bordered";
    };
    ExecGroupFunctionComponent.prototype.ShowModal = function (item) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ExecGroupFunctionViewModel__["a" /* ExecGroupFunctionViewModel */]();
        }
        else {
            this.mode = "PUT";
        }
        var modal = this.modalCtrl.create("BatchExecProgramAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.ExecGroupFunctionServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    ExecGroupFunctionComponent.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.program_func_no),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.ExecGroupFunctionServices.DeleteAsync(item.program_func_no).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    ExecGroupFunctionComponent.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.ExecGroupFunctionServices.GetSqlAsync(item.program_func_no, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    ExecGroupFunctionComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_2__providers_auth_services_auth_services__["a" /* AuthServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_3__providers_exec_group_function_services_exec_group_function_services__["a" /* ExecGroupFunctionServicesProvider */],
    ...
    ], ExecGroupFunctionComponent);
    return ExecGroupFunctionComponent;
}());

//# sourceMappingURL=exec-group-function.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ExecGroupFunctionListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_ExecGroupFunctionViewModel__ = __webpack_require__(915);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ListModelResponse__ = __webpack_require__(5);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var ExecGroupFunctionListResponse = /** @class */ (function (_super) {
    __extends(ExecGroupFunctionListResponse, _super);
    function ExecGroupFunctionListResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Model = [];
        _this.Message = obj.Messag;
        _this.DidError = obj.DidError;
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_ExecGroupFunctionViewModel__["a" /* ExecGroupFunctionViewModel */]();
                item.program_func_no = data.program_func_no;
                item.ssis_program_set_no = data.ssis_program_set_no;
                ...
                item.ssis_program_set_desc = data.ssis_program_set_desc;
    ...
    return ExecGroupFunctionListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=ExecGroupFunctionListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ExecGroupFunctionResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_ExecGroupFunctionViewModel__ = __webpack_require__(915);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var ExecGroupFunctionResponse = /** @class */ (function (_super) {
    __extends(ExecGroupFunctionResponse, _super);
    function ExecGroupFunctionResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_ExecGroupFunctionViewModel__["a" /* ExecGroupFunctionViewModel */]();
            _this.Model.program_func_no = obj.Model.program_func_no;
            _this.Model.ssis_program_set_no = obj.Model.ssis_program_set_no;
            ...
            _this.Model.ssis_program_set_desc = obj.Model.ssis_program_set_desc;
    ...
    return ExecGroupFunctionResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=ExecGroupFunctionResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProgramSetComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_global_global__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_auth_services_auth_services__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_program_set_services_program_set_services__ = __webpack_require__(936);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ionic_angular__ = __webpack_require__(63);
...
/**
 * Generated class for the ProgramSetComponent component.
 *
 * See https://angular.io/api/core/Component for more info on Angular
 * Components.
 */
var ProgramSetComponent = /** @class */ (function () {
    function ProgramSetComponent(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, ProgramSetServices, modalCtrl, platform, conf) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.loadingCtrl = loadingCtrl;
        this.alertCtrl = alertCtrl;
        this.global = global;
        this.authServices = authServices;
        this.ProgramSetServices = ProgramSetServices;
        this.modalCtrl = modalCtrl;
        this.platform = platform;
        this.conf = conf;
        this.selected = [];
        ...
        this.show_select = false;
        this.is_filter = true;
        this.ProgramSet_page = "ProgramSetSelectModalPage";
        this.onSelect = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        this.order_type = true;
        this.innerWidth = window.innerWidth;
        this.innerHeight = window.innerHeight;
    }
    ProgramSetComponent.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
        if (this.select_item > '')
    ...
    ProgramSetComponent.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    ProgramSetComponent.prototype.setPage = function (pageInfo) {
        this.pageNumber = Math.floor(pageInfo.offset / 3) + 1;
        if ((pageInfo.offset + 1) % 3 === 0) {
            if ((pageInfo.offset + 1) / 3 + 1 > this.loadPages) {
                this.loadPageNumber = this.pageNumber + 1;
    ...
    ProgramSetComponent.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    ProgramSetComponent.prototype.doInfinite = function () {
        var _this = this;
        console.log("Begin async operation");
        if (this.loadPages < this.totalPages) {
            this.pageNumber++;
    ...
    ProgramSetComponent.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.ProgramSetServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    ProgramSetComponent.prototype.get_board_class = function (item) {
        if (item.ssis_program_set_no === this.select_item)
            return "select_bordered";
        else
            return "bordered";
    };
    ProgramSetComponent.prototype.add = function (item) {
        // this.viewCtrl.dismiss(item);
        this.onSelect.emit(item);
    };
    ProgramSetComponent.prototype.close = function () {
        //this.viewCtrl.dismiss();
        this.onSelect.emit(null);
    };
    ProgramSetComponent.prototype.ionViewDidLoad = function () {
        console.log('Hello ProgramSetComponent Component');
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", String)
    ], ProgramSetComponent.prototype, "ssis_program_set_no", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", String)
    ], ProgramSetComponent.prototype, "keyword", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", String)
    ], ProgramSetComponent.prototype, "subject", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", String)
    ], ProgramSetComponent.prototype, "select_item", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Boolean)
    ], ProgramSetComponent.prototype, "show_select", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Boolean)
    ], ProgramSetComponent.prototype, "is_filter", void 0);
    ProgramSetComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'ProgramSetComponent',
            outputs: ['onSelect'],template:/*ion-inline-start:"C:\jones\ionic\prod\src\components\program-set\program-set.html"*/'<!--\n  Generated template for the RolePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n\n\n\n<ion-content (window:resize)="onResize($event)">\n  <ion-row>\n\n    <ion-col>\n\n      <ion-searchbar [ngClass]="[\'search\']" (keyup.enter)="LoadData(true)" placeholder="搜尋關鍵字(執行程式編號、執行程式說明包含)" [(ngModel)]="keyword">\n      </ion-searchbar>\n    </ion-col>\n  </ion-row>\n\n  <ion-grid *ngIf="conf.mobile_mode==false && selectedItem!=null" [ngClass]="\'bordered\'">\n    <ion-row>\n      <ion-col>\n\n        <button small title="加入" *ngIf="show_select==true" ion-button color="danger" icon-left (click)="add(selectedItem)">\n          <ion-icon name="checkmark-circle"></ion-icon>\n        </button>\n\n      </ion-col>\n\n\n    </ion-row>\n  </ion-grid>\n  <ngx-datatable NgxResizeWatcher class="bootstrap" *ngIf="totalRows>0 && conf.mobile_mode==false" [selected]="selected" [selectionType]="\'single\'"\n    (select)=\'onRowSelect($event)\' [rows]="data_list" [columnMode]="\'flex\'" [headerHeight]="40" [rowHeight]="\'auto\'"\n    [footerHeight]="40" [reorderable]=false [limit]="limit" [count]="totalRows" [offset]="offset" (page)=\'setPage($event)\'>\n\n\n    <ngx-datatable-column prop="ssis_program_set_no" name="執行程式編號" [flexGrow]="1">\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="ssis_program_set_desc" name="執行程式說明" [flexGrow]="2">\n    </ngx-datatable-column>\n\n  </ngx-datatable>\n  <div *ngIf="totalRows>0 && conf.mobile_mode==true">\n    <ion-row>\n\n      <ion-col col-lg-4 col-md-6 col-sm-6 col-12 *ngFor="let item of data_list">\n\n        <ion-grid [ngClass]=get_board_class(item)>\n          <ion-row>\n            <ion-col>\n\n              <button small title="加入" *ngIf="show_select==true" ion-button color="danger" icon-left (click)="add(item)">\n                <ion-icon name="checkmark-circle"></ion-icon>\n              </button>\n\n\n            </ion-col>\n          </ion-row>\n\n\n          <ion-row>\n            <ion-col>\n              {{item.ssis_program_set_no}}\n            </ion-col>\n            <ion-col>\n              <div title="執行程式說明" text-right>\n                {{item.ssis_program_set_desc}}\n              </div>\n\n            </ion-col>\n          </ion-row>\n\n\n        </ion-grid>\n      </ion-col>\n\n    </ion-row>\n  </div>\n  <ion-infinite-scroll *ngIf="pageNumber < totalPages && conf.mobile_mode==true" (ionInfinite)="$event.waitFor(doInfinite())">\n    <ion-infinite-scroll-content loadingSpinner="bubbles">\n    </ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n\n</ion-content>\n<ion-footer>\n  <ion-toolbar>\n    <ion-row>\n      <ion-col>\n        <div [ngClass]="[\'command\']">\n          <button small title="重新整理" ion-button color="dark" icon-left (click)="LoadData(true)">\n            <ion-checkbox name="order_type" title="遞增/遞減" color="dark" [(ngModel)]="order_type" (ionChange)="LoadData(true)"></ion-checkbox>\n            <ion-icon name="refresh"></ion-icon>\n          </button>\n          <button small title="取消" *ngIf="show_select==true" ion-button color="dark" icon-left (click)="close()">\n            <ion-icon name="backspace"></ion-icon>\n          </button>\n\n        </div>\n        <StatusComponent [pageNumber]="pageNumber" [totalPages]="totalPages" [totalRows]="totalRows"></StatusComponent>\n      </ion-col>\n    </ion-row>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\components\program-set\program-set.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["m" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["h" /* LoadingController */],
            ...
            __WEBPACK_IMPORTED_MODULE_1__components_global_global__["a" /* GlobalComponent */],
            __WEBPACK_IMPORTED_MODULE_2__providers_auth_services_auth_services__["a" /* AuthServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_3__providers_program_set_services_program_set_services__["a" /* ProgramSetServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["j" /* ModalController */],
            __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["n" /* Platform */],
            __WEBPACK_IMPORTED_MODULE_5__Model_MyAppSharedSettings__["a" /* MyAppSharedSettings */]])
    ], ProgramSetComponent);
    return ProgramSetComponent;
}());

//# sourceMappingURL=program-set.js.map
