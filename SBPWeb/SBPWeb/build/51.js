...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RoleListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ListModelResponse__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_RoleViewModel__ = __webpack_require__(939);
...
var RoleListResponse = /** @class */ (function (_super) {
    ...
    function RoleListResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.roles = ["admins", "Users"];
        _this.Model = [];
        ...
        if (obj.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_RoleViewModel__["a" /* RoleViewModel */]();
                item.roleName = data;
                item.can_del = _this.can_del(data);
                item.checked = false;
    ...
    RoleListResponse.prototype.can_del = function (roleName) {
        var result = true;
...
//# sourceMappingURL=RoleListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RoleResponse; });
...
var RoleResponse = /** @class */ (function (_super) {
    __extends(RoleResponse, _super);
    function RoleResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_RoleViewModel__["a" /* RoleViewModel */]();
            _this.Model.roleName = obj.Model;
            _this.Model.can_del = true;
        }
        return _this;
    }
    return RoleResponse;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_role_services_role_services__ = __webpack_require__(938);
...
var RolePage = /** @class */ (function () {
    function RolePage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, RoleServices, platform, conf) {
        ...
        this.totalPages = 1;
        this.totalRows = 0;
        this.user_page = "RoleUserPage";
        this.permission_page = "RolePermissionPage";
        this.order_type = true;
        this.innerWidth = window.innerWidth;
        this.innerHeight = window.innerHeight;
        if (this.authServices.authenticated() === true) {
            this.can_auth = this.authServices.CanAuth();
            this.CanEditAuth = this.authServices.CanEditAuth();
            this.LoadData(true);
        }
    }
    ...
    RolePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    RolePage.prototype.setPage = function (pageInfo) {
    ...
    RolePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    RolePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    RolePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.RoleServices.GetListsAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    RolePage.prototype.Add = function () {
        var _this = this;
                ...
                },
                {
                    ...
                    handler: function (data) {
                        ...
                        _this.global.loading.present().then(function () {
                            _this.RoleServices.PostAsync(data.roleName).subscribe(function (data) {
                                _this.global.dismissLoading();
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.showPopup("新增", data.Message);
                                }
                                else
                                    _this.global.showError(data.ErrorMessage);
                            }, function (err) {
    ...
    RolePage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.roleName),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.RoleServices.DeleteAsync(item.roleName).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    RolePage.prototype.openNavUserPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.user_page, { item: item });
        });
    };
    RolePage.prototype.openNavPermissionPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.permission_page, { item: item });
        });
    };
    ...
    RolePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-role",template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\role\role.html"*/'<!--\n  Generated template for the RolePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <headerComponent [title]="\'角色維護\'" [permission_id]="\'CanAuth\'" [show_table_select]=true></headerComponent>\n</ion-header>\n\n<ion-content  (window:resize)="onResize($event)">\n  <ion-row>\n    <ion-col>\n\n      <ion-searchbar [ngClass]="[\'search\']" (keyup.enter)="LoadData(true)" placeholder="搜尋關鍵字(角色名稱包含)" [(ngModel)]="keyword">\n      </ion-searchbar>\n    </ion-col>\n  </ion-row>\n  <ion-grid *ngIf="conf.mobile_mode==false && selectedItem!=null" [ngClass]="\'bordered\'">\n    <ion-row>\n      <ion-col>\n\n        <button small title="成員" ion-button color="light" icon-left (click)="openNavUserPage(selectedItem)">\n          <ion-icon name="person"></ion-icon>\n        </button>\n        <button small title="權限" ion-button color="primary" icon-left (click)="openNavPermissionPage(selectedItem)">\n          <ion-icon name="checkbox"></ion-icon>\n        </button>\n        <button small title="刪除" *ngIf="selectedItem.can_del==true && CanEditAuth==true" ion-button color="dark" icon-left (click)="Delete(selectedItem)">\n          <ion-icon name="trash"></ion-icon>\n        </button>\n\n      </ion-col>\n\n    </ion-row>\n  </ion-grid>\n  <ngx-datatable NgxResizeWatcher class="bootstrap" *ngIf="totalRows>0 && conf.mobile_mode==false" [selected]="selected" [selectionType]="\'single\'"\n    (select)=\'onRowSelect($event)\' [rows]="data_list" [columnMode]="\'flex\'" [headerHeight]="40" [rowHeight]="\'auto\'" [footerHeight]="40"\n    [reorderable]=false [limit]="limit" [count]="totalRows" [offset]="offset" (page)=\'setPage($event)\'>\n\n    <ngx-datatable-column prop="roleName" name="角色" [flexGrow]="1" [frozenLeft]="true">\n    </ngx-datatable-column>\n\n\n  </ngx-datatable>\n  <div *ngIf="totalRows>0 && conf.mobile_mode==true">\n    <ion-row>\n\n      <ion-col col-lg-4 col-md-6 col-sm-6 col-12 *ngFor="let item of data_list">\n\n        <ion-grid [ngClass]="[\'bordered\']">\n          <ion-row>\n            <ion-col>\n              <button small title="成員" ion-button color="light" icon-left (click)="openNavUserPage(item)">\n                <ion-icon name="person"></ion-icon>\n              </button>\n              <button small title="權限" ion-button color="primary" icon-left (click)="openNavPermissionPage(item)">\n                <ion-icon name="checkbox"></ion-icon>\n              </button>\n              <button small title="刪除" *ngIf="item.can_del==true && CanEditAuth==true" ion-button color="dark" icon-left (click)="Delete(item)">\n                <ion-icon name="trash"></ion-icon>\n              </button>\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              <!-- <button ion-item> -->\n              <ion-icon name="people" item-start></ion-icon>\n              {{item.roleName}}\n              <!-- </button> -->\n            </ion-col>\n\n          </ion-row>\n\n        </ion-grid>\n      </ion-col>\n\n    </ion-row>\n  </div>\n  <ion-infinite-scroll *ngIf="pageNumber < totalPages && conf.mobile_mode==true" (ionInfinite)="$event.waitFor(doInfinite())">\n    <ion-infinite-scroll-content loadingSpinner="bubbles">\n    </ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n\n</ion-content>\n<ion-footer>\n  <ion-toolbar>\n    <ion-row>\n      <ion-col>\n        <div [ngClass]="[\'command\']">\n          <button small title="重新整理" ion-button color="dark" icon-left (click)="LoadData(true)">\n            <ion-checkbox name="order_type" title="遞增/遞減" color="dark" [(ngModel)]="order_type" (ionChange)="LoadData(true)" ></ion-checkbox>\n             <ion-icon name="refresh"></ion-icon>\n          </button>\n          <button small *ngIf="CanEditAuth==true"  title="新增" ion-button color="dark" icon-left (click)="Add()">\n            <ion-icon name="add"></ion-icon>\n          </button>\n        </div>\n        <StatusComponent [pageNumber]="pageNumber" [totalPages]="totalPages" [totalRows]="totalRows"></StatusComponent>\n      </ion-col>\n    </ion-row>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\role\role.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_role_services_role_services__["a" /* RoleServicesProvider */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__role__ = __webpack_require__(1610);
...
var RolePageModule = /** @class */ (function () {
    ...
    RolePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_role_services_role_services__["a" /* RoleServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__role__["a" /* RolePage */]),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RoleServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_RoleListResponse__ = __webpack_require__(1071);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_RoleResponse__ = __webpack_require__(1072);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/*
  ...
  and Angular DI.
*/
var RoleServicesProvider = /** @class */ (function () {
    function RoleServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "Role";
        console.log("Hello RoleServiceProvider Provider");
    }
    RoleServicesProvider.prototype.GetListsAsync = function (PageSize, PageNumber, keyword, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "Role?PageSize={1}&PageNumber={2}&keyword={3}&order_type={4}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.Roles = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_RoleListResponse__["a" /* RoleListResponse */]({
    ...
    RoleServicesProvider.prototype.GetAddSelectByPermissionListsAsync = function (PageSize, PageNumber, keyword, permission_no, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "Role?PageSize={1}&PageNumber={2}&keyword={3}&permission_no={4}&order_type={5}";
    ...
    RoleServicesProvider.prototype.GetAddSelectByuserNameListsAsync = function (PageSize, PageNumber, keyword, userName, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "Role?PageSize={1}&PageNumber={2}&keyword={3}&userName={4}&order_type={5}";
    ...
    RoleServicesProvider.prototype.PostPutAsync = function (RoleViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "Role";
        else
            sub_url = "Role/" + RoleViewModel.roleName;
        return this.Services.PostPutAsync(sub_url, this.ctl, true, RoleViewModel, mode).map(function (item) {
            _this.Role = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_RoleResponse__["a" /* RoleResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
    ...
    RoleServicesProvider.prototype.PostAsync = function (roleName) {
        var _this = this;
        var sub_url;
        sub_url = "Role/" + roleName;
        return this.Services.PostAsync(sub_url, this.ctl, true, "").map(function (item) {
            _this.Role = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_RoleResponse__["a" /* RoleResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
    ...
    RoleServicesProvider.prototype.DeleteAsync = function (roleName) {
        var _this = this;
        var sub_url;
        sub_url = "Role/" + roleName;
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RoleViewModel; });
