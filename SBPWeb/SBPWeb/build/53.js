...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PermissionProgramPage; });
 ...
 */
var PermissionProgramPage = /** @class */ (function () {
    function PermissionProgramPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, ProgramPermissionServices, UserServices, modalCtrl, platform, conf) {
        ...
        this.totalPages = 1;
        this.totalRows = 0;
        this.permission_no = navParams.data.item.permission_no;
        this.title = navParams.data.item.permission_no;
    ...
    PermissionProgramPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    PermissionProgramPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    PermissionProgramPage.prototype.setPage = function (pageInfo) {
    ...
    PermissionProgramPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    PermissionProgramPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    PermissionProgramPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.ProgramPermissionServices.GetProgramListsAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.permission_no, _this.order_type).subscribe(function (data) {
    ...
    PermissionProgramPage.prototype.Add = function () {
        var _this = this;
        var add_Program_list = [];
        var modal = this.modalCtrl.create("PermissionProgramSelectModalPage", {
            permission_no: this.permission_no
        });
        modal.onDidDismiss(function (select_data) {
            ...
            select_data.forEach(function (element) {
                ...
                item.program_no = element.program_no;
                item.program_desc = element.program_desc;
                item.program_name = element.program_name;
                item.permission_no = _this.permission_no;
                add_Program_list.push(item);
            });
            _this.global.createLoader();
            _this.global.loading.present().then(function () {
                _this.ProgramPermissionServices.PostListAsync(add_Program_list).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("加入功能細項", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    PermissionProgramPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_6__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.program_no),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.ProgramPermissionServices.DeleteAsync(item.program_no, _this.permission_no).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    PermissionProgramPage.prototype.openNavDelPage = function (item) {
        var _this = this;
    ...
    ], PermissionProgramPage);
    return PermissionProgramPage;
}());

//# sourceMappingURL=permission-program.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PermissionProgramPageModule", function() { return PermissionProgramPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__permission_program__ = __webpack_require__(1592);
...
var PermissionProgramPageModule = /** @class */ (function () {
    function PermissionProgramPageModule() {
    }
    PermissionProgramPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__permission_program__["a" /* PermissionProgramPage */],
            ],
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__permission_program__["a" /* PermissionProgramPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], PermissionProgramPageModule);
    return PermissionProgramPageModule;
}());

//# sourceMappingURL=permission-program.module.js.map
