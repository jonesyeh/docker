...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProgramPermissionServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_ProgramPermissionListResponse__ = __webpack_require__(1179);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_ProgramPermissionResponse__ = __webpack_require__(1180);
...
/*
  Generated class for the ProgramPermissionServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var ProgramPermissionServicesProvider = /** @class */ (function () {
    function ProgramPermissionServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "ProgramPermission";
        console.log("Hello ProgramPermissionServiceProvider Provider");
    }
    ProgramPermissionServicesProvider.prototype.GetPermissionListsAsync = function (PageSize, PageNumber, keyword, program_no, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "ProgramPermission?PageSize={1}&PageNumber={2}&keyword={3}&program_no={4}&order_type={5}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.ProgramPermissions = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_ProgramPermissionListResponse__["a" /* ProgramPermissionListResponse */]({
            ...
            return _this.ProgramPermissions;
        });
    };
    ProgramPermissionServicesProvider.prototype.GetProgramListsAsync = function (PageSize, PageNumber, keyword, permission_no, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "ProgramPermission?PageSize={1}&PageNumber={2}&keyword={3}&permission_no={4}&order_type={5}";
    ...
    ProgramPermissionServicesProvider.prototype.PostAsync = function (ProgramPermission) {
        var _this = this;
        var sub_url;
        sub_url = "ProgramPermission";
        console.log(ProgramPermission);
        return this.Services.PostAsync(sub_url, this.ctl, true, ProgramPermission).map(function (item) {
            _this.ProgramPermission = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_ProgramPermissionResponse__["a" /* ProgramPermissionResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.ProgramPermission;
        });
    };
    ProgramPermissionServicesProvider.prototype.PutAsync = function (program_no, permission_no, ProgramPermission) {
        var _this = this;
        var sub_url;
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format("ProgramPermission?program_no={0}&permission_no={1}", program_no, permission_no);
        return this.Services.PutAsync(sub_url, this.ctl, true, ProgramPermission).map(function (item) {
            _this.ProgramPermission = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_ProgramPermissionResponse__["a" /* ProgramPermissionResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
    ...
    ProgramPermissionServicesProvider.prototype.PostListAsync = function (ProgramPermission) {
        var _this = this;
        var sub_url;
        sub_url = "ProgramPermission/AddList";
        return this.Services.PostAsync(sub_url, this.ctl, true, ProgramPermission).map(function (item) {
            _this.ProgramPermission = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_ProgramPermissionResponse__["a" /* ProgramPermissionResponse */]({
                Message: item.Message,
                DidError: item.DidError,
    ...
    ProgramPermissionServicesProvider.prototype.DeleteAsync = function (program_no, permission_no) {
        var _this = this;
        var sub_url;
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format("ProgramPermission?program_no={0}&permission_no={1}", program_no, permission_no);
    ...
    ProgramPermissionServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_services__["a" /* ServicesProvider */]])
    ], ProgramPermissionServicesProvider);
    return ProgramPermissionServicesProvider;
}());

//# sourceMappingURL=program-permission-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProgramPermissionListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ListModelResponse__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_ProgramPermissionViewModel__ = __webpack_require__(988);
 ...
 * @param   {Function}    [name]
 */
var ProgramPermissionListResponse = /** @class */ (function (_super) {
    __extends(ProgramPermissionListResponse, _super);
    function ProgramPermissionListResponse(obj) {
        ...
        if (obj.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_ProgramPermissionViewModel__["a" /* ProgramPermissionViewModel */]();
    ...
    return ProgramPermissionListResponse;
}(__WEBPACK_IMPORTED_MODULE_0__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=ProgramPermissionListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProgramPermissionResponse; });
...
var ProgramPermissionResponse = /** @class */ (function (_super) {
    __extends(ProgramPermissionResponse, _super);
    function ProgramPermissionResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_ProgramPermissionViewModel__["a" /* ProgramPermissionViewModel */]();
    ...
    return ProgramPermissionResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=ProgramPermissionResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return IonicProgramPermissionPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Model_ViewModel_ProgramPermissionViewModel__ = __webpack_require__(988);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_program_permission_services_program_permission_services__ = __webpack_require__(1062);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_user_services_user_services__ = __webpack_require__(273);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__Model_ViewModel_PermissionViewModel__ = __webpack_require__(66);
...
/**
 * Generated class for the programPermissionPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var IonicProgramPermissionPage = /** @class */ (function () {
    function IonicProgramPermissionPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, ProgramPermissionServices, UserServices, modalCtrl, platform, conf) {
        ...
        this.ProgramPermissionServices = ProgramPermissionServices;
        ...
        this.totalPages = 1;
        this.totalRows = 0;
        this.program_no = navParams.data.item.program_no;
        this.title = navParams.data.item.program_desc;
        this.order_type = true;
        this.innerWidth = window.innerWidth;
        this.innerHeight = window.innerHeight;
        if (this.authServices.authenticated() === true) {
            this.can_auth = this.authServices.CanAuth();
            this.CanEditPermission = this.authServices.CanEditPermission();
            this.LoadData(true);
        }
    }
    IonicProgramPermissionPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    IonicProgramPermissionPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    IonicProgramPermissionPage.prototype.setPage = function (pageInfo) {
    ...
    IonicProgramPermissionPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    IonicProgramPermissionPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    IonicProgramPermissionPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.ProgramPermissionServices.GetPermissionListsAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.program_no, _this.order_type).subscribe(function (data) {
    ...
    IonicProgramPermissionPage.prototype.Add = function () {
        var _this = this;
        var add_permission_list = [];
        var modal = this.modalCtrl.create("IonicProgramPermissionSelectModalPage", {
            program_no: this.program_no
        });
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
            select_data.forEach(function (element) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__Model_ViewModel_ProgramPermissionViewModel__["a" /* ProgramPermissionViewModel */]();
                item.permission_no = element.permission_no;
                item.program_no = _this.program_no;
                var t = new __WEBPACK_IMPORTED_MODULE_8__Model_ViewModel_PermissionViewModel__["a" /* PermissionViewModel */]();
                {
                    t.permission_no = element.permission_no;
                    t.permission_desc = element.permission_desc;
                    t.permission_func_desc = element.permission_func_desc;
                }
                item.PermissionViewModel = t;
                add_permission_list.push(item);
            });
            _this.global.createLoader();
            _this.global.loading.present().then(function () {
                _this.ProgramPermissionServices.PostListAsync(add_permission_list).subscribe(function (data) {
                    if (data.DidError === false) {
                        add_permission_list.forEach(function (element) {
                            _this.data_list.push(element);
                            _this.totalRows += 1;
                        });
                        _this.global.dismissLoading();
                        // this.LoadData(true);
                        _this.global.showPopup("加入權限", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    IonicProgramPermissionPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_6__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.permission_no),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.ProgramPermissionServices.DeleteAsync(_this.program_no, item.permission_no).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    IonicProgramPermissionPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_5__providers_program_permission_services_program_permission_services__["a" /* ProgramPermissionServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_7__providers_user_services_user_services__["a" /* UserServicesProvider */],
    ...
    ], IonicProgramPermissionPage);
    return IonicProgramPermissionPage;
}());

//# sourceMappingURL=ionic-program-permission.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IonicProgramPermissionPageModule", function() { return IonicProgramPermissionPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_program_permission__ = __webpack_require__(1526);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_program_permission_services_program_permission_services__ = __webpack_require__(1062);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var IonicProgramPermissionPageModule = /** @class */ (function () {
    function IonicProgramPermissionPageModule() {
    }
    IonicProgramPermissionPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__ionic_program_permission__["a" /* IonicProgramPermissionPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_program_permission_services_program_permission_services__["a" /* ProgramPermissionServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__ionic_program_permission__["a" /* IonicProgramPermissionPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], IonicProgramPermissionPageModule);
    return IonicProgramPermissionPageModule;
}());

//# sourceMappingURL=ionic-program-permission.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProgramPermissionViewModel; });
var ProgramPermissionViewModel = /** @class */ (function () {
    function ProgramPermissionViewModel() {
    }
    return ProgramPermissionViewModel;
}());

//# sourceMappingURL=ProgramPermissionViewModel.js.map
