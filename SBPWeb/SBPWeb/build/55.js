...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProgramCheckPkServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_ProgramCheckPKListResponse__ = __webpack_require__(1275);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_ProgramCheckPKResponse__ = __webpack_require__(1276);
...
/*
  Generated class for the ProgramCheckPKServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var ProgramCheckPkServicesProvider = /** @class */ (function () {
    function ProgramCheckPkServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "ProgramCheckPK";
        console.log("Hello ProgramCheckPkServiceProvider Provider");
    }
    ProgramCheckPkServicesProvider.prototype.GetListsAsync = function (PageSize, PageNumber, program_no, keyword, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "ProgramCheckPK?PageSize={1}&PageNumber={2}&program_no={3}&keyword={4}&order_type={5}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, PageSize, PageNumber, program_no, keyword, order_type);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.ProgramCheckPKs = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_ProgramCheckPKListResponse__["a" /* ProgramCheckPKListResponse */]({
            ...
            return _this.ProgramCheckPKs;
        });
    };
    ProgramCheckPkServicesProvider.prototype.GetAsync = function (program_no, column_id) {
        var _this = this;
        var sub_url;
        sub_url = "ProgramCheckPK?program_no={1}&column_id={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, program_no, column_id);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.ProgramCheckPK = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_ProgramCheckPKResponse__["a" /* ProgramCheckPKResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.ProgramCheckPK;
        });
    };
    ProgramCheckPkServicesProvider.prototype.PostPutAsync = function (ProgramCheckPKViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "ProgramCheckPK";
        else
            sub_url = "ProgramCheckPK?program_no={1}&column_id={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, ProgramCheckPKViewModel.program_no, ProgramCheckPKViewModel.column_id);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, ProgramCheckPKViewModel, mode).map(function (item) {
            _this.ProgramCheckPK = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_ProgramCheckPKResponse__["a" /* ProgramCheckPKResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
    ...
    ProgramCheckPkServicesProvider.prototype.DeleteAsync = function (program_no, column_id) {
        var _this = this;
        var sub_url;
        sub_url = "ProgramCheckPK?program_no={1}&column_id={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, program_no, column_id);
    ...
    ProgramCheckPkServicesProvider.prototype.GetSqlAsync = function (program_no, column_id, method) {
        var sub_url;
        sub_url = "ProgramCheckPK/get_{3}_sql?program_no={1}&column_id={2}";
    ...
    ProgramCheckPkServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_services__["a" /* ServicesProvider */]])
    ], ProgramCheckPkServicesProvider);
    return ProgramCheckPkServicesProvider;
}());

//# sourceMappingURL=program-check-pk-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BatchProgramCheckPkPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_program_check_pk_services_program_check_pk_services__ = __webpack_require__(1196);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_table_services_table_services__ = __webpack_require__(265);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Model_ViewModel_TableViewModel__ = __webpack_require__(132);
 ...
 * Components.
 */
var BatchProgramCheckPkPage = /** @class */ (function () {
    function BatchProgramCheckPkPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, ProgramCheckPkServices, TableServices, modalCtrl, platform, conf) {
        ...
        this.ProgramCheckPkServices = ProgramCheckPkServices;
        ...
        this.file_import_before_page = "FileImportBeforePage";
        this.file_import_after_page = "FileImportAfterPage";
        this.sql_page = "SqlPage";
        this.innerWidth = window.innerWidth;
        this.innerHeight = window.innerHeight;
        this.order_type = true;
        this.program_no = navParams.data.item.program_no;
        this.temp_table_item = new __WEBPACK_IMPORTED_MODULE_7__Model_ViewModel_TableViewModel__["a" /* TableViewModel */]();
        this.temp_table_item.schemaname = navParams.data.item.temp_schema;
        this.temp_table_item.tablename = navParams.data.item.temp_table;
        this.temp_table_item.err_columnname = navParams.data.item.temp_column_check;
        this.subject = __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("{0}", this.program_no);
    ...
    BatchProgramCheckPkPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    BatchProgramCheckPkPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    BatchProgramCheckPkPage.prototype.setPage = function (pageInfo) {
    ...
    BatchProgramCheckPkPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    BatchProgramCheckPkPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    BatchProgramCheckPkPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.ProgramCheckPkServices.GetListsAsync(_this.pageSize, _this.pageNumber, _this.program_no, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    BatchProgramCheckPkPage.prototype.ShowModal = function (item) {
        var _this = this;
        this.mode = 'PUT';
        var modal = this.modalCtrl.create("BatchProgramCheckPkEditModalPage", {
            item: item,
            temp_table_item: this.temp_table_item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.ProgramCheckPkServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("PK對應", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    BatchProgramCheckPkPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}-{1}嗎?", item.program_no, item.column_id),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.ProgramCheckPkServices.DeleteAsync(item.program_no, item.column_id).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    BatchProgramCheckPkPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.ProgramCheckPkServices.GetSqlAsync(item.program_no, item.column_id, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    BatchProgramCheckPkPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_program_check_pk_services_program_check_pk_services__["a" /* ProgramCheckPkServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_6__providers_table_services_table_services__["a" /* TableServicesProvider */],
    ...
    ], BatchProgramCheckPkPage);
    return BatchProgramCheckPkPage;
}());

//# sourceMappingURL=batch-program-check-pk.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProgramCheckPKListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ListModelResponse__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_ProgramCheckPKViewModel__ = __webpack_require__(1083);
 ...
 * @param   {Function}    [name]
 */
var ProgramCheckPKListResponse = /** @class */ (function (_super) {
    __extends(ProgramCheckPKListResponse, _super);
    function ProgramCheckPKListResponse(obj) {
        ...
        if (obj.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_ProgramCheckPKViewModel__["a" /* ProgramCheckPKViewModel */]();
                item.program_no = data.program_no;
                item.column_id = data.column_id;
                item.check_pk_column = data.check_pk_column;
                item.temp_pk_column = data.temp_pk_column;
    ...
    return ProgramCheckPKListResponse;
}(__WEBPACK_IMPORTED_MODULE_0__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=ProgramCheckPKListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProgramCheckPKResponse; });
...
var ProgramCheckPKResponse = /** @class */ (function (_super) {
    __extends(ProgramCheckPKResponse, _super);
    function ProgramCheckPKResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_ProgramCheckPKViewModel__["a" /* ProgramCheckPKViewModel */]();
            _this.Model.program_no = obj.Model.program_no;
            _this.Model.column_id = obj.Model.column_id;
            _this.Model.check_pk_column = obj.Model.check_pk_column;
            _this.Model.temp_pk_column = obj.Model.temp_pk_column;
    ...
    return ProgramCheckPKResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=ProgramCheckPKResponse.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__batch_program_check_pk__ = __webpack_require__(1274);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_program_check_pk_services_program_check_pk_services__ = __webpack_require__(1196);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BatchProgramCheckPkPageModule = /** @class */ (function () {
    function BatchProgramCheckPkPageModule() {
    }
    BatchProgramCheckPkPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__batch_program_check_pk__["a" /* BatchProgramCheckPkPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_program_check_pk_services_program_check_pk_services__["a" /* ProgramCheckPkServicesProvider */],],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__batch_program_check_pk__["a" /* BatchProgramCheckPkPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], BatchProgramCheckPkPageModule);
    return BatchProgramCheckPkPageModule;
}());

//# sourceMappingURL=batch-program-check-pk.module.js.map
