...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JobStepLoopServicesProvider; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Model_Response_JobStepLoopListResponse__ = __webpack_require__(1557);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_JobStepLoopResponse__ = __webpack_require__(1558);
...
/*
  Generated class for the JobStepLoopServicesProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var JobStepLoopServicesProvider = /** @class */ (function () {
    function JobStepLoopServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "JobStepLoop";
        console.log("Hello JobStepLoopServicesProvider Provider");
    }
    JobStepLoopServicesProvider.prototype.GetListsAsync = function (job_step_id, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "JobStepLoop?job_step_id={1}&order_type={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, job_step_id, order_type);
        return this.Services.GetAsync(sub_url, this.ctl, true)
            .map(function (item) {
            _this.JobStepLoops = new __WEBPACK_IMPORTED_MODULE_0__Model_Response_JobStepLoopListResponse__["a" /* JobStepLoopListResponse */]({
            ...
            return _this.JobStepLoops;
        });
    };
    JobStepLoopServicesProvider.prototype.PostPutAsync = function (JobStepLoopViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "JobStepLoop";
        else
            sub_url = "JobStepLoop/" + JobStepLoopViewModel.job_step_loop_id;
        return this.Services.PostPutAsync(sub_url, this.ctl, true, JobStepLoopViewModel, mode).map(function (item) {
            _this.JobStepLoop = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_JobStepLoopResponse__["a" /* JobStepLoopResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.JobStepLoop;
        });
    };
    JobStepLoopServicesProvider.prototype.DeleteAsync = function (job_step_loop_id) {
        var _this = this;
        var sub_url;
        sub_url = "JobStepLoop/" + job_step_loop_id;
    ...
    JobStepLoopServicesProvider.prototype.GetSqlAsync = function (job_step_loop_id, method) {
        var sub_url;
        sub_url = "JobStepLoop/get_{2}_sql?job_step_loop_id={1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, job_step_loop_id, method);
    ...
    JobStepLoopServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_services__["a" /* ServicesProvider */]])
    ], JobStepLoopServicesProvider);
    return JobStepLoopServicesProvider;
}());

//# sourceMappingURL=job-step-loop-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JobStepLoopPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Model_ViewModel_JobStepLoopViewModel__ = __webpack_require__(1065);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_job_step_loop_services_job_step_loop_services__ = __webpack_require__(1234);
...
var JobStepLoopPage = /** @class */ (function () {
    function JobStepLoopPage(menuCtrl, navCtrl, navParams, JobStepLoopServices, loadingCtrl, global, authServices, modalCtrl, alertCtrl) {
        this.menuCtrl = menuCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.JobStepLoopServices = JobStepLoopServices;
        ...
        this.title = navParams.data.item.step + "." + navParams.data.item.program_func_desc;
        this.job_step_item = navParams.data.item;
        this.detail_page = "JobStepLoopDetailPage";
        this.err_msg_log_page = "ErrMsgLogPage";
        this.log_page = "JobStepLoopExecLogPage";
    ...
    JobStepLoopPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    JobStepLoopPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.JobStepLoopServices.GetSqlAsync(item.job_step_loop_id, method).subscribe(function (data) {
    ...
    JobStepLoopPage.prototype.ShowModal = function (item) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_0__Model_ViewModel_JobStepLoopViewModel__["a" /* JobStepLoopViewModel */]();
            item.fail_step = this.job_step_item.fail_step;
            item.success_step = this.job_step_item.success_step;
            item.job_step_loop_id = this.job_step_item.job_step_id + "_";
            item.job_step_id = this.job_step_item.job_step_id;
            item.is_active = this.job_step_item.is_active;
            item.is_active_color = this.job_step_item.is_active_color;
            item.is_active_desc = this.job_step_item.is_active_desc;
            item.job01 = "";
            item.job02 = "";
            item.job03 = "";
        }
        ...
        var modal = this.modalCtrl.create("JobStepLoopAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.JobStepLoopServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("作業步驟例外設定", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    JobStepLoopPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_6__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.job_step_loop_id),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.JobStepLoopServices.DeleteAsync(item.job_step_loop_id).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    JobStepLoopPage.prototype.LoadData = function (init) {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.JobStepLoopServices.GetListsAsync(_this.job_step_item.job_step_id, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    JobStepLoopPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["i" /* MenuController */],
            ...
            __WEBPACK_IMPORTED_MODULE_5__providers_job_step_loop_services_job_step_loop_services__["a" /* JobStepLoopServicesProvider */],
    ...
    return JobStepLoopPage;
}());

//# sourceMappingURL=job-step-loop.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JobStepLoopListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_JobStepLoopViewModel__ = __webpack_require__(1065);
...
var JobStepLoopListResponse = /** @class */ (function (_super) {
    __extends(JobStepLoopListResponse, _super);
    function JobStepLoopListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_JobStepLoopViewModel__["a" /* JobStepLoopViewModel */]();
                item.job_step_loop_id = data.job_step_loop_id;
                ...
                switch (data.success_step) {
                    case 1: {
                        item.success_step_color = "success";
                        break;
                    }
                    case 0: {
                        item.success_step_color = "stop";
                        break;
                    }
                    default:
                        item.success_step_color = "normal";
                }
                switch (data.fail_step) {
                    case 1: {
                        item.fail_step_color = "success";
                        break;
                    }
                    case 0: {
                        item.fail_step_color = "stop";
                        break;
                    }
                    default:
                        item.fail_step_color = "normal";
                }
    ...
    return JobStepLoopListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=JobStepLoopListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JobStepLoopResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_JobStepLoopViewModel__ = __webpack_require__(1065);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var JobStepLoopResponse = /** @class */ (function (_super) {
    __extends(JobStepLoopResponse, _super);
    function JobStepLoopResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_JobStepLoopViewModel__["a" /* JobStepLoopViewModel */]();
            _this.Model.job_step_loop_id = obj.Model.job_step_loop_id;
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JobStepLoopPageModule", function() { return JobStepLoopPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__job_step_loop__ = __webpack_require__(1556);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_job_step_loop_services_job_step_loop_services__ = __webpack_require__(1234);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var JobStepLoopPageModule = /** @class */ (function () {
    function JobStepLoopPageModule() {
    }
    JobStepLoopPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__job_step_loop__["a" /* JobStepLoopPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_job_step_loop_services_job_step_loop_services__["a" /* JobStepLoopServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__job_step_loop__["a" /* JobStepLoopPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], JobStepLoopPageModule);
    return JobStepLoopPageModule;
}());

//# sourceMappingURL=job-step-loop.module.js.map
