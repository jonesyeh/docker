...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Model_Response_JobStepListResponse__ = __webpack_require__(1560);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_JobStepResponse__ = __webpack_require__(1561);
...
/*
  Generated class for the jobstepServicesProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var JobStepServicesProvider = /** @class */ (function () {
    function JobStepServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "jobstep";
        console.log("Hello jobstepServicesProvider Provider");
    }
    JobStepServicesProvider.prototype.GetListsAsync = function (ssis_job_no, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "jobstep?ssis_job_no={1}&order_type={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, ssis_job_no, order_type);
        return this.Services.GetAsync(sub_url, this.ctl, true)
            .map(function (item) {
            _this.jobsteps = new __WEBPACK_IMPORTED_MODULE_0__Model_Response_JobStepListResponse__["a" /* JobStepListResponse */]({
            ...
            return _this.jobsteps;
        });
    };
    JobStepServicesProvider.prototype.PostPutAsync = function (JobStepViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "JobStep";
        else
            sub_url = "JobStep/" + JobStepViewModel.job_step_id;
        return this.Services.PostPutAsync(sub_url, this.ctl, true, JobStepViewModel, mode).map(function (item) {
            _this.jobstep = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_JobStepResponse__["a" /* JobStepResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.jobstep;
        });
    };
    JobStepServicesProvider.prototype.DeleteAsync = function (job_step_id) {
        var _this = this;
        var sub_url;
        sub_url = "JobStep/" + job_step_id;
    ...
    JobStepServicesProvider.prototype.GetSqlAsync = function (job_step_id, method) {
        var sub_url;
        sub_url = "JobStep/get_{2}_sql?job_step_id={1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, job_step_id, method);
    ...
    JobStepServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_services__["a" /* ServicesProvider */]])
    ], JobStepServicesProvider);
    return JobStepServicesProvider;
}());

//# sourceMappingURL=job-step-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JobStepPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Model_ViewModel_JobStepViewModel__ = __webpack_require__(1066);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_job_step_services_job_step_services__ = __webpack_require__(1235);
...
var JobStepPage = /** @class */ (function () {
    function JobStepPage(menuCtrl, navCtrl, navParams, JobStepServices, loadingCtrl, global, authServices, modalCtrl, alertCtrl, platform, conf) {
        this.menuCtrl = menuCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.JobStepServices = JobStepServices;
        ...
        this.permission_id = "CanJob";
        this.title = navParams.data.item.ssis_job_no;
        this.item = navParams.data.item;
        this.detail_page = "JobStepDetailPage";
        this.err_msg_log_page = "ErrMsgLogPage";
        this.log_page = "JobStepExecLogPage";
    ...
    JobStepPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
    };
    JobStepPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
        console.log("Select Event", selected, this.selected);
    };
    JobStepPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    JobStepPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.JobStepServices.GetSqlAsync(item.job_step_id, method).subscribe(function (data) {
    ...
    JobStepPage.prototype.ShowModal = function (item) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_0__Model_ViewModel_JobStepViewModel__["a" /* JobStepViewModel */]();
            item.fail_step = 1;
            item.success_step = 1;
            item.step = this.totalRows + 1;
            item.ssis_job_no = this.item.ssis_job_no;
            item.is_active = true;
            if (item.step < 10)
                item.job_step_id = __WEBPACK_IMPORTED_MODULE_6__Model_String__["a" /* String */].Format("{0}_0{1}", this.item.ssis_job_no, this.totalRows + 1);
            else
                item.job_step_id = __WEBPACK_IMPORTED_MODULE_6__Model_String__["a" /* String */].Format("{0}_{1}", this.item.ssis_job_no, this.totalRows + 1);
        }
        else {
            this.mode = "PUT";
        }
        var modal = this.modalCtrl.create("JobStepAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.JobStepServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("作業步驟", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    JobStepPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_6__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.job_step_id),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.JobStepServices.DeleteAsync(item.job_step_id).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    JobStepPage.prototype.LoadData = function (init) {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.JobStepServices.GetListsAsync(_this.item.ssis_job_no, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    JobStepPage.prototype.openNavDetailsPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    JobStepPage.prototype.openNavSetPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            var page;
            if (item.program_type === "import_filelist")
                page = "FileImportPage";
            if (item.program_type === "ftp_downloadlist")
                page = "FileFtpDownPage";
            if (item.program_type === "ftp_uploadlist")
                page = "FileFtpUpPage";
            if (item.program_type === "unzip_filelist")
                page = "FileUnZipPage";
            if (item.program_type === "cmd_list")
                page = "FileCmdPage";
            if (item.program_type === "exec_ssis_packagelist")
                page = "FileSsisPage";
            if (item.program_type === "exec_sql_filelist")
                page = "FileSqlPage";
            if (item.program_type === "zip_filelist")
                page = "FileZipListPage";
            if (item.program_type === "export_filelist")
                page = "FileExportAllPage";
            if (item.program_type === "file_managementlist")
                page = "FileManagementAllPage";
            if (item.program_type === "odata_export_filelist")
                page = "FileHttpDownAllPage";
            if (item.program_type === "import_tablelist")
                page = "SqlAllPage";
            if (item.program_type === "sp_delete_tablelist")
                page = "DelTablePage";
            if (item.program_type === "http_upload_list")
                page = "FileHttpUpPage";
            if (item.program_type === "send_email") {
                page = "EmailPage";
                _this.navCtrl.push(page, { exec_group: item.exec_group.substr(0, item.exec_group.length - 2) });
            }
            else
                _this.navCtrl.push(page, { exec_group: item.exec_group });
        });
    };
    JobStepPage.prototype.openNavLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.log_page, { item: item, seq_type: "job_step_id" });
        });
    };
    JobStepPage.prototype.openNavJobStepLoopPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push("JobStepLoopPage", { item: item });
        });
    };
    JobStepPage.prototype.openNavFileTableLogPage = function (item) {
        var _this = this;
        if (item.is_table_log)
            this.file_log_page = "TableExecLogPage";
        else
            this.file_log_page = "FileExecLogPage";
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.file_log_page, {
                item: item,
                seq_type: "job_step_id"
            });
        });
    };
    JobStepPage.prototype.openNavErrMsgLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    JobStepPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["i" /* MenuController */],
            ...
            __WEBPACK_IMPORTED_MODULE_5__providers_job_step_services_job_step_services__["a" /* JobStepServicesProvider */],
...
//# sourceMappingURL=job-step.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JobStepListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_JobStepViewModel__ = __webpack_require__(1066);
...
var JobStepListResponse = /** @class */ (function (_super) {
    __extends(JobStepListResponse, _super);
    function JobStepListResponse(obj) {
        ...
        if (_this.DidError === false) {
            ...
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_JobStepViewModel__["a" /* JobStepViewModel */]();
                item.job_step_id = data.job_step_id;
                item.ssis_job_no = data.ssis_job_no;
                item.program_func_no = data.program_func_no;
                item.program_func_desc = data.program_func_desc;
                item.program_type = data.program_type;
                item.step = data.step;
                item.success_step = data.success_step;
                item.fail_step = data.fail_step;
                ...
                item.last_exec_status = data.last_exec_status;
                item.last_exec_status_desc = data.last_exec_status_desc;
                item.end_time = data.end_time;
                item.duration = data.duration;
                item.success_step_desc = data.success_step_desc;
                item.fail_step_desc = data.fail_step_desc;
                item.is_table_log = data.is_table_log;
                item.exec_group = data.exec_group;
                if (item.is_table_log === true)
                    item.log_color = "danger";
                else
                    item.log_color = "light";
                ...
                switch (data.success_step) {
                    case 1: {
                        item.success_step_color = "success-left";
                        break;
                    }
                    case 0: {
                        item.success_step_color = "stop-left";
                        break;
                    }
                    default:
                        item.success_step_color = "normal-left";
                }
                switch (data.fail_step) {
                    case 1: {
                        item.fail_step_color = "success-left";
                        break;
                    }
                    case 0: {
                        item.fail_step_color = "stop-left";
                        break;
                    }
                    default:
                        item.fail_step_color = "normal-left";
                }
...
//# sourceMappingURL=JobStepListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JobStepResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_JobStepViewModel__ = __webpack_require__(1066);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var JobStepResponse = /** @class */ (function (_super) {
    __extends(JobStepResponse, _super);
    function JobStepResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            if (obj.Model.ssis_JobStep_no) {
                _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_JobStepViewModel__["a" /* JobStepViewModel */]();
                _this.Model.job_step_id = obj.Model.job_step_id;
                _this.Model.ssis_job_no = obj.Model.ssis_job_no;
                _this.Model.program_func_no = obj.Model.program_func_no;
                _this.Model.step = obj.Model.step;
                _this.Model.success_step = obj.Model.success_step;
                _this.Model.fail_step = obj.Model.fail_step;
...
//# sourceMappingURL=JobStepResponse.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__job_step__ = __webpack_require__(1559);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_job_step_services_job_step_services__ = __webpack_require__(1235);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var JobStepPageModule = /** @class */ (function () {
    function JobStepPageModule() {
    }
    JobStepPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__job_step__["a" /* JobStepPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_job_step_services_job_step_services__["a" /* JobStepServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__job_step__["a" /* JobStepPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], JobStepPageModule);
    return JobStepPageModule;
}());

//# sourceMappingURL=job-step.module.js.map
