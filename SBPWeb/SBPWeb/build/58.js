...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Model_Response_JobLoopListResponse__ = __webpack_require__(1183);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_JobLoopResponse__ = __webpack_require__(1184);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JobLoopPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_job_loop_services_job_loop_services__ = __webpack_require__(1064);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_run_job_services_run_job_services__ = __webpack_require__(268);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_JobLoopViewModel__ = __webpack_require__(934);
...
var JobLoopPage = /** @class */ (function () {
    function JobLoopPage(menuCtrl, navCtrl, navParams, JobLoopServices, loadingCtrl, global, authServices, runJobServices, modalCtrl, alertCtrl, platform, conf) {
        ...
        this.detail_page = "JobLoopDetailPage";
        ...
        if (this.authServices.authenticated() === true) {
            ...
            this.CanEditLoopJob = this.authServices.CanEditLoopJob();
            this.LoadData(true);
        }
    }
    JobLoopPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    JobLoopPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    JobLoopPage.prototype.setPage = function (pageInfo) {
    ...
    JobLoopPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    JobLoopPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    JobLoopPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.JobLoopServices.GetListsAsync(_this.item.ssis_job_no, _this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    JobLoopPage.prototype.openNavDetailsPage = function (item) {
        var _this = this;
    ...
    JobLoopPage.prototype.openNavRunPage = function (item) {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.runJobServices
                .RunJobLoopAsync(item.ssis_job_no, item.job01, item.job02, item.job03)
    ...
    JobLoopPage.prototype.openNavLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.log_page, {
                item: item,
                seq_type: "job_loop_replace_desc"
            });
        });
    };
    JobLoopPage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    JobLoopPage.prototype.openNavTableLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.table_log_page, {
                item: item,
                seq_type: "job_loop_replace_desc"
            });
        });
    };
    JobLoopPage.prototype.openNavErrMsgLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    JobLoopPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.JobLoopServices.GetSqlAsync(item.loop_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    JobLoopPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_JobLoopViewModel__["a" /* JobLoopViewModel */]();
        ...
        if (change_mode === "zip_password") {
            var modal = this.modalCtrl.create("JobLoopAddPwdModalPage", {
                mode: this.mode,
                item: item,
                change_mode: change_mode,
                CanEditLoopJob: this.CanEditLoopJob
            });
            modal.onDidDismiss(function (select_data) {
                ...
                _this.global.loading.present().then(function () {
                    _this.JobLoopServices.zip_pwd(select_data).subscribe(function (data) {
                        if (data.DidError === false) {
                            _this.LoadData(true);
                            _this.global.dismissLoading();
                            _this.global.showPopup("壓縮密碼", data.Message);
                        }
                        else
                            _this.global.showError(data.ErrorMessage);
                    }, function (err) {
        ...
        if (change_mode === "unzip_password") {
            ...
            modal.onDidDismiss(function (select_data) {
                ...
                _this.global.createLoader();
                _this.global.loading.present().then(function () {
                    _this.JobLoopServices.unzip_pwd(select_data).subscribe(function (data) {
                        if (data.DidError === false) {
                            _this.LoadData(true);
                            _this.global.dismissLoading();
                            _this.global.showPopup("解壓縮密碼", data.Message);
                        }
                        else
                            _this.global.showError(data.ErrorMessage);
                    }, function (err) {
        ...
        if (change_mode === "e" || change_mode === "c" || change_mode === "n") {
            var modal = this.modalCtrl.create("JobLoopAddEditModalPage", {
                mode: this.mode,
                item: item,
                change_mode: change_mode,
                CanEditLoopJob: this.CanEditLoopJob
            ...
            modal.onDidDismiss(function (select_data) {
                ...
                _this.global.createLoader();
                _this.global.loading.present().then(function () {
                    _this.JobLoopServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                        if (data.DidError === false) {
                            _this.LoadData(true);
                            _this.global.dismissLoading();
                            _this.global.showPopup("作業迴圈", data.Message);
                        }
                        else
                            _this.global.showError(data.ErrorMessage);
                    }, function (err) {
    ...
    JobLoopPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_7__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.loop_seq),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.JobLoopServices.DeleteAsync(item.loop_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    JobLoopPage.prototype.clear_zip_pwd = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "清除壓縮密碼?",
            message: __WEBPACK_IMPORTED_MODULE_7__Model_String__["a" /* String */].Format("確認要清除壓縮密碼{0}嗎?", item.loop_seq),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.JobLoopServices.clear_zip_pwd(item).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
                                    _this.global.showPopup("清除壓縮密碼", data.Message);
                                }
                                else
                                    _this.global.showError(data.ErrorMessage);
                            }, function (err) {
    ...
    JobLoopPage.prototype.clear_unzip_pwd = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "清除解壓縮密碼?",
            message: __WEBPACK_IMPORTED_MODULE_7__Model_String__["a" /* String */].Format("確認要清除解壓縮密碼{0}嗎?", item.loop_seq),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.JobLoopServices.clear_unzip_pwd(item).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
                                    _this.global.showPopup("清除解壓縮密碼", data.Message);
                                }
                                else
                                    _this.global.showError(data.ErrorMessage);
                            }, function (err) {
    ...
    JobLoopPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad job-loop");
    };
    JobLoopPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-job-loop",template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\job-loop\job-loop.html"*/'<!--\n  Generated template for the JobStepPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n    <headerComponent [title]="\'作業迴圈\'" [permission_id]="\'CanJob\'" [show_table_select]=true></headerComponent>\n\n  </ion-header>\n\n\n<ion-content (window:resize)="onResize($event)">\n  <ion-grid>\n      <ion-row>\n        <ion-col col-12 col-sm-2 col-md-3>\n        </ion-col>\n        <ion-col col-12 col-sm-8 col-md-6>\n\n          <ion-grid [ngClass]="[\'subject\']">\n            <ion-row>\n              <ion-col>\n                <div [ngClass]="[\'label80\']">\n                  作業編號\n                </div>\n                <b>{{title}}</b>\n              </ion-col>\n            </ion-row>\n          </ion-grid>\n        </ion-col>\n        <ion-col col-12 col-sm-2 col-md-3>\n        </ion-col>\n      </ion-row>\n    </ion-grid>\n    <ion-row>\n      <ion-col>\n\n        <ion-searchbar [ngClass]="[\'search\']" (keyup.enter)="LoadData(true)" placeholder="搜尋關鍵字(JOB01,JOB02,JOB03,作業迴圈說明，連線編號)"\n          [(ngModel)]="keyword">\n        </ion-searchbar>\n\n      </ion-col>\n    </ion-row>\n    <ion-grid *ngIf="conf.mobile_mode==false && selectedItem!=null" [ngClass]="\'bordered\'">\n      <ion-row >\n          <ion-col>\n              <button small *ngIf="CanEditLoopJob==true && selectedItem.loop_seq>0" title="編輯" ion-button color="light" icon-left (click)="ShowModal(selectedItem,\'e\')">\n                <ion-icon name="create"></ion-icon>\n              </button>\n              <button small *ngIf="CanEditLoopJob==true" title="複製" ion-button color="light" icon-left (click)="ShowModal(selectedItem,\'c\')">\n                <ion-icon name="copy"></ion-icon>\n              </button>\n              <button small *ngIf="CanEditLoopJob==true && selectedItem.loop_seq>0" title="刪除" ion-button color="dark" icon-left (click)="Delete(selectedItem)">\n                <ion-icon name="trash"></ion-icon>\n              </button>\n              <button small title="明細" *ngIf="selectedItem.loop_seq>0" ion-button color="secondary" icon-left (click)="openNavDetailsPage(selectedItem)">\n                  <ion-icon name="albums"></ion-icon>\n                </button>\n            </ion-col>\n        <ion-col>\n\n          <button *ngIf="CanJobExec==true"  small title="執行" ion-button color="dark" icon-left (click)="openNavRunPage(selectedItem)">\n            <ion-icon name="arrow-dropright-circle"></ion-icon>\n          </button>\n          <button *ngIf="can_view_log==true" small title="歷史執行紀錄" ion-button color="primary" icon-left (click)="openNavLogPage(selectedItem)">\n            <ion-icon name="logo-twitch"></ion-icon>\n          </button>\n          <button *ngIf="can_view_log==true" small title="檔案執行紀錄" ion-button color="light" icon-left (click)="openNavFileLogPage(selectedItem)">\n            <ion-icon name="logo-twitch"></ion-icon>\n          </button>\n          <button *ngIf="can_view_log==true" small title="資料表執行紀錄" ion-button color="danger" icon-left (click)="openNavTableLogPage(selectedItem)">\n              <ion-icon name="logo-twitch"></ion-icon>\n          </button>\n          </ion-col>\n\n          <ion-col>\n              <button *ngIf="CanEditLoopJob==true" small title="壓縮加密" ion-button color="primary" icon-left (click)="ShowModal(selectedItem,\'zip_password\')">\n                  <ion-icon name="key"></ion-icon>\n                </button>\n                <button *ngIf="CanEditLoopJob==true" small title="解壓縮加密" ion-button color="secondary" icon-left (click)="ShowModal(selectedItem,\'unzip_password\')">\n                  <ion-icon name="key"></ion-icon>\n                </button>\n                <button *ngIf="CanEditLoopJob==true" small title="清除壓縮加密" ion-button color="dark" icon-left (click)="clear_zip_pwd(selectedItem)">\n                    <ion-icon name="key"></ion-icon>\n                  </button>\n                  <button *ngIf="CanEditLoopJob==true" small title="清除解壓縮加密" ion-button color="light" icon-left (click)="clear_unzip_pwd(selectedItem)">\n                    <ion-icon name="key"></ion-icon>\n                  </button>\n          </ion-col>\n          <ion-col>\n\n            <button small title="產生Insert SQL語法" *ngIf="selectedItem.loop_seq>0" ion-button color="light" icon-left (click)="openNavSqlPage(selectedItem,\'insert\')">\n              Ins\n            </button>\n            <button small title="產生Update SQL語法" *ngIf="selectedItem.loop_seq>0" ion-button color="light" icon-left (click)="openNavSqlPage(selectedItem,\'update\')">\n              Upd\n            </button>\n          </ion-col>\n          </ion-row>\n          </ion-grid>\n          <ngx-datatable NgxResizeWatcher class="bootstrap"\n          *ngIf="totalRows>0 && conf.mobile_mode==false"\n          [selected]="selected"\n          [selectionType]="\'single\'"\n          (select)=\'onRowSelect($event)\'\n           [rows]="data_list"\n           [columnMode]="\'flex\'"\n           [headerHeight]="40" [rowHeight]="\'auto\'" [footerHeight]="40"\n    [reorderable]=false [limit]="limit" [count]="totalRows" [offset]="offset" (page)=\'setPage($event)\'>\n\n           <ngx-datatable-column\n          prop="loop_seq" *ngIf="innerWidth>=1024"\n           name="迴圈序號"\n           [flexGrow]="1"\n           [frozenLeft]="true">\n          </ngx-datatable-column>\n          <ngx-datatable-column\n          prop="job01"\n           name="{JOB01}"\n           [flexGrow]="1"\n           [frozenLeft]="true">\n          </ngx-datatable-column>\n          <ngx-datatable-column\n          prop="job02"\n           name="{JOB02}"\n           [flexGrow]="1">\n          </ngx-datatable-column>\n          <ngx-datatable-column\n          prop="job03"\n           name="{JOB03}"\n           [flexGrow]="1">\n          </ngx-datatable-column>\n          <ngx-datatable-column\n          prop="exec_seq"\n           name="執行順序"\n           [flexGrow]="1">\n          </ngx-datatable-column>\n          <ngx-datatable-column\n          prop="job_loop_replace_desc"\n           name="作業替換迴圈說明"\n           [flexGrow]="1">\n          </ngx-datatable-column>\n          <ngx-datatable-column\n           prop="last_exec_date"\n           name="執行時間"\n           [flexGrow]="1">\n           <ng-template  let-value="value" ngx-datatable-cell-template>\n            <div *ngIf="platform.is(\'ios\')==true">\n              {{value | date:\'y/MM/dd HH:mm:ss \'}}\n            </div>\n            <div *ngIf="platform.is(\'ios\')!=true">\n              {{value | date:\'y/MM/dd HH:mm:ss\'}}\n            </div>\n          </ng-template>\n\n          </ngx-datatable-column>\n          <ngx-datatable-column *ngIf="innerWidth>=1024"\n           prop="duration"\n            name="持續"\n            [flexGrow]="1">\n         </ngx-datatable-column>\n           <ngx-datatable-column\n           prop="last_exec_status_desc"\n            name="執行狀態"\n            [flexGrow]="1">\n            <ng-template let-row="row"  let-value="value" ngx-datatable-cell-template>\n              <div>\n                <button [ngClass]="\'exec_fail\'" *ngIf="row[\'last_exec_status_key\']==\'012|F\'" (click)="openNavErrMsgLogPage(row)">\n                  {{value}}\n                </button>\n                <div *ngIf="row[\'last_exec_status_key\']!=\'012|F\'" [ngClass]="row[\'last_exec_status_color\']">{{value}}</div>\n              </div>\n            </ng-template>\n         </ngx-datatable-column>\n         <ngx-datatable-column\n           prop="is_active_desc"\n            name="啟用"\n            [flexGrow]="1">\n            <ng-template let-row="row"  let-value="value" ngx-datatable-cell-template>\n              <div [ngClass]="row[\'is_active_color\']">{{value}}</div>\n            </ng-template>\n         </ngx-datatable-column>\n\n          </ngx-datatable>\n  <div *ngIf="data_list.length>0 && conf.mobile_mode==true">\n    <ion-row>\n\n      <ion-col col-lg-4 col-md-6 col-sm-6 col-12 *ngFor="let item of data_list">\n\n        <ion-grid [ngClass]="[\'bordered\']">\n          <ion-row>\n            <ion-col>\n              <button small title="明細" ion-button color="secondary" icon-left (click)="openNavDetailsPage(item)">\n                <ion-icon name="albums"></ion-icon>\n              </button>\n              <button *ngIf="CanJobExec==true"  small title="執行" ion-button color="dark" icon-left (click)="openNavRunPage(item)">\n                <ion-icon name="arrow-dropright-circle"></ion-icon>\n              </button>\n              <button *ngIf="can_view_log==true" small title="歷史執行紀錄" ion-button color="primary" icon-left (click)="openNavLogPage(item)">\n                <ion-icon name="logo-twitch"></ion-icon>\n              </button>\n              <button *ngIf="can_view_log==true" small title="檔案執行紀錄" ion-button color="light" icon-left (click)="openNavFileLogPage(item)">\n                <ion-icon name="logo-twitch"></ion-icon>\n              </button>\n              <button *ngIf="can_view_log==true" small title="資料表執行紀錄" ion-button color="danger" icon-left (click)="openNavTableLogPage(item)">\n                  <ion-icon name="logo-twitch"></ion-icon>\n              </button>\n\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              <button small *ngIf="CanEditLoopJob==true && item.loop_seq>0"  title="編輯" ion-button color="light" icon-left (click)="ShowModal(item,\'e\')">\n                <ion-icon name="create"></ion-icon>\n              </button>\n              <button small *ngIf="CanEditLoopJob==true" title="複製" ion-button color="light" icon-left (click)="ShowModal(item,\'c\')">\n                <ion-icon name="copy"></ion-icon>\n              </button>\n              <button small *ngIf="CanEditLoopJob==true && item.loop_seq>0" title="刪除" ion-button color="dark" icon-left (click)="Delete(item)">\n                <ion-icon name="trash"></ion-icon>\n              </button>\n\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              <button *ngIf="CanEditLoopJob==true" small title="壓縮加密" ion-button color="primary" icon-left (click)="ShowModal(item,\'zip_password\')">\n                <ion-icon name="key"></ion-icon>\n              </button>\n              <button *ngIf="CanEditLoopJob==true" small title="解壓縮加密" ion-button color="secondary" icon-left (click)="ShowModal(item,\'unzip_password\')">\n                <ion-icon name="key"></ion-icon>\n              </button>\n              <button *ngIf="CanEditLoopJob==true" small title="清除壓縮加密" ion-button color="dark" icon-left (click)="clear_zip_pwd(item)">\n                  <ion-icon name="key"></ion-icon>\n                </button>\n                <button *ngIf="CanEditLoopJob==true" small title="清除解壓縮加密" ion-button color="light" icon-left (click)="clear_unzip_pwd(item)">\n                  <ion-icon name="key"></ion-icon>\n                </button>\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              <button small title="產生Insert SQL語法" *ngIf="item.loop_seq>0" ion-button color="light" icon-left (click)="openNavSqlPage(item,\'insert\')">\n                Ins\n              </button>\n              <button small title="產生Update SQL語法" *ngIf="item.loop_seq>0" ion-button color="light" icon-left (click)="openNavSqlPage(item,\'update\')">\n                Upd\n              </button>\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col *ngIf="item.job01>\'\'">\n              JOB01:{{item.job01}}\n            </ion-col>\n            <ion-col *ngIf="item.job02>\'\'" >\n              JOB02:{{item.job02}}\n            </ion-col>\n            <ion-col *ngIf="item.job03>\'\'" >\n              JOB03:{{item.job03}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col >\n              {{item.loop_seq}}\n            </ion-col>\n            <ion-col align-self-end>\n                <div text-right>\n              {{item.exec_seq}}\n              </div>\n            </ion-col>\n\n          </ion-row>\n          <ion-row>\n            <ion-col >\n              {{item.job_loop_desc}}\n            </ion-col>\n            <ion-col col-4 align-self-end>\n              <div text-right>\n                <button [ngClass]="\'exec_fail\'" *ngIf="item.last_exec_status_key==\'012|F\'" (click)="openNavErrMsgLogPage(item)">\n                  {{item.last_exec_status_desc}}\n                </button>\n                <div text-right *ngIf="item.last_exec_status_key!=\'012|F\'" [ngClass]="item.last_exec_status_color">{{item.last_exec_status_desc}}</div>\n              </div>\n            </ion-col>\n\n          </ion-row>\n          <ion-row>\n            <ion-col col-4>\n              <div [ngClass]="item.is_active_color">{{item.is_active_desc}}</div>\n            </ion-col>\n            <ion-col col-8 align-self-end>\n                <div *ngIf="platform.is(\'ios\')==true" text-right>\n                    {{item.last_exec_date | date:\'y/MM/dd HH:mm:ss \'}}\n                  </div>\n                <div *ngIf="platform.is(\'ios\')!=true" text-right>\n                    {{item.last_exec_date | date:\'y/MM/dd HH:mm:ss\'}}\n                  </div>\n              <!-- <div text-right>\n                {{item.last_exec_date | date:\'short\'}}\n              </div> -->\n            </ion-col>\n            </ion-row>\n        </ion-grid>\n      </ion-col>\n    </ion-row>\n  </div>\n  <ion-infinite-scroll *ngIf="pageNumber < totalPages" (ionInfinite)="$event.waitFor(doInfinite())">\n    <ion-infinite-scroll-content loadingSpinner="bubbles">\n    </ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n</ion-content>\n<ion-footer>\n    <ion-toolbar>\n        <ion-row>\n            <ion-col>\n                <div [ngClass]="[\'command\']">\n                  <button small title="重新整理" ion-button color="dark" icon-left (click)="LoadData(true)">\n                    <ion-checkbox name="order_type" title="遞增/遞減" color="dark" [(ngModel)]="order_type" (ionChange)="LoadData(true)" ></ion-checkbox>\n                     <ion-icon name="refresh"></ion-icon>\n                  </button>\n                  <button *ngIf="CanEditLoopJob==true" small title="新增" ion-button color="dark" icon-left (click)="ShowModal(null,\'n\')">\n                    <ion-icon name="add"></ion-icon>\n                  </button>\n                </div>\n                <StatusComponent [pageNumber]="pageNumber" [totalPages]="totalPages" [totalRows]="totalRows"></StatusComponent>\n              </ion-col>\n          </ion-row>\n    </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\job-loop\job-loop.html"*/
        }),
...
//# sourceMappingURL=job-loop.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JobLoopPageModule", function() { return JobLoopPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__job_loop__ = __webpack_require__(1543);
...
var JobLoopPageModule = /** @class */ (function () {
    function JobLoopPageModule() {
    }
    JobLoopPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__job_loop__["a" /* JobLoopPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_job_loop_services_job_loop_services__["a" /* JobLoopServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__job_loop__["a" /* JobLoopPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], JobLoopPageModule);
    return JobLoopPageModule;
}());

//# sourceMappingURL=job-loop.module.js.map
