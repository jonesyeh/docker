...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JobBySchSelectModalPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_JobSelectViewModel__ = __webpack_require__(1530);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/**
 * Generated class for the SchRolePage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var JobBySchSelectModalPage = /** @class */ (function () {
    function JobBySchSelectModalPage(navCtrl, navParams, global, authServices, JobServices, viewCtrl, modalCtrl, ConnServices) {
        ...
        this.totalPages = 1;
        this.totalRows = 0;
        this.sch_no = navParams.data.sch_no;
        this.JobSelect = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_JobSelectViewModel__["a" /* JobSelectViewModel */]();
        this.JobSelect.remote_conn_id = "SBP";
        this.order_type = true;
        if (this.authServices.authenticated() === true) {
            this.can_auth = this.authServices.CanAuth();
            this.LoadData(true);
            this.get_sbp_conn_string("SBP");
        }
    }
    JobBySchSelectModalPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    JobBySchSelectModalPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.JobServices.GetListsBySchAsync(_this.pageSize, _this.pageNumber, _this.keyword, _this.sch_no, false, _this.order_type)
    ...
    JobBySchSelectModalPage.prototype.SelectConn = function () {
        var _this = this;
        var modal = this.modalCtrl.create("ConnSelectModalPage", {
            select_remote_conn_id: this.JobSelect.remote_conn_id,
            conn_type_key: "065|005"
        });
        modal.onDidDismiss(function (select_data) {
            if (select_data == null)
                return;
            _this.JobSelect.remote_conn_id = select_data.remote_conn_id;
            _this.JobSelect.remote_conn_string = select_data.conn_string;
        });
        modal.present();
    };
    JobBySchSelectModalPage.prototype.get_sbp_conn_string = function (remote_conn_id) {
        var _this = this;
        ...
        this.global.loading.present().then(function () {
            _this.ConnServices.GetConnAsync(remote_conn_id).subscribe(function (data) {
                if (data.DidError === true) {
                    ...
                    _this.JobSelect.remote_conn_string =
    ...
    JobBySchSelectModalPage.prototype.add = function () {
        var data = this.data_list.filter(function (obj) { return obj.checked === true; });
        if (data.length === 0)
            this.global.showError("最少勾選一個");
        else {
            this.JobSelect.job = data.slice();
            this.viewCtrl.dismiss(this.JobSelect);
        }
    };
    JobBySchSelectModalPage.prototype.close = function () {
        this.viewCtrl.dismiss();
    };
    JobBySchSelectModalPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad SchByJobSelectModalPage");
    };
    JobBySchSelectModalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-job-by-sch-select-modal",template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\job-by-sch-select-modal\job-by-sch-select-modal.html"*/'\n<ion-header>\n    <ion-title>勾選作業加入</ion-title>\n  </ion-header>\n  <ion-content>\n    <ion-row>\n        <ion-col col-12 col-sm-4 >\n            <ion-item>\n              <ion-label stacked>SBP編號</ion-label>\n              <ion-input type="text"  name="remote_conn_id" #remote_conn_id="ngModel" [(ngModel)]="JobSelect.remote_conn_id"\n                required maxlength="20"></ion-input>\n\n              <button ion-button outline item-end  icon-right (click)="SelectConn()">\n                <ion-icon name="arrow-dropdown"></ion-icon>\n              </button>\n            </ion-item>\n\n            <div *ngIf="remote_conn_id.errors && remote_conn_id.touched " class="error-message">\n              連線編號不能為空白\n            </div>\n          </ion-col>\n          <ion-col col-12 col-sm-8>\n              <ion-item>\n                <ion-label stacked>程式</ion-label>\n                <ion-input [disabled]=true name="remote_conn_string" #remote_conn_string="ngModel" [(ngModel)]="JobSelect.remote_conn_string" required></ion-input>\n\n              </ion-item>\n\n            </ion-col>\n    </ion-row>\n    <ion-row>\n      <ion-col>\n\n        <ion-searchbar [ngClass]="[\'search\']" (keyup.enter)="LoadData(true)" placeholder="作業編號(包含)、作業名稱(包含)"\n          [(ngModel)]="keyword">\n        </ion-searchbar>\n\n      </ion-col>\n    </ion-row>\n    <div *ngIf="data_list">\n      <ion-row>\n\n        <ion-col col-lg-4 col-md-6 col-sm-6 col-12 *ngFor="let item of data_list">\n\n          <ion-grid [ngClass]="[\'bordered\']">\n\n            <ion-row>\n              <ion-col>\n              <ion-checkbox checked="false" [(ngModel)]="item.checked"></ion-checkbox> {{item.ssis_job_no}}\n              </ion-col>\n\n            </ion-row>\n            <ion-row>\n                <ion-col>\n                {{item.ssis_job_name}}\n                </ion-col>\n\n              </ion-row>\n          </ion-grid>\n        </ion-col>\n\n      </ion-row>\n    </div>\n    <ion-infinite-scroll *ngIf="pageNumber < totalPages" (ionInfinite)="$event.waitFor(doInfinite())">\n      <ion-infinite-scroll-content loadingSpinner="bubbles">\n      </ion-infinite-scroll-content>\n    </ion-infinite-scroll>\n  </ion-content>\n  <ion-footer>\n    <ion-toolbar>\n      <ion-row>\n        <ion-col>\n            <div [ngClass]="[\'command\']">\n              <button small title="重新整理" ion-button color="dark" icon-left (click)="LoadData(true)">\n                <ion-checkbox name="order_type" title="遞增/遞減" color="dark" [(ngModel)]="order_type" (ionChange)="LoadData(true)" ></ion-checkbox>\n                 <ion-icon name="refresh"></ion-icon>\n              </button>\n          <button small title="取消" ion-button color="dark" icon-left (click)="close()">\n            <ion-icon name="backspace"></ion-icon>\n          </button>\n          <button small title="加入" ion-button color="dark" icon-left (click)="add()">\n            <ion-icon name="checkmark-circle"></ion-icon>\n          </button>\n          </div>\n          <StatusComponent [pageNumber]="pageNumber" [totalPages]="totalPages" [totalRows]="totalRows"></StatusComponent>\n\n        </ion-col>\n      </ion-row>\n    </ion-toolbar>\n  </ion-footer>\n\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\job-by-sch-select-modal\job-by-sch-select-modal.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_job_services_job_services__["a" /* JobServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* ViewController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* ModalController */],
            __WEBPACK_IMPORTED_MODULE_5__providers_conn_services_conn_services__["a" /* ConnServicesProvider */]])
    ], JobBySchSelectModalPage);
    return JobBySchSelectModalPage;
}());

//# sourceMappingURL=job-by-sch-select-modal.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JobSelectViewModel; });
var JobSelectViewModel = /** @class */ (function () {
    function JobSelectViewModel() {
    }
    return JobSelectViewModel;
}());

//# sourceMappingURL=JobSelectViewModel.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__job_by_sch_select_modal__ = __webpack_require__(1529);
...
var JobBySchSelectModalPageModule = /** @class */ (function () {
    function JobBySchSelectModalPageModule() {
    }
    JobBySchSelectModalPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__job_by_sch_select_modal__["a" /* JobBySchSelectModalPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_job_services_job_services__["a" /* JobServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__job_by_sch_select_modal__["a" /* JobBySchSelectModalPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], JobBySchSelectModalPageModule);
    return JobBySchSelectModalPageModule;
}());

//# sourceMappingURL=job-by-sch-select-modal.module.js.map
