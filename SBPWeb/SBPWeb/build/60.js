...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_ForsListResponse__ = __webpack_require__(1177);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_ForsResponse__ = __webpack_require__(1178);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_ForsViewModel__ = __webpack_require__(985);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_ForsViewModel__ = __webpack_require__(985);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ForsPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_fors_services_fors_services__ = __webpack_require__(1058);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ForsViewModel__ = __webpack_require__(985);
 ...
 * Components.
 */
var ForsPage = /** @class */ (function () {
    function ForsPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, ForsServices, modalCtrl, viewCtrl, platform, conf) {
        ...
        this.page_name = "ForsPage";
        this.File_page = "SqlTablePage";
    ...
    ForsPage.prototype.openNavTableLogPage = function (item) {
        var _this = this;
    ...
    ForsPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    ForsPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    ForsPage.prototype.setPage = function (pageInfo) {
    ...
    ForsPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    ForsPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    ForsPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.ForsServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    ForsPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ForsViewModel__["a" /* ForsViewModel */]();
            item.is_active = true;
        ...
        var modal = this.modalCtrl.create("ForsAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.ForsServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    ForsPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.ForsServices.DeleteAsync(item.exec_table_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    ForsPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.ForsServices.GetSqlAsync(item.exec_table_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    ForsPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    ForsPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_fors_services_fors_services__["a" /* ForsServicesProvider */],
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ForsPageModule", function() { return ForsPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__fors__ = __webpack_require__(1510);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_fors_services_fors_services__ = __webpack_require__(1058);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ForsPageModule = /** @class */ (function () {
    function ForsPageModule() {
    }
    ForsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__fors__["a" /* ForsPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_fors_services_fors_services__["a" /* ForsServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__fors__["a" /* ForsPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], ForsPageModule);
    return ForsPageModule;
}());

//# sourceMappingURL=fors.module.js.map
