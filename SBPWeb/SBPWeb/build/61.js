...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FordListResponse__ = __webpack_require__(1175);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FordResponse__ = __webpack_require__(1176);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FordViewModel__ = __webpack_require__(984);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FordViewModel__ = __webpack_require__(984);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FordPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_ford_services_ford_services__ = __webpack_require__(1057);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FordViewModel__ = __webpack_require__(984);
 ...
 * Components.
 */
var FordPage = /** @class */ (function () {
    function FordPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FordServices, modalCtrl, viewCtrl, platform, conf) {
    ...
    FordPage.prototype.openNavTableLogPage = function (item) {
        var _this = this;
    ...
    FordPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FordPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FordPage.prototype.setPage = function (pageInfo) {
    ...
    FordPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FordPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FordPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.FordServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    FordPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FordViewModel__["a" /* FordViewModel */]();
            item.is_active = true;
        ...
        var modal = this.modalCtrl.create("FordAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FordServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    FordPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FordServices.DeleteAsync(item.exec_table_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FordPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FordServices.GetSqlAsync(item.exec_table_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FordPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FordPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_ford_services_ford_services__["a" /* FordServicesProvider */],
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FordPageModule", function() { return FordPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ford__ = __webpack_require__(1506);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_ford_services_ford_services__ = __webpack_require__(1057);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FordPageModule = /** @class */ (function () {
    function FordPageModule() {
    }
    FordPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__ford__["a" /* FordPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_ford_services_ford_services__["a" /* FordServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__ford__["a" /* FordPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FordPageModule);
    return FordPageModule;
}());

//# sourceMappingURL=ford.module.js.map
