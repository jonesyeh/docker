...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_ForListResponse__ = __webpack_require__(1173);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_ForResponse__ = __webpack_require__(1174);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_ForViewModel__ = __webpack_require__(983);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_ForViewModel__ = __webpack_require__(983);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_for_services_for_services__ = __webpack_require__(1056);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ForViewModel__ = __webpack_require__(983);
 ...
 * Components.
 */
var ForPage = /** @class */ (function () {
    function ForPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, ForServices, modalCtrl, viewCtrl, platform, conf) {
    ...
    ForPage.prototype.openNavTableLogPage = function (item) {
        var _this = this;
    ...
    ForPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    ForPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    ForPage.prototype.setPage = function (pageInfo) {
    ...
    ForPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    ForPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    ForPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.ForServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.order_type).subscribe(function (data) {
    ...
    ForPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_ForViewModel__["a" /* ForViewModel */]();
            item.is_active = true;
            ...
            item.sql_statement = "";
            item.for_data_sql_statement = "";
            item.for_lastdata_sql_statement = "";
            item.datatype_key = "009|DATE";
            item.datatype = "日期";
        }
        else {
            this.mode = "PUT";
        ...
        var modal = this.modalCtrl.create("ForAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.ForServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    ForPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.ForServices.DeleteAsync(item.exec_table_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    ForPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.ForServices.GetSqlAsync(item.exec_table_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    ForPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    ForPage.prototype.add = function (item) {
        this.viewCtrl.dismiss(item);
    };
    ForPage.prototype.close = function () {
    ...
    ForPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_for_services_for_services__["a" /* ForServicesProvider */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__for__ = __webpack_require__(1502);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_for_services_for_services__ = __webpack_require__(1056);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ForPageModule = /** @class */ (function () {
    ...
    ForPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_for_services_for_services__["a" /* ForServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__for__["a" /* ForPage */]),
