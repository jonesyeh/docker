...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileZipSrcListResponse__ = __webpack_require__(1171);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileZipSrcResponse__ = __webpack_require__(1172);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileZipSrcViewModel__ = __webpack_require__(982);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileZipSrcViewModel__ = __webpack_require__(982);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileZipSrcPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileZipSrcViewModel__ = __webpack_require__(982);
 ...
 * Components.
 */
var FileZipSrcPage = /** @class */ (function () {
    function FileZipSrcPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileZipSrcServices, modalCtrl, viewCtrl, runjobServices, platform, conf) {
        ...
        this.File_page = "FileZipSrcTablePage";
    ...
    FileZipSrcPage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
    ...
    FileZipSrcPage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
    ...
    FileZipSrcPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileZipSrcPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileZipSrcPage.prototype.setPage = function (pageInfo) {
    ...
    FileZipSrcPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileZipSrcPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileZipSrcPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileZipSrcServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileZipSrcPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileZipSrcViewModel__["a" /* FileZipSrcViewModel */]();
        ...
        var modal = this.modalCtrl.create("FileZipSrcAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileZipSrcServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("壓縮來源檔案設定", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileZipSrcPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileZipSrcServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileZipSrcPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileZipSrcServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileZipSrcPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileZipSrcPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_zip_src_services_file_zip_src_services__["a" /* FileZipSrcServicesProvider */],
    ...
    return FileZipSrcPage;
}());

//# sourceMappingURL=file-zip-src.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_zip_src__ = __webpack_require__(1500);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_zip_src_services_file_zip_src_services__ = __webpack_require__(1055);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileZipSrcPageModule = /** @class */ (function () {
    function FileZipSrcPageModule() {
    }
    FileZipSrcPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_zip_src__["a" /* FileZipSrcPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_zip_src_services_file_zip_src_services__["a" /* FileZipSrcServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_zip_src__["a" /* FileZipSrcPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileZipSrcPageModule);
    return FileZipSrcPageModule;
}());

//# sourceMappingURL=file-zip-src.module.js.map
