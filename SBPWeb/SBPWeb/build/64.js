...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileZipSetServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileZipSetListResponse__ = __webpack_require__(1500);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileZipSetResponse__ = __webpack_require__(1501);
...
/*
  Generated class for the FileZipSetServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var FileZipSetServicesProvider = /** @class */ (function () {
    function FileZipSetServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "FileZipSet";
        console.log("Hello FileZipSetServiceProvider Provider");
    }
    FileZipSetServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, zip_seq, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "FileZip?PageSize={1}&PageNumber={2}&keyword={3}&zip_seq={4}&order_type={5}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, PageSize, PageNumber, keyword, zip_seq, order_type);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.FileZipSets = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileZipSetListResponse__["a" /* FileZipSetListResponse */]({
            ...
            return _this.FileZipSets;
        });
    };
    FileZipSetServicesProvider.prototype.PostPutAsync = function (FileZipSetViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "FileZip";
        else
            sub_url = "FileZip?zip_seq={1}&src_exec_group={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, FileZipSetViewModel.zip_seq, FileZipSetViewModel.src_exec_group);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, FileZipSetViewModel, mode).map(function (item) {
            _this.FileZipSet = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileZipSetResponse__["a" /* FileZipSetResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.FileZipSet;
        });
    };
    FileZipSetServicesProvider.prototype.DeleteAsync = function (zip_seq, src_exec_group) {
        var sub_url;
        sub_url = "FileZip?zip_seq={1}&src_exec_group={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, zip_seq, src_exec_group);
    ...
    FileZipSetServicesProvider.prototype.GetSqlAsync = function (zip_seq, src_exec_group, method) {
        var sub_url;
        sub_url = "FileZip/get_{3}_sql?zip_seq={1}&src_exec_group={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, zip_seq, src_exec_group, method);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            return new __WEBPACK_IMPORTED_MODULE_5__Model_Response_StringResponse__["a" /* StringResponse */]({
                Message: item.Message,
                DidError: item.DidError,
    ...
    FileZipSetServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_services__["a" /* ServicesProvider */]])
    ], FileZipSetServicesProvider);
    return FileZipSetServicesProvider;
}());

//# sourceMappingURL=file-zip-set-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileZipSetPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_zip_set_services_file_zip_set_services__ = __webpack_require__(1230);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileZipSetViewModel__ = __webpack_require__(1054);
 ...
 * Components.
 */
var FileZipSetPage = /** @class */ (function () {
    function FileZipSetPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileZipSetServices, modalCtrl, viewCtrl, platform, conf) {
        ...
        this.FileZipSetServices = FileZipSetServices;
        ...
        this.File_page = "FileZipSetTablePage";
        ...
        this.subject = __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("{0}", navParams.data.item.zip_filename);
    }
    FileZipSetPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileZipSetPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileZipSetPage.prototype.setPage = function (pageInfo) {
    ...
    FileZipSetPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileZipSetPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileZipSetPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.FileZipSetServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.zip_seq, _this.order_type).subscribe(function (data) {
    ...
    FileZipSetPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileZipSetViewModel__["a" /* FileZipSetViewModel */]();
            item.zip_seq = this.zip_seq;
        }
        else {
            this.mode = "PUT";
            if (change_mode === "c")
        ...
        var modal = this.modalCtrl.create("FileZipSetAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileZipSetServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("壓縮檔來源設定", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileZipSetPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.zip_seq, item.src_exec_group),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileZipSetServices.DeleteAsync(item.zip_seq, item.src_exec_group).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileZipSetPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileZipSetServices.GetSqlAsync(item.zip_seq, item.src_exec_group, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileZipSetPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileZipSetPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_zip_set_services_file_zip_set_services__["a" /* FileZipSetServicesProvider */],
    ...
    return FileZipSetPage;
}());

//# sourceMappingURL=file-zip-set.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileZipSetListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileZipSetViewModel__ = __webpack_require__(1054);
...
var FileZipSetListResponse = /** @class */ (function (_super) {
    __extends(FileZipSetListResponse, _super);
    function FileZipSetListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileZipSetViewModel__["a" /* FileZipSetViewModel */]();
                item.zip_seq = data.zip_seq;
                item.src_exec_group = data.src_exec_group;
    ...
    return FileZipSetListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=FileZipSetListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileZipSetResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileZipSetViewModel__ = __webpack_require__(1054);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var FileZipSetResponse = /** @class */ (function (_super) {
    __extends(FileZipSetResponse, _super);
    function FileZipSetResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileZipSetViewModel__["a" /* FileZipSetViewModel */]();
            _this.Model.zip_seq = obj.Model.zip_seq;
            _this.Model.src_exec_group = obj.Model.src_exec_group;
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileZipSetPageModule", function() { return FileZipSetPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_zip_set__ = __webpack_require__(1499);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_zip_set_services_file_zip_set_services__ = __webpack_require__(1230);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileZipSetPageModule = /** @class */ (function () {
    function FileZipSetPageModule() {
    }
    FileZipSetPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_zip_set__["a" /* FileZipSetPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_zip_set_services_file_zip_set_services__["a" /* FileZipSetServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_zip_set__["a" /* FileZipSetPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileZipSetPageModule);
    return FileZipSetPageModule;
}());

//# sourceMappingURL=file-zip-set.module.js.map
