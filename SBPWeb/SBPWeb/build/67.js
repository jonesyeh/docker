...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileSsisParmServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileSsisParmListResponse__ = __webpack_require__(1490);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_Response_FileSsisParmResponse__ = __webpack_require__(1491);
...
/*
  Generated class for the FileSsisParmServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var FileSsisParmServicesProvider = /** @class */ (function () {
    function FileSsisParmServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "FileSsisParm";
        console.log("Hello FileSsisParmServiceProvider Provider");
    }
    FileSsisParmServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, exec_file_seq, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "FileSsisParm?PageSize={1}&PageNumber={2}&keyword={3}&exec_file_seq={4}&order_type={5}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.FileSsisParms = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileSsisParmListResponse__["a" /* FileSsisParmListResponse */]({
            ...
            return _this.FileSsisParms;
        });
    };
    FileSsisParmServicesProvider.prototype.PostPutAsync = function (FileSsisParmViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "FileSsisParm";
        else
            sub_url = "FileSsisParm?exec_file_seq={1}&ssis_parm_name={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, FileSsisParmViewModel.exec_file_seq, FileSsisParmViewModel.ssis_parm_name);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, FileSsisParmViewModel, mode).map(function (item) {
            _this.FileSsisParm = new __WEBPACK_IMPORTED_MODULE_5__Model_Response_FileSsisParmResponse__["a" /* FileSsisParmResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.FileSsisParm;
        });
    };
    FileSsisParmServicesProvider.prototype.DeleteAsync = function (exec_file_seq, ssis_parm_name) {
        var _this = this;
        var sub_url;
        sub_url = "FileSsisParm?exec_file_seq={1}&ssis_parm_name={2}";
    ...
    FileSsisParmServicesProvider.prototype.GetSqlAsync = function (exec_file_seq, ssis_parm_name, method) {
        var sub_url;
        sub_url = "FileSsisParm/get_{3}_sql?exec_file_seq={1}&ssis_parm_name={2}";
    ...
    FileSsisParmServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_services__["a" /* ServicesProvider */]])
    ], FileSsisParmServicesProvider);
    return FileSsisParmServicesProvider;
}());

//# sourceMappingURL=file-ssis-parm-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileSsisParmPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_ssis_parm_services_file_ssis_parm_services__ = __webpack_require__(1229);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileSsisParmViewModel__ = __webpack_require__(1051);
 ...
 * Components.
 */
var FileSsisParmPage = /** @class */ (function () {
    function FileSsisParmPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileSsisParmServices, modalCtrl, viewCtrl, platform, conf) {
        ...
        this.FileSsisParmServices = FileSsisParmServices;
        ...
        this.File_page = "FileSsisParmTablePage";
    ...
    FileSsisParmPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileSsisParmPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileSsisParmPage.prototype.setPage = function (pageInfo) {
    ...
    FileSsisParmPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileSsisParmPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileSsisParmPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.FileSsisParmServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
    ...
    FileSsisParmPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileSsisParmViewModel__["a" /* FileSsisParmViewModel */]();
        ...
        var modal = this.modalCtrl.create("FileSsisParmAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileSsisParmServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("ssis參數設定", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileSsisParmPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileSsisParmServices.DeleteAsync(item.exec_file_seq, item.ssis_parm_name).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileSsisParmPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileSsisParmServices.GetSqlAsync(item.exec_file_seq, item.ssis_parm_name, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileSsisParmPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileSsisParmPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_ssis_parm_services_file_ssis_parm_services__["a" /* FileSsisParmServicesProvider */],
    ...
    return FileSsisParmPage;
}());

//# sourceMappingURL=file-ssis-parm.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileSsisParmListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileSsisParmViewModel__ = __webpack_require__(1051);
...
var FileSsisParmListResponse = /** @class */ (function (_super) {
    __extends(FileSsisParmListResponse, _super);
    function FileSsisParmListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileSsisParmViewModel__["a" /* FileSsisParmViewModel */]();
                item.exec_file_seq = data.exec_file_seq;
                item.ssis_parm_name = data.ssis_parm_name;
                item.ssis_parm_value = data.ssis_parm_value;
    ...
    return FileSsisParmListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=FileSsisParmListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileSsisParmResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileSsisParmViewModel__ = __webpack_require__(1051);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var FileSsisParmResponse = /** @class */ (function (_super) {
    __extends(FileSsisParmResponse, _super);
    function FileSsisParmResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileSsisParmViewModel__["a" /* FileSsisParmViewModel */]();
            _this.Model.exec_file_seq = obj.Model.exec_file_seq;
            _this.Model.ssis_parm_name = obj.Model.ssis_parm_name;
            _this.Model.ssis_parm_value = obj.Model.ssis_parm_value;
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileSsisParmPageModule", function() { return FileSsisParmPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_ssis_parm__ = __webpack_require__(1489);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_ssis_parm_services_file_ssis_parm_services__ = __webpack_require__(1229);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileSsisParmPageModule = /** @class */ (function () {
    function FileSsisParmPageModule() {
    }
    FileSsisParmPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_ssis_parm__["a" /* FileSsisParmPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_ssis_parm_services_file_ssis_parm_services__["a" /* FileSsisParmServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_ssis_parm__["a" /* FileSsisParmPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileSsisParmPageModule);
    return FileSsisParmPageModule;
}());

//# sourceMappingURL=file-ssis-parm.module.js.map
