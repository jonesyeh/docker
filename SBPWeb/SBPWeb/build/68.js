...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileSsisConnParmServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileSsisConnParmListResponse__ = __webpack_require__(1486);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_Response_FileSsisConnParmResponse__ = __webpack_require__(1487);
...
/*
  Generated class for the FileSsisConnParmServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var FileSsisConnParmServicesProvider = /** @class */ (function () {
    function FileSsisConnParmServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "FileSsisConnParm";
        console.log("Hello FileSsisConnParmServiceProvider Provider");
    }
    FileSsisConnParmServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, exec_file_seq, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "FileSsisConnParm?PageSize={1}&PageNumber={2}&keyword={3}&exec_file_seq={4}&order_type={5}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.FileSsisConnParms = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileSsisConnParmListResponse__["a" /* FileSsisConnParmListResponse */]({
            ...
            return _this.FileSsisConnParms;
        });
    };
    FileSsisConnParmServicesProvider.prototype.PostPutAsync = function (FileSsisConnParmViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "FileSsisConnParm";
        else
            sub_url = "FileSsisConnParm?exec_file_seq={1}&ssis_parm_name={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, FileSsisConnParmViewModel.exec_file_seq, FileSsisConnParmViewModel.ssis_parm_name);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, FileSsisConnParmViewModel, mode).map(function (item) {
            _this.FileSsisConnParm = new __WEBPACK_IMPORTED_MODULE_5__Model_Response_FileSsisConnParmResponse__["a" /* FileSsisConnParmResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.FileSsisConnParm;
        });
    };
    FileSsisConnParmServicesProvider.prototype.DeleteAsync = function (exec_file_seq, ssis_parm_name) {
        var _this = this;
        var sub_url;
        sub_url = "FileSsisConnParm?exec_file_seq={1}&ssis_parm_name={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, exec_file_seq, ssis_parm_name);
    ...
    FileSsisConnParmServicesProvider.prototype.GetSqlAsync = function (exec_file_seq, ssis_parm_name, method) {
        var sub_url;
        sub_url = "FileSsisConnParm/get_{3}_sql?exec_file_seq={1}&ssis_parm_name={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, exec_file_seq, ssis_parm_name, method);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
    ...
    FileSsisConnParmServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_services__["a" /* ServicesProvider */]])
    ], FileSsisConnParmServicesProvider);
    return FileSsisConnParmServicesProvider;
}());

//# sourceMappingURL=file-ssis-conn-parm-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileSsisConnParmPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_ssis_conn_parm_services_file_ssis_conn_parm_services__ = __webpack_require__(1228);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileSsisConnParmViewModel__ = __webpack_require__(1050);
 ...
 * Components.
 */
var FileSsisConnParmPage = /** @class */ (function () {
    function FileSsisConnParmPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileSsisConnParmServices, modalCtrl, viewCtrl, platform, conf) {
        ...
        this.FileSsisConnParmServices = FileSsisConnParmServices;
        ...
        this.File_page = "FileSsisConnParmTablePage";
        ...
        this.package_src_key = navParams.data.item.package_src_key;
        this.exec_file_seq = navParams.data.item.exec_file_seq;
    }
    FileSsisConnParmPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileSsisConnParmPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileSsisConnParmPage.prototype.setPage = function (pageInfo) {
    ...
    FileSsisConnParmPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileSsisConnParmPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileSsisConnParmPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.FileSsisConnParmServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
    ...
    FileSsisConnParmPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileSsisConnParmViewModel__["a" /* FileSsisConnParmViewModel */]();
            item.exec_file_seq = this.exec_file_seq;
            item.ssis_parm_type_key = "068|1";
            item.ssis_parm_type = "封裝參數";
        }
        else {
            this.mode = "PUT";
            if (change_mode === "c")
        ...
        var modal = this.modalCtrl.create("FileSsisConnParmAddEditModalPage", {
            mode: this.mode,
            item: item,
            package_src_key: this.package_src_key,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileSsisConnParmServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("ssis連線參數設定", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileSsisConnParmPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}-{1}嗎?", item.exec_file_seq, item.ssis_parm_name),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileSsisConnParmServices.DeleteAsync(item.exec_file_seq, item.ssis_parm_name).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileSsisConnParmPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileSsisConnParmServices.GetSqlAsync(item.exec_file_seq, item.ssis_parm_name, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileSsisConnParmPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileSsisConnParmPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_ssis_conn_parm_services_file_ssis_conn_parm_services__["a" /* FileSsisConnParmServicesProvider */],
    ...
    ], FileSsisConnParmPage);
    return FileSsisConnParmPage;
}());

//# sourceMappingURL=file-ssis-conn-parm.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileSsisConnParmListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileSsisConnParmViewModel__ = __webpack_require__(1050);
...
var FileSsisConnParmListResponse = /** @class */ (function (_super) {
    __extends(FileSsisConnParmListResponse, _super);
    function FileSsisConnParmListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileSsisConnParmViewModel__["a" /* FileSsisConnParmViewModel */]();
                item.exec_file_seq = data.exec_file_seq;
                item.ssis_parm_name = data.ssis_parm_name;
                item.remote_conn_id = data.remote_conn_id;
                item.ssis_parm_type_key = data.ssis_parm_type_key;
                item.ssis_parm_type = data.ssis_parm_type;
    ...
    return FileSsisConnParmListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=FileSsisConnParmListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileSsisConnParmResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileSsisConnParmViewModel__ = __webpack_require__(1050);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var FileSsisConnParmResponse = /** @class */ (function (_super) {
    __extends(FileSsisConnParmResponse, _super);
    function FileSsisConnParmResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileSsisConnParmViewModel__["a" /* FileSsisConnParmViewModel */]();
            _this.Model.exec_file_seq = obj.Model.exec_file_seq;
            _this.Model.ssis_parm_name = obj.Model.ssis_parm_name;
            _this.Model.remote_conn_id = obj.Model.remote_conn_id;
            _this.Model.remote_conn_string = obj.Model.remote_conn_string;
            _this.Model.ssis_parm_type_key = obj.Model.ssis_parm_type_key;
            _this.Model.ssis_parm_type = obj.Model.ssis_parm_type;
    ...
    return FileSsisConnParmResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=FileSsisConnParmResponse.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileSsisConnParmPageModule", function() { return FileSsisConnParmPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_ssis_conn_parm__ = __webpack_require__(1485);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_ssis_conn_parm_services_file_ssis_conn_parm_services__ = __webpack_require__(1228);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileSsisConnParmPageModule = /** @class */ (function () {
    function FileSsisConnParmPageModule() {
    }
    FileSsisConnParmPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_ssis_conn_parm__["a" /* FileSsisConnParmPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_ssis_conn_parm_services_file_ssis_conn_parm_services__["a" /* FileSsisConnParmServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_ssis_conn_parm__["a" /* FileSsisConnParmPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileSsisConnParmPageModule);
    return FileSsisConnParmPageModule;
}());

//# sourceMappingURL=file-ssis-conn-parm.module.js.map
