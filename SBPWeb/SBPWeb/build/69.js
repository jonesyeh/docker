...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileSqlListResponse__ = __webpack_require__(1161);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileSqlResponse__ = __webpack_require__(1162);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileSqlViewModel__ = __webpack_require__(976);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileSqlViewModel__ = __webpack_require__(976);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileSqlPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_sql_services_file_sql_services__ = __webpack_require__(1047);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileSqlViewModel__ = __webpack_require__(976);
 ...
 * Components.
 */
var FileSqlPage = /** @class */ (function () {
    function FileSqlPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileSqlServices, modalCtrl, viewCtrl, runjobServices, platform, conf) {
        ...
        this.File_page = "FileSqlTablePage";
    ...
    FileSqlPage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
    ...
    FileSqlPage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
    ...
    FileSqlPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileSqlPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileSqlPage.prototype.setPage = function (pageInfo) {
    ...
    FileSqlPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileSqlPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileSqlPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileSqlServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileSqlPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileSqlViewModel__["a" /* FileSqlViewModel */]();
            item.replace_variable = false;
            item.file_proc_key = "018|1";
            item.file_proc = "不動作";
            item.file_min_length = 0;
            item.file_max_length = 50;
            item.file_keyword = "*.sql";
            item.is_active = true;
            item.is_fail_stop = true;
            item.parameter_column_group = "001";
            item.can_rerun = true;
            item.remote_conn_id = "localdb";
        }
        else {
            this.mode = "PUT";
            if (change_mode === "c")
        ...
        var modal = this.modalCtrl.create("FileSqlAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileSqlServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("SqL檔案執行設定", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileSqlPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileSqlServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileSqlPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileSqlServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileSqlPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileSqlPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_sql_services_file_sql_services__["a" /* FileSqlServicesProvider */],
...
//# sourceMappingURL=file-sql.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_sql__ = __webpack_require__(1481);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_sql_services_file_sql_services__ = __webpack_require__(1047);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileSqlPageModule = /** @class */ (function () {
    function FileSqlPageModule() {
    }
    FileSqlPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_sql__["a" /* FileSqlPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_sql_services_file_sql_services__["a" /* FileSqlServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_sql__["a" /* FileSqlPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileSqlPageModule);
    return FileSqlPageModule;
}());

//# sourceMappingURL=file-sql.module.js.map
