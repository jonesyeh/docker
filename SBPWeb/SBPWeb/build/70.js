...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileReplaceDataListResponse__ = __webpack_require__(1163);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileReplaceDataResponse__ = __webpack_require__(1164);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileReplaceDataViewModel__ = __webpack_require__(977);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileReplaceDataViewModel__ = __webpack_require__(977);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileReplaceDataPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_replace_data_services_file_replace_data_services__ = __webpack_require__(1048);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileReplaceDataViewModel__ = __webpack_require__(977);
 ...
 * Components.
 */
var FileReplaceDataPage = /** @class */ (function () {
    function FileReplaceDataPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileReplaceDataServices, modalCtrl, viewCtrl, TableServices, runjobServices, platform, conf) {
        ...
        this.File_page = "FileReplaceDataTablePage";
    ...
    FileReplaceDataPage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
    ...
    FileReplaceDataPage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
    ...
    FileReplaceDataPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileReplaceDataPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileReplaceDataPage.prototype.setPage = function (pageInfo) {
    ...
    FileReplaceDataPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileReplaceDataPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileReplaceDataPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileReplaceDataServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileReplaceDataPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileReplaceDataViewModel__["a" /* FileReplaceDataViewModel */]();
        ...
        var modal = this.modalCtrl.create("FileReplaceDataAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileReplaceDataServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    FileReplaceDataPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileReplaceDataServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileReplaceDataPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileReplaceDataServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileReplaceDataPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileReplaceDataPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_replace_data_services_file_replace_data_services__["a" /* FileReplaceDataServicesProvider */],
    ...
    return FileReplaceDataPage;
}());

//# sourceMappingURL=file-replace-data.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_replace_data__ = __webpack_require__(1480);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_replace_data_services_file_replace_data_services__ = __webpack_require__(1048);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileReplaceDataPageModule = /** @class */ (function () {
    function FileReplaceDataPageModule() {
    }
    FileReplaceDataPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_replace_data__["a" /* FileReplaceDataPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_replace_data_services_file_replace_data_services__["a" /* FileReplaceDataServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_replace_data__["a" /* FileReplaceDataPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileReplaceDataPageModule);
    return FileReplaceDataPageModule;
}());

//# sourceMappingURL=file-replace-data.module.js.map
