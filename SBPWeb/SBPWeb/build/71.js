...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileReplaceDataItemViewModel; });
var FileReplaceDataItemViewModel = /** @class */ (function () {
    function FileReplaceDataItemViewModel() {
    }
    return FileReplaceDataItemViewModel;
}());

//# sourceMappingURL=FileReplaceDataItemViewModel.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileReplaceDataItemServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileReplaceDataItemListResponse__ = __webpack_require__(1478);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileReplaceDataItemResponse__ = __webpack_require__(1479);
...
/*
  Generated class for the FileReplaceDataItemServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var FileReplaceDataItemServicesProvider = /** @class */ (function () {
    function FileReplaceDataItemServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "FileReplaceDataItem";
        console.log("Hello FileReplaceDataItemServiceProvider Provider");
    }
    FileReplaceDataItemServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, exec_file_seq, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "FileReplaceDataItem?PageSize={1}&PageNumber={2}&keyword={3}&exec_file_seq={4}&order_type={5}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.FileReplaceDataItems = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileReplaceDataItemListResponse__["a" /* FileReplaceDataItemListResponse */]({
            ...
            return _this.FileReplaceDataItems;
        });
    };
    FileReplaceDataItemServicesProvider.prototype.PostPutAsync = function (FileReplaceDataItemViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "FileReplaceDataItem";
        else
            sub_url = "FileReplaceDataItem?exec_file_seq={1}&search_data={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, FileReplaceDataItemViewModel.exec_file_seq, FileReplaceDataItemViewModel.search_data);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, FileReplaceDataItemViewModel, mode).map(function (item) {
            _this.FileReplaceDataItem = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileReplaceDataItemResponse__["a" /* FileReplaceDataItemResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.FileReplaceDataItem;
        });
    };
    FileReplaceDataItemServicesProvider.prototype.DeleteAsync = function (exec_file_seq, search_data) {
        var _this = this;
        var sub_url;
        sub_url = "FileReplaceDataItem?exec_file_seq={1}&search_data={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, exec_file_seq, search_data);
    ...
    FileReplaceDataItemServicesProvider.prototype.GetAsync = function (exec_file_seq, search_data) {
        var sub_url;
        sub_url = "FileReplaceDataItem?exec_file_seq={1}&search_data={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, exec_file_seq, search_data);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            return new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileReplaceDataItemResponse__["a" /* FileReplaceDataItemResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
    ...
    FileReplaceDataItemServicesProvider.prototype.GetSqlAsync = function (exec_file_seq, search_data, method) {
        var sub_url;
        sub_url = "FileReplaceDataItem/get_{3}_sql?exec_file_seq={1}&search_data={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, exec_file_seq, search_data, method);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
    ...
    FileReplaceDataItemServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_services__["a" /* ServicesProvider */]])
    ], FileReplaceDataItemServicesProvider);
    return FileReplaceDataItemServicesProvider;
}());

//# sourceMappingURL=file-replace-data-item-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileReplaceDataItemPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_replace_data_item_services_file_replace_data_item_services__ = __webpack_require__(1227);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileReplaceDataItemViewModel__ = __webpack_require__(1047);
 ...
 * Components.
 */
var FileReplaceDataItemPage = /** @class */ (function () {
    function FileReplaceDataItemPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileReplaceDataItemServices, modalCtrl, viewCtrl, TableServices, platform, conf) {
        ...
        this.FileReplaceDataItemServices = FileReplaceDataItemServices;
        ...
        this.File_page = "FileReplaceDataItemTablePage";
    ...
    FileReplaceDataItemPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileReplaceDataItemPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileReplaceDataItemPage.prototype.setPage = function (pageInfo) {
    ...
    FileReplaceDataItemPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileReplaceDataItemPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileReplaceDataItemPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.FileReplaceDataItemServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
    ...
    FileReplaceDataItemPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileReplaceDataItemViewModel__["a" /* FileReplaceDataItemViewModel */]();
        ...
        var modal = this.modalCtrl.create("FileReplaceDataItemAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileReplaceDataItemServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup(_this.title, data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileReplaceDataItemPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}-{1}嗎?", item.exec_file_seq, item.search_data),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileReplaceDataItemServices.DeleteAsync(item.exec_file_seq, item.search_data).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileReplaceDataItemPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileReplaceDataItemServices.GetSqlAsync(item.exec_file_seq, item.search_data, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileReplaceDataItemPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileReplaceDataItemPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_replace_data_item_services_file_replace_data_item_services__["a" /* FileReplaceDataItemServicesProvider */],
    ...
    ], FileReplaceDataItemPage);
    return FileReplaceDataItemPage;
}());

//# sourceMappingURL=file-replace-data-item.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileReplaceDataItemListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileReplaceDataItemViewModel__ = __webpack_require__(1047);
...
var FileReplaceDataItemListResponse = /** @class */ (function (_super) {
    __extends(FileReplaceDataItemListResponse, _super);
    function FileReplaceDataItemListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileReplaceDataItemViewModel__["a" /* FileReplaceDataItemViewModel */]();
    ...
    return FileReplaceDataItemListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=FileReplaceDataItemListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileReplaceDataItemResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileReplaceDataItemViewModel__ = __webpack_require__(1047);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var FileReplaceDataItemResponse = /** @class */ (function (_super) {
    __extends(FileReplaceDataItemResponse, _super);
    function FileReplaceDataItemResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileReplaceDataItemViewModel__["a" /* FileReplaceDataItemViewModel */]();
    ...
    return FileReplaceDataItemResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=FileReplaceDataItemResponse.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_replace_data_item__ = __webpack_require__(1477);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_replace_data_item_services_file_replace_data_item_services__ = __webpack_require__(1227);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileReplaceDataItemPageModule = /** @class */ (function () {
    function FileReplaceDataItemPageModule() {
    }
    FileReplaceDataItemPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_replace_data_item__["a" /* FileReplaceDataItemPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_replace_data_item_services_file_replace_data_item_services__["a" /* FileReplaceDataItemServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_replace_data_item__["a" /* FileReplaceDataItemPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileReplaceDataItemPageModule);
    return FileReplaceDataItemPageModule;
}());

//# sourceMappingURL=file-replace-data-item.module.js.map
