...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FilePdf2ImageListResponse__ = __webpack_require__(1159);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FilePdf2ImageResponse__ = __webpack_require__(1160);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FilePdf2ImageViewModel__ = __webpack_require__(975);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FilePdf2ImageViewModel__ = __webpack_require__(975);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FilePdf2ImagePage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_pdf2_image_services_file_pdf2_image_services__ = __webpack_require__(1045);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FilePdf2ImageViewModel__ = __webpack_require__(975);
 ...
 * Components.
 */
var FilePdf2ImagePage = /** @class */ (function () {
    function FilePdf2ImagePage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FilePdf2ImageServices, modalCtrl, viewCtrl, TableServices, runjobServices, platform, conf) {
        ...
        this.File_page = "FilePdf2ImageTablePage";
    ...
    FilePdf2ImagePage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
    ...
    FilePdf2ImagePage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
    ...
    FilePdf2ImagePage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FilePdf2ImagePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FilePdf2ImagePage.prototype.setPage = function (pageInfo) {
    ...
    FilePdf2ImagePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FilePdf2ImagePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FilePdf2ImagePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FilePdf2ImageServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FilePdf2ImagePage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FilePdf2ImageViewModel__["a" /* FilePdf2ImageViewModel */]();
            item.empty_file_check_flag = false;
            item.file_proc_key = "018|1";
            item.file_proc = "不動作";
            item.file_min_length = 0;
            item.file_max_length = 50;
            item.file_keyword = "*.pdf";
            item.is_active = true;
            item.is_fail_stop = true;
            item.parameter_column_group = "001";
            item.can_rerun = true;
            item.recursive = false;
            item.convert_to_filename = "";
            item.page_index = 0;
            item.scale = 1;
            item.file_func_proc_key = "060|PPNG";
            item.file_func_proc = "PDF轉換至PNG";
        }
        else {
            this.mode = "PUT";
            if (change_mode === "c")
        ...
        var modal = this.modalCtrl.create("FilePdf2ImageAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FilePdf2ImageServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("PDF轉影像檔", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FilePdf2ImagePage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FilePdf2ImageServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FilePdf2ImagePage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FilePdf2ImageServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FilePdf2ImagePage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FilePdf2ImagePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_pdf2_image_services_file_pdf2_image_services__["a" /* FilePdf2ImageServicesProvider */],
    ...
    return FilePdf2ImagePage;
}());

//# sourceMappingURL=file-pdf2-image.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FilePdf2ImagePageModule", function() { return FilePdf2ImagePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_pdf2_image__ = __webpack_require__(1475);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_pdf2_image_services_file_pdf2_image_services__ = __webpack_require__(1045);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FilePdf2ImagePageModule = /** @class */ (function () {
    function FilePdf2ImagePageModule() {
    }
    FilePdf2ImagePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_pdf2_image__["a" /* FilePdf2ImagePage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_pdf2_image_services_file_pdf2_image_services__["a" /* FilePdf2ImageServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_pdf2_image__["a" /* FilePdf2ImagePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FilePdf2ImagePageModule);
    return FilePdf2ImagePageModule;
}());

//# sourceMappingURL=file-pdf2-image.module.js.map
