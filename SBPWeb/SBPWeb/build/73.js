...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileManagementAllViewModel; });
...
var FileManagementAllViewModel = /** @class */ (function (_super) {
    __extends(FileManagementAllViewModel, _super);
    function FileManagementAllViewModel() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return FileManagementAllViewModel;
}(__WEBPACK_IMPORTED_MODULE_0__FileManagementViewModel__["a" /* FileManagementViewModel */]));

//# sourceMappingURL=FileManagementAllViewModel.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileManagementAllServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileManagementAllListResponse__ = __webpack_require__(1464);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileManagementAllResponse__ = __webpack_require__(1465);
...
/*
  Generated class for the FileManagementAllServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var FileManagementAllServicesProvider = /** @class */ (function (_super) {
    __extends(FileManagementAllServicesProvider, _super);
    function FileManagementAllServicesProvider(Services) {
        var _this = _super.call(this, Services) || this;
        _this.Services = Services;
        _this.ctl = "FileManagementAll";
        console.log("Hello FileManagementAllServiceProvider Provider");
        return _this;
    }
    FileManagementAllServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, exec_group, exec_file_seq, order_type) {
        var _this = this;
        var sub_url;
        if (exec_file_seq === 0) {
            sub_url = "FileManagementAll?PageSize={1}&PageNumber={2}&keyword={3}&exec_group={4}&order_type={5}";
            ...
            sub_url = "FileManagementAll?PageSize={1}&PageNumber={2}&keyword={3}&exec_group={4}&exec_file_seq={5}&order_type={6}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.FileManagementAlls = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileManagementAllListResponse__["a" /* FileManagementAllListResponse */]({
            ...
            return _this.FileManagementAlls;
        });
    };
    FileManagementAllServicesProvider.prototype.PostPutAsync = function (controller, data, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = controller;
        ...
        return this.Services.PostPutAsync(sub_url, this.ctl, true, data, mode).map(function (item) {
            _this.FileManagementAll = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileManagementAllResponse__["a" /* FileManagementAllResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.FileManagementAll;
        });
    };
    FileManagementAllServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_services__["a" /* ServicesProvider */]])
    ], FileManagementAllServicesProvider);
    return FileManagementAllServicesProvider;
}(__WEBPACK_IMPORTED_MODULE_5__file_services_file_services__["a" /* FileServicesProvider */]));

//# sourceMappingURL=file-management-all-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileManagementAllPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_management_all_services_file_management_all_services__ = __webpack_require__(1223);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileManagementAllViewModel__ = __webpack_require__(1158);
 ...
 * Components.
 */
var FileManagementAllPage = /** @class */ (function () {
    function FileManagementAllPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileManagementAllServices, modalCtrl, viewCtrl, TableServices, platform, conf) {
        ...
        this.FileManagementAllServices = FileManagementAllServices;
        ...
        this.File_page = "FileManagementAllTablePage";
    ...
    FileManagementAllPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileManagementAllPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
        console.log("Select Event", selected, this.selected);
    };
    FileManagementAllPage.prototype.setPage = function (pageInfo) {
    ...
    FileManagementAllPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileManagementAllPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileManagementAllPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.FileManagementAllServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
    ...
    FileManagementAllPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileManagementAllViewModel__["a" /* FileManagementAllViewModel */]();
            item.is_active = true;
        ...
        if (item.func_sub_type === 1)
            page = "FileBackupManagementAddEditModalPage";
        ...
        if (item.func_sub_type === 5)
            page = "FilePdf2ImageAddEditModalPage";
        if (item.func_sub_type === 6)
            page = "FileFilterAddEditModalPage";
        if (item.func_sub_type === 7)
            page = "FileReplaceDataAddEditModalPage";
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                ...
                if (item.func_sub_type === 2)
                    controller = "FileCopy";
                if (item.func_sub_type === 3)
                    controller = "FileCodePage";
                if (item.func_sub_type === 4)
                    controller = "FileImage";
                if (item.func_sub_type === 5)
                    controller = "FilePdf2Image";
                if (item.func_sub_type === 6)
                    controller = "FileFilter";
                if (item.func_sub_type === 7)
                    controller = "FileReplaceData";
                _this.FileManagementAllServices.PostPutAsync(controller, select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("檔案管理", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileManagementAllPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileManagementAllServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                _this.global.dismissLoading();
                                if (data.DidError === false) {
    ...
    FileManagementAllPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileManagementAllServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileManagementAllPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileManagementAllPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_management_all_services_file_management_all_services__["a" /* FileManagementAllServicesProvider */],
    ...
    ], FileManagementAllPage);
    return FileManagementAllPage;
}());

//# sourceMappingURL=file-management-all.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileManagementAllListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileManagementAllViewModel__ = __webpack_require__(1158);
...
var FileManagementAllListResponse = /** @class */ (function (_super) {
    __extends(FileManagementAllListResponse, _super);
    function FileManagementAllListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileManagementAllViewModel__["a" /* FileManagementAllViewModel */]();
                ...
                item.find = data.find;
                item.line_process_flag = data.line_process_flag;
    ...
    return FileManagementAllListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=FileManagementAllListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileManagementAllResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileManagementAllViewModel__ = __webpack_require__(1158);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var FileManagementAllResponse = /** @class */ (function (_super) {
    __extends(FileManagementAllResponse, _super);
    function FileManagementAllResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileManagementAllViewModel__["a" /* FileManagementAllViewModel */]();
    ...
    return FileManagementAllResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=FileManagementAllResponse.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileManagementAllPageModule", function() { return FileManagementAllPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_management_all__ = __webpack_require__(1463);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_management_all_services_file_management_all_services__ = __webpack_require__(1223);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileManagementAllPageModule = /** @class */ (function () {
    function FileManagementAllPageModule() {
    }
    FileManagementAllPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_management_all__["a" /* FileManagementAllPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_management_all_services_file_management_all_services__["a" /* FileManagementAllServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_management_all__["a" /* FileManagementAllPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileManagementAllPageModule);
    return FileManagementAllPageModule;
}());

//# sourceMappingURL=file-management-all.module.js.map
