...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportTablePage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileImportTableViewModel__ = __webpack_require__(973);
 ...
 * Components.
 */
var FileImportTablePage = /** @class */ (function () {
    function FileImportTablePage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileImportTableServices, TableServices, modalCtrl, platform, conf) {
        ...
        this.file_type_key = navParams.data.item.file_type_key;
    ...
    FileImportTablePage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
    };
    FileImportTablePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileImportTablePage.prototype.setPage = function (pageInfo) {
    ...
    FileImportTablePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileImportTablePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileImportTablePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.FileImportTableServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
    ...
    FileImportTablePage.prototype.openNavFileImportBeforeSqlPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push('FileImportBeforeSqlAddEditPage', { item: item });
        });
    };
    FileImportTablePage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileImportTableViewModel__["a" /* FileImportTableViewModel */]();
            item.exec_file_seq = this.exec_file_seq;
            item.db_conn_id = "localdb";
            item.schemaname = "dbo";
            item.import_mode_key = "002|M";
        ...
        var modal = this.modalCtrl.create("FileImportTableAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileImportTableServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    FileImportTablePage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}-{1}嗎?", item.exec_file_seq, item.tablefullname),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileImportTableServices.DeleteAsync(item.exec_file_seq, item.schemaname, item.tablename, item.db_conn_id, item.parameter_column_group).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileImportTablePage.prototype.openNavFileMergeSqlPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.TableServices.GetFileMergeSqlAsync(item.schemaname, item.tablename, item.import_mode_key, item.file_format_key).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileImportTablePage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileImportTableServices.GetSqlAsync(item.exec_file_seq, item.schemaname, item.tablename, item.db_conn_id, item.parameter_column_group, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileImportTablePage.prototype.openNavTableDetailPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileImportTablePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_import_table_services_file_import_table_services__["a" /* FileImportTableServicesProvider */],
    ...
    return FileImportTablePage;
}());

//# sourceMappingURL=file-import-table.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileImportTablePageModule", function() { return FileImportTablePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_import_table__ = __webpack_require__(1461);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_import_table_services_file_import_table_services__ = __webpack_require__(1043);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileImportTablePageModule = /** @class */ (function () {
    function FileImportTablePageModule() {
    }
    FileImportTablePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_import_table__["a" /* FileImportTablePage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_import_table_services_file_import_table_services__["a" /* FileImportTableServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_import_table__["a" /* FileImportTablePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileImportTablePageModule);
    return FileImportTablePageModule;
}());

//# sourceMappingURL=file-import-table.module.js.map
