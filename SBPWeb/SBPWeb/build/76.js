...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportDataSearchReplaceServicesProvider; });
...
/*
  Generated class for the FileImportDataSearchReplaceServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var FileImportDataSearchReplaceServicesProvider = /** @class */ (function () {
    function FileImportDataSearchReplaceServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "FileImportDataSearchReplace";
        console.log("Hello FileImportDataSearchReplaceServiceProvider Provider");
    }
    FileImportDataSearchReplaceServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, schemaname, tablename, columnname, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "FileImportDataSearchReplace?PageSize={1}&PageNumber={2}&keyword={3}&schemaname={4}&tablename={5}&columnname={6}&order_type={7}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.FileImportDataSearchReplaces = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileImportDataSearchReplaceListResponse__["a" /* FileImportDataSearchReplaceListResponse */]({
            ...
            return _this.FileImportDataSearchReplaces;
        });
    };
    FileImportDataSearchReplaceServicesProvider.prototype.PostPutAsync = function (FileImportDataSearchReplaceViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "FileImportDataSearchReplace";
        else
            sub_url = "FileImportDataSearchReplace?schemaname={1}&tablename={2}&columnname={3}&search_value={4}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, FileImportDataSearchReplaceViewModel.schemaname, FileImportDataSearchReplaceViewModel.tablename, FileImportDataSearchReplaceViewModel.columnname, FileImportDataSearchReplaceViewModel.search_value);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, FileImportDataSearchReplaceViewModel, mode).map(function (item) {
            _this.FileImportDataSearchReplace = new __WEBPACK_IMPORTED_MODULE_5__Model_Response_FileImportDataSearchReplaceResponse__["a" /* FileImportDataSearchReplaceResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.FileImportDataSearchReplace;
        });
    };
    FileImportDataSearchReplaceServicesProvider.prototype.DeleteAsync = function (schemaname, tablename, columnname, search_value) {
        var _this = this;
        var sub_url;
        sub_url = "FileImportDataSearchReplace?schemaname={1}&tablename={2}&columnname={3}&search_value={4}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, schemaname, tablename, columnname, search_value);
    ...
    FileImportDataSearchReplaceServicesProvider.prototype.GetSqlAsync = function (schemaname, tablename, columnname, search_value, method) {
        var sub_url;
        sub_url = "FileImportDataSearchReplace/get_{5}_sql?schemaname={1}&tablename={2}&columnname={3}&search_value={4}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, schemaname, tablename, columnname, search_value, method);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
    ...
    FileImportDataSearchReplaceServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_services__["a" /* ServicesProvider */]])
    ], FileImportDataSearchReplaceServicesProvider);
    return FileImportDataSearchReplaceServicesProvider;
}());

//# sourceMappingURL=file-import-data-search-replace-services.js.map
...
var FileImportDataSearchReplacePage = /** @class */ (function () {
    function FileImportDataSearchReplacePage(menuCtrl, navCtrl, navParams, FileImportDataSearchReplaceServices, loadingCtrl, global, authServices, modalCtrl, alertCtrl) {
        this.menuCtrl = menuCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.FileImportDataSearchReplaceServices = FileImportDataSearchReplaceServices;
        ...
        this.CanFileImportDataSearchReplaceExec = true;
        this.detail_page = "FileImportDataSearchReplaceDetailPage";
    ...
    FileImportDataSearchReplacePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
        this.show_title();
    };
    FileImportDataSearchReplacePage.prototype.show_title = function () {
    ...
    FileImportDataSearchReplacePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileImportDataSearchReplacePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.FileImportDataSearchReplaceServices.GetListsByAsync(_this.pageSize, _this.pageNumber, _this.keyword, _this.schemaname, _this.tablename, _this.columnname, _this.order_type).subscribe(function (data) {
    ...
    FileImportDataSearchReplacePage.prototype.openNavSqlPage = function (item, method, is_exec) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileImportDataSearchReplaceServices.GetSqlAsync(item.schemaname, item.tablename, item.columnname, item.search_value, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileImportDataSearchReplacePage.prototype.ShowModal = function (item) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_FileImportDataSearchReplaceViewModel__["a" /* FileImportDataSearchReplaceViewModel */]();
        ...
        var modal = this.modalCtrl.create("FileImportDataSearchReplaceAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileImportDataSearchReplaceServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("搜尋取代", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileImportDataSearchReplacePage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_6__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.search_value),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileImportDataSearchReplaceServices.DeleteAsync(item.schemaname, item.tablename, item.columnname, item.search_value).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileImportDataSearchReplacePage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad FileImportDataSearchReplace");
    };
    __decorate([
    ...
    FileImportDataSearchReplacePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* MenuController */],
            ...
            __WEBPACK_IMPORTED_MODULE_2__providers_file_import_data_search_replace_services_file_import_data_search_replace_services__["a" /* FileImportDataSearchReplaceServicesProvider */],
    ...
    ], FileImportDataSearchReplacePage);
    return FileImportDataSearchReplacePage;
}());

//# sourceMappingURL=file-import-data-search-replace.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportDataSearchReplaceListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileImportDataSearchReplaceViewModel__ = __webpack_require__(1042);
...
var FileImportDataSearchReplaceListResponse = /** @class */ (function (_super) {
    __extends(FileImportDataSearchReplaceListResponse, _super);
    function FileImportDataSearchReplaceListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileImportDataSearchReplaceViewModel__["a" /* FileImportDataSearchReplaceViewModel */]();
                item.schemaname = data.schemaname;
                item.tablename = data.tablename;
                item.columnname = data.columnname;
                item.search_value = data.search_value;
                item.replace_value = (data && data.replace_value) || null;
    ...
    return FileImportDataSearchReplaceListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=FileImportDataSearchReplaceListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportDataSearchReplaceResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileImportDataSearchReplaceViewModel__ = __webpack_require__(1042);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var FileImportDataSearchReplaceResponse = /** @class */ (function (_super) {
    __extends(FileImportDataSearchReplaceResponse, _super);
    function FileImportDataSearchReplaceResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileImportDataSearchReplaceViewModel__["a" /* FileImportDataSearchReplaceViewModel */]();
            ...
            _this.Model.search_value = obj.Model.search_value;
            _this.Model.replace_value = (obj && obj.Model.replace_value) || null;
    ...
    return FileImportDataSearchReplaceResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=FileImportDataSearchReplaceResponse.js.map
...
var FileImportDataSearchReplacePageModule = /** @class */ (function () {
    function FileImportDataSearchReplacePageModule() {
    }
    FileImportDataSearchReplacePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_import_data_search_replace__["a" /* FileImportDataSearchReplacePage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_import_data_search_replace_services_file_import_data_search_replace_services__["a" /* FileImportDataSearchReplaceServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_import_data_search_replace__["a" /* FileImportDataSearchReplacePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileImportDataSearchReplacePageModule);
    return FileImportDataSearchReplacePageModule;
}());

//# sourceMappingURL=file-import-data-search-replace.module.js.map
