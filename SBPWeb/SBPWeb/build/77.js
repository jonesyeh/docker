...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportDataLookupServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileImportDataLookupListResponse__ = __webpack_require__(1446);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_Response_FileImportDataLookupResponse__ = __webpack_require__(1447);
...
/*
  Generated class for the FileImportDataLookupServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var FileImportDataLookupServicesProvider = /** @class */ (function () {
    function FileImportDataLookupServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "FileImportDataLookup";
        console.log("Hello FileImportDataLookupServiceProvider Provider");
    }
    FileImportDataLookupServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, schemaname, tablename, columnname, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "FileImportDataLookup?PageSize={1}&PageNumber={2}&keyword={3}&schemaname={4}&tablename={5}&columnname={6}&order_type={7}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, PageSize, PageNumber, keyword, schemaname, tablename, columnname, order_type);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.FileImportDataLookups = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileImportDataLookupListResponse__["a" /* FileImportDataLookupListResponse */]({
            ...
            return _this.FileImportDataLookups;
        });
    };
    FileImportDataLookupServicesProvider.prototype.PostPutAsync = function (FileImportDataLookupViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "FileImportDataLookup";
        else
            sub_url = "FileImportDataLookup?schemaname={1}&tablename={2}&columnname={3}&lookup_src={4}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, FileImportDataLookupViewModel.schemaname, FileImportDataLookupViewModel.tablename, FileImportDataLookupViewModel.columnname, FileImportDataLookupViewModel.lookup_src);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, FileImportDataLookupViewModel, mode).map(function (item) {
            _this.FileImportDataLookup = new __WEBPACK_IMPORTED_MODULE_5__Model_Response_FileImportDataLookupResponse__["a" /* FileImportDataLookupResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.FileImportDataLookup;
        });
    };
    FileImportDataLookupServicesProvider.prototype.DeleteAsync = function (schemaname, tablename, columnname, lookup_src) {
        var _this = this;
        var sub_url;
        sub_url = "FileImportDataLookup?schemaname={1}&tablename={2}&columnname={3}&lookup_src={4}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, schemaname, tablename, columnname, lookup_src);
    ...
    FileImportDataLookupServicesProvider.prototype.GetSqlAsync = function (schemaname, tablename, columnname, lookup_src, method) {
        var sub_url;
        sub_url = "FileImportDataLookup/get_{5}_sql?schemaname={1}&tablename={2}&columnname={3}&lookup_src={4}";
        sub_url = __WEBPACK_IMPORTED_MODULE_1__Model_String__["a" /* String */].Format(sub_url, this.ctl, schemaname, tablename, columnname, lookup_src, method);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
    ...
    FileImportDataLookupServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_services__["a" /* ServicesProvider */]])
    ], FileImportDataLookupServicesProvider);
    return FileImportDataLookupServicesProvider;
}());

//# sourceMappingURL=file-import-data-lookup-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportDataLookupPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_file_import_data_lookup_services_file_import_data_lookup_services__ = __webpack_require__(1220);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_FileImportDataLookupViewModel__ = __webpack_require__(1041);
...
var FileImportDataLookupPage = /** @class */ (function () {
    function FileImportDataLookupPage(menuCtrl, navCtrl, navParams, FileImportDataLookupServices, loadingCtrl, global, authServices, modalCtrl, alertCtrl) {
        this.menuCtrl = menuCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.FileImportDataLookupServices = FileImportDataLookupServices;
        this.loadingCtrl = loadingCtrl;
        this.global = global;
        this.authServices = authServices;
        this.modalCtrl = modalCtrl;
        this.alertCtrl = alertCtrl;
        this.title_min_width = 425;
        this.data_list = [];
        this.keyword = "";
        this.pageNumber = 1;
        this.pageSize = 24;
        ...
        this.CanFileImportDataLookupExec = true;
        this.detail_page = "FileImportDataLookupDetailPage";
        ...
        this.columnname = navParams.data.item.columnname;
        this.subject = __WEBPACK_IMPORTED_MODULE_6__Model_String__["a" /* String */].Format("{0}", this.columnname);
    ...
    FileImportDataLookupPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
        this.show_title();
    };
    FileImportDataLookupPage.prototype.show_title = function () {
        if (this.innerWidth <= this.title_min_width) {
            this.title = "查閱取代";
        }
        else
            this.title = "完整字串查閱取代";
    };
    FileImportDataLookupPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileImportDataLookupPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.FileImportDataLookupServices.GetListsByAsync(_this.pageSize, _this.pageNumber, _this.keyword, _this.schemaname, _this.tablename, _this.columnname, _this.order_type).subscribe(function (data) {
    ...
    FileImportDataLookupPage.prototype.openNavSqlPage = function (item, method, is_exec) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileImportDataLookupServices.GetSqlAsync(item.schemaname, item.tablename, item.columnname, item.lookup_src, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileImportDataLookupPage.prototype.ShowModal = function (item) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_5__Model_ViewModel_FileImportDataLookupViewModel__["a" /* FileImportDataLookupViewModel */]();
        ...
        var modal = this.modalCtrl.create("FileImportDataLookupAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileImportDataLookupServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("欄位替換", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileImportDataLookupPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_6__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.lookup_src),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileImportDataLookupServices.DeleteAsync(item.schemaname, item.tablename, item.columnname, item.lookup_src).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileImportDataLookupPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad FileImportDataLookup");
    };
    __decorate([
    ...
    ], FileImportDataLookupPage);
    return FileImportDataLookupPage;
}());

//# sourceMappingURL=file-import-data-lookup.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportDataLookupListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileImportDataLookupViewModel__ = __webpack_require__(1041);
...
var FileImportDataLookupListResponse = /** @class */ (function (_super) {
    __extends(FileImportDataLookupListResponse, _super);
    function FileImportDataLookupListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileImportDataLookupViewModel__["a" /* FileImportDataLookupViewModel */]();
                item.schemaname = data.schemaname;
                item.tablename = data.tablename;
                item.columnname = data.columnname;
                item.lookup_src = data.lookup_src;
                item.lookup_result = data.lookup_result;
    ...
    return FileImportDataLookupListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=FileImportDataLookupListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImportDataLookupResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileImportDataLookupViewModel__ = __webpack_require__(1041);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var FileImportDataLookupResponse = /** @class */ (function (_super) {
    __extends(FileImportDataLookupResponse, _super);
    function FileImportDataLookupResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileImportDataLookupViewModel__["a" /* FileImportDataLookupViewModel */]();
            ...
            _this.Model.lookup_src = obj.Model.lookup_src;
            _this.Model.lookup_result = obj.Model.lookup_result;
    ...
    return FileImportDataLookupResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=FileImportDataLookupResponse.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileImportDataLookupPageModule", function() { return FileImportDataLookupPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_import_data_lookup__ = __webpack_require__(1445);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_import_data_lookup_services_file_import_data_lookup_services__ = __webpack_require__(1220);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileImportDataLookupPageModule = /** @class */ (function () {
    function FileImportDataLookupPageModule() {
    }
    FileImportDataLookupPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_import_data_lookup__["a" /* FileImportDataLookupPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_import_data_lookup_services_file_import_data_lookup_services__["a" /* FileImportDataLookupServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_import_data_lookup__["a" /* FileImportDataLookupPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileImportDataLookupPageModule);
    return FileImportDataLookupPageModule;
}());

//# sourceMappingURL=file-import-data-lookup.module.js.map
