...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileImageListResponse__ = __webpack_require__(1152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileImageResponse__ = __webpack_require__(1153);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileImageViewModel__ = __webpack_require__(969);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileImageViewModel__ = __webpack_require__(969);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileImagePage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_image_services_file_image_services__ = __webpack_require__(1039);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileImageViewModel__ = __webpack_require__(969);
 ...
 * Components.
 */
var FileImagePage = /** @class */ (function () {
    function FileImagePage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileImageServices, modalCtrl, viewCtrl, TableServices, runjobServices, platform, conf) {
        ...
        this.File_page = "FileImageTablePage";
    ...
    FileImagePage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
    ...
    FileImagePage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
    ...
    FileImagePage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileImagePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileImagePage.prototype.setPage = function (pageInfo) {
    ...
    FileImagePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileImagePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileImagePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileImageServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileImagePage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileImageViewModel__["a" /* FileImageViewModel */]();
            ...
            item.height = 600;
            item.quality = 100;
            item.file_func_proc_key = "060|IPNG";
            item.file_func_proc = "影像檔轉換至PNG";
        }
        else {
            this.mode = "PUT";
            if (change_mode === "c")
        ...
        var modal = this.modalCtrl.create("FileImageAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileImageServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("影像檔轉換", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileImagePage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileImageServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileImagePage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileImageServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileImagePage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileImagePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_image_services_file_image_services__["a" /* FileImageServicesProvider */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_image__ = __webpack_require__(1431);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_image_services_file_image_services__ = __webpack_require__(1039);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileImagePageModule = /** @class */ (function () {
    function FileImagePageModule() {
    }
    FileImagePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_image__["a" /* FileImagePage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_image_services_file_image_services__["a" /* FileImageServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_image__["a" /* FileImagePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileImagePageModule);
    return FileImagePageModule;
}());

//# sourceMappingURL=file-image.module.js.map
