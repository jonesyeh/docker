...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DirectoryBrowserComponentsModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__directory_browser_directory_browser__ = __webpack_require__(1014);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__file_browser_file_browser__ = __webpack_require__(1015);
...
var DirectoryBrowserComponentsModule = /** @class */ (function () {
    function DirectoryBrowserComponentsModule() {
    }
    DirectoryBrowserComponentsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__directory_browser_directory_browser__["a" /* DirectoryBrowserComponent */],
                __WEBPACK_IMPORTED_MODULE_4__file_browser_file_browser__["a" /* FileBrowserComponent */],
            ],
    ...
    ], DirectoryBrowserComponentsModule);
    return DirectoryBrowserComponentsModule;
}());

//# sourceMappingURL=directory-browser.components.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DirectoryBrowserComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_directory_browser_services_directory_browser_services__ = __webpack_require__(286);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_global_global__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_ViewModel_DirectoryBrowserViewModel__ = __webpack_require__(130);
...
var DirectoryBrowserComponent = /** @class */ (function () {
    function DirectoryBrowserComponent(menuCtrl, navCtrl, navParams, DirectoryBrowserServices, loadingCtrl, global, modalCtrl, alertCtrl, FilePathServices, authServices, platform, conf) {
        this.menuCtrl = menuCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.DirectoryBrowserServices = DirectoryBrowserServices;
        ...
        this.has_file = false;
        this.has_file_color = "primary";
        this.file_cnt = 0;
        this.is_modal = false;
        this.show_select_type = "D"; //D:Direcotry,F:File
        this.show_select = false;
        this.onDirectorySelect = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        this.onFile = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
    ...
    DirectoryBrowserComponent.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
        this.limit = Math.floor(this.pageSize / 3);
        if (this.authServices.authenticated() === true) {
            this.CanEditFileBrowser = this.authServices.CanEditFileBrowser();
            if (this.parent_path != "") {
                this.LoadData(true);
            }
            else
    ...
    DirectoryBrowserComponent.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    DirectoryBrowserComponent.prototype.setPage = function (pageInfo) {
    ...
    DirectoryBrowserComponent.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    DirectoryBrowserComponent.prototype.doInfinite = function () {
        var _this = this;
    ...
    DirectoryBrowserComponent.prototype.add = function (filepath) {
        var item = new __WEBPACK_IMPORTED_MODULE_4__Model_ViewModel_DirectoryBrowserViewModel__["a" /* DirectoryBrowserViewModel */]();
        item.filepath = filepath;
        this.onDirectorySelect.emit(item);
    };
    DirectoryBrowserComponent.prototype.close = function () {
        this.onDirectorySelect.emit(null);
    };
    DirectoryBrowserComponent.prototype.get_default_path = function () {
        var _this = this;
        this.global.createLoader("取得預設資料夾中...");
        this.global.loading.present().then(function () {
            _this.FilePathServices.GetPathAsync("004|BK").subscribe(function (data) {
    ...
    DirectoryBrowserComponent.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.DirectoryBrowserServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.parent_path, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    DirectoryBrowserComponent.prototype.CheckHasFile = function () {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.DirectoryBrowserServices.GetAsync(_this.parent_path).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
                else {
                    _this.has_file = data.Model.has_file;
                    _this.has_file_color = data.Model.has_file_color;
                    _this.file_cnt = data.Model.file_cnt;
                    _this.global.dismissLoading();
                }
            }, function (err) {
                _this.global.dismissLoading();
    ...
    DirectoryBrowserComponent.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_4__Model_ViewModel_DirectoryBrowserViewModel__["a" /* DirectoryBrowserViewModel */]();
        ...
        var modal = this.modalCtrl.create("DirectoryBrowserAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.DirectoryBrowserServices.PostPutAsync(item.filepath, select_data, _this.mode).subscribe(function (data) {
    ...
    DirectoryBrowserComponent.prototype.back = function () {
        try {
    ...
    DirectoryBrowserComponent.prototype.openNavPage = function (page, parent_path) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(page, { parent_path: parent_path, parent_page: _this, is_modal: _this.is_modal });
        });
    };
    DirectoryBrowserComponent.prototype.openNavDirectorySelectPage = function (parent_path) {
        this.parent_path = parent_path;
        this.LoadData(true);
    };
    DirectoryBrowserComponent.prototype.openNavFileSelectPage = function () {
        this.onFile.emit(this.parent_path);
    };
    DirectoryBrowserComponent.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.DirectoryBrowserServices.DeleteAsync(item.filepath).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    return DirectoryBrowserComponent;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_file_browser_services_file_browser_services__ = __webpack_require__(287);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_global_global__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_ViewModel_DirectoryBrowserViewModel__ = __webpack_require__(130);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_String__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_file_path_services_file_path_services__ = __webpack_require__(267);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_auth_services_auth_services__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_file_saver__ = __webpack_require__(940);
...
var FileBrowserComponent = /** @class */ (function () {
    function FileBrowserComponent(menuCtrl, navCtrl, navParams, FileBrowserServices, loadingCtrl, global, modalCtrl, alertCtrl, FilePathServices, authServices, platform, conf) {
        this.menuCtrl = menuCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.FileBrowserServices = FileBrowserServices;
        this.loadingCtrl = loadingCtrl;
        this.global = global;
        this.modalCtrl = modalCtrl;
        this.alertCtrl = alertCtrl;
    ...
    FileBrowserComponent.prototype.ngOnInit = function () {
        if (this.authServices.authenticated() === true) {
            ...
            this.limit = Math.floor(this.pageSize / 3);
            this.CanEditFileBrowser = this.authServices.CanEditFileBrowser();
            this.CanDownloadFileBrowser = this.authServices.CanDownloadFileBrowser();
            this.CanUploadFtpFileBrowser = this.authServices.CanUploadFtpFileBrowser();
            this.CanDownloadFtpFileBrowser = this.authServices.CanDownloadFtpFileBrowser();
            this.CanUploadFileBrowser = this.authServices.CanUploadFileBrowser();
            if (this.parent_path > "") {
                this.LoadData(true);
            }
            else
    ...
    FileBrowserComponent.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileBrowserComponent.prototype.setPage = function (pageInfo) {
        this.pageNumber = Math.floor(pageInfo.offset / 3) + 1;
        if ((pageInfo.offset + 1) % 3 === 0) {
            if ((pageInfo.offset + 1) / 3 + 1 > this.loadPages) {
                this.loadPageNumber = this.pageNumber + 1;
    ...
    FileBrowserComponent.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileBrowserComponent.prototype.doInfinite = function () {
        var _this = this;
        console.log("Begin async operation");
        if (this.loadPages < this.totalPages) {
            this.pageNumber++;
    ...
    FileBrowserComponent.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        this.mode = "Rename";
        if (change_mode === "c") {
            this.mode = "Copy";
        }
        var modal = this.modalCtrl.create("FileBrowserCopyEditModalPage", {
            mode: this.mode,
            item: item,
            change_mode: change_mode,
            CanEditFileBrowser: this.CanEditFileBrowser
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.createLoader();
            _this.global.loading.present().then(function () {
                _this.FileBrowserServices.PutAsync(item.filefullname, select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
    ...
    FileBrowserComponent.prototype.add = function (item) {
        this.onSelect.emit(item);
    };
    FileBrowserComponent.prototype.close = function () {
        this.onSelect.emit(null);
    };
    FileBrowserComponent.prototype.get_default_path = function () {
        var _this = this;
        this.global.createLoader("取得預設資料夾中...");
        this.global.loading.present().then(function () {
            _this.FilePathServices.GetPathAsync("004|BK").subscribe(function (data) {
    ...
    FileBrowserComponent.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileBrowserServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.parent_path, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileBrowserComponent.prototype.ftp_Upload = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push("FtpFileBrowserUploadPage", { upload_file: item, parent_page: _this });
        });
    };
    FileBrowserComponent.prototype.ftp_download = function () {
        var _this = this;
        var Directory = new __WEBPACK_IMPORTED_MODULE_4__Model_ViewModel_DirectoryBrowserViewModel__["a" /* DirectoryBrowserViewModel */]();
        Directory.filepath = this.parent_path;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push("FtpFileBrowserDownloadPage", { Directory: Directory, parent_page: _this });
        });
    };
    FileBrowserComponent.prototype.onChange = function (event) {
        var _this = this;
        var file = event.srcElement.files[0];
        var formData = new FormData();
        formData.append('file', file, file.name);
        formData.append("filepath", this.parent_path);
        this.global.createLoader("檔案上傳中...");
        this.global.loading.present().then(function () {
            _this.FileBrowserServices.upload(formData).subscribe(function (data) {
                _this.LoadData(true);
                _this.parent_page.CheckHasFile();
                _this.global.dismissLoading();
                _this.global.showMessage("上傳", "上傳成功");
            }, function (error) {
                _this.global.dismissLoading();
                console.log(error);
    ...
    FileBrowserComponent.prototype.download = function (item) {
        var _this = this;
        this.global.createLoader("檔案下載中...");
        this.global.loading.present().then(function () {
            _this.FileBrowserServices.download(item.filefullname).subscribe(function (data) {
                _this.global.dismissLoading();
                __WEBPACK_IMPORTED_MODULE_8_file_saver__["saveAs"](data, item.filename);
            }, function (error) {
                _this.global.dismissLoading();
                console.log(error);
                _this.global.showError(error);
    ...
    FileBrowserComponent.prototype.back = function () {
        this.navCtrl.pop();
    };
    FileBrowserComponent.prototype.openNavPage = function (page, parent_path) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileBrowserComponent.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileBrowserServices.DeleteAsync(item.filefullname).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
                                    _this.global.showPopup("刪除", data.Message);
    ...
    FileBrowserComponent.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad FileBrowser");
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Boolean)
    ], FileBrowserComponent.prototype, "is_modal", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Object)
    ], FileBrowserComponent.prototype, "parent_page", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */])
    ], FileBrowserComponent.prototype, "parent_path", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Boolean)
    ], FileBrowserComponent.prototype, "show_select", void 0);
    FileBrowserComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "FileBrowserComponent",
            outputs: ['onSelect', 'onDirectory'],template:/*ion-inline-start:"C:\jones\ionic\prod\src\components\file-browser\file-browser.html"*/'<ion-content (window:resize)="onResize($event)">\n  <ion-row>\n    <ion-col col-12>\n      <ion-searchbar [ngClass]="[\'search\']" (keyup.enter)="LoadData(true)" placeholder="檔案名稱包含" [(ngModel)]="keyword">\n      </ion-searchbar>\n    </ion-col>\n  </ion-row>\n  <ion-grid>\n    <ion-row>\n      <ion-col col-12 col-sm-2 col-md-3>\n      </ion-col>\n      <ion-col col-12 col-sm-8 col-md-6>\n        <ion-grid [ngClass]="[\'subject\']">\n          <ion-row>\n            <ion-col>\n              <b>{{parent_path}}</b>\n            </ion-col>\n          </ion-row>\n\n        </ion-grid>\n      </ion-col>\n      <ion-col col-12 col-sm-2 col-md-3>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n  <ion-grid *ngIf="conf.mobile_mode==false && selectedItem!=null" [ngClass]="\'bordered\'">\n    <ion-row>\n      <ion-col>\n        <button small title="變更" ion-button color="light" icon-left (click)="ShowModal(selectedItem)">\n          <ion-icon name="create"></ion-icon>\n        </button>\n        <button small title="複製" ion-button color="light" icon-left (click)="ShowModal(selectedItem,\'c\')">\n          <ion-icon name="copy"></ion-icon>\n        </button>\n        <button small title="下載" *ngIf="CanDownloadFileBrowser==true && is_app==false" ion-button color="light" icon-left (click)="download(selectedItem)">\n          <ion-icon name="download"></ion-icon>\n        </button>\n        <button small title="上傳至Ftp" *ngIf="CanUploadFtpFileBrowser==true" ion-button color="light" icon-left (click)="ftp_Upload(selectedItem)">\n          <ion-icon name="cloud-upload"></ion-icon>\n        </button>\n\n        <button small title="刪除" ion-button color="dark" icon-left (click)="Delete(selectedItem)">\n          <ion-icon name="trash"></ion-icon>\n        </button>\n        <button small title="加入" *ngIf="show_select==true" ion-button color="danger" icon-left (click)="add(selectedItem)">\n          <ion-icon name="checkmark-circle"></ion-icon>\n        </button>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n  <ngx-datatable NgxResizeWatcher class="bootstrap" *ngIf="totalRows>0 && conf.mobile_mode==false" [selected]="selected" [selectionType]="\'single\'"\n    (select)=\'onRowSelect($event)\'   [rows]="data_list" [columnMode]="\'flex\'" [headerHeight]="40" [rowHeight]="\'auto\'" [footerHeight]="40"\n    [reorderable]=false [limit]="limit" [count]="totalRows" [offset]="offset" (page)=\'setPage($event)\'>\n\n    <ngx-datatable-column prop="filename" name="檔案名稱" [flexGrow]="1" [frozenLeft]="true">\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="file_size_desc" name="檔案容量" [flexGrow]="1" [frozenLeft]="true">\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="create_time" name="建立時間" [flexGrow]="2" *ngIf="innerWidth>=1024">\n      <ng-template let-value="value" ngx-datatable-cell-template>\n        <div *ngIf="platform.is(\'ios\')==true">\n          {{value | date:\'y/MM/dd HH:mm:ss \'}}\n        </div>\n        <div *ngIf="platform.is(\'ios\')!=true">\n          {{value | date:\'y/MM/dd HH:mm:ss\'}}\n        </div>\n      </ng-template>\n\n    </ngx-datatable-column>\n\n  </ngx-datatable>\n  <div *ngIf="totalRows>0 && conf.mobile_mode==true">\n    <ion-row>\n      <ion-col col-lg-4 col-md-6 col-sm-6 col-12 *ngFor="let item of data_list">\n        <ion-grid [ngClass]="[\'bordered\']">\n\n          <ion-row>\n            <ion-col>\n              <button small title="變更" ion-button color="light" icon-left (click)="ShowModal(item)">\n                <ion-icon name="create"></ion-icon>\n              </button>\n              <button small title="複製" ion-button color="light" icon-left (click)="ShowModal(item,\'c\')">\n                <ion-icon name="copy"></ion-icon>\n              </button>\n              <button small title="下載" *ngIf="CanDownloadFileBrowser==true && is_app==false" ion-button color="light" icon-left (click)="download(item)">\n                <ion-icon name="download"></ion-icon>\n              </button>\n              <button small title="上傳至Ftp" *ngIf="CanUploadFtpFileBrowser==true" ion-button color="light" icon-left (click)="ftp_Upload(item)">\n                <ion-icon name="cloud-upload"></ion-icon>\n              </button>\n\n              <button small title="刪除" ion-button color="dark" icon-left (click)="Delete(item)">\n                <ion-icon name="trash"></ion-icon>\n              </button>\n              <button small title="加入" *ngIf="show_select==true" ion-button color="danger" icon-left (click)="add(item)">\n                <ion-icon name="checkmark-circle"></ion-icon>\n              </button>\n            </ion-col>\n          </ion-row>\n\n          <ion-row>\n            <ion-col>\n              {{item.filename}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              {{item.file_size_desc}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col>\n              {{item.create_time | date:\'short\'}}\n\n            </ion-col>\n          </ion-row>\n\n\n        </ion-grid>\n      </ion-col>\n    </ion-row>\n  </div>\n  <ion-infinite-scroll *ngIf="pageNumber < totalPages && conf.mobile_mode==true" (ionInfinite)="$event.waitFor(doInfinite())">\n    <ion-infinite-scroll-content loadingSpinner="bubbles">\n    </ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n</ion-content>\n<ion-footer>\n  <ion-toolbar>\n    <ion-row>\n      <ion-col>\n        <div [ngClass]="[\'command\']">\n          <button small title="重新整理" ion-button color="dark" icon-left (click)="LoadData(true)">\n            <ion-checkbox name="order_type" title="遞增/遞減" color="dark" [(ngModel)]="order_type" (ionChange)="LoadData(true)"></ion-checkbox>\n            <ion-icon name="refresh"></ion-icon>\n          </button>\n          <button small title="返回" *ngIf="navCtrl.canGoBack() && show_select==false" ion-button color="dark" icon-left (click)="back()">\n            <ion-icon name="backspace"></ion-icon>\n          </button>\n          <button small title="取消" *ngIf="show_select==true" ion-button color="dark" icon-left (click)="close()">\n            <ion-icon name="backspace"></ion-icon>\n          </button>\n          <input hidden type="file" id="fileInput" (change)="onChange($event)">\n          <label small color="light" title="上傳" for="fileInput" icon-only ion-button>\n            <ion-icon name="cloud-upload"></ion-icon>\n          </label>\n          <button small title="從Ftp下載" *ngIf="CanDownloadFtpFileBrowser==true" ion-button color="light" icon-left (click)="ftp_download()">\n            <ion-icon name="download"></ion-icon>\n          </button>\n        </div>\n        <StatusComponent [pageNumber]="pageNumber" [totalPages]="totalPages" [totalRows]="totalRows"></StatusComponent>\n      </ion-col>\n\n    </ion-row>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\components\file-browser\file-browser.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* MenuController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__providers_file_browser_services_file_browser_services__["a" /* FileBrowserServicesProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* LoadingController */],
            __WEBPACK_IMPORTED_MODULE_3__components_global_global__["a" /* GlobalComponent */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* ModalController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */],
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DirectoryBrowserSelectModalPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
 ...
 */
var DirectoryBrowserSelectModalPage = /** @class */ (function () {
    function DirectoryBrowserSelectModalPage(navCtrl, navParams, viewCtrl, modalCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    ...
    DirectoryBrowserSelectModalPage.prototype.onDirSelect = function (item) {
        this.viewCtrl.dismiss(item);
    };
    DirectoryBrowserSelectModalPage.prototype.onFileSelect = function (item) {
        this.viewCtrl.dismiss(item);
    };
    DirectoryBrowserSelectModalPage.prototype.onFile = function (parent_path) {
        this.select_mode = "file";
        this.parent_path = parent_path;
    };
    DirectoryBrowserSelectModalPage.prototype.onDirectory = function () {
        this.select_mode = "Directory";
    };
    DirectoryBrowserSelectModalPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad DirectoryBrowserSelectModalPage');
    };
    DirectoryBrowserSelectModalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-directory-browser-select-modal',template:/*ion-inline-start:"C:\jones\ionic\prod\src\pages\directory-browser-select-modal\directory-browser-select-modal.html"*/'<DirectoryBrowserComponent [title]="\'資料夾\'" *ngIf="select_mode!=\'file\'" (onFile)="onFile($event)" (onDirectorySelect)="onDirSelect($event)" [is_modal]=true [parent_path]="parent_path" [parent_page]="parent_page"  [show_select]=true [show_select_type]="show_select_type" ></DirectoryBrowserComponent>\n<FileBrowserComponent [title]="\'檔案\'" *ngIf="show_select_type==\'F\' && select_mode==\'file\'" (onDirectory)="onDirectory($event)" (onSelect)="onFileSelect($event)" [is_modal]=true [parent_path]="parent_path" [parent_page]="parent_page"  [show_select]=true ></FileBrowserComponent>\n'/*ion-inline-end:"C:\jones\ionic\prod\src\pages\directory-browser-select-modal\directory-browser-select-modal.html"*/,
        }),
    ...
    ], DirectoryBrowserSelectModalPage);
    return DirectoryBrowserSelectModalPage;
}());

//# sourceMappingURL=directory-browser-select-modal.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__directory_browser_select_modal__ = __webpack_require__(1336);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_directory_browser_components_module__ = __webpack_require__(1013);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DirectoryBrowserSelectModalPageModule = /** @class */ (function () {
    function DirectoryBrowserSelectModalPageModule() {
    }
    DirectoryBrowserSelectModalPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__directory_browser_select_modal__["a" /* DirectoryBrowserSelectModalPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__directory_browser_select_modal__["a" /* DirectoryBrowserSelectModalPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_directory_browser_components_module__["a" /* DirectoryBrowserComponentsModule */],
            ],
        })
    ], DirectoryBrowserSelectModalPageModule);
    return DirectoryBrowserSelectModalPageModule;
}());

//# sourceMappingURL=directory-browser-select-modal.module.js.map
...
} else if (("function" !== "undefined" && __webpack_require__(941) !== null) && (__webpack_require__(942) !== null)) {
