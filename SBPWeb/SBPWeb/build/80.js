...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileHttpJson2CsvPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileHttpJson2CsvViewModel__ = __webpack_require__(967);
 ...
 * Components.
 */
var FileHttpJson2CsvPage = /** @class */ (function () {
    function FileHttpJson2CsvPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileHttpJson2CsvServices, TableServices, modalCtrl, viewCtrl, platform, conf) {
        ...
        this.FileHttpJson2CsvServices = FileHttpJson2CsvServices;
    ...
    FileHttpJson2CsvPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileHttpJson2CsvPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
        console.log("Select Event", selected, this.selected);
    };
    FileHttpJson2CsvPage.prototype.setPage = function (pageInfo) {
    ...
    FileHttpJson2CsvPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileHttpJson2CsvPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileHttpJson2CsvPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.FileHttpJson2CsvServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
    ...
    FileHttpJson2CsvPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileHttpJson2CsvViewModel__["a" /* FileHttpJson2CsvViewModel */]();
            item.is_active = true;
            item.function_name = "";
        ...
        var modal = this.modalCtrl.create("FileHttpJson2CsvAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileHttpJson2CsvServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        if (select_data.exec_seq === 1)
                            _this.parent_page.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("Json轉CSV檔案", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileHttpJson2CsvPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileHttpJson2CsvServices.DeleteAsync(item.export_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileHttpJson2CsvPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileHttpJson2CsvServices.GetSqlAsync(item.export_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileHttpJson2CsvPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileHttpJson2CsvPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_http_json2_csv_services_file_http_json2_csv_services__["a" /* FileHttpJson2CsvServicesProvider */],
    ...
    ], FileHttpJson2CsvPage);
    return FileHttpJson2CsvPage;
}());

//# sourceMappingURL=file-http-json2-csv.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_http_json2_csv__ = __webpack_require__(1427);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_http_json2_csv_services_file_http_json2_csv_services__ = __webpack_require__(1086);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileHttpJson2CsvPageModule = /** @class */ (function () {
    function FileHttpJson2CsvPageModule() {
    }
    FileHttpJson2CsvPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_http_json2_csv__["a" /* FileHttpJson2CsvPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_http_json2_csv_services_file_http_json2_csv_services__["a" /* FileHttpJson2CsvServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_http_json2_csv__["a" /* FileHttpJson2CsvPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileHttpJson2CsvPageModule);
    return FileHttpJson2CsvPageModule;
}());

//# sourceMappingURL=file-http-json2-csv.module.js.map
