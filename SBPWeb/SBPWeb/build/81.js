...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileHttpJ2CListResponse__ = __webpack_require__(1146);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileHttpJ2CResponse__ = __webpack_require__(1147);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileHttpJ2CViewModel__ = __webpack_require__(966);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileHttpJ2CViewModel__ = __webpack_require__(966);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileHttpJ2CPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_http_j2_c_services_file_http_j2_c_services__ = __webpack_require__(1037);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileHttpJ2CViewModel__ = __webpack_require__(966);
 ...
 * Components.
 */
var FileHttpJ2CPage = /** @class */ (function () {
    function FileHttpJ2CPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileHttpJ2CServices, modalCtrl, viewCtrl, TableServices, runjobServices, platform, conf) {
        ...
        this.totalRows = 0;
        this.keyword = "";
        this.title = "Json至CSV檔案設定";
        this.exec_file_seq = 0;
        this.show_select = false;
        this.File_page = "FileHttpJ2CTablePage";
    ...
    FileHttpJ2CPage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
    ...
    FileHttpJ2CPage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
    ...
    FileHttpJ2CPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileHttpJ2CPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
        console.log("Select Event", selected, this.selected);
    };
    FileHttpJ2CPage.prototype.setPage = function (pageInfo) {
    ...
    FileHttpJ2CPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileHttpJ2CPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileHttpJ2CPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileHttpJ2CServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileHttpJ2CPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileHttpJ2CViewModel__["a" /* FileHttpJ2CViewModel */]();
            item.is_active = true;
            ...
            item.del_empty_flag = false;
            item.header_flag = false;
        ...
        var modal = this.modalCtrl.create("FileHttpJ2CAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            if (_this.mode != "PUT")
                select_data.export_seq = select_data.exec_file_seq * 100 + 1;
            _this.global.createLoader();
            _this.global.loading.present().then(function () {
                _this.FileHttpJ2CServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("Json至CSV檔案設定", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileHttpJ2CPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileHttpJ2CServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileHttpJ2CPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileHttpJ2CServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileHttpJ2CPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileHttpJ2CPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_http_j2_c_services_file_http_j2_c_services__["a" /* FileHttpJ2CServicesProvider */],
    ...
    return FileHttpJ2CPage;
}());

//# sourceMappingURL=file-http-j2-c.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileHttpJ2CPageModule", function() { return FileHttpJ2CPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_http_j2_c__ = __webpack_require__(1426);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_http_j2_c_services_file_http_j2_c_services__ = __webpack_require__(1037);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileHttpJ2CPageModule = /** @class */ (function () {
    function FileHttpJ2CPageModule() {
    }
    FileHttpJ2CPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_http_j2_c__["a" /* FileHttpJ2CPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_http_j2_c_services_file_http_j2_c_services__["a" /* FileHttpJ2CServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_http_j2_c__["a" /* FileHttpJ2CPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileHttpJ2CPageModule);
    return FileHttpJ2CPageModule;
}());

//# sourceMappingURL=file-http-j2-c.module.js.map
