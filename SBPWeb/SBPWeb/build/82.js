...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileHttpHtmlDownFilePage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileHttpHtmlDownFileViewModel__ = __webpack_require__(964);
 ...
 * Components.
 */
var FileHttpHtmlDownFilePage = /** @class */ (function () {
    function FileHttpHtmlDownFilePage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileHttpHtmlDownFileServices, TableServices, modalCtrl, viewCtrl, runjobServices, platform, conf) {
        ...
        this.FileHttpHtmlDownFileServices = FileHttpHtmlDownFileServices;
        ...
        this.down_type_key = navParams.data.item.down_type_key;
    ...
    FileHttpHtmlDownFilePage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
    ...
    FileHttpHtmlDownFilePage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
    ...
    FileHttpHtmlDownFilePage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileHttpHtmlDownFilePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
        console.log("Select Event", selected, this.selected);
    };
    FileHttpHtmlDownFilePage.prototype.setPage = function (pageInfo) {
    ...
    FileHttpHtmlDownFilePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileHttpHtmlDownFilePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileHttpHtmlDownFilePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileHttpHtmlDownFileServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileHttpHtmlDownFilePage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileHttpHtmlDownFileViewModel__["a" /* FileHttpHtmlDownFileViewModel */]();
            item.is_active = true;
        ...
        var modal = this.modalCtrl.create("FileHttpHtmlDownFileAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileHttpHtmlDownFileServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    FileHttpHtmlDownFilePage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileHttpHtmlDownFileServices.DeleteAsync(item.export_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileHttpHtmlDownFilePage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileHttpHtmlDownFileServices.GetSqlAsync(item.export_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileHttpHtmlDownFilePage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileHttpHtmlDownFilePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_http_html_down_file_services_file_http_html_down_file_services__["a" /* FileHttpHtmlDownFileServicesProvider */],
    ...
    ], FileHttpHtmlDownFilePage);
    return FileHttpHtmlDownFilePage;
}());

//# sourceMappingURL=file-http-html-down-file.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileHttpHtmlDownFilePageModule", function() { return FileHttpHtmlDownFilePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_http_html_down_file__ = __webpack_require__(1434);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_http_html_down_file_services_file_http_html_down_file_services__ = __webpack_require__(1084);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileHttpHtmlDownFilePageModule = /** @class */ (function () {
    function FileHttpHtmlDownFilePageModule() {
    }
    FileHttpHtmlDownFilePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_http_html_down_file__["a" /* FileHttpHtmlDownFilePage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_http_html_down_file_services_file_http_html_down_file_services__["a" /* FileHttpHtmlDownFileServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_http_html_down_file__["a" /* FileHttpHtmlDownFilePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileHttpHtmlDownFilePageModule);
    return FileHttpHtmlDownFilePageModule;
}());

//# sourceMappingURL=file-http-html-down-file.module.js.map
