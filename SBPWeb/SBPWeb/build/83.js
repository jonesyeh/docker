...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileHttpHtml2CsvListResponse__ = __webpack_require__(1144);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileHttpHtml2CsvResponse__ = __webpack_require__(1145);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileHttpHtml2CsvViewModel__ = __webpack_require__(965);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileHttpHtml2CsvViewModel__ = __webpack_require__(965);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileHttpHtml2CsvPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_http_html2_csv_services_file_http_html2_csv_services__ = __webpack_require__(1085);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileHttpHtml2CsvViewModel__ = __webpack_require__(965);
 ...
 * Components.
 */
var FileHttpHtml2CsvPage = /** @class */ (function () {
    function FileHttpHtml2CsvPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileHttpHtml2CsvServices, TableServices, modalCtrl, viewCtrl, platform, conf) {
        ...
        this.FileHttpHtml2CsvServices = FileHttpHtml2CsvServices;
    ...
    FileHttpHtml2CsvPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileHttpHtml2CsvPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
        console.log("Select Event", selected, this.selected);
    };
    FileHttpHtml2CsvPage.prototype.setPage = function (pageInfo) {
    ...
    FileHttpHtml2CsvPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileHttpHtml2CsvPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileHttpHtml2CsvPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.FileHttpHtml2CsvServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
    ...
    FileHttpHtml2CsvPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileHttpHtml2CsvViewModel__["a" /* FileHttpHtml2CsvViewModel */]();
            item.is_active = true;
        ...
        var modal = this.modalCtrl.create("FileHttpHtml2CsvAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileHttpHtml2CsvServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        if (select_data.exec_seq === 1)
                            _this.parent_page.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("Html轉CSV檔案", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileHttpHtml2CsvPage.prototype.Delete = function (item) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: "刪除?",
            message: __WEBPACK_IMPORTED_MODULE_5__Model_String__["a" /* String */].Format("確認要刪除{0}嗎?", item.export_seq),
            buttons: [
                {
                    text: "取消",
                    handler: function () {
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileHttpHtml2CsvServices.DeleteAsync(item.export_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileHttpHtml2CsvPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileHttpHtml2CsvServices.GetSqlAsync(item.export_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileHttpHtml2CsvPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileHttpHtml2CsvPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_http_html2_csv_services_file_http_html2_csv_services__["a" /* FileHttpHtml2CsvServicesProvider */],
    ...
    ], FileHttpHtml2CsvPage);
    return FileHttpHtml2CsvPage;
}());

//# sourceMappingURL=file-http-html2-csv.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileHttpHtml2CsvPageModule", function() { return FileHttpHtml2CsvPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_http_html2_csv__ = __webpack_require__(1423);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_http_html2_csv_services_file_http_html2_csv_services__ = __webpack_require__(1085);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileHttpHtml2CsvPageModule = /** @class */ (function () {
    function FileHttpHtml2CsvPageModule() {
    }
    FileHttpHtml2CsvPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_http_html2_csv__["a" /* FileHttpHtml2CsvPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_http_html2_csv_services_file_http_html2_csv_services__["a" /* FileHttpHtml2CsvServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_http_html2_csv__["a" /* FileHttpHtml2CsvPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileHttpHtml2CsvPageModule);
    return FileHttpHtml2CsvPageModule;
}());

//# sourceMappingURL=file-http-html2-csv.module.js.map
