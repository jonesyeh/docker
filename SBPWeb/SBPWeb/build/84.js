...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileHttpH2CPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileHttpH2CViewModel__ = __webpack_require__(963);
 ...
 * Components.
 */
var FileHttpH2CPage = /** @class */ (function () {
    function FileHttpH2CPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileHttpH2CServices, modalCtrl, viewCtrl, TableServices, runjobServices, platform, conf) {
        ...
        this.totalRows = 0;
        this.keyword = "";
        this.title = "html至CSV檔案設定";
        this.exec_file_seq = 0;
        this.show_select = false;
        this.File_page = "FileHttpH2CTablePage";
    ...
    FileHttpH2CPage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
    ...
    FileHttpH2CPage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
    ...
    FileHttpH2CPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileHttpH2CPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
        console.log("Select Event", selected, this.selected);
    };
    FileHttpH2CPage.prototype.setPage = function (pageInfo) {
    ...
    FileHttpH2CPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileHttpH2CPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileHttpH2CPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileHttpH2CServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileHttpH2CPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileHttpH2CViewModel__["a" /* FileHttpH2CViewModel */]();
            item.is_active = true;
            item.is_fail_stop = true;
            item.parameter_column_group = "001";
            item.can_rerun = true;
            item.down_type_key = "061|4";
            item.down_type = "html table回傳<td>欄位內容以分隔符號產出";
            item.can_rerun = true;
            item.function_name = "";
            item.conn_string = "";
        ...
        var modal = this.modalCtrl.create("FileHttpH2CAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileHttpH2CServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("Http下載html至CSV檔案設定", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileHttpH2CPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileHttpH2CServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileHttpH2CPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileHttpH2CServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileHttpH2CPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileHttpH2CPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_http_h2_c_services_file_http_h2_c_services__["a" /* FileHttpH2CServicesProvider */],
    ...
    return FileHttpH2CPage;
}());

//# sourceMappingURL=file-http-h2-c.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_http_h2_c__ = __webpack_require__(1420);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_http_h2_c_services_file_http_h2_c_services__ = __webpack_require__(1036);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileHttpH2CPageModule = /** @class */ (function () {
    function FileHttpH2CPageModule() {
    }
    FileHttpH2CPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_http_h2_c__["a" /* FileHttpH2CPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_http_h2_c_services_file_http_h2_c_services__["a" /* FileHttpH2CServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_http_h2_c__["a" /* FileHttpH2CPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileHttpH2CPageModule);
    return FileHttpH2CPageModule;
}());

//# sourceMappingURL=file-http-h2-c.module.js.map
