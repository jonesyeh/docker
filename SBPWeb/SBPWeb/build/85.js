...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileHttpDownFilePage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileHttpDownFileViewModel__ = __webpack_require__(962);
 ...
 * Components.
 */
var FileHttpDownFilePage = /** @class */ (function () {
    function FileHttpDownFilePage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileHttpDownFileServices, modalCtrl, viewCtrl, TableServices, runjobServices, platform, conf) {
        ...
        this.totalRows = 0;
        this.keyword = "";
        this.title = "Http下載檔案設定";
        this.exec_file_seq = 0;
        this.show_select = false;
        this.File_page = "FileHttpDownFileTablePage";
    ...
    FileHttpDownFilePage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
    ...
    FileHttpDownFilePage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
    ...
    FileHttpDownFilePage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileHttpDownFilePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
        console.log("Select Event", selected, this.selected);
    };
    FileHttpDownFilePage.prototype.setPage = function (pageInfo) {
    ...
    FileHttpDownFilePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileHttpDownFilePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileHttpDownFilePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileHttpDownFileServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileHttpDownFilePage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileHttpDownFileViewModel__["a" /* FileHttpDownFileViewModel */]();
            item.is_active = true;
            item.is_fail_stop = true;
            item.parameter_column_group = "001";
            item.can_rerun = true;
            item.down_type_key = "061|1";
            item.down_type = "檔案下載";
        ...
        var modal = this.modalCtrl.create("FileHttpDownFileAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileHttpDownFileServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("檔案下載", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileHttpDownFilePage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileHttpDownFileServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileHttpDownFilePage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileHttpDownFileServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileHttpDownFilePage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileHttpDownFilePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_http_down_file_services_file_http_down_file_services__["a" /* FileHttpDownFileServicesProvider */],
    ...
    ], FileHttpDownFilePage);
    return FileHttpDownFilePage;
}());

//# sourceMappingURL=file-http-down-file.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_http_down_file__ = __webpack_require__(1417);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_http_down_file_services_file_http_down_file_services__ = __webpack_require__(1035);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileHttpDownFilePageModule = /** @class */ (function () {
    function FileHttpDownFilePageModule() {
    }
    FileHttpDownFilePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_http_down_file__["a" /* FileHttpDownFilePage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_http_down_file_services_file_http_down_file_services__["a" /* FileHttpDownFileServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_http_down_file__["a" /* FileHttpDownFilePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileHttpDownFilePageModule);
    return FileHttpDownFilePageModule;
}());

//# sourceMappingURL=file-http-down-file.module.js.map
