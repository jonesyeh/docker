...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileHttpDownAllViewModel; });
var FileHttpDownAllViewModel = /** @class */ (function () {
    function FileHttpDownAllViewModel() {
    }
    return FileHttpDownAllViewModel;
}());

//# sourceMappingURL=FileHttpDownAllViewModel.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileHttpDownAllServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileHttpDownAllListResponse__ = __webpack_require__(1414);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileHttpDownAllResponse__ = __webpack_require__(1415);
...
/*
  Generated class for the FileHttpDownAllServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var FileHttpDownAllServicesProvider = /** @class */ (function (_super) {
    __extends(FileHttpDownAllServicesProvider, _super);
    function FileHttpDownAllServicesProvider(Services) {
        var _this = _super.call(this, Services) || this;
        _this.Services = Services;
        _this.ctl = "FileHttpDownAll";
        console.log("Hello FileHttpDownAllServiceProvider Provider");
        return _this;
    }
    FileHttpDownAllServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, exec_group, exec_file_seq, order_type) {
        var _this = this;
        var sub_url;
        if (exec_file_seq === 0) {
            sub_url = "FileHttpDownAll?PageSize={1}&PageNumber={2}&keyword={3}&exec_group={4}&order_type={5}";
            ...
            sub_url = "FileHttpDownAll/Select?PageSize={1}&PageNumber={2}&keyword={3}&exec_group={4}&exec_file_seq={5}&order_type={6}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.FileHttpDownAlls = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileHttpDownAllListResponse__["a" /* FileHttpDownAllListResponse */]({
            ...
            return _this.FileHttpDownAlls;
        });
    };
    FileHttpDownAllServicesProvider.prototype.PostPutAsync = function (controller, data, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = controller;
        ...
        return this.Services.PostPutAsync(sub_url, this.ctl, true, data, mode).map(function (item) {
            _this.FileHttpDownAll = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileHttpDownAllResponse__["a" /* FileHttpDownAllResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.FileHttpDownAll;
        });
    };
    FileHttpDownAllServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_services__["a" /* ServicesProvider */]])
    ], FileHttpDownAllServicesProvider);
    return FileHttpDownAllServicesProvider;
}(__WEBPACK_IMPORTED_MODULE_5__file_services_file_services__["a" /* FileServicesProvider */]));

//# sourceMappingURL=file-http-down-all-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileHttpDownAllPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_http_down_all_services_file_http_down_all_services__ = __webpack_require__(1214);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileHttpDownAllViewModel__ = __webpack_require__(1137);
 ...
 * Components.
 */
var FileHttpDownAllPage = /** @class */ (function () {
    function FileHttpDownAllPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileHttpDownAllServices, modalCtrl, viewCtrl, TableServices, runjobServices, platform, conf) {
        ...
        this.FileHttpDownAllServices = FileHttpDownAllServices;
        ...
        this.File_page = "FileHttpDownAllTablePage";
    ...
    FileHttpDownAllPage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
    ...
    FileHttpDownAllPage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
    ...
    FileHttpDownAllPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileHttpDownAllPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
        console.log("Select Event", selected, this.selected);
    };
    FileHttpDownAllPage.prototype.setPage = function (pageInfo) {
    ...
    FileHttpDownAllPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileHttpDownAllPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileHttpDownAllPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileHttpDownAllServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileHttpDownAllPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileHttpDownAllViewModel__["a" /* FileHttpDownAllViewModel */]();
            item.is_active = true;
        ...
        if (item.func_sub_type === 1)
            page = "FileHttpDownFileAddEditModalPage";
        if (item.func_sub_type === 2)
            page = "FileHttpH2CAddEditModalPage";
        if (item.func_sub_type === 3)
            page = "FileHttpJ2CAddEditModalPage";
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                var controller;
                if (item.func_sub_type === 1)
                    controller = "FileHttpDownFile";
                if (item.func_sub_type === 2)
                    controller = "FileHttpH2C";
                if (item.func_sub_type === 3)
                    controller = "FileHttpJ2C";
                _this.FileHttpDownAllServices.PostPutAsync(controller, select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("Http下載檔案", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileHttpDownAllPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileHttpDownAllServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileHttpDownAllPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileHttpDownAllServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileHttpDownAllPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileHttpDownAllPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_http_down_all_services_file_http_down_all_services__["a" /* FileHttpDownAllServicesProvider */],
    ...
    return FileHttpDownAllPage;
}());

//# sourceMappingURL=file-http-down-all.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileHttpDownAllListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileHttpDownAllViewModel__ = __webpack_require__(1137);
...
var FileHttpDownAllListResponse = /** @class */ (function (_super) {
    __extends(FileHttpDownAllListResponse, _super);
    function FileHttpDownAllListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileHttpDownAllViewModel__["a" /* FileHttpDownAllViewModel */]();
    ...
    return FileHttpDownAllListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=FileHttpDownAllListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileHttpDownAllResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileHttpDownAllViewModel__ = __webpack_require__(1137);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var FileHttpDownAllResponse = /** @class */ (function (_super) {
    __extends(FileHttpDownAllResponse, _super);
    function FileHttpDownAllResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileHttpDownAllViewModel__["a" /* FileHttpDownAllViewModel */]();
    ...
    return FileHttpDownAllResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=FileHttpDownAllResponse.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_http_down_all__ = __webpack_require__(1413);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_http_down_all_services_file_http_down_all_services__ = __webpack_require__(1214);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileHttpDownAllPageModule = /** @class */ (function () {
    function FileHttpDownAllPageModule() {
    }
    FileHttpDownAllPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_http_down_all__["a" /* FileHttpDownAllPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_http_down_all_services_file_http_down_all_services__["a" /* FileHttpDownAllServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_http_down_all__["a" /* FileHttpDownAllPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileHttpDownAllPageModule);
    return FileHttpDownAllPageModule;
}());

//# sourceMappingURL=file-http-down-all.module.js.map
