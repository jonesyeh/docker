...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileFilterServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileFilterListResponse__ = __webpack_require__(1131);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileFilterResponse__ = __webpack_require__(1132);
...
/*
  Generated class for the FileFilterServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var FileFilterServicesProvider = /** @class */ (function (_super) {
    __extends(FileFilterServicesProvider, _super);
    function FileFilterServicesProvider(Services) {
        var _this = _super.call(this, Services) || this;
        _this.Services = Services;
        _this.ctl = "FileFilter";
        console.log("Hello FileFilterServiceProvider Provider");
        return _this;
    }
    FileFilterServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, exec_group, exec_file_seq, order_type) {
        var _this = this;
        var sub_url;
        if (exec_file_seq === 0) {
            sub_url = "FileFilter?PageSize={1}&PageNumber={2}&keyword={3}&exec_group={4}&order_type={5}";
            ...
            sub_url = "FileFilter?PageSize={1}&PageNumber={2}&keyword={3}&exec_group={4}&exec_file_seq={5}&order_type={6}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.FileFilters = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileFilterListResponse__["a" /* FileFilterListResponse */]({
            ...
            return _this.FileFilters;
        });
    };
    FileFilterServicesProvider.prototype.PostPutAsync = function (FileFilterViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "FileFilter";
        else
            sub_url = "FileFilter/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, FileFilterViewModel.exec_file_seq);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, FileFilterViewModel, mode).map(function (item) {
            _this.FileFilter = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileFilterResponse__["a" /* FileFilterResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.FileFilter;
        });
    };
    FileFilterServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_services__["a" /* ServicesProvider */]])
    ], FileFilterServicesProvider);
    return FileFilterServicesProvider;
}(__WEBPACK_IMPORTED_MODULE_5__file_services_file_services__["a" /* FileServicesProvider */]));

//# sourceMappingURL=file-filter-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileFilterListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileFilterViewModel__ = __webpack_require__(959);
...
var FileFilterListResponse = /** @class */ (function (_super) {
    __extends(FileFilterListResponse, _super);
    function FileFilterListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileFilterViewModel__["a" /* FileFilterViewModel */]();
...
//# sourceMappingURL=FileFilterListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileFilterResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileFilterViewModel__ = __webpack_require__(959);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var FileFilterResponse = /** @class */ (function (_super) {
    __extends(FileFilterResponse, _super);
    function FileFilterResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileFilterViewModel__["a" /* FileFilterViewModel */]();
            ...
            _this.Model.find = (obj && obj.Model.find) || null;
            _this.Model.search_data = (obj && obj.Model.search_data) || null;
            _this.Model.line_process_flag = obj.Model.line_process_flag;
        }
        return _this;
    }
...
//# sourceMappingURL=FileFilterResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileFilterPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_filter_services_file_filter_services__ = __webpack_require__(1032);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileFilterViewModel__ = __webpack_require__(959);
 ...
 * Components.
 */
var FileFilterPage = /** @class */ (function () {
    function FileFilterPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileFilterServices, modalCtrl, viewCtrl, TableServices, runjobServices, platform, conf) {
        ...
        this.FileFilterServices = FileFilterServices;
        ...
        this.File_page = "FileFilterTablePage";
    ...
    FileFilterPage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
    ...
    FileFilterPage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
    ...
    FileFilterPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileFilterPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileFilterPage.prototype.setPage = function (pageInfo) {
    ...
    FileFilterPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileFilterPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileFilterPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileFilterServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileFilterPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileFilterViewModel__["a" /* FileFilterViewModel */]();
        ...
        var modal = this.modalCtrl.create("FileFilterAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileFilterServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    FileFilterPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileFilterServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileFilterPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileFilterServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileFilterPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileFilterPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_filter_services_file_filter_services__["a" /* FileFilterServicesProvider */],
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileFilterPageModule", function() { return FileFilterPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_filter__ = __webpack_require__(1405);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_filter_services_file_filter_services__ = __webpack_require__(1032);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileFilterPageModule = /** @class */ (function () {
    function FileFilterPageModule() {
    }
    FileFilterPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_filter__["a" /* FileFilterPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_filter_services_file_filter_services__["a" /* FileFilterServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_filter__["a" /* FileFilterPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileFilterPageModule);
    return FileFilterPageModule;
}());

//# sourceMappingURL=file-filter.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileFilterViewModel; });
...
var FileFilterViewModel = /** @class */ (function (_super) {
    __extends(FileFilterViewModel, _super);
    function FileFilterViewModel() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return FileFilterViewModel;
}(__WEBPACK_IMPORTED_MODULE_0__FileManagementViewModel__["a" /* FileManagementViewModel */]));

//# sourceMappingURL=FileFilterViewModel.js.map
