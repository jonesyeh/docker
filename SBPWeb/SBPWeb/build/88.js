...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileFilterItemServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileFilterItemListResponse__ = __webpack_require__(1403);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileFilterItemResponse__ = __webpack_require__(1404);
...
/*
  Generated class for the FileFilterItemServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var FileFilterItemServicesProvider = /** @class */ (function () {
    function FileFilterItemServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "FileFilterItem";
        console.log("Hello FileFilterItemServiceProvider Provider");
    }
    FileFilterItemServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, exec_file_seq, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "FileFilterItem?PageSize={1}&PageNumber={2}&keyword={3}&exec_file_seq={4}&order_type={5}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.FileFilterItems = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileFilterItemListResponse__["a" /* FileFilterItemListResponse */]({
            ...
            return _this.FileFilterItems;
        });
    };
    FileFilterItemServicesProvider.prototype.PostPutAsync = function (FileFilterItemViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "FileFilterItem";
        else
            sub_url = "FileFilterItem?exec_file_seq={1}&search_data={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, FileFilterItemViewModel.exec_file_seq, FileFilterItemViewModel.search_data);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, FileFilterItemViewModel, mode).map(function (item) {
            _this.FileFilterItem = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileFilterItemResponse__["a" /* FileFilterItemResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.FileFilterItem;
        });
    };
    FileFilterItemServicesProvider.prototype.DeleteAsync = function (exec_file_seq, search_data) {
        var _this = this;
        var sub_url;
        sub_url = "FileFilterItem?exec_file_seq={1}&search_data={2}";
    ...
    FileFilterItemServicesProvider.prototype.GetAsync = function (exec_file_seq, search_data) {
        var sub_url;
        sub_url = "FileFilterItem?exec_file_seq={1}&search_data={2}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, exec_file_seq, search_data);
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            return new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileFilterItemResponse__["a" /* FileFilterItemResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
    ...
    FileFilterItemServicesProvider.prototype.GetSqlAsync = function (exec_file_seq, search_data, method) {
        var sub_url;
        sub_url = "FileFilterItem/get_{3}_sql?exec_file_seq={1}&search_data={2}";
    ...
    FileFilterItemServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_services__["a" /* ServicesProvider */]])
    ], FileFilterItemServicesProvider);
    return FileFilterItemServicesProvider;
}());

//# sourceMappingURL=file-filter-item-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileFilterItemPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_filter_item_services_file_filter_item_services__ = __webpack_require__(1211);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileFilterItemViewModel__ = __webpack_require__(1032);
 ...
 * Components.
 */
var FileFilterItemPage = /** @class */ (function () {
    function FileFilterItemPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileFilterItemServices, modalCtrl, viewCtrl, TableServices, platform, conf) {
        ...
        this.FileFilterItemServices = FileFilterItemServices;
        ...
        this.File_page = "FileFilterItemTablePage";
    ...
    FileFilterItemPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileFilterItemPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
        console.log("Select Event", selected, this.selected);
    };
    FileFilterItemPage.prototype.setPage = function (pageInfo) {
    ...
    FileFilterItemPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileFilterItemPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileFilterItemPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.FileFilterItemServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
    ...
    FileFilterItemPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileFilterItemViewModel__["a" /* FileFilterItemViewModel */]();
        ...
        var modal = this.modalCtrl.create("FileFilterItemAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileFilterItemServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    FileFilterItemPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileFilterItemServices.DeleteAsync(item.exec_file_seq, item.search_data).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileFilterItemPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileFilterItemServices.GetSqlAsync(item.exec_file_seq, item.search_data, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileFilterItemPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileFilterItemPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_filter_item_services_file_filter_item_services__["a" /* FileFilterItemServicesProvider */],
    ...
    return FileFilterItemPage;
}());

//# sourceMappingURL=file-filter-item.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileFilterItemListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileFilterItemViewModel__ = __webpack_require__(1032);
...
var FileFilterItemListResponse = /** @class */ (function (_super) {
    __extends(FileFilterItemListResponse, _super);
    function FileFilterItemListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileFilterItemViewModel__["a" /* FileFilterItemViewModel */]();
    ...
    return FileFilterItemListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=FileFilterItemListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileFilterItemResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileFilterItemViewModel__ = __webpack_require__(1032);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var FileFilterItemResponse = /** @class */ (function (_super) {
    __extends(FileFilterItemResponse, _super);
    function FileFilterItemResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileFilterItemViewModel__["a" /* FileFilterItemViewModel */]();
    ...
    return FileFilterItemResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=FileFilterItemResponse.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileFilterItemPageModule", function() { return FileFilterItemPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_filter_item__ = __webpack_require__(1402);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_filter_item_services_file_filter_item_services__ = __webpack_require__(1211);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileFilterItemPageModule = /** @class */ (function () {
    function FileFilterItemPageModule() {
    }
    FileFilterItemPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_filter_item__["a" /* FileFilterItemPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_filter_item_services_file_filter_item_services__["a" /* FileFilterItemServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_filter_item__["a" /* FileFilterItemPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileFilterItemPageModule);
    return FileFilterItemPageModule;
}());

//# sourceMappingURL=file-filter-item.module.js.map
