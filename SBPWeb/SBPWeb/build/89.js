...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileExportTsqlTablePage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileExportTsqlTableViewModel__ = __webpack_require__(958);
 ...
 * Components.
 */
var FileExportTsqlTablePage = /** @class */ (function () {
    function FileExportTsqlTablePage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileExportTsqlTableServices, TableServices, modalCtrl, viewCtrl, platform, conf) {
    ...
    FileExportTsqlTablePage.prototype.openNavTableDetailPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileExportTsqlTablePage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileExportTsqlTablePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileExportTsqlTablePage.prototype.setPage = function (pageInfo) {
    ...
    FileExportTsqlTablePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileExportTsqlTablePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileExportTsqlTablePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.FileExportTsqlTableServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
    ...
    FileExportTsqlTablePage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileExportTsqlTableViewModel__["a" /* FileExportTsqlTableViewModel */]();
            item.is_active = true;
        ...
        var modal = this.modalCtrl.create("FileExportTsqlTableAddEditModalPage", {
            mode: this.mode,
            item: item,
    ...
    FileExportTsqlTablePage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileExportTsqlTableServices.DeleteAsync(item.exec_file_seq, item.schemaname, item.tablename, item.db_conn_id, item.parameter_column_group, item.src_export_type_key).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileExportTsqlTablePage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileExportTsqlTableServices.GetSqlAsync(item.exec_file_seq, item.schemaname, item.tablename, item.db_conn_id, item.parameter_column_group, item.src_export_type_key, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileExportTsqlTablePage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileExportTsqlTablePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_export_tsql_table_services_file_export_tsql_table_services__["a" /* FileExportTsqlTableServicesProvider */],
    ...
    ], FileExportTsqlTablePage);
    return FileExportTsqlTablePage;
}());

//# sourceMappingURL=file-export-tsql-table.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_export_tsql_table__ = __webpack_require__(1395);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_export_tsql_table_services_file_export_tsql_table_services__ = __webpack_require__(1030);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileExportTsqlTablePageModule = /** @class */ (function () {
    function FileExportTsqlTablePageModule() {
    }
    FileExportTsqlTablePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_export_tsql_table__["a" /* FileExportTsqlTablePage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_export_tsql_table_services_file_export_tsql_table_services__["a" /* FileExportTsqlTableServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_export_tsql_table__["a" /* FileExportTsqlTablePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileExportTsqlTablePageModule);
    return FileExportTsqlTablePageModule;
}());

//# sourceMappingURL=file-export-tsql-table.module.js.map
