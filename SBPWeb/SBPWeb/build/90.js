...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileExportTsqlPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileExportTsqlViewModel__ = __webpack_require__(957);
 ...
 * Components.
 */
var FileExportTsqlPage = /** @class */ (function () {
    function FileExportTsqlPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileExportTsqlServices, modalCtrl, viewCtrl, TableServices, runjobServices, platform, conf) {
        ...
        this.totalRows = 0;
        this.keyword = "";
        this.title = "SQL語法檔案匯出設定";
        this.exec_file_seq = 0;
        this.show_select = false;
        this.File_page = "FileExportTsqlTablePage";
    ...
    FileExportTsqlPage.prototype.openNavTablePage = function (tablefullname) {
        var _this = this;
    ...
    FileExportTsqlPage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileExportTsqlPage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
    ...
    FileExportTsqlPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileExportTsqlPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
        console.log("Select Event", selected, this.selected);
    };
    FileExportTsqlPage.prototype.setPage = function (pageInfo) {
    ...
    FileExportTsqlPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileExportTsqlPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileExportTsqlPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileExportTsqlServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileExportTsqlPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileExportTsqlViewModel__["a" /* FileExportTsqlViewModel */]();
            item.is_active = true;
        ...
        var modal = this.modalCtrl.create("FileExportTsqlAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileExportTsqlServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    FileExportTsqlPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileExportTsqlServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileExportTsqlPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileExportTsqlServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileExportTsqlPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileExportTsqlPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_export_tsql_services_file_export_tsql_services__["a" /* FileExportTsqlServicesProvider */],
    ...
    return FileExportTsqlPage;
}());

//# sourceMappingURL=file-export-tsql.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_export_tsql__ = __webpack_require__(1397);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_export_tsql_services_file_export_tsql_services__ = __webpack_require__(1029);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileExportTsqlPageModule = /** @class */ (function () {
    function FileExportTsqlPageModule() {
    }
    FileExportTsqlPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_export_tsql__["a" /* FileExportTsqlPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_export_tsql_services_file_export_tsql_services__["a" /* FileExportTsqlServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_export_tsql__["a" /* FileExportTsqlPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileExportTsqlPageModule);
    return FileExportTsqlPageModule;
}());

//# sourceMappingURL=file-export-tsql.module.js.map
