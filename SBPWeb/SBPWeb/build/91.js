...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileExportTableServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileExportTableListResponse__ = __webpack_require__(1125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileExportTableResponse__ = __webpack_require__(1126);
...
/*
  Generated class for the FileExportTableServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var FileExportTableServicesProvider = /** @class */ (function () {
    function FileExportTableServicesProvider(Services) {
        this.Services = Services;
        this.ctl = "FileExportTable";
        console.log("Hello FileExportTableServiceProvider Provider");
    }
    FileExportTableServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, exec_file_seq, order_type) {
        var _this = this;
        var sub_url;
        sub_url = "FileExportTable?PageSize={1}&PageNumber={2}&keyword={3}&exec_file_seq={4}&order_type={5}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.FileExportTables = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileExportTableListResponse__["a" /* FileExportTableListResponse */]({
            ...
            return _this.FileExportTables;
        });
    };
    FileExportTableServicesProvider.prototype.PostPutAsync = function (FileExportTableViewModel, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = "FileExportTable";
        else
            sub_url = "FileExportTable?exec_file_seq={1}&schemaname={2}&tablename={3}&db_conn_id={4}&parameter_column_group={5}&src_export_type_key={6}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, FileExportTableViewModel.exec_file_seq, FileExportTableViewModel.schemaname, FileExportTableViewModel.tablename, FileExportTableViewModel.db_conn_id, FileExportTableViewModel.parameter_column_group, FileExportTableViewModel.src_export_type_key);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, FileExportTableViewModel, mode).map(function (item) {
            _this.FileExportTable = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileExportTableResponse__["a" /* FileExportTableResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.FileExportTable;
        });
    };
    FileExportTableServicesProvider.prototype.DeleteAsync = function (exec_file_seq, schemaname, tablename, db_conn_id, parameter_column_group, src_export_type_key) {
        var sub_url;
        sub_url = "FileExportTable?exec_file_seq={1}&schemaname={2}&tablename={3}&db_conn_id={4}&parameter_column_group={5}&src_export_type_key={6}";
    ...
    FileExportTableServicesProvider.prototype.GetMaxExecSeqAsync = function (exec_file_seq) {
        var sub_url;
    ...
    FileExportTableServicesProvider.prototype.GetSqlAsync = function (exec_file_seq, schemaname, tablename, db_conn_id, parameter_column_group, src_export_type_key, method) {
        var sub_url;
    ...
    FileExportTableServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_services__["a" /* ServicesProvider */]])
    ], FileExportTableServicesProvider);
    return FileExportTableServicesProvider;
}());

//# sourceMappingURL=file-export-table-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileExportTableListResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileExportTableViewModel__ = __webpack_require__(956);
...
var FileExportTableListResponse = /** @class */ (function (_super) {
    __extends(FileExportTableListResponse, _super);
    function FileExportTableListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileExportTableViewModel__["a" /* FileExportTableViewModel */]();
    ...
    return FileExportTableListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=FileExportTableListResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileExportTableResponse; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileExportTableViewModel__ = __webpack_require__(956);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var FileExportTableResponse = /** @class */ (function (_super) {
    __extends(FileExportTableResponse, _super);
    function FileExportTableResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileExportTableViewModel__["a" /* FileExportTableViewModel */]();
    ...
    return FileExportTableResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=FileExportTableResponse.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileExportTablePage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_export_table_services_file_export_table_services__ = __webpack_require__(1028);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileExportTableViewModel__ = __webpack_require__(956);
 ...
 * Components.
 */
var FileExportTablePage = /** @class */ (function () {
    function FileExportTablePage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileExportTableServices, TableServices, modalCtrl, viewCtrl, platform, conf) {
        ...
        this.FileExportTableServices = FileExportTableServices;
    ...
    FileExportTablePage.prototype.openNavTablePage = function (tablefullname) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push("TableExtPage", { keyword: "=" + tablefullname });
        });
    };
    FileExportTablePage.prototype.openNavTableDetailPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.navCtrl.push(_this.table_detail_page, { item: item, columnname: "", parameter_column_group: item.parameter_column_group });
        });
    };
    FileExportTablePage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileExportTablePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileExportTablePage.prototype.setPage = function (pageInfo) {
    ...
    FileExportTablePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileExportTablePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileExportTablePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.FileExportTableServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
    ...
    FileExportTablePage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileExportTableViewModel__["a" /* FileExportTableViewModel */]();
            item.is_active = true;
            item.parameter_column_group = "001";
            item.db_conn_id = "localdb";
            item.field_terminator = ",";
            item.row_terminator = "\\r\\n";
            item.src_export_type_key = "008|T";
            item.src_export_type = "從資料表或檢視表匯出";
            item.file_format_key = "011|C";
            item.file_format = "Char(若是中文代表big5)";
            item.export_mode_key = "007|C";
            item.export_mode = "Create(若檔案存在會覆蓋)";
            item.del_empty_file = false;
            item.last_data_type_key = "009|ALL";
            item.last_data_type = "全部";
            item.last_data_column_name = "";
        ...
        var modal = this.modalCtrl.create("FileExportTableAddEditModalPage", {
            mode: this.mode,
            item: item,
            exec_file_seq: this.exec_file_seq,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileExportTableServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    FileExportTablePage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileExportTableServices.DeleteAsync(item.exec_file_seq, item.schemaname, item.tablename, item.db_conn_id, item.parameter_column_group, item.src_export_type_key).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileExportTablePage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileExportTableServices.GetSqlAsync(item.exec_file_seq, item.schemaname, item.tablename, item.db_conn_id, item.parameter_column_group, item.src_export_type_key, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileExportTablePage.prototype.openNavExportSqlPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.TableServices.GetExportSqlAsync(item.schemaname, item.tablename, item.field_terminator, item.file_format_key, "tb", item.src_export_type_key).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileExportTablePage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileExportTablePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_export_table_services_file_export_table_services__["a" /* FileExportTableServicesProvider */],
    ...
    return FileExportTablePage;
}());

//# sourceMappingURL=file-export-table.js.map
...
var FileExportTablePageModule = /** @class */ (function () {
    function FileExportTablePageModule() {
    }
    FileExportTablePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_export_table__["a" /* FileExportTablePage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_export_table_services_file_export_table_services__["a" /* FileExportTableServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_export_table__["a" /* FileExportTablePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileExportTablePageModule);
    return FileExportTablePageModule;
}());

//# sourceMappingURL=file-export-table.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileExportTableViewModel; });
var FileExportTableViewModel = /** @class */ (function () {
    function FileExportTableViewModel() {
    }
    return FileExportTableViewModel;
}());

//# sourceMappingURL=FileExportTableViewModel.js.map
