...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileExportScriptTablePage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileExportScriptTableViewModel__ = __webpack_require__(955);
 ...
 * Components.
 */
var FileExportScriptTablePage = /** @class */ (function () {
    function FileExportScriptTablePage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileExportScriptTableServices, TableServices, modalCtrl, viewCtrl, platform, conf) {
    ...
    FileExportScriptTablePage.prototype.openNavTablePage = function (tablefullname) {
        var _this = this;
    ...
    FileExportScriptTablePage.prototype.openNavTableDetailPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileExportScriptTablePage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileExportScriptTablePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileExportScriptTablePage.prototype.setPage = function (pageInfo) {
    ...
    FileExportScriptTablePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileExportScriptTablePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileExportScriptTablePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.FileExportScriptTableServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
    ...
    FileExportScriptTablePage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileExportScriptTableViewModel__["a" /* FileExportScriptTableViewModel */]();
            item.is_active = true;
            item.parameter_column_group = "001";
            item.db_conn_id = "localdb";
            item.field_terminator = ",";
            item.row_terminator = "\\r\\n";
            item.script_file_proc_key = "018|1";
            item.script_file_proc = "不動作";
        ...
        var modal = this.modalCtrl.create("FileExportScriptTableAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileExportScriptTableServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
                    if (data.DidError === false) {
                        _this.LoadData(true);
                        _this.global.dismissLoading();
                        _this.global.showPopup("SQL檔案匯出", data.Message);
                    }
                    else
                        _this.global.showError(data.ErrorMessage);
                }, function (err) {
    ...
    FileExportScriptTablePage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileExportScriptTableServices.DeleteAsync(item.exec_file_seq, item.schemaname, item.tablename, item.db_conn_id, item.parameter_column_group, item.src_export_type_key).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileExportScriptTablePage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileExportScriptTableServices.GetSqlAsync(item.exec_file_seq, item.schemaname, item.tablename, item.db_conn_id, item.parameter_column_group, item.src_export_type_key, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileExportScriptTablePage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileExportScriptTablePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_export_script_table_services_file_export_script_table_services__["a" /* FileExportScriptTableServicesProvider */],
    ...
    ], FileExportScriptTablePage);
    return FileExportScriptTablePage;
}());

//# sourceMappingURL=file-export-script-table.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileExportScriptTablePageModule", function() { return FileExportScriptTablePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_export_script_table__ = __webpack_require__(1390);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_export_script_table_services_file_export_script_table_services__ = __webpack_require__(1027);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileExportScriptTablePageModule = /** @class */ (function () {
    function FileExportScriptTablePageModule() {
    }
    FileExportScriptTablePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_export_script_table__["a" /* FileExportScriptTablePage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_export_script_table_services_file_export_script_table_services__["a" /* FileExportScriptTableServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_export_script_table__["a" /* FileExportScriptTablePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileExportScriptTablePageModule);
    return FileExportScriptTablePageModule;
}());

//# sourceMappingURL=file-export-script-table.module.js.map
