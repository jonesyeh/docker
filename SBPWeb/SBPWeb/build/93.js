...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileExportScriptListResponse__ = __webpack_require__(1121);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileExportScriptResponse__ = __webpack_require__(1122);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileExportScriptViewModel__ = __webpack_require__(954);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileExportScriptViewModel__ = __webpack_require__(954);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileExportScriptPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_export_script_services_file_export_script_services__ = __webpack_require__(1026);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileExportScriptViewModel__ = __webpack_require__(954);
 ...
 * Components.
 */
var FileExportScriptPage = /** @class */ (function () {
    function FileExportScriptPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileExportScriptServices, modalCtrl, viewCtrl, TableServices, runjobServices, platform, conf) {
        ...
        this.totalRows = 0;
        this.keyword = "";
        this.title = "SQL檔案匯出設定";
        this.exec_file_seq = 0;
        this.show_select = false;
        this.File_page = "FileExportScriptTablePage";
    ...
    FileExportScriptPage.prototype.openNavTablePage = function (tablefullname) {
        var _this = this;
    ...
    FileExportScriptPage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileExportScriptPage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.runjobServices.RunExecGroupAsync(id, item.exec_group).subscribe(function (data) {
    ...
    FileExportScriptPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileExportScriptPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
        console.log("Select Event", selected, this.selected);
    };
    FileExportScriptPage.prototype.setPage = function (pageInfo) {
    ...
    FileExportScriptPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileExportScriptPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileExportScriptPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileExportScriptServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileExportScriptPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileExportScriptViewModel__["a" /* FileExportScriptViewModel */]();
            item.is_active = true;
        ...
        var modal = this.modalCtrl.create("FileExportScriptAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileExportScriptServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    FileExportScriptPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileExportScriptServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileExportScriptPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileExportScriptServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileExportScriptPage.prototype.openNavExportSqlPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.TableServices.GetExportSqlAsync(item.schemaname, item.tablename, item.field_terminator, item.file_format_key, "tb", "008|S").subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileExportScriptPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileExportScriptPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_export_script_services_file_export_script_services__["a" /* FileExportScriptServicesProvider */],
    ...
    ], FileExportScriptPage);
    return FileExportScriptPage;
}());

//# sourceMappingURL=file-export-script.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileExportScriptPageModule", function() { return FileExportScriptPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_export_script__ = __webpack_require__(1391);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_export_script_services_file_export_script_services__ = __webpack_require__(1026);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileExportScriptPageModule = /** @class */ (function () {
    function FileExportScriptPageModule() {
    }
    FileExportScriptPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_export_script__["a" /* FileExportScriptPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_export_script_services_file_export_script_services__["a" /* FileExportScriptServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_export_script__["a" /* FileExportScriptPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileExportScriptPageModule);
    return FileExportScriptPageModule;
}());

//# sourceMappingURL=file-export-script.module.js.map
