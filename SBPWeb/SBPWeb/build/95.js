...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileExportHKTableListResponse__ = __webpack_require__(1119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileExportHKTableResponse__ = __webpack_require__(1120);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileExportHKTableViewModel__ = __webpack_require__(953);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileExportHKTableViewModel__ = __webpack_require__(953);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileExportHkTablePage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_export_hk_table_services_file_export_hk_table_services__ = __webpack_require__(1025);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileExportHKTableViewModel__ = __webpack_require__(953);
 ...
 * Components.
 */
var FileExportHkTablePage = /** @class */ (function () {
    function FileExportHkTablePage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileExportHKTableServices, TableServices, modalCtrl, viewCtrl, platform, conf) {
    ...
    FileExportHkTablePage.prototype.openNavTableDetailPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileExportHkTablePage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileExportHkTablePage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileExportHkTablePage.prototype.setPage = function (pageInfo) {
    ...
    FileExportHkTablePage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileExportHkTablePage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileExportHkTablePage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.loading.present().then(function () {
            _this.FileExportHKTableServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
    ...
    FileExportHkTablePage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileExportHKTableViewModel__["a" /* FileExportHKTableViewModel */]();
            item.is_active = true;
            item.parameter_column_group = "001";
            item.db_conn_id = "localdb";
            item.field_terminator = ",";
            item.row_terminator = "\\r\\n";
            item.src_export_type_key = "008|HS1";
            item.src_export_type = "House Keeping(匯出並刪除過期資料)-delete";
        ...
        var modal = this.modalCtrl.create("FileExportHkTableAddEditModalPage", {
            mode: this.mode,
            item: item,
    ...
    FileExportHkTablePage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileExportHKTableServices.DeleteAsync(item.exec_file_seq, item.schemaname, item.tablename, item.db_conn_id, item.parameter_column_group, item.src_export_type_key).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileExportHkTablePage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileExportHKTableServices.GetSqlAsync(item.exec_file_seq, item.schemaname, item.tablename, item.db_conn_id, item.parameter_column_group, item.src_export_type_key, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileExportHkTablePage.prototype.openNavExportSqlPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.TableServices.GetHSExportSqlAsync(item.schemaname, item.tablename, item.field_terminator, item.file_format_key, "tb", item.src_export_type_key, item.where_condition, item.last_data_type_key, item.last_data_column_name, _this.exec_group, item.keep_days).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileExportHkTablePage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileExportHkTablePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_export_hk_table_services_file_export_hk_table_services__["a" /* FileExportHkTableServicesProvider */],
    ...
    ], FileExportHkTablePage);
    return FileExportHkTablePage;
}());

//# sourceMappingURL=file-export-hk-table.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_export_hk_table__ = __webpack_require__(1384);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_export_hk_table_services_file_export_hk_table_services__ = __webpack_require__(1025);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileExportHkTablePageModule = /** @class */ (function () {
    function FileExportHkTablePageModule() {
    }
    FileExportHkTablePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_export_hk_table__["a" /* FileExportHkTablePage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_export_hk_table_services_file_export_hk_table_services__["a" /* FileExportHkTableServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_export_hk_table__["a" /* FileExportHkTablePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileExportHkTablePageModule);
    return FileExportHkTablePageModule;
}());

//# sourceMappingURL=file-export-hk-table.module.js.map
