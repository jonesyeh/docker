...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileExportHKListResponse__ = __webpack_require__(1117);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileExportHKResponse__ = __webpack_require__(1118);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileExportHKViewModel__ = __webpack_require__(952);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileExportHKViewModel__ = __webpack_require__(952);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileExportHkPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_export_hk_services_file_export_hk_services__ = __webpack_require__(1024);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileExportHKViewModel__ = __webpack_require__(952);
 ...
 * Components.
 */
var FileExportHkPage = /** @class */ (function () {
    function FileExportHkPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileExportHKServices, modalCtrl, viewCtrl, TableServices, runjobServices, platform, conf) {
        ...
        this.File_page = "FileExportHKTablePage";
    ...
    FileExportHkPage.prototype.openNavTablePage = function (tablefullname) {
        var _this = this;
    ...
    FileExportHkPage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileExportHkPage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
    ...
    FileExportHkPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileExportHkPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileExportHkPage.prototype.setPage = function (pageInfo) {
    ...
    FileExportHkPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileExportHkPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileExportHkPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileExportHKServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileExportHkPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileExportHKViewModel__["a" /* FileExportHKViewModel */]();
            item.is_active = true;
        ...
        var modal = this.modalCtrl.create("FileExportHkAddEditModalPage", {
            mode: this.mode,
            item: item,
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                _this.FileExportHKServices.PostPutAsync(select_data, _this.mode).subscribe(function (data) {
    ...
    FileExportHkPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileExportHKServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileExportHkPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileExportHKServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileExportHkPage.prototype.openNavExportSqlPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileExportHkPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileExportHkPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_export_hk_services_file_export_hk_services__["a" /* FileExportHkServicesProvider */],
    ...
    return FileExportHkPage;
}());

//# sourceMappingURL=file-export-hk.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileExportHkPageModule", function() { return FileExportHkPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_export_hk__ = __webpack_require__(1384);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_export_hk_services_file_export_hk_services__ = __webpack_require__(1024);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileExportHkPageModule = /** @class */ (function () {
    function FileExportHkPageModule() {
    }
    FileExportHkPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_export_hk__["a" /* FileExportHkPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_export_hk_services_file_export_hk_services__["a" /* FileExportHkServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_export_hk__["a" /* FileExportHkPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileExportHkPageModule);
    return FileExportHkPageModule;
}());

//# sourceMappingURL=file-export-hk.module.js.map
