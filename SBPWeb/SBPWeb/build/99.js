...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileExportAllViewModel; });
var FileExportAllViewModel = /** @class */ (function () {
    function FileExportAllViewModel() {
    }
    return FileExportAllViewModel;
}());

//# sourceMappingURL=FileExportAllViewModel.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileExportAllServicesProvider; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileExportAllListResponse__ = __webpack_require__(1376);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileExportAllResponse__ = __webpack_require__(1377);
...
/*
  Generated class for the FileExportAllServiceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
var FileExportAllServicesProvider = /** @class */ (function (_super) {
    __extends(FileExportAllServicesProvider, _super);
    function FileExportAllServicesProvider(Services) {
        var _this = _super.call(this, Services) || this;
        _this.Services = Services;
        _this.ctl = "FileExportAll";
        console.log("Hello FileExportAllServiceProvider Provider");
        return _this;
    }
    FileExportAllServicesProvider.prototype.GetListsByAsync = function (PageSize, PageNumber, keyword, exec_group, exec_file_seq, order_type) {
        var _this = this;
        var sub_url;
        if (exec_file_seq === 0) {
            sub_url = "FileExportAll?PageSize={1}&PageNumber={2}&keyword={3}&exec_group={4}&order_type={5}";
            ...
            sub_url = "FileExportAll/Select?PageSize={1}&PageNumber={2}&keyword={3}&exec_group={4}&exec_file_seq={5}&order_type={6}";
        ...
        return this.Services.GetAsync(sub_url, this.ctl, true).map(function (item) {
            _this.FileExportAlls = new __WEBPACK_IMPORTED_MODULE_3__Model_Response_FileExportAllListResponse__["a" /* FileExportAllListResponse */]({
            ...
            return _this.FileExportAlls;
        });
    };
    FileExportAllServicesProvider.prototype.PostPutAsync = function (controller, data, mode) {
        var _this = this;
        var sub_url;
        if (mode === "POST")
            sub_url = controller;
        else
            sub_url = controller + "/{1}";
        sub_url = __WEBPACK_IMPORTED_MODULE_0__Model_String__["a" /* String */].Format(sub_url, this.ctl, data.exec_file_seq);
        return this.Services.PostPutAsync(sub_url, this.ctl, true, data, mode).map(function (item) {
            _this.FileExportAll = new __WEBPACK_IMPORTED_MODULE_4__Model_Response_FileExportAllResponse__["a" /* FileExportAllResponse */]({
                Message: item.Message,
                DidError: item.DidError,
                ErrorMessage: item.ErrorMessage,
                Model: item.Model
            });
            return _this.FileExportAll;
        });
    };
    FileExportAllServicesProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_services__["a" /* ServicesProvider */]])
    ], FileExportAllServicesProvider);
    return FileExportAllServicesProvider;
}(__WEBPACK_IMPORTED_MODULE_5__file_services_file_services__["a" /* FileServicesProvider */]));

//# sourceMappingURL=file-export-all-services.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileExportAllPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_file_export_all_services_file_export_all_services__ = __webpack_require__(1208);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileExportAllViewModel__ = __webpack_require__(1112);
 ...
 * Components.
 */
var FileExportAllPage = /** @class */ (function () {
    function FileExportAllPage(navCtrl, navParams, loadingCtrl, alertCtrl, global, authServices, FileExportAllServices, modalCtrl, viewCtrl, TableServices, runjobServices, platform, conf) {
        ...
        this.FileExportAllServices = FileExportAllServices;
        ...
        this.File_page = "FileExportAllTablePage";
        ...
        if (navParams.data.exec_group != null)
            this.exec_group = navParams.data.exec_group;
    }
    FileExportAllPage.prototype.openNavTablePage = function (tablefullname) {
        var _this = this;
    ...
    FileExportAllPage.prototype.openNavFileLogPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileExportAllPage.prototype.openNavRunPage = function (item, id) {
        var _this = this;
    ...
    FileExportAllPage.prototype.ngOnInit = function () {
        this.pageNumber = 1;
        this.offset = 0;
    ...
    FileExportAllPage.prototype.onRowSelect = function (_a) {
        var selected = _a.selected;
        this.selectedItem = selected[0];
    };
    FileExportAllPage.prototype.setPage = function (pageInfo) {
    ...
    FileExportAllPage.prototype.onResize = function (event) {
        this.innerWidth = event.target.innerWidth;
        this.innerHeight = event.target.innerHeight;
    };
    FileExportAllPage.prototype.doInfinite = function () {
        var _this = this;
    ...
    FileExportAllPage.prototype.LoadData = function (init) {
        var _this = this;
        if (init) {
            this.data_list = [];
            this.pageNumber = 1;
        ...
        this.global.createLoader();
        this.global.loading.present().then(function () {
            _this.FileExportAllServices.GetListsByAsync(_this.pageSize, _this.loadPageNumber, _this.keyword, _this.exec_group, _this.exec_file_seq, _this.order_type).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileExportAllPage.prototype.ShowModal = function (item, change_mode) {
        var _this = this;
        if (item == null) {
            this.mode = "POST";
            item = new __WEBPACK_IMPORTED_MODULE_6__Model_ViewModel_FileExportAllViewModel__["a" /* FileExportAllViewModel */]();
            item.is_active = true;
        ...
        var page;
        if (item.func_sub_type === 1)
            page = "FileExportAddEditModalPage";
        if (item.func_sub_type === 2)
            page = "FileExportScriptAddEditModalPage";
        if (item.func_sub_type === 3)
            page = "FileExportTsqlAddEditModalPage";
        if (item.func_sub_type === 4)
            page = "FileExportBlobAddEditModalPage";
        if (item.func_sub_type === 5)
            page = "FileExportHkAddEditModalPage";
        ...
        modal.onDidDismiss(function (select_data) {
            ...
            _this.global.loading.present().then(function () {
                ...
                if (item.func_sub_type === 2)
                    controller = "FileExportScript";
                if (item.func_sub_type === 3)
                    controller = "FileExportTsql";
                if (item.func_sub_type === 4)
                    controller = "FileExportBlob";
                if (item.func_sub_type === 5)
                    controller = "FileExportHk";
                _this.FileExportAllServices.PostPutAsync(controller, select_data, _this.mode).subscribe(function (data) {
    ...
    FileExportAllPage.prototype.Delete = function (item) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.global.createLoader();
                        _this.global.loading.present().then(function () {
                            _this.FileExportAllServices.DeleteAsync(item.exec_file_seq).subscribe(function (data) {
                                if (data.DidError === false) {
                                    _this.LoadData(true);
                                    _this.global.dismissLoading();
    ...
    FileExportAllPage.prototype.openNavSqlPage = function (item, method) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
            _this.FileExportAllServices.GetSqlAsync(item.exec_file_seq, method).subscribe(function (data) {
                if (data.DidError === true) {
                    _this.global.dismissLoading();
                    _this.global.showError(data.ErrorMessage);
                }
    ...
    FileExportAllPage.prototype.openNavExportSqlPage = function (item) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileExportAllPage.prototype.openNavPage = function (item, Page) {
        var _this = this;
        this.global.createLoader("連線中...");
        this.global.loading.present().then(function () {
    ...
    FileExportAllPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_file_export_all_services_file_export_all_services__["a" /* FileExportAllServicesProvider */],
    ...
    return FileExportAllPage;
}());

//# sourceMappingURL=file-export-all.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileExportAllViewModel__ = __webpack_require__(1112);
...
var FileExportAllListResponse = /** @class */ (function (_super) {
    __extends(FileExportAllListResponse, _super);
    function FileExportAllListResponse(obj) {
        ...
        if (_this.DidError === false) {
            obj.Model.forEach(function (data) {
                var item = new __WEBPACK_IMPORTED_MODULE_0__ViewModel_FileExportAllViewModel__["a" /* FileExportAllViewModel */]();
                ...
                item.func_sub_type = data.func_sub_type;
    ...
    return FileExportAllListResponse;
}(__WEBPACK_IMPORTED_MODULE_1__ListModelResponse__["a" /* ListModelResponse */]));

//# sourceMappingURL=FileExportAllListResponse.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileExportAllViewModel__ = __webpack_require__(1112);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var FileExportAllResponse = /** @class */ (function (_super) {
    __extends(FileExportAllResponse, _super);
    function FileExportAllResponse(obj) {
        var _this = _super.call(this, obj) || this;
        _this.Message = obj.Message;
        _this.DidError = obj.DidError;
        _this.ErrorMessage = obj.ErrorMessage;
        if (_this.DidError === false) {
            _this.Model = new __WEBPACK_IMPORTED_MODULE_1__ViewModel_FileExportAllViewModel__["a" /* FileExportAllViewModel */]();
            ...
            _this.Model.func_sub_type = obj.Model.func_sub_type;
            _this.Model.export_mode_key = (obj.Model && obj.Model.export_mode_key) || null;
            _this.Model.last_data_type_key = (obj.Model && obj.Model.last_data_type_key) || null;
            _this.Model.last_data_column_name =
                (obj.Model && obj.Model.last_data_column_name) || null;
            _this.Model.where_condition = (obj.Model && obj.Model.where_condition) || null;
            _this.Model.keep_days = obj.Model.keep_days;
            _this.Model.last_data_type = (obj.Model && obj.Model.last_data_type) || null;
            _this.Model.export_mode = (obj.Model && obj.Model.export_mode) || null;
        }
        return _this;
    }
    return FileExportAllResponse;
}(__WEBPACK_IMPORTED_MODULE_0__SingleModelResponse__["a" /* SingleModelResponse */]));

//# sourceMappingURL=FileExportAllResponse.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_export_all__ = __webpack_require__(1375);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_file_export_all_services_file_export_all_services__ = __webpack_require__(1208);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileExportAllPageModule = /** @class */ (function () {
    function FileExportAllPageModule() {
    }
    FileExportAllPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__file_export_all__["a" /* FileExportAllPage */],
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_4__providers_file_export_all_services_file_export_all_services__["a" /* FileExportAllServicesProvider */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__file_export_all__["a" /* FileExportAllPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            ],
        })
    ], FileExportAllPageModule);
    return FileExportAllPageModule;
}());

//# sourceMappingURL=file-export-all.module.js.map
